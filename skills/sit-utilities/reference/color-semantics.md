# Canvas Color Token Suffix Semantics

Shared reference for suffix modifiers used consistently across all Canvas color utilities — background, border, and text.
...
| Token pattern | Scope |
|--------------|-------|
| `sit:bg-{color}-default` | Page level |
| `sit:bg-{color}-surface-default` | Component level |
| `sit:bg-surface-default` | Component (foundational, no semantic color) |
