...
```html
<div class="sit:bg-surface-default">
...
<div class="sit:bg-surface-default">
  Card background
  <span class="sit:bg-surface-raised">
...
- Always pairs with `sit:text-inverse`

```html
<div class="sit:bg-surface-inverse">
...
**Important**: Always pair with `sit:text-fixed-dark` for contrast.

```html
<div>
  <img src="photo.jpg" />
  <div class="sit:bg-surface-fixed-light">
...
**Important**: Always pair with `sit:text-fixed-light` for contrast.

```html
<div>
  <img src="light-photo.jpg" />
  <div class="sit:bg-surface-fixed-dark">
...
> **Note**: Use library components like `<sit-card>` when available. Surface tokens are for creating custom components when library components don't meet your needs.
...
<div>
  <img src="hero.jpg" />
  <div class="sit:bg-surface-fixed-dark"></div>
  <div class="sit:bg-surface-fixed-light">
    <h2>Image Title</h2>
...
<div class="sit:bg-surface-default">
  <span class="sit:bg-surface-raised">Badge</span>
</div>
```
...
<div class="sit:bg-surface-default">
  <span class="sit:bg-surface-default">Badge doesn't stand out</span>
</div>
```
