---
name: "sit-writing"
description: "Writing style guide for the SIT Canvas Design System. Use when writing or reviewing UI copy, documentation, labels, error messages, tooltips, or any content that accompanies Canvas components. Covers tone, grammar, spelling, casing, punctuation, and plain language principles."
metadata:
  author: sit-canvas
  version: "0.0.0"
  audience: external
...
# Canvas Writing Guide

Content standards for digital products built with the SIT Canvas Design System. Apply these rules to all UI copy, documentation, tooltips, labels, error messages, and any written content that accompanies Canvas components.

---

## Tone and voice

Write as a trusted, competent partner — not as a bureaucracy. Canvas's voice is:
...
**Preferred:** We help students and staff manage their records securely.
**Avoid:** We leverage cutting-edge, innovative solutions to holistically enable seamless data exchange across the institution.
...
- Proper nouns: Singapore Institute of Technology, SIT Canvas, Singapore
- Acronyms that are always written in capitals: API, ICT, UI, UX, PDF, URL
- Product and system names that have an established capitalisation: Canvas
...
- Institutional services or programmes used generically: "the student portal", "the enrolment system"
...
- Alt text for images should describe function, not appearance: "SIT logo" not "blue rectangular image with text".
