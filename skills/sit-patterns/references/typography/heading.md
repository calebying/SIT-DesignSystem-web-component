...
|---|---|---|---|
| H1 | `h1.stories.js` | h1.stories.js | Main page heading with overline and supporting text |
| H1 Light | `h1-light.stories.js` | h1-light.stories.js | Main page heading, light font weight |
| H2 | `h2.stories.js` | h2.stories.js | Secondary heading with overline and supporting text |
| H2 Light | `h2-light.stories.js` | h2-light.stories.js | Secondary heading, light font weight |
| H3 | `h3.stories.js` | h3.stories.js | Tertiary heading with overline and supporting text |
| H3 Light | `h3-light.stories.js` | h3-light.stories.js | Tertiary heading, light font weight |
