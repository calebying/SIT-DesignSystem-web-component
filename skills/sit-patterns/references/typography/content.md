...
|---|---|---|---|
| H4 | `h4.stories.js` | h4.stories.js | Content heading with supporting text |
| H4 Light | `h4-light.stories.js` | h4-light.stories.js | Content heading, light font weight |
| H5 | `h5.stories.js` | h5.stories.js | Content heading variant with supporting text |
| H5 Light | `h5-light.stories.js` | h5-light.stories.js | Content heading variant, light font weight |
| H6 | `h6.stories.js` | h6.stories.js | Content heading variant with supporting text |
| H6 Light | `h6-light.stories.js` | h6-light.stories.js | Content heading variant, light font weight |
