...
|---|---|---|---|
| Paragraph Body Small | `paragraph-body-sm.stories.js` | paragraph-body-sm.stories.js | Body text, small size |
| Paragraph Body Medium | `paragraph-body-md.stories.js` | paragraph-body-md.stories.js | Body text, medium size |
| Paragraph Body Large | `paragraph-body-lg.stories.js` | paragraph-body-lg.stories.js | Body text, large size |
