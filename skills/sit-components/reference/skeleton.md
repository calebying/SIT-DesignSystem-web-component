# Canvas Skeleton Component Skill

`<sit-skeleton>` renders a placeholder shape to represent content that is still loading. Use it to reduce perceived loading time and prevent layout shift when data is being fetched.
...
- Inside components that have a built-in `loading` prop (e.g. `<sit-button loading>`, `<sit-input loading>`) — those render their own loading indicator.
...
<sit-skeleton width="200px" height="20px"></sit-skeleton>

<!-- Rounded rectangle (card) -->
<sit-skeleton width="128px" height="64px" borderRadius="4px"></sit-skeleton>

<!-- Circle (avatar) -->
<sit-skeleton width="96px" height="96px" borderRadius="50%"></sit-skeleton>

<!-- Multiple text lines -->
<sit-skeleton width="100%" height="80px" rows="3"></sit-skeleton>

<!-- Animated shimmer -->
<sit-skeleton width="200px" height="20px" sheen></sit-skeleton>
```
