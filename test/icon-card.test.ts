...
import { SitIconCard } from "../src/components";
import "../src/index";

describe("<sit-icon-card>", () => {
  it("renders a default card", async () => {
    const el = await fixture<SitIconCard>(html`<sit-icon-card></sit-icon-card>`);
  ...
  it("hides .card-media if no icon provided and orientation is horizontal", async () => {
    const el = await fixture<SitIconCard>(html`<sit-icon-card orientation="horizontal"></sit-icon-card>`);
  ...
  it("shows .card-media if icon is slotted", async () => {
    const el = await fixture<SitIconCard>(html`
      <sit-icon-card>
        <span slot="icon">⭐</span>
      </sit-icon-card>
    `);
  ...
  it("shows .card-media with upper slot when orientation is vertical", async () => {
    const el = await fixture<SitIconCard>(html`
      <sit-icon-card orientation="vertical">
  ...
  it("applies disabled class when disabled", async () => {
    const el = await fixture<SitIconCard>(html`<sit-icon-card disabled></sit-icon-card>`);
  ...
  it("renders tinted background when tinted and not noPadding", async () => {
    const el = await fixture<SitIconCard>(html`<sit-icon-card tinted></sit-icon-card>`);
