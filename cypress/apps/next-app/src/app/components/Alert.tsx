...
export const Alert = () => {
  return (
    <>
      <sit-alert variant="neutral" show suppressHydrationWarning>
        <span slot="icon">
      ...
      <sit-alert variant="success" show suppressHydrationWarning>
        <span slot="icon">
        ...
        <div>
          <p>
            ...
            <sit-alert-link href="#" suppressHydrationWarning>alert message</sit-alert-link>.
