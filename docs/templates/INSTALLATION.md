...
npm install @sit-canvas/canvas-web-component@<version>
...
<script src="https://cdn.jsdelivr.net/npm/@sit-canvas/canvas-web-component@<version>/components/Masthead/index.umd.min.js" async crossorigin="anonymous" integrity="<subresource-integrity-masthead>"></script>
