...
const DisplaySmCenterTemplate = () => html`
  <div class="sit:flex sit:flex-col sit:items-center sit:text-center" style="max-width: var(--Sit-text-max-width);">
    ...
    <h1 class="sit:text-display-sm sit:font-bold sit:leading-2-xl sit:tracking-tighter sit:text-display-default">
      Display Small Center Heading
    </h1>
...
export const DisplaySmallCenter = {
  render: DisplaySmCenterTemplate.bind({}),
  name: "Display Small Center"
};
