...
const DisplayMdCenterTemplate = () => html`
  <div class="sit:flex sit:flex-col sit:items-center sit:text-center" style="max-width: var(--Sit-text-max-width);">
    ...
    <h1 class="sit:text-display-md sit:font-bold sit:leading-3-xl sit:tracking-tighter sit:text-display-default">
      Display Medium Center Heading
    </h1>
...
export const DisplayMediumCenter = {
  render: DisplayMdCenterTemplate.bind({}),
  name: "Display Medium Center"
};
