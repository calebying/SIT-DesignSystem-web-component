...
const BodySmTemplate = () => html`
  <div style="max-width: var(--Sit-text-max-width);">
    <p class="sit:text-body-sm sit:font-regular sit:leading-xs sit:tracking-normal sit:text-body-default sit:mb-xl">
    ...
    <p class="sit:text-body-sm sit:font-regular sit:leading-xs sit:tracking-normal sit:text-body-default">
