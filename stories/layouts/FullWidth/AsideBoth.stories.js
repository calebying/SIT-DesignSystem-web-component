...
export default {
  ...
  title: "Layouts/Full Width/Aside Both"
};
    ...
    <main>
      <div class="sit-container sit:py-layout-md">
        <div class="sit-grid sit:gap-layout-md sit:items-stretch">
          <aside class="content-placeholder sit:border sit:border-muted sit-col-3 sit-col-sm-8 sit-col-lg-3"></aside>
          <div class="content-placeholder sit:border sit:border-muted sit-col-6 sit-col-sm-8 sit-col-lg-6"></div>
          <aside class="content-placeholder sit:border sit:border-muted sit-col-3 sit-col-sm-8 sit-col-lg-3"></aside>
        </div>
      </div>
    </main>
