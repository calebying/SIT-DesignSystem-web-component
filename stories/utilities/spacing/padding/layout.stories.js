...
export const Layout = () => html`
  <sit-table>
    ...
    ${TOKENS.map(
      ({ suffix, value }) => html`
        <sit-table-row>
          ${renderTokenCell(`sit:p-layout-${suffix}`)}
          ...
          <sit-table-cell>
            <div
              class="sit:bg-warning-surface-muted sit:border sit:border-warning-default sit:rounded-sm sit:inline-block"
            >
              <div
                class="sit:p-layout-${suffix} sit:bg-warning-default sit:text-fixed-dark sit:rounded-sm sit:text-label-sm"
              >
                Content
              </div>
            </div>
