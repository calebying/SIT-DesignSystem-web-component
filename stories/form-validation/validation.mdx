...
Sit form web components have HTML constraint validation and Sit's own validation behaviour built into it with the [ElementInternals API](https://developer.mozilla.org/en-US/docs/Web/API/ElementInternals)
...
## Sit validation behaviour

Sit form components are validated onchange, after the input is blurred. If the input's value do not meet the constraint validation, it will be flagged as invalid.
...
Try focusing and blurring on the controls without inputting any value to observe Sit onchange validation behaviour.
...
| **Component**      | **Status**                                  | **Constraint Validations**                                                                   | **Sit Validation Behaviour**                                                                                                                                                                                               | **Additional Sit Custom Validation** |
| ------------------ | ------------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
...
| **CheckboxGroup**  | Implemented                                 | 1. Required                                                                                  | 1. Validation after input is touched. <br/> 2. Validation happens on form submit, blocks submission. <br/> 3. Validation resets when form resets. <br/> 4. When disabled, validation is disabled.                           |                                       |
...
| **Combobox**       | Implemented                                 | 1. Required                                                                                  | 1. Validation occurs on `onChange` and after input is touched. <br/> 2. Validation happens on form submit, blocks submission. <br/> 3. Validation resets when form resets. <br/> 4. When disabled, validation is disabled.  |                                       |
| **Datepicker**     | Implemented                                 | 1. Required <br/> 2. Min <br/> 3. Max                                                        | 1. Validation happens on `onChange` and after input is touched. <br/> 2. Validation happens on form submit, blocks submission. <br/> 3. Validation resets when form resets. <br/> 4. When disabled, validation is disabled. |                                       |
