...
export class SitStageCard extends LitElement {
  ...
  _handleGateClick(e) {
    e.stopPropagation();
    this.dispatchEvent(
      new CustomEvent("sit-gate-decision", {
    ...
    return html`
      <div class="stage-inner">
        ...
        <div class="stage-body">
          ...
          ${this.gateLabel
            ? html`<button class="gate-button" ?disabled=${this.gateDisabled} @click=${this._handleGateClick}>
                ${this.gateLabel}
              </button>`
            : ""}
        </div>
...
`;
__decorate([property({ type: String })], SitStageCard.prototype, "stageNumber", void 0);
__decorate([property({ type: String })], SitStageCard.prototype, "stageTitle", void 0);
__decorate([property({ type: String })], SitStageCard.prototype, "stageColor", void 0);
__decorate([property({ type: String })], SitStageCard.prototype, "status", void 0);
__decorate([property({ type: String })], SitStageCard.prototype, "statusLabel", void 0);
__decorate([property({ type: String })], SitStageCard.prototype, "outputLabel", void 0);
__decorate([property({ type: String })], SitStageCard.prototype, "gateLabel", void 0);
__decorate([property({ type: String })], SitStageCard.prototype, "gate", void 0);
__decorate([property({ type: Boolean, reflect: true })], SitStageCard.prototype, "gateDisabled", void 0);
__decorate([property({ type: Boolean, reflect: true })], SitStageCard.prototype, "active", void 0);
__decorate([property({ type: Boolean, reflect: true })], SitStageCard.prototype, "inactive", void 0);
