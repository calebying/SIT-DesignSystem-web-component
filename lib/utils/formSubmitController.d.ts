...
export declare class FormSubmitController implements ReactiveController {
     ...
     */
    doAction(type: "submit" | "reset", invoker?: HTMLInputElement | SitButton): void;
    /** Resets the form, restoring all the control to their default value */
    reset(invoker?: HTMLInputElement | SitButton): void;
    /** Submits the form, triggering validation and form data injection. */
    submit(invoker?: HTMLInputElement | SitButton): void;
}
