...
var sitTextarea = require('../components/Textarea/sit-textarea.cjs.js');
...
ceRegistry.register("sit-textarea", sitTextarea.SitTextarea);
var index = react.createComponent({
    react: React__namespace,
    tagName: "sit-textarea",
    elementClass: sitTextarea.SitTextarea,
    events: {
