...
var sitRadioGroup = require('../components/Radio/sit-radio-group.cjs.js');
...
ceRegistry.register("sit-radio-group", sitRadioGroup.SitRadioGroup);
var index = react.createComponent({
    react: React__namespace,
    tagName: "sit-radio-group",
    elementClass: sitRadioGroup.SitRadioGroup,
    events: {
