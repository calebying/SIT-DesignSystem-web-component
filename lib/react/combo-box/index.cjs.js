...
var sitComboBox = require('../components/ComboBox/sit-combo-box.cjs.js');
...
ceRegistry.register("sit-combo-box", sitComboBox.SitComboBox);
var index = react.createComponent({
    react: React__namespace,
    tagName: "sit-combo-box",
    elementClass: sitComboBox.SitComboBox,
    events: {
