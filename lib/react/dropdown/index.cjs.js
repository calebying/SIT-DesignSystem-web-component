...
var sitDropdown = require('../components/Dropdown/sit-dropdown.cjs.js');
...
ceRegistry.register("sit-dropdown", sitDropdown.SitDropdown);
var index = react.createComponent({
    react: React__namespace,
    tagName: "sit-dropdown",
    elementClass: sitDropdown.SitDropdown,
    events: {
