 ...
 */
class SitFooter extends sitElement["default"] {
    constructor() {
        super(...arguments);
        ...
        this.hasSlotController = new slot.HasSlotController(this, "[default]", "title", "description", "items");
    }
...
SitFooter.styles = [...sitElement["default"].styles, grid["default"], footer["default"]];
/** @internal */
...
exports.SitFooter = SitFooter;
exports["default"] = SitFooter;
//# sourceMappingURL=sit-footer.cjs.js.map
