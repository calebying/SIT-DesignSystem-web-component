...
import css_248z from './tooltip.js';
...
class SitTooltip extends SitElement {
    constructor() {
        ...
        this._tooltipId = genId("tooltip", "bubble");
    ...
    async updateFloatingPosition() {
        if (!this._myTooltip.value || !this._tooltipBubble.value)
            return;
        const { x, y, placement, strategy, middlewareData } = await computePosition(this._tooltipTargetElements[0], this._tooltipBubble.value, {
            strategy: "fixed",
    ...
    async show() {
        ...
        if (this._myTooltip.value && this._tooltipBubble.value) {
            this._cleanupAutoUpdate = autoUpdate(this._tooltipTargetElements[0], this._tooltipBubble.value, () => this.updateFloatingPosition());
        }
...
SitTooltip.styles = [...SitElement.styles, css_248z];
__decorate([
...
export { SitTooltip, SitTooltip as default };
//# sourceMappingURL=sit-tooltip.js.map
