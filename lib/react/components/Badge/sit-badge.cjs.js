...
var sitTooltip = require('../Tooltip/sit-tooltip.cjs.js');
 ...
 */
class SitBadge extends sitElement["default"] {
    constructor() {
        super(...arguments);
    ...
    _handleTruncation() {
        ...
        const badgeLabel = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector(".badge__label");
        if (badgeLabel) {
    ...
    render() {
        return (this.dismissible && this.show) || !this.dismissible
            ? this.truncated
                ? lit.html `<sit-tooltip content=${this.text} @sit-hide=${e => e.stopPropagation()}
...
SitBadge.styles = [...sitElement["default"].styles, badge["default"]];
/**@internal */
SitBadge.dependencies = {
    "sit-close-button": sitCloseButton.SitCloseButton,
    "sit-tooltip": sitTooltip.SitTooltip
};
tslib.__decorate([
...
exports.SitBadge = SitBadge;
exports["default"] = SitBadge;
//# sourceMappingURL=sit-badge.cjs.js.map
