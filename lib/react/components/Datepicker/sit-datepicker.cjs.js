 ...
 */
class SitDatepicker extends validatorMixin.SitFormValidatorMixin(dropdownElement.DropdownElement) {
    constructor() {
        super();
    ...
    render() {
      ...
      <div class="datepicker-container m-width-160">
        <sit-datepicker-input
          ...
          hasFeedback=${ifDefined_js.ifDefined(this.hasFeedback ? "both" : undefined)}
...
SitDatepicker.styles = [...dropdownElement.DropdownElement.styles, dropdownMenu["default"], datepicker["default"]];
/**@internal */
SitDatepicker.dependencies = {
    "sit-datepicker-input": datepickerInput.DatepickerInput,
    "sit-datepicker-calendar": datepickerCalendar.DatepickerCalendar,
    "sit-datepicker-header": datepickerHeader.DatepickerHeader,
...
tslib.__decorate([
    decorators_js.queryAsync("sit-datepicker-calendar")
...
tslib.__decorate([
    decorators_js.query("sit-datepicker-input")
...
exports.SitDatepicker = SitDatepicker;
exports["default"] = SitDatepicker;
//# sourceMappingURL=sit-datepicker.cjs.js.map
