...
var sitBadge = require('../Badge/sit-badge.cjs.js');
...
var sitComboBoxOption = require('./sit-combo-box-option.cjs.js');
 ...
 */
class SitComboBox extends selectElement.SelectElement {
    constructor() {
        super(...arguments);
        ...
        this.suffixIconTemplate = lit.html `<sit-icon
  ...
  ></sit-icon>`;
    ...
    _renderInput(showClearButton) {
      ...
      >
        ...
        <div class="combobox-input-container">
          ${this.multiSelect
            ? lit.html `
                ${repeat_js.repeat(this.selectedItems, item => item.value, item => lit.html `<sit-badge
                      outlined
                      variant="neutral"
                      show
    ...
    _renderFeedbackMenu() {
        ...
        if (this.async) {
            return this.emptyMenuAsync || this.optionList.length === 0 ? this._renderEmptyMenu() : lit.nothing;
        }
        else {
    ...
    render() {
      ...
      >
        ...
        >
          <slot
            id="default"
            class=${classMap_js.classMap({ "d-none": this.loading || this.emptyMenuAsync || this.optionList.length === 0 })}
...
SitComboBox.styles = [...selectElement.SelectElement.styles, formTextControl["default"], comboBox["default"]];
SitComboBox.childName = "sit-combo-box-option";
/** @internal */
SitComboBox.dependencies = {
    [SitComboBox.childName]: sitComboBoxOption.SitComboBoxOption,
    "sit-icon": sitIcon.SitIcon,
    "sit-badge": sitBadge.SitBadge,
...
tslib.__decorate([
    decorators_js.queryAssignedElements({ flatten: true, selector: "sit-combo-box-option" })
...
tslib.__decorate([
    watch.watch("optionList", { waitUntilFirstUpdate: true })
...
exports.SitComboBox = SitComboBox;
exports["default"] = SitComboBox;
//# sourceMappingURL=sit-combo-box.cjs.js.map
