 ...
 *
 */
class SitTabGroup extends sitElement["default"] {
    constructor() {
        super(...arguments);
        this._tabs = [];
        this._panels = [];
    ...
    _getAllPanels() {
        return [...this._body.assignedElements()].filter(el => el.tagName.toLowerCase() === "sit-tab-panel");
    }
    _getActiveTab() {
    ...
    _handleClick(event) {
        ...
        const tab = target.closest("sit-tab");
        const tabGroup = tab === null || tab === void 0 ? void 0 : tab.closest("sit-tab-group");
    ...
    _handleKeyDown(event) {
        ...
        if (["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(event.key)) {
            ...
            if ((activeEl === null || activeEl === void 0 ? void 0 : activeEl.tagName.toLowerCase()) === "sit-tab") {
...
SitTabGroup.styles = [...sitElement["default"].styles, tabGroup["default"]];
tslib.__decorate([
    decorators_js.query(".tab-group")
], SitTabGroup.prototype, "_tabGroup", void 0);
tslib.__decorate([
    decorators_js.query(".tab-group__body")
], SitTabGroup.prototype, "_body", void 0);
tslib.__decorate([
    decorators_js.query(".tab-group__nav")
], SitTabGroup.prototype, "_nav", void 0);
tslib.__decorate([
    decorators_js.property({ type: String, reflect: true })
], SitTabGroup.prototype, "variant", void 0);
tslib.__decorate([
    decorators_js.property({ type: String, reflect: true })
], SitTabGroup.prototype, "orientation", void 0);
tslib.__decorate([
    decorators_js.property({ type: String, reflect: true })
], SitTabGroup.prototype, "density", void 0);
tslib.__decorate([
    decorators_js.queryAssignedElements({ slot: "nav", flatten: true })
], SitTabGroup.prototype, "_navSlot", void 0);

exports.SitTabGroup = SitTabGroup;
exports["default"] = SitTabGroup;
//# sourceMappingURL=sit-tab-group.cjs.js.map
