 ...
 */
class SitIconButton extends buttonElement["default"] {
        ...
        return staticHtml_js.html `
          ...
          >
            ...
            ? staticHtml_js.html `<sit-spinner
                  ...
                  ></sit-spinner>`
            : staticHtml_js.html `<sit-icon
                    name=${ifDefined_js.ifDefined(this.name)}
                    size=${ifDefined_js.ifDefined(this._assignIconSize(this.size))}
                  ></sit-icon>`}
          </${tag}>
        `;
    }
}
SitIconButton.styles = [...buttonElement["default"].styles, iconButton["default"]];
/** @internal */
SitIconButton.dependencies = {
    "sit-icon": sitIcon.SitIcon,
    "sit-spinner": sitSpinner.SitSpinner
};
tslib.__decorate([
    decorators_js.property({ type: String, reflect: true })
], SitIconButton.prototype, "name", void 0);

exports.SitIconButton = SitIconButton;
exports["default"] = SitIconButton;
//# sourceMappingURL=sit-icon-button.cjs.js.map
