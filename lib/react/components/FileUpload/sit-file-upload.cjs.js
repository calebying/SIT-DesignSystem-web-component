...
var file = require('../../utils/file.cjs.js');
 ...
 */
class SitFileUpload extends validatorMixin.SitFormValidatorMixin(formControlElement["default"]) {
    constructor() {
        super(...arguments);
        ...
        this._dragZoneRef = ref_js.createRef();
        this._dragCounter = 0;
    ...
    _renderLabel() {
        const labelTemplate = lit.html ` <label id=${this._labelId} class="form-label"> ${this.label} </label> `;
    ...
    render() {
        const getCheckedIcon = (metadata) => {
            ...
            return lit.html `<sit-icon name="check-circle-fill" class="${iconClass}"></sit-icon>`;
        };
        const listItems = repeat_js.repeat(this.selectedFiles, file => file, // Use File object as stable key
        (file$1, index) => {
            const metadata = this.fileMetadata.get(file$1);
            return lit.html `
          <li class="file-upload-list-item-container ${this.exitingFile === file$1 ? "file-upload-exit" : ""}">
            <div class="file-upload-list-item ${(metadata === null || metadata === void 0 ? void 0 : metadata.error) ? "file-upload-error" : ""}">
              ${(metadata === null || metadata === void 0 ? void 0 : metadata.uploading) ? lit.html `<sit-spinner size="sm"></sit-spinner>` : getCheckedIcon(metadata)}
              <span class="filename">${file$1.name}</span>
              <span class="filesize">${file.formatFileSize(file$1.size)}</span>
              <sit-close-button
...
SitFileUpload.styles = [...formControlElement["default"].styles, fileUpload["default"]];
/**@internal */
...
exports.SitFileUpload = SitFileUpload;
exports["default"] = SitFileUpload;
//# sourceMappingURL=sit-file-upload.cjs.js.map
