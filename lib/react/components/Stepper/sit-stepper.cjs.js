 ...
 *
 */
class SitStepper extends sitElement["default"] {
    constructor() {
        super(...arguments);
    ...
    render() {
        return lit.html `
      <div
        class="stepper ${classMap_js.classMap({
                ...
                <div class="stepper-item-container">
                  ...
                  >
                    <div class="stepper-marker">
                      ${iconName ? lit.html `<sit-icon name=${iconName} size="md"></sit-icon>` : index + 1}
                    </div>
...
SitStepper.styles = [...sitElement["default"].styles, stepper["default"]];
/** @internal */
SitStepper.dependencies = { "sit-icon": sitIcon.SitIcon };
tslib.__decorate([
...
exports.SitStepper = SitStepper;
exports["default"] = SitStepper;
//# sourceMappingURL=sit-stepper.cjs.js.map
