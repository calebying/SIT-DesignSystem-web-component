...
class SitSidebar extends sitElement["default"] {
    ...
    _handleActiveItem(oldItem) {
        ...
        if (childLevel === 1) {
            ...
            while (parentEle instanceof sitSidebarGroup.SitSidebarGroup && parentEle._childLevel >= 1) {
     ...
     */
    _handleResize() {
        const isNarrowViewport = window.innerWidth < breakpoints.XL_BREAKPOINT;
    ...
    _updateOverlayState() {
        if (this.variant === "overlay") {
            ...
            this._isOverlay = window.innerWidth < breakpoints.MD_BREAKPOINT;
        }
        else {
            this._isOverlay = false;
        }
...
SitSidebar.styles = [...sitElement["default"].styles, sidebar["default"]];
...
tslib.__decorate([
    context.provide({ context: sidebarContext.SidebarActiveGroup }),
    decorators_js.state()
], SitSidebar.prototype, "_sidebarActiveGroup", void 0);
tslib.__decorate([
    context.provide({ context: sidebarContext.SidebarCollapsed }),
    decorators_js.state()
], SitSidebar.prototype, "_sidebarCollapsed", void 0);
tslib.__decorate([
    context.provide({ context: sidebarContext.SidebarActiveItem }),
    decorators_js.state()
], SitSidebar.prototype, "_sidebarActiveItem", void 0);
tslib.__decorate([
    context.provide({ context: sidebarContext.SidebarDrawerItems }),
    decorators_js.state()
], SitSidebar.prototype, "_drawerItems", void 0);
tslib.__decorate([
    context.provide({ context: sidebarContext.SidebarDrawerOpen }),
    decorators_js.state()
], SitSidebar.prototype, "_showDrawer", void 0);
tslib.__decorate([
    context.provide({ context: sidebarContext.SidebarDrawerOverlay }),
    decorators_js.state()
...
exports.SitSidebar = SitSidebar;
exports["default"] = SitSidebar;
//# sourceMappingURL=sit-sidebar.cjs.js.map
