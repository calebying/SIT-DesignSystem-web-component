...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const O=(e,t,l)=>(l.configurable=!0,l.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,l),l);
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */let k;function B(e,t){return(l,o,n)=>{const r=l=>{const n=l.renderRoot?.querySelector(e)??null;if(null===n&&t&&!l.hasUpdated){const t="object"==typeof o?o.name:o;k("",`@query'd field ${JSON.stringify(String(t))} with the 'cache' flag set for selector '${e}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return n};if(t){const{get:e,set:t}="object"==typeof o?l:n??(()=>{const e=Symbol(`${String(o)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return O(l,o,{get(){let l=e.call(this);return void 0===l&&(l=r(this),(null!==l||this.hasUpdated)&&t.call(this,l)),l}})}return O(l,o,{get(){return r(this)}})}}
/**
   * @license
   * Copyright 2021 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function A(e){return(t,l)=>{const{slot:o,selector:n}=e??{},r="slot"+(o?`[name=${o}]`:":not([name])");return O(t,l,{get(){const t=this.renderRoot?.querySelector(r),l=t?.assignedElements(e)??[];return void 0===n?l:l.filter(e=>e.matches(n))}})}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */globalThis.litIssuedWarnings??=new Set,k=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))};const j=globalThis,$=e=>{j.emitLitDebugLogEvents&&j.dispatchEvent(new CustomEvent("lit-debug",{detail:e}))};let L,S=0;j.litIssuedWarnings??=new Set,L=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",j.litIssuedWarnings.has(t)||j.litIssuedWarnings.has(e)||(console.warn(t),j.litIssuedWarnings.add(t))},queueMicrotask(()=>{L("dev-mode","Lit is in dev mode. Not recommended for production!")});const E=j.ShadyDOM?.inUse&&!0===j.ShadyDOM?.noPatch?j.ShadyDOM.wrap:e=>e,T=j.trustedTypes,R=T?T.createPolicy("lit-html",{createHTML:e=>e}):void 0,I=e=>e,D=(e,t,l)=>I,N=e=>{if(fe!==D)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");fe=e},U=()=>{fe=D},W=(e,t,l)=>fe(e,t,l),F="$lit$",q=`lit$${Math.random().toFixed(9).slice(2)}$`,K="?"+q,J=`<${K}>`,Y=document,X=()=>Y.createComment(""),G=e=>null===e||"object"!=typeof e&&"function"!=typeof e,Q=Array.isArray,ee="[ \t\n\f\r]",te=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,le=/-->/g,oe=/>/g,ne=new RegExp(`>|${ee}(?:([^\\s"'>=/]+)(${ee}*=${ee}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),re=/'/g,ie=/"/g,ae=/^(?:script|style|textarea|title)$/i,ce=(se=1,(e,...t)=>(e.some(e=>void 0===e)&&console.warn("Some template strings are undefined.\nThis is probably caused by illegal octal escape sequences."),t.some(e=>e?._$litStatic$)&&L("","Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.\nPlease use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions"),{_$litType$:se,strings:e,values:t}));var se;const he=Symbol.for("lit-noChange"),de=Symbol.for("lit-nothing"),ue=new WeakMap,ve=Y.createTreeWalker(Y,129);let fe=D;function pe(e,t){if(!Q(e)||!e.hasOwnProperty("raw")){let e="invalid template strings array";throw e="\n          Internal Error: expected template strings to be an array\n          with a 'raw' field. Faking a template strings array by\n          calling html or svg like an ordinary function is effectively\n          the same as calling unsafeHtml and can lead to major security\n          issues, e.g. opening your code up to XSS attacks.\n          If you're using the html or svg tagged template functions normally\n          and still seeing this error, please file a bug at\n          https://github.com/lit/lit/issues/new?template=bug_report.md\n          and include information about your build tooling, if any.\n        ".trim().replace(/\n */g,"\n"),new Error(e)}return void 0!==R?R.createHTML(t):t}class ge{constructor({strings:e,_$litType$:t},l){let o;this.parts=[];let n=0,r=0;const i=e.length-1,a=this.parts,[c,s]=((e,t)=>{const l=e.length-1,o=[];let n,r=2===t?"<svg>":3===t?"<math>":"",i=te;for(let t=0;t<l;t++){const l=e[t];let a,c,s=-1,h=0;for(;h<l.length&&(i.lastIndex=h,c=i.exec(l),null!==c);)if(h=i.lastIndex,i===te){if("!--"===c[1])i=le;else if(void 0!==c[1])i=oe;else if(void 0!==c[2])ae.test(c[2])&&(n=new RegExp(`</${c[2]}`,"g")),i=ne;else if(void 0!==c[3])throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else i===ne?">"===c[0]?(i=n??te,s=-1):void 0===c[1]?s=-2:(s=i.lastIndex-c[2].length,a=c[1],i=void 0===c[3]?ne:'"'===c[3]?ie:re):i===ie||i===re?i=ne:i===le||i===oe?i=te:(i=ne,n=void 0);console.assert(-1===s||i===ne||i===re||i===ie,"unexpected parse state B");const d=i===ne&&e[t+1].startsWith("/>")?" ":"";r+=i===te?l+J:s>=0?(o.push(a),l.slice(0,s)+F+l.slice(s)+q+d):l+q+(-2===s?t:d)}return[pe(e,r+(e[l]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),o]})(e,t);if(this.el=ge.createElement(c,l),ve.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(o=ve.nextNode())&&a.length<i;){if(1===o.nodeType){{const e=o.localName;if(/^(?:textarea|template)$/i.test(e)&&o.innerHTML.includes(q)){const t=`Expressions are not supported inside \`${e}\` elements. See https://lit.dev/msg/expression-in-${e} for more information.`;if("template"===e)throw new Error(t);L("",t)}}if(o.hasAttributes())for(const e of o.getAttributeNames())if(e.endsWith(F)){const t=s[r++],l=o.getAttribute(e).split(q),i=/([.?@])?(.*)/.exec(t);a.push({type:1,index:n,name:i[2],strings:l,ctor:"."===i[1]?be:"?"===i[1]?Ze:"@"===i[1]?Ce:xe}),o.removeAttribute(e)}else e.startsWith(q)&&(a.push({type:6,index:n}),o.removeAttribute(e));if(ae.test(o.tagName)){const e=o.textContent.split(q),t=e.length-1;if(t>0){o.textContent=T?T.emptyScript:"";for(let l=0;l<t;l++)o.append(e[l],X()),ve.nextNode(),a.push({type:2,index:++n});o.append(e[t],X())}}}else if(8===o.nodeType){if(o.data===K)a.push({type:2,index:n});else{let e=-1;for(;-1!==(e=o.data.indexOf(q,e+1));)a.push({type:7,index:n}),e+=q.length-1}}n++}if(s.length!==r)throw new Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+e.join("${...}")+"`");$&&$({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const l=Y.createElement("template");return l.innerHTML=e,l}}function we(e,t,l=e,o){if(t===he)return t;let n=void 0!==o?l.__directives?.[o]:l.__directive;const r=G(t)?void 0:t._$litDirective$;return n?.constructor!==r&&(n?._$notifyDirectiveConnectionChanged?.(!1),void 0===r?n=void 0:(n=new r(e),n._$initialize(e,l,o)),void 0!==o?(l.__directives??=[])[o]=n:l.__directive=n),void 0!==n&&(t=we(e,n._$resolve(e,t.values),n,o)),t}class me{constructor(e,t){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){const{el:{content:t},parts:l}=this._$template,o=(e?.creationScope??Y).importNode(t,!0);ve.currentNode=o;let n=ve.nextNode(),r=0,i=0,a=l[0];for(;void 0!==a;){if(r===a.index){let t;2===a.type?t=new _e(n,n.nextSibling,this,e):1===a.type?t=new a.ctor(n,a.name,a.strings,this,e):6===a.type&&(t=new Me(n,this,e)),this._$parts.push(t),a=l[++i]}r!==a?.index&&(n=ve.nextNode(),r++)}return ve.currentNode=Y,o}_update(e){let t=0;for(const l of this._$parts)void 0!==l&&($&&$({kind:"set part",part:l,value:e[t],valueIndex:t,values:e,templateInstance:this}),void 0!==l.strings?(l._$setValue(e,l,t),t+=l.strings.length-2):l._$setValue(e[t])),t++}}class _e{get _$isConnected(){return this._$parent?._$isConnected??this.__isConnected}constructor(e,t,l,o){this.type=2,this._$committedValue=de,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=l,this.options=o,this.__isConnected=o?.isConnected??!0,this._textSanitizer=void 0}get parentNode(){let e=E(this._$startNode).parentNode;const t=this._$parent;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){if(null===this.parentNode)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=we(this,e,t),G(e))e===de||null==e||""===e?(this._$committedValue!==de&&($&&$({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=de):e!==this._$committedValue&&e!==he&&this._commitText(e);else if(void 0!==e._$litType$)this._commitTemplateResult(e);else if(void 0!==e.nodeType){if(this.options?.host===e)return this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),void console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");this._commitNode(e)}else(e=>Q(e)||"function"==typeof e?.[Symbol.iterator])(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return E(E(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){if(this._$committedValue!==e){if(this._$clear(),fe!==D){const e=this._$startNode.parentNode?.nodeName;if("STYLE"===e||"SCRIPT"===e){let t="Forbidden";throw t="STYLE"===e?"Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":"Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(t)}}$&&$({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==de&&G(this._$committedValue)){const t=E(this._$startNode).nextSibling;void 0===this._textSanitizer&&(this._textSanitizer=W(t,"data","property")),e=this._textSanitizer(e),$&&$({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=Y.createTextNode("");this._commitNode(t),void 0===this._textSanitizer&&(this._textSanitizer=W(t,"data","property")),e=this._textSanitizer(e),$&&$({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){const{values:t,_$litType$:l}=e,o="number"==typeof l?this._$getTemplate(e):(void 0===l.el&&(l.el=ge.createElement(pe(l.h,l.h[0]),this.options)),l);if(this._$committedValue?._$template===o)$&&$({kind:"template updating",template:o,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:t}),this._$committedValue._update(t);else{const e=new me(o,this),l=e._clone(this.options);$&&$({kind:"template instantiated",template:o,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),e._update(t),$&&$({kind:"template instantiated and updated",template:o,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),this._commitNode(l),this._$committedValue=e}}_$getTemplate(e){let t=ue.get(e.strings);return void 0===t&&ue.set(e.strings,t=new ge(e)),t}_commitIterable(e){Q(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let l,o=0;for(const n of e)o===t.length?t.push(l=new _e(this._insert(X()),this._insert(X()),this,this.options)):l=t[o],l._$setValue(n),o++;o<t.length&&(this._$clear(l&&E(l._$endNode).nextSibling,o),t.length=o)}_$clear(e=E(this._$startNode).nextSibling,t){for(this._$notifyConnectionChanged?.(!1,!0,t);e!==this._$endNode;){const t=E(e).nextSibling;E(e).remove(),e=t}}setConnected(e){if(void 0!==this._$parent)throw new Error("part.setConnected() may only be called on a RootPart returned from render().");this.__isConnected=e,this._$notifyConnectionChanged?.(e)}}class xe{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(e,t,l,o,n){this.type=1,this._$committedValue=de,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=o,this.options=n,l.length>2||""!==l[0]||""!==l[1]?(this._$committedValue=new Array(l.length-1).fill(new String),this.strings=l):this._$committedValue=de,this._sanitizer=void 0}_$setValue(e,t=this,l,o){const n=this.strings;let r=!1;if(void 0===n)e=we(this,e,t,0),r=!G(e)||e!==this._$committedValue&&e!==he,r&&(this._$committedValue=e);else{const o=e;let i,a;for(e=n[0],i=0;i<n.length-1;i++)a=we(this,o[l+i],t,i),a===he&&(a=this._$committedValue[i]),r||=!G(a)||a!==this._$committedValue[i],a===de?e=de:e!==de&&(e+=(a??"")+n[i+1]),this._$committedValue[i]=a}r&&!o&&this._commitValue(e)}_commitValue(e){e===de?E(this.element).removeAttribute(this.name):(void 0===this._sanitizer&&(this._sanitizer=fe(this.element,this.name,"attribute")),e=this._sanitizer(e??""),$&&$({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),E(this.element).setAttribute(this.name,e??""))}}class be extends xe{constructor(){super(...arguments),this.type=3}_commitValue(e){void 0===this._sanitizer&&(this._sanitizer=fe(this.element,this.name,"property")),e=this._sanitizer(e),$&&$({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===de?void 0:e}}class Ze extends xe{constructor(){super(...arguments),this.type=4}_commitValue(e){$&&$({kind:"commit boolean attribute",element:this.element,name:this.name,value:!(!e||e===de),options:this.options}),E(this.element).toggleAttribute(this.name,!!e&&e!==de)}}class Ce extends xe{constructor(e,t,l,o,n){if(super(e,t,l,o,n),this.type=5,void 0!==this.strings)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){if((e=we(this,e,t,0)??de)===he)return;const l=this._$committedValue,o=e===de&&l!==de||e.capture!==l.capture||e.once!==l.once||e.passive!==l.passive,n=e!==de&&(l===de||o);$&&$({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:o,addListener:n,oldListener:l}),o&&this.element.removeEventListener(this.name,this,l),n&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){"function"==typeof this._$committedValue?this._$committedValue.call(this.options?.host??this.element,e):this._$committedValue.handleEvent(e)}}class Me{constructor(e,t,l){this.element=e,this.type=6,this._$disconnectableChildren=void 0,this._$parent=t,this.options=l}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){$&&$({kind:"commit to element binding",element:this.element,value:e,options:this.options}),we(this,e)}}const ye=j.litHtmlPolyfillSupportDevMode;ye?.(ge,_e),(j.litHtmlVersions??=[]).push("3.3.3"),j.litHtmlVersions.length>1&&queueMicrotask(()=>{L("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});const Ve=(e,t,l)=>{if(null==t)throw new TypeError(`The container to render into may not be ${t}`);const o=S++,n=l?.renderBefore??t;let r=n._$litPart$;if($&&$({kind:"begin render",id:o,value:e,container:t,options:l,part:r}),void 0===r){const e=l?.renderBefore??null;n._$litPart$=r=new _e(t.insertBefore(X(),e),e,void 0,l??{})}return r._$setValue(e),$&&$({kind:"end render",id:o,value:e,container:t,options:l,part:r}),r};Ve.setSanitizer=N,Ve.createSanitizer=W,Ve._testOnlyClearSanitizerFactoryDoNotCallOrElse=U;
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const He=e=>e??de,Pe=Symbol.for(""),ze=e=>{if(e?.r===Pe)return e?._$litStatic$},Oe=new Map,ke=(Be=ce,(e,...t)=>{const l=t.length;let o,n;const r=[],i=[];let a,c=0,s=!1;for(;c<l;){for(a=e[c];c<l&&void 0!==(n=t[c],o=ze(n));)a+=o+e[++c],s=!0;c!==l&&i.push(n),r.push(a),c++}if(c===l&&r.push(e[l]),s){const l=r.join("$$lit$$");void 0===(e=Oe.get(l))&&(r.raw=r,Oe.set(l,e=r)),t=i}return Be(e,...t)});
/**
   * @license
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const We=(e,t)=>{const l=e._$disconnectableChildren;if(void 0===l)return!1;for(const e of l)e._$notifyDirectiveConnectionChanged?.(t,!1),We(e,t);return!0},Fe=e=>{let t,l;do{if(void 0===(t=e._$parent))break;l=t._$disconnectableChildren,l.delete(e),e=t}while(0===l?.size)},qe=e=>{for(let t;t=e._$parent;e=t){let l=t._$disconnectableChildren;if(void 0===l)t._$disconnectableChildren=l=new Set;else if(l.has(e))break;l.add(e),Ye(t)}};function Ke(e){void 0!==this._$disconnectableChildren?(Fe(this),this._$parent=e,qe(this)):this._$parent=e}function Je(e,t=!1,l=0){const o=this._$committedValue,n=this._$disconnectableChildren;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(o))for(let e=l;e<o.length;e++)We(o[e],!1),Fe(o[e]);else null!=o&&(We(o,!1),Fe(o));else We(this,e)}const Ye=e=>{e.type==De&&(e._$notifyConnectionChanged??=Je,e._$reparentDisconnectables??=Ke)};class Xe extends Ue{constructor(){super(...arguments),this._$disconnectableChildren=void 0}_$initialize(e,t,l){super._$initialize(e,t,l),qe(this),this.isConnected=e._$isConnected}_$notifyDirectiveConnectionChanged(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(We(this,e),Fe(this))}setValue(e){if(void 0===this.__part.strings)this.__part._$setValue(e,this);else{if(void 0===this.__attributeIndex)throw new Error("Expected this.__attributeIndex to be a number");const t=[...this.__part._$committedValue];t[this.__attributeIndex]=e,this.__part._$setValue(t,this,0)}}disconnected(){}reconnected(){}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const Ge=()=>new Qe;class Qe{}const et=new WeakMap;const tt=Ne(class extends Xe{render(e){return de}update(e,[t]){const l=t!==this._ref;return l&&this._updateRefValue(void 0),(l||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),de}_updateRefValue(e){if(void 0!==this._ref)if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let l=et.get(t);void 0===l&&(l=new WeakMap,et.set(t,l)),void 0!==l.get(this._ref)&&this._ref.call(this._context,void 0),l.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?et.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}}),lt=Math.min,ot=Math.max,nt=Math.round,rt=Math.floor,it=e=>({x:e,y:e}),at={left:"right",right:"left",bottom:"top",top:"bottom"};function ct(e,t,l){return ot(e,lt(t,l))}function st(e,t){return"function"==typeof e?e(t):e}function ht(e){return e.split("-")[0]}function dt(e){return e.split("-")[1]}function ut(e){return"x"===e?"y":"x"}function vt(e){return"y"===e?"height":"width"}function ft(e){const t=e[0];return"t"===t||"b"===t?"y":"x"}function pt(e){return ut(ft(e))}function gt(e,t,l){void 0===l&&(l=!1);const o=dt(e),n=pt(e),r=vt(n);let i="x"===n?o===(l?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[r]>t.floating[r]&&(i=Ct(i)),[i,Ct(i)]}function wt(e){return e.includes("start")?e.replace("start","end"):e.replace("end","start")}const mt=["left","right"],_t=["right","left"],xt=["top","bottom"],bt=["bottom","top"];function Zt(e,t,l,o){const n=dt(e);let r=function(e,t,l){switch(e){case"top":case"bottom":return l?t?_t:mt:t?mt:_t;case"left":case"right":return t?xt:bt;default:return[]}}(ht(e),"start"===l,o);return n&&(r=r.map(e=>e+"-"+n),t&&(r=r.concat(r.map(wt)))),r}function Ct(e){const t=ht(e);return at[t]+e.slice(t.length)}function Mt(e){return"number"!=typeof e?function(e){var t,l,o,n;return{top:null!=(t=e.top)?t:0,right:null!=(l=e.right)?l:0,bottom:null!=(o=e.bottom)?o:0,left:null!=(n=e.left)?n:0}}(e):{top:e,right:e,bottom:e,left:e}}function yt(e){const{x:t,y:l,width:o,height:n}=e;return{width:o,height:n,top:l,left:t,right:t+o,bottom:l+n,x:t,y:l}}function Vt(e,t,l){let{reference:o,floating:n}=e;const r=ft(t),i=pt(t),a=vt(i),c=ht(t),s="y"===r,h=o.x+o.width/2-n.width/2,d=o.y+o.height/2-n.height/2,u=o[a]/2-n[a]/2;let v;switch(c){case"top":v={x:h,y:o.y-n.height};break;case"bottom":v={x:h,y:o.y+o.height};break;case"right":v={x:o.x+o.width,y:d};break;case"left":v={x:o.x-n.width,y:d};break;default:v={x:o.x,y:o.y}}const f=dt(t);return f&&(v[i]+=u*("end"===f?1:-1)*(l&&s?-1:1)),v}async function Ht(e,t){var l;void 0===t&&(t={});const{x:o,y:n,platform:r,rects:i,elements:a,strategy:c}=e,{boundary:s="clippingAncestors",rootBoundary:h="viewport",elementContext:d="floating",altBoundary:u=!1,padding:v=0}=st(t,e),f=Mt(v),p=a[u?"floating"===d?"reference":"floating":d],g=yt(await r.getClippingRect({element:null==(l=await(null==r.isElement?void 0:r.isElement(p)))||l?p:p.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(a.floating)),boundary:s,rootBoundary:h,strategy:c})),w="floating"===d?{x:o,y:n,width:i.floating.width,height:i.floating.height}:i.reference,m=await(null==r.getOffsetParent?void 0:r.getOffsetParent(a.floating)),_=await(null==r.isElement?void 0:r.isElement(m))&&await(null==r.getScale?void 0:r.getScale(m))||{x:1,y:1},x=yt(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:m,strategy:c}):w);return{top:(g.top-x.top+f.top)/_.y,bottom:(x.bottom-g.bottom+f.bottom)/_.y,left:(g.left-x.left+f.left)/_.x,right:(x.right-g.right+f.right)/_.x}}const Pt=new Set(["left","top"]);function zt(){return"undefined"!=typeof window}function Ot(e){return At(e)?(e.nodeName||"").toLowerCase():"#document"}function kt(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function Bt(e){var t;return null==(t=(At(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function At(e){return!!zt()&&(e instanceof Node||e instanceof kt(e).Node)}function jt(e){return!!zt()&&(e instanceof Element||e instanceof kt(e).Element)}function $t(e){return!!zt()&&(e instanceof HTMLElement||e instanceof kt(e).HTMLElement)}function Lt(e){return!(!zt()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof kt(e).ShadowRoot)}function St(e){const{overflow:t,overflowX:l,overflowY:o,display:n}=qt(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+l)&&"inline"!==n&&"contents"!==n}function Et(e){return/^(table|td|th)$/.test(Ot(e))}function Tt(e){try{if(e.matches(":popover-open"))return!0}catch(e){}try{return e.matches(":modal")}catch(e){return!1}}const Rt=/transform|translate|scale|rotate|perspective|filter/,It=/paint|layout|strict|content/,Dt=e=>!!e&&"none"!==e;let Nt;function Ut(e){const t=jt(e)?qt(e):e;return Dt(t.transform)||Dt(t.translate)||Dt(t.scale)||Dt(t.rotate)||Dt(t.perspective)||!Wt()&&(Dt(t.backdropFilter)||Dt(t.filter))||Rt.test(t.willChange||"")||It.test(t.contain||"")}function Wt(){return null==Nt&&(Nt="undefined"!=typeof CSS&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),Nt}function Ft(e){return/^(html|body|#document)$/.test(Ot(e))}function qt(e){return kt(e).getComputedStyle(e)}function Kt(e){return jt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Jt(e){if("html"===Ot(e))return e;const t=e.assignedSlot||e.parentNode||Lt(e)&&e.host||Bt(e);return Lt(t)?t.host:t}function Yt(e){const t=Jt(e);return Ft(t)?(e.ownerDocument||e).body:$t(t)&&St(t)?t:Yt(t)}function Xt(e,t,l){var o;void 0===t&&(t=[]),void 0===l&&(l=!0);const n=Yt(e),r=n===(null==(o=e.ownerDocument)?void 0:o.body),i=kt(n);if(r){const e=Gt(i);return t.concat(i,i.visualViewport||[],St(n)?n:[],e&&l?Xt(e):[])}return t.concat(n,Xt(n,[],l))}function Gt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Qt(e){const t=qt(e);let l=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const n=$t(e),r=n?e.offsetWidth:l,i=n?e.offsetHeight:o,a=nt(l)!==r||nt(o)!==i;return a&&(l=r,o=i),{width:l,height:o,$:a}}function el(e){return jt(e)?e:e.contextElement}function tl(e){const t=el(e);if(!$t(t))return it(1);const l=t.getBoundingClientRect(),{width:o,height:n,$:r}=Qt(t);let i=(r?nt(l.width):l.width)/o,a=(r?nt(l.height):l.height)/n;return i&&Number.isFinite(i)||(i=1),a&&Number.isFinite(a)||(a=1),{x:i,y:a}}const ll=it(0);function ol(e){const t=kt(e);return Wt()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:ll}function nl(e,t,l,o){void 0===t&&(t=!1),void 0===l&&(l=!1);const n=e.getBoundingClientRect(),r=el(e);let i=it(1);t&&(o?jt(o)&&(i=tl(o)):i=tl(e));const a=function(e,t,l){return void 0===t&&(t=!1),!!l&&t&&l===kt(e)}(r,l,o)?ol(r):it(0);let c=(n.left+a.x)/i.x,s=(n.top+a.y)/i.y,h=n.width/i.x,d=n.height/i.y;if(r&&o){const e=kt(r),t=jt(o)?kt(o):o;let l=e,n=Gt(l);for(;n&&t!==l;){const e=tl(n),t=n.getBoundingClientRect(),o=qt(n),r=t.left+(n.clientLeft+parseFloat(o.paddingLeft))*e.x,i=t.top+(n.clientTop+parseFloat(o.paddingTop))*e.y;c*=e.x,s*=e.y,h*=e.x,d*=e.y,c+=r,s+=i,l=kt(n),n=Gt(l)}}return yt({width:h,height:d,x:c,y:s})}function rl(e,t){const l=Kt(e).scrollLeft;return t?t.left+l:nl(Bt(e)).left+l}function il(e,t){const l=e.getBoundingClientRect();return{x:l.left+t.scrollLeft-rl(e,l),y:l.top+t.scrollTop}}function al(e,t,l){let o;if("viewport"===t||"layoutViewport"===t)o=function(e,t,l){void 0===l&&(l="viewport");const o="layoutViewport"===l,n=kt(e),r=Bt(e),i=n.visualViewport;let a=r.clientWidth,c=r.clientHeight,s=0,h=0;if(i){const e=!Wt()||"fixed"===t;o?e||(s=-i.offsetLeft,h=-i.offsetTop):(a=i.width,c=i.height,e&&(s=i.offsetLeft,h=i.offsetTop))}if(rl(r)<=0){const e=r.ownerDocument,t=e.body,l=getComputedStyle(t),o="CSS1Compat"===e.compatMode&&parseFloat(l.marginLeft)+parseFloat(l.marginRight)||0,n=Math.abs(r.clientWidth-t.clientWidth-o),i="stable both-edges"===getComputedStyle(r).scrollbarGutter?n/2:n;i<=25&&(a-=i)}return{width:a,height:c,x:s,y:h}}(e,l,t);else if("document"===t)o=function(e){const t=Kt(e),l=e.ownerDocument.body,o=ot(e.scrollWidth,e.clientWidth,l.scrollWidth,l.clientWidth),n=ot(e.scrollHeight,e.clientHeight,l.scrollHeight,l.clientHeight);let r=-t.scrollLeft+rl(e);const i=-t.scrollTop;return"rtl"===qt(l).direction&&(r+=ot(e.clientWidth,l.clientWidth)-o),{width:o,height:n,x:r,y:i}}(Bt(e));else if(jt(t))o=function(e,t){const l=nl(e,!0,"fixed"===t),o=l.top+e.clientTop,n=l.left+e.clientLeft,r=tl(e);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:n*r.x,y:o*r.y}}(t,l);else{const l=ol(e);o={x:t.x-l.x,y:t.y-l.y,width:t.width,height:t.height}}return yt(o)}function cl(e,t,l){const o=$t(t),n=Bt(t),r="fixed"===l,i=nl(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const c=it(0);if((o||!r)&&(("body"!==Ot(t)||St(n))&&(a=Kt(t)),o)){const e=nl(t,!0,r,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}!o&&n&&(c.x=rl(n));const s=!n||o||r?it(0):il(n,a);return{x:i.left+a.scrollLeft-c.x-s.x,y:i.top+a.scrollTop-c.y-s.y,width:i.width,height:i.height}}function sl(e){return"static"===qt(e).position}function hl(e,t){if(!$t(e)||"fixed"===qt(e).position)return null;if(t)return t(e);let l=e.offsetParent;return Bt(e)===l&&(l=l.ownerDocument.body),l}function dl(e,t){const l=kt(e);if(Tt(e))return l;if(!$t(e)){let t=Jt(e);for(;t&&!Ft(t);){if(jt(t)&&!sl(t))return t;t=Jt(t)}return l}let o=hl(e,t);for(;o&&Et(o)&&sl(o);)o=hl(o,t);return o&&Ft(o)&&sl(o)&&!Ut(o)?l:o||function(e){let t=Jt(e);for(;$t(t)&&!Ft(t);){if(Ut(t))return t;if(Tt(t))return null;t=Jt(t)}return null}(e)||l}const ul={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:l,offsetParent:o,strategy:n}=e;const r="fixed"===n,i=Bt(o),a=!!t&&Tt(t.floating);if(o===i||a&&r)return l;let c={scrollLeft:0,scrollTop:0},s=it(1);const h=it(0),d=$t(o);if((d||!r)&&(("body"!==Ot(o)||St(i))&&(c=Kt(o)),d)){const e=nl(o);s=tl(o),h.x=e.x+o.clientLeft,h.y=e.y+o.clientTop}const u=!i||d||r?it(0):il(i,c);return{width:l.width*s.x,height:l.height*s.y,x:l.x*s.x-c.scrollLeft*s.x+h.x+u.x,y:l.y*s.y-c.scrollTop*s.y+h.y+u.y}},getDocumentElement:Bt,getClippingRect:function(e){let{element:t,boundary:l,rootBoundary:o,strategy:n}=e;const r=[..."clippingAncestors"===l?Tt(t)?[]:function(e,t){const l=t.get(e);if(l)return l;let o=Xt(e,[],!1).filter(e=>jt(e)&&"body"!==Ot(e)),n=null;const r="fixed"===qt(e).position;let i=r?Jt(e):e;for(;jt(i)&&!Ft(i);){const e=qt(i),t=Ut(i),l=n?n.position:r?"fixed":"";t||"fixed"!==l&&("absolute"!==l||"static"!==e.position)?n=e:o=o.filter(e=>e!==i),i=Jt(i)}return t.set(e,o),o}(t,this._c):[].concat(l),o],i=al(t,r[0],n);let a=i.top,c=i.right,s=i.bottom,h=i.left;for(let e=1;e<r.length;e++){const l=al(t,r[e],n);a=ot(l.top,a),c=lt(l.right,c),s=lt(l.bottom,s),h=ot(l.left,h)}return{width:c-h,height:s-a,x:h,y:a}},getOffsetParent:dl,getElementRects:async function(e){const t=this.getOffsetParent||dl,l=this.getDimensions,o=await l(e.floating);return{reference:cl(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return e.getClientRects?Array.from(e.getClientRects()):[]},getDimensions:function(e){const{width:t,height:l}=Qt(e);return{width:t,height:l}},getScale:tl,isElement:jt,isRTL:function(e){return"rtl"===qt(e).direction}};function vl(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function fl(e,t,l,o){void 0===o&&(o={});const{ancestorScroll:n=!0,ancestorResize:r=!0,elementResize:i="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:c=!1}=o,s=el(e),h=n||r?[...s?Xt(s):[],...t?Xt(t):[]]:[];h.forEach(e=>{n&&e.addEventListener("scroll",l),r&&e.addEventListener("resize",l)});const d=s&&a?function(e,t,l){let o,n=null;const r=Bt(e);function i(){var e;clearTimeout(o),null==(e=n)||e.disconnect(),n=null}function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),i();const s=e.getBoundingClientRect(),{left:h,top:d,width:u,height:v}=s;if(l||t(),!u||!v)return;const f={rootMargin:-rt(d)+"px "+-rt(r.clientWidth-(h+u))+"px "+-rt(r.clientHeight-(d+v))+"px "+-rt(h)+"px",threshold:ot(0,lt(1,c))||1};let p=!0;function g(t){const l=t[0].intersectionRatio;if(!vl(s,e.getBoundingClientRect()))return a();if(l!==c){if(!p)return a();l?a(!1,l):o=setTimeout(()=>{a(!1,1e-7)},1e3)}p=!1}try{n=new IntersectionObserver(g,{...f,root:r.ownerDocument})}catch(e){n=new IntersectionObserver(g,f)}n.observe(e)}const c=kt(e),s=()=>a(l);return c.addEventListener("resize",s),a(!0),()=>{c.removeEventListener("resize",s),i()}}(s,l,r):null;let u,v=-1,f=null;i&&(f=new ResizeObserver(e=>{let[o]=e;o&&o.target===s&&f&&t&&(f.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=f)||e.observe(t)})),l()}),s&&!c&&f.observe(s),t&&f.observe(t));let p=c?nl(e):null;return c&&function t(){const o=nl(e);p&&!vl(p,o)&&l();p=o,u=requestAnimationFrame(t)}(),l(),()=>{var e;h.forEach(e=>{n&&e.removeEventListener("scroll",l),r&&e.removeEventListener("resize",l)}),null==d||d(),null==(e=f)||e.disconnect(),f=null,c&&cancelAnimationFrame(u)}}const pl=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var l,o;const{x:n,y:r,placement:i,middlewareData:a}=t,c=await async function(e,t){const{placement:l,platform:o,elements:n}=e,r=await(null==o.isRTL?void 0:o.isRTL(n.floating)),i=ht(l),a=dt(l),c="y"===ft(l),s=Pt.has(i)?-1:1,h=r&&c?-1:1,d=st(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:f}="number"==typeof d?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&"number"==typeof f&&(v="end"===a?-1*f:f),c?{x:v*h,y:u*s}:{x:u*s,y:v*h}}(t,e);return i===(null==(l=a.offset)?void 0:l.placement)&&null!=(o=a.arrow)&&o.alignmentOffset?{}:{x:n+c.x,y:r+c.y,data:{...c,placement:i}}}}},gl=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:l,y:o,placement:n,platform:r}=t,{mainAxis:i=!0,crossAxis:a=!1,limiter:c={fn:e=>{let{x:t,y:l}=e;return{x:t,y:l}}},...s}=st(e,t),h={x:l,y:o},d=await r.detectOverflow(t,s),u=ft(n),v=ut(u);let f=h[v],p=h[u];const g=(e,t)=>ct(t+d["y"===e?"top":"left"],t,t-d["y"===e?"bottom":"right"]);i&&(f=g(v,f)),a&&(p=g(u,p));const w=c.fn({...t,[v]:f,[u]:p});return{...w,data:{x:w.x-l,y:w.y-o,enabled:{[v]:i,[u]:a}}}}}},wl=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var l,o;const{placement:n,middlewareData:r,rects:i,initialPlacement:a,platform:c,elements:s}=t,{mainAxis:h=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:p=!0,...g}=st(e,t);if(null!=(l=r.arrow)&&l.alignmentOffset)return{};const w=ht(n),m=ft(a),_=ht(a)===a,x=await(null==c.isRTL?void 0:c.isRTL(s.floating)),b=u||(_||!p?[Ct(a)]:function(e){const t=Ct(e);return[wt(e),t,wt(t)]}(a)),Z="none"!==f;!u&&Z&&b.push(...Zt(a,p,f,x));const C=[a,...b],M=await c.detectOverflow(t,g),y=[];let V=(null==(o=r.flip)?void 0:o.overflows)||[];if(h&&y.push(M[w]),d){const e=gt(n,i,x);y.push(M[e[0]],M[e[1]])}if(V=[...V,{placement:n,overflows:y}],!y.every(e=>e<=0)){var H,P;const e=((null==(H=r.flip)?void 0:H.index)||0)+1,t=C[e];if(t){if(!("alignment"===d&&m!==ft(t))||V.every(e=>ft(e.placement)!==m||e.overflows[0]>0))return{data:{index:e,overflows:V},reset:{placement:t}}}let l=null==(P=V.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:P.placement;if(!l)switch(v){case"bestFit":{var z;const e=null==(z=V.filter(e=>{if(Z){const t=ft(e.placement);return t===m||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:z[0];e&&(l=e);break}case"initialPlacement":l=a}if(n!==l)return{reset:{placement:l}}}return{}}}},ml=(e,t,l)=>{const o=new Map,n=null!=l?l:{},r={...ul,...n.platform,_c:o};return(async(e,t,l)=>{const{placement:o="bottom",strategy:n="absolute",middleware:r=[],platform:i}=l,a=i.detectOverflow?i:{...i,detectOverflow:Ht},c=await(null==i.isRTL?void 0:i.isRTL(t));let s=await i.getElementRects({reference:e,floating:t,strategy:n}),{x:h,y:d}=Vt(s,o,c),u=o,v=0;const f={};for(let l=0;l<r.length;l++){const p=r[l];if(!p)continue;const{name:g,fn:w}=p,{x:m,y:_,data:x,reset:b}=await w({x:h,y:d,initialPlacement:o,placement:u,strategy:n,middlewareData:f,rects:s,platform:a,elements:{reference:e,floating:t}});h=null!=m?m:h,d=null!=_?_:d,f[g]={...f[g],...x},b&&v<50&&(v++,"object"==typeof b&&(b.placement&&(u=b.placement),b.rects&&(s=!0===b.rects?await i.getElementRects({reference:e,floating:t,strategy:n}):b.rects),({x:h,y:d}=Vt(s,u,c))),l=-1)}return{x:h,y:d,placement:u,strategy:n,middlewareData:f}})(e,t,{...n,platform:r})};class _l extends Te{constructor(){super(...arguments),this.myDropdown=Ge(),this.dropdownMenuId=function(e="",t=""){return`id-${Math.random().toString().substring(2,6)}-sit-${e}-${t}`}("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=Ge(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=fl(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const l=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},o=t.map(l),n=e.map(e=>{const n=l(e),r=o.indexOf(n);return-1!==r?t[r]:e}).concat(t.filter(t=>!e.some(e=>l(e)===l(t))));return n}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[pl(8),this.noFlip?void 0:wl(),gl()].filter(Boolean);let l=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(l=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const o=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:l}),{x:n,y:r,strategy:i,placement:a}=await ml(this.myDropdown.value,this.menuRef.value,o);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:i,left:`${n}px`,top:`${r}px`})}}e([P({type:Boolean,state:!0})],_l.prototype,"noFlip",void 0),e([P({type:Boolean,reflect:!0,state:!0})],_l.prototype,"menuAlignRight",void 0),e([P({type:String,reflect:!0,state:!0})],_l.prototype,"drop",void 0),e([P({type:Object})],_l.prototype,"floatingOpts",void 0),e([P({type:Boolean,reflect:!0})],_l.prototype,"menuIsOpen",void 0),e([P({type:Boolean,reflect:!0})],_l.prototype,"disabled",void 0),e([P({type:Boolean,reflect:!0})],_l.prototype,"readonly",void 0);class xl extends _l{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),l=t.find(t=>e.composedPath().includes(t));if(!l)return;const o=t.indexOf(l);this.nextDropdownItemNo=o+1,this.prevDropdownItemNo=o<=0?t.length-1:o-1,l.disabled||(this.emit("sit-select",{detail:{item:l}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const l=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");l&&l.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const l=(e%t.length+t.length)%t.length,o=t[l];this.emit("i-sit-option-focus",{detail:{option:o}}),this.nextDropdownItemNo=(l+1)%t.length,this.prevDropdownItemNo=(l-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===o?"0":"-1"),e===o&&t.focus()})}}function bl(e,t){const l=Object.assign({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:n}=t;if(e in t){const r=e;t.update=function(e){if(e.has(r)){const t=e.get(r),n=this[r];t!==n&&(l.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,n))}n.call(this,e)}}}}xl.styles=_l.styles,e([B("ul.dropdown-menu")],xl.prototype,"menu",void 0),e([z()],xl.prototype,"nextDropdownItemNo",void 0),e([z()],xl.prototype,"prevDropdownItemNo",void 0),e([P({type:Boolean,reflect:!0})],xl.prototype,"hidden",void 0);var Zl=i`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:0 0 1px 0 hsla(0,0%,5%,.12),0 4px 8px 0 hsla(0,0%,5%,.12);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:left;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-top-left-radius:0;border-top-right-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{left:0;right:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,Cl=i`.dropdown{display:flex;height:inherit;position:relative}.dropdown-menu{max-width:var(--sit-dimension-320)}.toggler-container{flex:1;pointer-events:none}.toggler-container ::slotted(*){pointer-events:auto}`;class Ml extends xl{constructor(){super(),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.close="default",this.menuRef=tt()}async _handleClick(e){if(this.disabled)return;const t=this._toggler[0];if(!t)return void this.toggleMenu();if(e.composedPath().includes(t))return void this.toggleMenu();if(!this.menuIsOpen)return;const l=this.menuRef.value;l&&e.composedPath().includes(l)||this.hideMenu()}_handleCloseMenu(){const e=this._toggler[0];null==e||e.focus()}async connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._handleCloseMenu)}async disconnectedCallback(){this.removeEventListener("sit-hide",this._handleCloseMenu)}async firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&await this.updateFloatingPosition(),this._handleDisabled()}_handleTogglerSlotChange(e){const t=e.target.assignedElements({flatten:!0})[0];t&&(t.setAttribute("aria-haspopup","menu"),t.setAttribute("aria-expanded",String(this.menuIsOpen)))}_handleMenuIsOpenChange(){const e=this._toggler[0];e&&e.setAttribute("aria-expanded",String(this.menuIsOpen))}_handleDisabled(){const e=this._toggler[0];e&&(this.disabled?e.setAttribute("disabled","true"):e.hasAttribute("disabled")&&e.removeAttribute("disabled"))}render(){return ce`
    ...
    `}}Ml.styles=[...xl.styles,Cl,Zl],e([P({type:Boolean,reflect:!0,state:!1})],Ml.prototype,"noFlip",void 0),e([P({type:Boolean,reflect:!0,state:!1})],Ml.prototype,"menuAlignRight",void 0),e([P({type:String,reflect:!0,state:!1})],Ml.prototype,"drop",void 0),e([P({type:String,reflect:!0,state:!1})],Ml.prototype,"close",void 0),e([A({slot:"toggler",flatten:!0})],Ml.prototype,"_toggler",void 0),e([bl("menuIsOpen")],Ml.prototype,"_handleMenuIsOpenChange",null),e([bl("disabled",{waitUntilFirstUpdate:!0})],Ml.prototype,"_handleDisabled",null);const yl=Ne(
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
class extends Ue{constructor(e){if(super(e),e.type!==Ie||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const o=!!t[e];o===this._previousClasses.has(e)||this._staticClasses?.has(e)||(o?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return he}}),Vl={announcement:()=>Promise.resolve().then(function(){return Il}),archive:()=>Promise.resolve().then(function(){return Nl}),"arrow-bar-down":()=>Promise.resolve().then(function(){return Wl}),"arrow-bar-left":()=>Promise.resolve().then(function(){return ql}),"arrow-bar-right":()=>Promise.resolve().then(function(){return Jl}),"arrow-bar-up":()=>Promise.resolve().then(function(){return Xl}),"arrow-circle-down":()=>Promise.resolve().then(function(){return Ql}),"arrow-circle-left":()=>Promise.resolve().then(function(){return to}),"arrow-circle-right":()=>Promise.resolve().then(function(){return oo}),"arrow-circle-up":()=>Promise.resolve().then(function(){return ro}),"arrow-clockwise":()=>Promise.resolve().then(function(){return ao}),"arrow-down":()=>Promise.resolve().then(function(){return so}),"arrow-left":()=>Promise.resolve().then(function(){return uo}),"arrow-repeat":()=>Promise.resolve().then(function(){return fo}),"arrow-right":()=>Promise.resolve().then(function(){return go}),"arrow-square-down":()=>Promise.resolve().then(function(){return mo}),"arrow-square-left":()=>Promise.resolve().then(function(){return xo}),"arrow-square-right":()=>Promise.resolve().then(function(){return Zo}),"arrow-square-up":()=>Promise.resolve().then(function(){return Mo}),"arrow-up":()=>Promise.resolve().then(function(){return Vo}),"bank-fill":()=>Promise.resolve().then(function(){return Po}),"bell-slash":()=>Promise.resolve().then(function(){return Oo}),bell:()=>Promise.resolve().then(function(){return Bo}),"bi-funnel":()=>Promise.resolve().then(function(){return jo}),"bookmark-fill":()=>Promise.resolve().then(function(){return Lo}),bookmark:()=>Promise.resolve().then(function(){return Eo}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return Ro}),"box-seam":()=>Promise.resolve().then(function(){return Do}),building:()=>Promise.resolve().then(function(){return Uo}),bus:()=>Promise.resolve().then(function(){return Fo}),calculator:()=>Promise.resolve().then(function(){return Ko}),"calendar-check":()=>Promise.resolve().then(function(){return Yo}),"calendar-heart":()=>Promise.resolve().then(function(){return Go}),"calendar-x":()=>Promise.resolve().then(function(){return en}),calendar:()=>Promise.resolve().then(function(){return ln}),camera:()=>Promise.resolve().then(function(){return nn}),car:()=>Promise.resolve().then(function(){return an}),"chat-dots":()=>Promise.resolve().then(function(){return sn}),"chat-left-text":()=>Promise.resolve().then(function(){return dn}),chat:()=>Promise.resolve().then(function(){return vn}),"check-circle-fill":()=>Promise.resolve().then(function(){return pn}),"check-circle":()=>Promise.resolve().then(function(){return wn}),check:()=>Promise.resolve().then(function(){return _n}),"chevron-down":()=>Promise.resolve().then(function(){return bn}),"chevron-left":()=>Promise.resolve().then(function(){return Cn}),"chevron-right":()=>Promise.resolve().then(function(){return yn}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return Hn}),"chevron-up":()=>Promise.resolve().then(function(){return zn}),clock:()=>Promise.resolve().then(function(){return kn}),"cloud-check":()=>Promise.resolve().then(function(){return An}),"cloud-download":()=>Promise.resolve().then(function(){return $n}),"cloud-upload":()=>Promise.resolve().then(function(){return Sn}),cloud:()=>Promise.resolve().then(function(){return Tn}),"code-square":()=>Promise.resolve().then(function(){return In}),"coins-hand":()=>Promise.resolve().then(function(){return Nn}),compass:()=>Promise.resolve().then(function(){return Wn}),copy:()=>Promise.resolve().then(function(){return qn}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return Jn}),cross:()=>Promise.resolve().then(function(){return Xn}),"cursor-fill":()=>Promise.resolve().then(function(){return Qn}),cursor:()=>Promise.resolve().then(function(){return tr}),"dash-circle":()=>Promise.resolve().then(function(){return or}),"dash-square":()=>Promise.resolve().then(function(){return rr}),dash:()=>Promise.resolve().then(function(){return ar}),database:()=>Promise.resolve().then(function(){return sr}),dataflow:()=>Promise.resolve().then(function(){return dr}),download:()=>Promise.resolve().then(function(){return vr}),edit:()=>Promise.resolve().then(function(){return pr}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return wr}),"exclamation-circle":()=>Promise.resolve().then(function(){return _r}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return br}),"exclamation-triangle":()=>Promise.resolve().then(function(){return Cr}),exclamation:()=>Promise.resolve().then(function(){return yr}),"eye-fill":()=>Promise.resolve().then(function(){return Hr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return zr}),"eye-slash":()=>Promise.resolve().then(function(){return kr}),eye:()=>Promise.resolve().then(function(){return Ar}),"face-smile-fill":()=>Promise.resolve().then(function(){return $r}),"face-smile":()=>Promise.resolve().then(function(){return Sr}),facebook:()=>Promise.resolve().then(function(){return Tr}),"file-earmark-text":()=>Promise.resolve().then(function(){return Ir}),"file-pdf":()=>Promise.resolve().then(function(){return Nr}),"file-plus":()=>Promise.resolve().then(function(){return Wr}),"file-text":()=>Promise.resolve().then(function(){return qr}),file:()=>Promise.resolve().then(function(){return Jr}),files:()=>Promise.resolve().then(function(){return Xr}),fingerprint:()=>Promise.resolve().then(function(){return Qr}),flash:()=>Promise.resolve().then(function(){return ti}),"folder-check":()=>Promise.resolve().then(function(){return oi}),"folder-minus":()=>Promise.resolve().then(function(){return ri}),"folder-plus":()=>Promise.resolve().then(function(){return ai}),folder:()=>Promise.resolve().then(function(){return si}),gear:()=>Promise.resolve().then(function(){return di}),"geo-alt":()=>Promise.resolve().then(function(){return vi}),"geo-fill":()=>Promise.resolve().then(function(){return pi}),geo:()=>Promise.resolve().then(function(){return wi}),"globe-alt":()=>Promise.resolve().then(function(){return _i}),globe:()=>Promise.resolve().then(function(){return bi}),google:()=>Promise.resolve().then(function(){return Ci}),"grid-alt":()=>Promise.resolve().then(function(){return yi}),"grid-fill":()=>Promise.resolve().then(function(){return Hi}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return zi}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return ki}),"hard-drive":()=>Promise.resolve().then(function(){return Ai}),heart:()=>Promise.resolve().then(function(){return $i}),"house-door":()=>Promise.resolve().then(function(){return Si}),house:()=>Promise.resolve().then(function(){return Ti}),image:()=>Promise.resolve().then(function(){return Ii}),"in-box":()=>Promise.resolve().then(function(){return Ni}),"info-circle-fill":()=>Promise.resolve().then(function(){return Wi}),"info-circle":()=>Promise.resolve().then(function(){return qi}),instagram:()=>Promise.resolve().then(function(){return Ji}),key:()=>Promise.resolve().then(function(){return Xi}),"laptop-gear":()=>Promise.resolve().then(function(){return Qi}),laptop:()=>Promise.resolve().then(function(){return ta}),layers:()=>Promise.resolve().then(function(){return oa}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return ra}),"layout-text-window":()=>Promise.resolve().then(function(){return aa}),layout:()=>Promise.resolve().then(function(){return sa}),"life-buoy":()=>Promise.resolve().then(function(){return da}),lightbulb:()=>Promise.resolve().then(function(){return va}),link:()=>Promise.resolve().then(function(){return pa}),linkedin:()=>Promise.resolve().then(function(){return wa}),list:()=>Promise.resolve().then(function(){return _a}),"lock-fill":()=>Promise.resolve().then(function(){return ba}),lock:()=>Promise.resolve().then(function(){return Ca}),login:()=>Promise.resolve().then(function(){return ya}),logout:()=>Promise.resolve().then(function(){return Ha}),luggage:()=>Promise.resolve().then(function(){return za}),"mail-open":()=>Promise.resolve().then(function(){return ka}),mail:()=>Promise.resolve().then(function(){return Aa}),map:()=>Promise.resolve().then(function(){return $a}),meetup:()=>Promise.resolve().then(function(){return Sa}),menu:()=>Promise.resolve().then(function(){return Ta}),microphone:()=>Promise.resolve().then(function(){return Ia}),monitor:()=>Promise.resolve().then(function(){return Na}),moon:()=>Promise.resolve().then(function(){return Wa}),move:()=>Promise.resolve().then(function(){return qa}),paperclip:()=>Promise.resolve().then(function(){return Ja}),passcode:()=>Promise.resolve().then(function(){return Xa}),passport:()=>Promise.resolve().then(function(){return Qa}),pause:()=>Promise.resolve().then(function(){return tc}),pencil:()=>Promise.resolve().then(function(){return oc}),"pending-circle":()=>Promise.resolve().then(function(){return rc}),"person-dash":()=>Promise.resolve().then(function(){return ac}),"person-plus":()=>Promise.resolve().then(function(){return sc}),"person-x":()=>Promise.resolve().then(function(){return dc}),person:()=>Promise.resolve().then(function(){return vc}),phone:()=>Promise.resolve().then(function(){return pc}),"pin-map-fill":()=>Promise.resolve().then(function(){return wc}),pin:()=>Promise.resolve().then(function(){return _c}),placeholder:()=>Promise.resolve().then(function(){return bc}),plane:()=>Promise.resolve().then(function(){return Cc}),play:()=>Promise.resolve().then(function(){return yc}),"plus-circle":()=>Promise.resolve().then(function(){return Hc}),"plus-square":()=>Promise.resolve().then(function(){return zc}),plus:()=>Promise.resolve().then(function(){return kc}),printer:()=>Promise.resolve().then(function(){return Ac}),"question-circle":()=>Promise.resolve().then(function(){return $c}),rocket:()=>Promise.resolve().then(function(){return Sc}),save:()=>Promise.resolve().then(function(){return Tc}),search:()=>Promise.resolve().then(function(){return Ic}),send:()=>Promise.resolve().then(function(){return Nc}),"sg-crest":()=>Promise.resolve().then(function(){return Wc}),share:()=>Promise.resolve().then(function(){return qc}),"shield-tick":()=>Promise.resolve().then(function(){return Jc}),"sidebar-collapse":()=>Promise.resolve().then(function(){return Xc}),"sidebar-expand":()=>Promise.resolve().then(function(){return Qc}),"slash-circle":()=>Promise.resolve().then(function(){return ts}),"slash-divider":()=>Promise.resolve().then(function(){return os}),sliders:()=>Promise.resolve().then(function(){return rs}),"sort-ascending":()=>Promise.resolve().then(function(){return as}),"sort-descending":()=>Promise.resolve().then(function(){return ss}),speedometer:()=>Promise.resolve().then(function(){return ds}),"star-ai":()=>Promise.resolve().then(function(){return vs}),"star-fill":()=>Promise.resolve().then(function(){return ps}),star:()=>Promise.resolve().then(function(){return ws}),stoplights:()=>Promise.resolve().then(function(){return _s}),sun:()=>Promise.resolve().then(function(){return bs}),"switch-horizontal":()=>Promise.resolve().then(function(){return Cs}),"switch-vertical":()=>Promise.resolve().then(function(){return ys}),tablet:()=>Promise.resolve().then(function(){return Hs}),telegram:()=>Promise.resolve().then(function(){return zs}),telephone:()=>Promise.resolve().then(function(){return ks}),"three-dots-vertical":()=>Promise.resolve().then(function(){return As}),"three-dots":()=>Promise.resolve().then(function(){return $s}),ticket:()=>Promise.resolve().then(function(){return Ss}),"toggle-off":()=>Promise.resolve().then(function(){return Ts}),"toggle-on":()=>Promise.resolve().then(function(){return Is}),train:()=>Promise.resolve().then(function(){return Ns}),translate:()=>Promise.resolve().then(function(){return Ws}),trash:()=>Promise.resolve().then(function(){return qs}),"trend-down":()=>Promise.resolve().then(function(){return Js}),"trend-up":()=>Promise.resolve().then(function(){return Xs}),truck:()=>Promise.resolve().then(function(){return Qs}),"twitter-x":()=>Promise.resolve().then(function(){return th}),unlock:()=>Promise.resolve().then(function(){return oh}),upload:()=>Promise.resolve().then(function(){return rh}),"user-check":()=>Promise.resolve().then(function(){return ah}),"user-circle":()=>Promise.resolve().then(function(){return sh}),"user-pause":()=>Promise.resolve().then(function(){return dh}),"user-square":()=>Promise.resolve().then(function(){return vh}),users:()=>Promise.resolve().then(function(){return ph}),"video-recorder":()=>Promise.resolve().then(function(){return wh}),"volume-max":()=>Promise.resolve().then(function(){return _h}),"volume-x":()=>Promise.resolve().then(function(){return bh}),"window-dash":()=>Promise.resolve().then(function(){return Ch}),"window-desktop":()=>Promise.resolve().then(function(){return yh}),"window-dock":()=>Promise.resolve().then(function(){return Hh}),"window-fullscreen":()=>Promise.resolve().then(function(){return zh}),"window-plus":()=>Promise.resolve().then(function(){return kh}),"window-sidebar":()=>Promise.resolve().then(function(){return Ah}),"window-split":()=>Promise.resolve().then(function(){return $h}),"window-stack":()=>Promise.resolve().then(function(){return Sh}),"window-x":()=>Promise.resolve().then(function(){return Th}),window:()=>Promise.resolve().then(function(){return Ih}),"xcircle-fill":()=>Promise.resolve().then(function(){return Nh}),xcircle:()=>Promise.resolve().then(function(){return Wh}),youtube:()=>Promise.resolve().then(function(){return qh}),"zoom-in":()=>Promise.resolve().then(function(){return Jh}),"zoom-out":()=>Promise.resolve().then(function(){return Xh})};var Hl=i`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const Pl=new Map;class zl extends Te{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(Pl.has(e))return void(this._icon=Pl.get(e));const t=Vl[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();Pl.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:de}}zl.styles=[...Te.styles,Hl],e([P({type:String,reflect:!0})],zl.prototype,"name",void 0),e([P({type:String,reflect:!0})],zl.prototype,"size",void 0),e([P({type:String})],zl.prototype,"ariaLabel",void 0),e([z()],zl.prototype,"_icon",void 0);var Ol=i`:host([disabled]){cursor:not-allowed}.dropdown-item{align-items:center;background-color:var(--sit-bg-transparent);clear:both;color:var(--sit-color-default);cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-sm);padding:var(--sit-padding-sm) var(--sit-padding-lg);text-align:inherit}.dropdown-item:hover{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus,.dropdown-item:focus-visible{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus-visible{outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.dropdown-item.active{background-color:var(--sit-bg-translucent-subtle);color:var(--sit-primary-color-default);text-decoration:none}.dropdown-item.disabled,.dropdown-item:disabled{opacity:var(--sit-opacity-40);pointer-events:none}::slotted(*){color:inherit!important;display:flex;gap:var(--sit-gap-sm);text-decoration:none!important}::slotted(a),::slotted(sit-checkbox){flex:1;margin:calc(var(--sit-padding-sm)*-1) calc(var(--sit-padding-lg)*-1);padding:var(--sit-padding-sm) var(--sit-padding-lg)}.dropdown-item.mainnav-dropdown-link{padding:var(--sit-padding-none)}.dropdown-item.mainnav-dropdown-link ::slotted(*){box-sizing:border-box;margin:auto;max-width:var(--sit-mainnav-max-width,1440px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x)}@media screen and (min-width:1024px){.dropdown-item.mainnav-dropdown-link ::slotted(*){padding:var(--sit-padding-sm) var(--sit-mainnav-padding-x)}}`;class kl extends Te{constructor(){super(...arguments),this.active=!1,this.disabled=!1,this.ariaLabel=""}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",e=>{"Enter"===e.key&&this.anchor.length>0&&this.anchor[0].click()}),this.setAttribute("role","menuitem"),this.setAttribute("aria-disabled",`${this.disabled}`)}render(){return ce`
      <div
        class="dropdown-item ${yl({disabled:this.disabled,active:this.active})}"
        tabindex=${this.disabled?"-1":"0"}
        aria-label=${He(this.ariaLabel||void 0)}
      >
        <slot></slot>
      </div>
    `}}kl.styles=[Cl,Ol],kl.dependencies={"sit-icon":zl},e([A({flatten:!0})],kl.prototype,"anchor",void 0),e([P({type:Boolean})],kl.prototype,"active",void 0),e([P({type:Boolean,reflect:!0})],kl.prototype,"disabled",void 0),e([P({type:String})],kl.prototype,"ariaLabel",void 0);class Bl extends Te{constructor(){super(...arguments),this.size="md"}render(){return ce`
      <sit-dropdown>
...
`,Il=Object.freeze({__proto__:null,default:Rl}),Dl=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Nl=Object.freeze({__proto__:null,default:Dl}),Ul=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wl=Object.freeze({__proto__:null,default:Ul}),Fl=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ql=Object.freeze({__proto__:null,default:Fl}),Kl=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Jl=Object.freeze({__proto__:null,default:Kl}),Yl=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xl=Object.freeze({__proto__:null,default:Yl}),Gl=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ql=Object.freeze({__proto__:null,default:Gl}),eo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,to=Object.freeze({__proto__:null,default:eo}),lo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oo=Object.freeze({__proto__:null,default:lo}),no=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ro=Object.freeze({__proto__:null,default:no}),io=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ao=Object.freeze({__proto__:null,default:io}),co=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,so=Object.freeze({__proto__:null,default:co}),ho=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,uo=Object.freeze({__proto__:null,default:ho}),vo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fo=Object.freeze({__proto__:null,default:vo}),po=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,go=Object.freeze({__proto__:null,default:po}),wo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,mo=Object.freeze({__proto__:null,default:wo}),_o=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xo=Object.freeze({__proto__:null,default:_o}),bo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zo=Object.freeze({__proto__:null,default:bo}),Co=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Mo=Object.freeze({__proto__:null,default:Co}),yo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vo=Object.freeze({__proto__:null,default:yo}),Ho=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Po=Object.freeze({__proto__:null,default:Ho}),zo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oo=Object.freeze({__proto__:null,default:zo}),ko=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bo=Object.freeze({__proto__:null,default:ko}),Ao=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jo=Object.freeze({__proto__:null,default:Ao}),$o=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lo=Object.freeze({__proto__:null,default:$o}),So=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Eo=Object.freeze({__proto__:null,default:So}),To=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ro=Object.freeze({__proto__:null,default:To}),Io=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Do=Object.freeze({__proto__:null,default:Io}),No=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Uo=Object.freeze({__proto__:null,default:No}),Wo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fo=Object.freeze({__proto__:null,default:Wo}),qo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ko=Object.freeze({__proto__:null,default:qo}),Jo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yo=Object.freeze({__proto__:null,default:Jo}),Xo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Go=Object.freeze({__proto__:null,default:Xo}),Qo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,en=Object.freeze({__proto__:null,default:Qo}),tn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ln=Object.freeze({__proto__:null,default:tn}),on=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nn=Object.freeze({__proto__:null,default:on}),rn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,an=Object.freeze({__proto__:null,default:rn}),cn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sn=Object.freeze({__proto__:null,default:cn}),hn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,dn=Object.freeze({__proto__:null,default:hn}),un=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vn=Object.freeze({__proto__:null,default:un}),fn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pn=Object.freeze({__proto__:null,default:fn}),gn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wn=Object.freeze({__proto__:null,default:gn}),mn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_n=Object.freeze({__proto__:null,default:mn}),xn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bn=Object.freeze({__proto__:null,default:xn}),Zn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Cn=Object.freeze({__proto__:null,default:Zn}),Mn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yn=Object.freeze({__proto__:null,default:Mn}),Vn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Hn=Object.freeze({__proto__:null,default:Vn}),Pn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zn=Object.freeze({__proto__:null,default:Pn}),On=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,kn=Object.freeze({__proto__:null,default:On}),Bn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,An=Object.freeze({__proto__:null,default:Bn}),jn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$n=Object.freeze({__proto__:null,default:jn}),Ln=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sn=Object.freeze({__proto__:null,default:Ln}),En=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tn=Object.freeze({__proto__:null,default:En}),Rn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,In=Object.freeze({__proto__:null,default:Rn}),Dn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Nn=Object.freeze({__proto__:null,default:Dn}),Un=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wn=Object.freeze({__proto__:null,default:Un}),Fn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,qn=Object.freeze({__proto__:null,default:Fn}),Kn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jn=Object.freeze({__proto__:null,default:Kn}),Yn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xn=Object.freeze({__proto__:null,default:Yn}),Gn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qn=Object.freeze({__proto__:null,default:Gn}),er=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,tr=Object.freeze({__proto__:null,default:er}),lr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,or=Object.freeze({__proto__:null,default:lr}),nr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rr=Object.freeze({__proto__:null,default:nr}),ir=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ar=Object.freeze({__proto__:null,default:ir}),cr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sr=Object.freeze({__proto__:null,default:cr}),hr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dr=Object.freeze({__proto__:null,default:hr}),ur=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vr=Object.freeze({__proto__:null,default:ur}),fr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pr=Object.freeze({__proto__:null,default:fr}),gr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wr=Object.freeze({__proto__:null,default:gr}),mr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,_r=Object.freeze({__proto__:null,default:mr}),xr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,br=Object.freeze({__proto__:null,default:xr}),Zr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Cr=Object.freeze({__proto__:null,default:Zr}),Mr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,yr=Object.freeze({__proto__:null,default:Mr}),Vr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hr=Object.freeze({__proto__:null,default:Vr}),Pr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zr=Object.freeze({__proto__:null,default:Pr}),Or=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kr=Object.freeze({__proto__:null,default:Or}),Br=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ar=Object.freeze({__proto__:null,default:Br}),jr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$r=Object.freeze({__proto__:null,default:jr}),Lr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sr=Object.freeze({__proto__:null,default:Lr}),Er=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Tr=Object.freeze({__proto__:null,default:Er}),Rr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ir=Object.freeze({__proto__:null,default:Rr}),Dr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nr=Object.freeze({__proto__:null,default:Dr}),Ur=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wr=Object.freeze({__proto__:null,default:Ur}),Fr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qr=Object.freeze({__proto__:null,default:Fr}),Kr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jr=Object.freeze({__proto__:null,default:Kr}),Yr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xr=Object.freeze({__proto__:null,default:Yr}),Gr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qr=Object.freeze({__proto__:null,default:Gr}),ei=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ti=Object.freeze({__proto__:null,default:ei}),li=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oi=Object.freeze({__proto__:null,default:li}),ni=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,ri=Object.freeze({__proto__:null,default:ni}),ii=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ai=Object.freeze({__proto__:null,default:ii}),ci=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,si=Object.freeze({__proto__:null,default:ci}),hi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,di=Object.freeze({__proto__:null,default:hi}),ui=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vi=Object.freeze({__proto__:null,default:ui}),fi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pi=Object.freeze({__proto__:null,default:fi}),gi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wi=Object.freeze({__proto__:null,default:gi}),mi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,_i=Object.freeze({__proto__:null,default:mi}),xi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bi=Object.freeze({__proto__:null,default:xi}),Zi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ci=Object.freeze({__proto__:null,default:Zi}),Mi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yi=Object.freeze({__proto__:null,default:Mi}),Vi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Hi=Object.freeze({__proto__:null,default:Vi}),Pi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zi=Object.freeze({__proto__:null,default:Pi}),Oi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ki=Object.freeze({__proto__:null,default:Oi}),Bi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ai=Object.freeze({__proto__:null,default:Bi}),ji=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$i=Object.freeze({__proto__:null,default:ji}),Li=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Si=Object.freeze({__proto__:null,default:Li}),Ei=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ti=Object.freeze({__proto__:null,default:Ei}),Ri=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ii=Object.freeze({__proto__:null,default:Ri}),Di=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ni=Object.freeze({__proto__:null,default:Di}),Ui=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wi=Object.freeze({__proto__:null,default:Ui}),Fi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qi=Object.freeze({__proto__:null,default:Fi}),Ki=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ji=Object.freeze({__proto__:null,default:Ki}),Yi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Xi=Object.freeze({__proto__:null,default:Yi}),Gi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qi=Object.freeze({__proto__:null,default:Gi}),ea=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ta=Object.freeze({__proto__:null,default:ea}),la=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oa=Object.freeze({__proto__:null,default:la}),na=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ra=Object.freeze({__proto__:null,default:na}),ia=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,aa=Object.freeze({__proto__:null,default:ia}),ca=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sa=Object.freeze({__proto__:null,default:ca}),ha=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,da=Object.freeze({__proto__:null,default:ha}),ua=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,va=Object.freeze({__proto__:null,default:ua}),fa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pa=Object.freeze({__proto__:null,default:fa}),ga=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wa=Object.freeze({__proto__:null,default:ga}),ma=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,_a=Object.freeze({__proto__:null,default:ma}),xa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ba=Object.freeze({__proto__:null,default:xa}),Za=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ca=Object.freeze({__proto__:null,default:Za}),Ma=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ya=Object.freeze({__proto__:null,default:Ma}),Va=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ha=Object.freeze({__proto__:null,default:Va}),Pa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,za=Object.freeze({__proto__:null,default:Pa}),Oa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ka=Object.freeze({__proto__:null,default:Oa}),Ba=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Aa=Object.freeze({__proto__:null,default:Ba}),ja=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$a=Object.freeze({__proto__:null,default:ja}),La=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sa=Object.freeze({__proto__:null,default:La}),Ea=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ta=Object.freeze({__proto__:null,default:Ea}),Ra=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ia=Object.freeze({__proto__:null,default:Ra}),Da=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Na=Object.freeze({__proto__:null,default:Da}),Ua=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wa=Object.freeze({__proto__:null,default:Ua}),Fa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,qa=Object.freeze({__proto__:null,default:Fa}),Ka=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ja=Object.freeze({__proto__:null,default:Ka}),Ya=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xa=Object.freeze({__proto__:null,default:Ya}),Ga=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qa=Object.freeze({__proto__:null,default:Ga}),ec=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,tc=Object.freeze({__proto__:null,default:ec}),lc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oc=Object.freeze({__proto__:null,default:lc}),nc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rc=Object.freeze({__proto__:null,default:nc}),ic=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ac=Object.freeze({__proto__:null,default:ic}),cc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sc=Object.freeze({__proto__:null,default:cc}),hc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dc=Object.freeze({__proto__:null,default:hc}),uc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vc=Object.freeze({__proto__:null,default:uc}),fc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pc=Object.freeze({__proto__:null,default:fc}),gc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wc=Object.freeze({__proto__:null,default:gc}),mc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_c=Object.freeze({__proto__:null,default:mc}),xc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bc=Object.freeze({__proto__:null,default:xc}),Zc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Cc=Object.freeze({__proto__:null,default:Zc}),Mc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,yc=Object.freeze({__proto__:null,default:Mc}),Vc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hc=Object.freeze({__proto__:null,default:Vc}),Pc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zc=Object.freeze({__proto__:null,default:Pc}),Oc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kc=Object.freeze({__proto__:null,default:Oc}),Bc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ac=Object.freeze({__proto__:null,default:Bc}),jc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$c=Object.freeze({__proto__:null,default:jc}),Lc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sc=Object.freeze({__proto__:null,default:Lc}),Ec=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tc=Object.freeze({__proto__:null,default:Ec}),Rc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ic=Object.freeze({__proto__:null,default:Rc}),Dc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nc=Object.freeze({__proto__:null,default:Dc}),Uc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="#DB0000"
...
`,Wc=Object.freeze({__proto__:null,default:Uc}),Fc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qc=Object.freeze({__proto__:null,default:Fc}),Kc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Jc=Object.freeze({__proto__:null,default:Kc}),Yc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xc=Object.freeze({__proto__:null,default:Yc}),Gc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qc=Object.freeze({__proto__:null,default:Gc}),es=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rs=Object.freeze({__proto__:null,default:ns}),is=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,as=Object.freeze({__proto__:null,default:is}),cs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ss=Object.freeze({__proto__:null,default:cs}),hs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ds=Object.freeze({__proto__:null,default:hs}),us=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vs=Object.freeze({__proto__:null,default:us}),fs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ps=Object.freeze({__proto__:null,default:fs}),gs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ws=Object.freeze({__proto__:null,default:gs}),ms=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_s=Object.freeze({__proto__:null,default:ms}),xs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bs=Object.freeze({__proto__:null,default:xs}),Zs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Cs=Object.freeze({__proto__:null,default:Zs}),Ms=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ys=Object.freeze({__proto__:null,default:Ms}),Vs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Hs=Object.freeze({__proto__:null,default:Vs}),Ps=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zs=Object.freeze({__proto__:null,default:Ps}),Os=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ks=Object.freeze({__proto__:null,default:Os}),Bs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,As=Object.freeze({__proto__:null,default:Bs}),js=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$s=Object.freeze({__proto__:null,default:js}),Ls=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ss=Object.freeze({__proto__:null,default:Ls}),Es=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ts=Object.freeze({__proto__:null,default:Es}),Rs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Is=Object.freeze({__proto__:null,default:Rs}),Ds=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ns=Object.freeze({__proto__:null,default:Ds}),Us=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ws=Object.freeze({__proto__:null,default:Us}),Fs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qs=Object.freeze({__proto__:null,default:Fs}),Ks=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Js=Object.freeze({__proto__:null,default:Ks}),Ys=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xs=Object.freeze({__proto__:null,default:Ys}),Gs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qs=Object.freeze({__proto__:null,default:Gs}),eh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,th=Object.freeze({__proto__:null,default:eh}),lh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oh=Object.freeze({__proto__:null,default:lh}),nh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rh=Object.freeze({__proto__:null,default:nh}),ih=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ah=Object.freeze({__proto__:null,default:ih}),ch=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sh=Object.freeze({__proto__:null,default:ch}),hh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,dh=Object.freeze({__proto__:null,default:hh}),uh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vh=Object.freeze({__proto__:null,default:uh}),fh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ph=Object.freeze({__proto__:null,default:fh}),gh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wh=Object.freeze({__proto__:null,default:gh}),mh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_h=Object.freeze({__proto__:null,default:mh}),xh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bh=Object.freeze({__proto__:null,default:xh}),Zh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Ch=Object.freeze({__proto__:null,default:Zh}),Mh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,yh=Object.freeze({__proto__:null,default:Mh}),Vh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Hh=Object.freeze({__proto__:null,default:Vh}),Ph=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zh=Object.freeze({__proto__:null,default:Ph}),Oh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,kh=Object.freeze({__proto__:null,default:Oh}),Bh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ah=Object.freeze({__proto__:null,default:Bh}),jh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$h=Object.freeze({__proto__:null,default:jh}),Lh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sh=Object.freeze({__proto__:null,default:Lh}),Eh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Th=Object.freeze({__proto__:null,default:Eh}),Rh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ih=Object.freeze({__proto__:null,default:Rh}),Dh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nh=Object.freeze({__proto__:null,default:Dh}),Uh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wh=Object.freeze({__proto__:null,default:Uh}),Fh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,qh=Object.freeze({__proto__:null,default:Fh}),Kh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jh=Object.freeze({__proto__:null,default:Kh}),Yh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xh=Object.freeze({__proto__:null,default:Yh})});
