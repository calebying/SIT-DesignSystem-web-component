...
/**
   ...
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const Ge=()=>new Qe;class Qe{}const et=new WeakMap;const tt=Ne(class extends Xe{render(e){return de}update(e,[t]){const l=t!==this._ref;return l&&void 0!==this._ref&&this._updateRefValue(void 0),(l||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),de}_updateRefValue(e){if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let l=et.get(t);void 0===l&&(l=new WeakMap,et.set(t,l)),void 0!==l.get(this._ref)&&this._ref.call(this._context,void 0),l.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?et.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}}),lt=Math.min,ot=Math.max,nt=Math.round,rt=Math.floor,it=e=>({x:e,y:e}),at={left:"right",right:"left",bottom:"top",top:"bottom"},ct={start:"end",end:"start"};function st(e,t,l){return ot(e,lt(t,l))}function ht(e,t){return"function"==typeof e?e(t):e}function dt(e){return e.split("-")[0]}function ut(e){return e.split("-")[1]}function vt(e){return"x"===e?"y":"x"}function ft(e){return"y"===e?"height":"width"}const pt=new Set(["top","bottom"]);function gt(e){return pt.has(dt(e))?"y":"x"}function wt(e){return vt(gt(e))}function mt(e,t,l){void 0===l&&(l=!1);const o=ut(e),n=wt(e),r=ft(n);let i="x"===n?o===(l?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[r]>t.floating[r]&&(i=yt(i)),[i,yt(i)]}function _t(e){return e.replace(/start|end/g,e=>ct[e])}const xt=["left","right"],bt=["right","left"],Zt=["top","bottom"],Ct=["bottom","top"];function Mt(e,t,l,o){const n=ut(e);let r=function(e,t,l){switch(e){case"top":case"bottom":return l?t?bt:xt:t?xt:bt;case"left":case"right":return t?Zt:Ct;default:return[]}}(dt(e),"start"===l,o);return n&&(r=r.map(e=>e+"-"+n),t&&(r=r.concat(r.map(_t)))),r}function yt(e){return e.replace(/left|right|bottom|top/g,e=>at[e])}function Vt(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function Ht(e){const{x:t,y:l,width:o,height:n}=e;return{width:o,height:n,top:l,left:t,right:t+o,bottom:l+n,x:t,y:l}}function Pt(e,t,l){let{reference:o,floating:n}=e;const r=gt(t),i=wt(t),a=ft(i),c=dt(t),s="y"===r,h=o.x+o.width/2-n.width/2,d=o.y+o.height/2-n.height/2,u=o[a]/2-n[a]/2;let v;switch(c){case"top":v={x:h,y:o.y-n.height};break;case"bottom":v={x:h,y:o.y+o.height};break;case"right":v={x:o.x+o.width,y:d};break;case"left":v={x:o.x-n.width,y:d};break;default:v={x:o.x,y:o.y}}switch(ut(t)){case"start":v[i]-=u*(l&&s?-1:1);break;case"end":v[i]+=u*(l&&s?-1:1)}return v}async function zt(e,t){var l;void 0===t&&(t={});const{x:o,y:n,platform:r,rects:i,elements:a,strategy:c}=e,{boundary:s="clippingAncestors",rootBoundary:h="viewport",elementContext:d="floating",altBoundary:u=!1,padding:v=0}=ht(t,e),f=Vt(v),p=a[u?"floating"===d?"reference":"floating":d],g=Ht(await r.getClippingRect({element:null==(l=await(null==r.isElement?void 0:r.isElement(p)))||l?p:p.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(a.floating)),boundary:s,rootBoundary:h,strategy:c})),w="floating"===d?{x:o,y:n,width:i.floating.width,height:i.floating.height}:i.reference,m=await(null==r.getOffsetParent?void 0:r.getOffsetParent(a.floating)),_=await(null==r.isElement?void 0:r.isElement(m))&&await(null==r.getScale?void 0:r.getScale(m))||{x:1,y:1},x=Ht(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:m,strategy:c}):w);return{top:(g.top-x.top+f.top)/_.y,bottom:(x.bottom-g.bottom+f.bottom)/_.y,left:(g.left-x.left+f.left)/_.x,right:(x.right-g.right+f.right)/_.x}}const Ot=new Set(["left","top"]);function kt(){return"undefined"!=typeof window}function Bt(e){return $t(e)?(e.nodeName||"").toLowerCase():"#document"}function At(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function jt(e){var t;return null==(t=($t(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function $t(e){return!!kt()&&(e instanceof Node||e instanceof At(e).Node)}function St(e){return!!kt()&&(e instanceof Element||e instanceof At(e).Element)}function Lt(e){return!!kt()&&(e instanceof HTMLElement||e instanceof At(e).HTMLElement)}function Et(e){return!(!kt()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof At(e).ShadowRoot)}const Tt=new Set(["inline","contents"]);function Rt(e){const{overflow:t,overflowX:l,overflowY:o,display:n}=Gt(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+l)&&!Tt.has(n)}const It=new Set(["table","td","th"]);function Dt(e){return It.has(Bt(e))}const Nt=[":popover-open",":modal"];function Ut(e){return Nt.some(t=>{try{return e.matches(t)}catch(e){return!1}})}const Wt=["transform","translate","scale","rotate","perspective"],Ft=["transform","translate","scale","rotate","perspective","filter"],qt=["paint","layout","strict","content"];function Kt(e){const t=Jt(),l=St(e)?Gt(e):e;return Wt.some(e=>!!l[e]&&"none"!==l[e])||!!l.containerType&&"normal"!==l.containerType||!t&&!!l.backdropFilter&&"none"!==l.backdropFilter||!t&&!!l.filter&&"none"!==l.filter||Ft.some(e=>(l.willChange||"").includes(e))||qt.some(e=>(l.contain||"").includes(e))}function Jt(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}const Yt=new Set(["html","body","#document"]);function Xt(e){return Yt.has(Bt(e))}function Gt(e){return At(e).getComputedStyle(e)}function Qt(e){return St(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function el(e){if("html"===Bt(e))return e;const t=e.assignedSlot||e.parentNode||Et(e)&&e.host||jt(e);return Et(t)?t.host:t}function tl(e){const t=el(e);return Xt(t)?e.ownerDocument?e.ownerDocument.body:e.body:Lt(t)&&Rt(t)?t:tl(t)}function ll(e,t,l){var o;void 0===t&&(t=[]),void 0===l&&(l=!0);const n=tl(e),r=n===(null==(o=e.ownerDocument)?void 0:o.body),i=At(n);if(r){const e=ol(i);return t.concat(i,i.visualViewport||[],Rt(n)?n:[],e&&l?ll(e):[])}return t.concat(n,ll(n,[],l))}function ol(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function nl(e){const t=Gt(e);let l=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const n=Lt(e),r=n?e.offsetWidth:l,i=n?e.offsetHeight:o,a=nt(l)!==r||nt(o)!==i;return a&&(l=r,o=i),{width:l,height:o,$:a}}function rl(e){return St(e)?e:e.contextElement}function il(e){const t=rl(e);if(!Lt(t))return it(1);const l=t.getBoundingClientRect(),{width:o,height:n,$:r}=nl(t);let i=(r?nt(l.width):l.width)/o,a=(r?nt(l.height):l.height)/n;return i&&Number.isFinite(i)||(i=1),a&&Number.isFinite(a)||(a=1),{x:i,y:a}}const al=it(0);function cl(e){const t=At(e);return Jt()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:al}function sl(e,t,l,o){void 0===t&&(t=!1),void 0===l&&(l=!1);const n=e.getBoundingClientRect(),r=rl(e);let i=it(1);t&&(o?St(o)&&(i=il(o)):i=il(e));const a=function(e,t,l){return void 0===t&&(t=!1),!(!l||t&&l!==At(e))&&t}(r,l,o)?cl(r):it(0);let c=(n.left+a.x)/i.x,s=(n.top+a.y)/i.y,h=n.width/i.x,d=n.height/i.y;if(r){const e=At(r),t=o&&St(o)?At(o):o;let l=e,n=ol(l);for(;n&&o&&t!==l;){const e=il(n),t=n.getBoundingClientRect(),o=Gt(n),r=t.left+(n.clientLeft+parseFloat(o.paddingLeft))*e.x,i=t.top+(n.clientTop+parseFloat(o.paddingTop))*e.y;c*=e.x,s*=e.y,h*=e.x,d*=e.y,c+=r,s+=i,l=At(n),n=ol(l)}}return Ht({width:h,height:d,x:c,y:s})}function hl(e,t){const l=Qt(e).scrollLeft;return t?t.left+l:sl(jt(e)).left+l}function dl(e,t){const l=e.getBoundingClientRect();return{x:l.left+t.scrollLeft-hl(e,l),y:l.top+t.scrollTop}}const ul=new Set(["absolute","fixed"]);function vl(e,t,l){let o;if("viewport"===t)o=function(e,t){const l=At(e),o=jt(e),n=l.visualViewport;let r=o.clientWidth,i=o.clientHeight,a=0,c=0;if(n){r=n.width,i=n.height;const e=Jt();(!e||e&&"fixed"===t)&&(a=n.offsetLeft,c=n.offsetTop)}const s=hl(o);if(s<=0){const e=o.ownerDocument,t=e.body,l=getComputedStyle(t),n="CSS1Compat"===e.compatMode&&parseFloat(l.marginLeft)+parseFloat(l.marginRight)||0,i=Math.abs(o.clientWidth-t.clientWidth-n);i<=25&&(r-=i)}else s<=25&&(r+=s);return{width:r,height:i,x:a,y:c}}(e,l);else if("document"===t)o=function(e){const t=jt(e),l=Qt(e),o=e.ownerDocument.body,n=ot(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),r=ot(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let i=-l.scrollLeft+hl(e);const a=-l.scrollTop;return"rtl"===Gt(o).direction&&(i+=ot(t.clientWidth,o.clientWidth)-n),{width:n,height:r,x:i,y:a}}(jt(e));else if(St(t))o=function(e,t){const l=sl(e,!0,"fixed"===t),o=l.top+e.clientTop,n=l.left+e.clientLeft,r=Lt(e)?il(e):it(1);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:n*r.x,y:o*r.y}}(t,l);else{const l=cl(e);o={x:t.x-l.x,y:t.y-l.y,width:t.width,height:t.height}}return Ht(o)}function fl(e,t){const l=el(e);return!(l===t||!St(l)||Xt(l))&&("fixed"===Gt(l).position||fl(l,t))}function pl(e,t,l){const o=Lt(t),n=jt(t),r="fixed"===l,i=sl(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const c=it(0);function s(){c.x=hl(n)}if(o||!o&&!r)if(("body"!==Bt(t)||Rt(n))&&(a=Qt(t)),o){const e=sl(t,!0,r,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else n&&s();r&&!o&&n&&s();const h=!n||o||r?it(0):dl(n,a);return{x:i.left+a.scrollLeft-c.x-h.x,y:i.top+a.scrollTop-c.y-h.y,width:i.width,height:i.height}}function gl(e){return"static"===Gt(e).position}function wl(e,t){if(!Lt(e)||"fixed"===Gt(e).position)return null;if(t)return t(e);let l=e.offsetParent;return jt(e)===l&&(l=l.ownerDocument.body),l}function ml(e,t){const l=At(e);if(Ut(e))return l;if(!Lt(e)){let t=el(e);for(;t&&!Xt(t);){if(St(t)&&!gl(t))return t;t=el(t)}return l}let o=wl(e,t);for(;o&&Dt(o)&&gl(o);)o=wl(o,t);return o&&Xt(o)&&gl(o)&&!Kt(o)?l:o||function(e){let t=el(e);for(;Lt(t)&&!Xt(t);){if(Kt(t))return t;if(Ut(t))return null;t=el(t)}return null}(e)||l}const _l={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:l,offsetParent:o,strategy:n}=e;const r="fixed"===n,i=jt(o),a=!!t&&Ut(t.floating);if(o===i||a&&r)return l;let c={scrollLeft:0,scrollTop:0},s=it(1);const h=it(0),d=Lt(o);if((d||!d&&!r)&&(("body"!==Bt(o)||Rt(i))&&(c=Qt(o)),Lt(o))){const e=sl(o);s=il(o),h.x=e.x+o.clientLeft,h.y=e.y+o.clientTop}const u=!i||d||r?it(0):dl(i,c);return{width:l.width*s.x,height:l.height*s.y,x:l.x*s.x-c.scrollLeft*s.x+h.x+u.x,y:l.y*s.y-c.scrollTop*s.y+h.y+u.y}},getDocumentElement:jt,getClippingRect:function(e){let{element:t,boundary:l,rootBoundary:o,strategy:n}=e;const r=[..."clippingAncestors"===l?Ut(t)?[]:function(e,t){const l=t.get(e);if(l)return l;let o=ll(e,[],!1).filter(e=>St(e)&&"body"!==Bt(e)),n=null;const r="fixed"===Gt(e).position;let i=r?el(e):e;for(;St(i)&&!Xt(i);){const t=Gt(i),l=Kt(i);l||"fixed"!==t.position||(n=null),(r?!l&&!n:!l&&"static"===t.position&&n&&ul.has(n.position)||Rt(i)&&!l&&fl(e,i))?o=o.filter(e=>e!==i):n=t,i=el(i)}return t.set(e,o),o}(t,this._c):[].concat(l),o],i=r[0],a=r.reduce((e,l)=>{const o=vl(t,l,n);return e.top=ot(o.top,e.top),e.right=lt(o.right,e.right),e.bottom=lt(o.bottom,e.bottom),e.left=ot(o.left,e.left),e},vl(t,i,n));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}},getOffsetParent:ml,getElementRects:async function(e){const t=this.getOffsetParent||ml,l=this.getDimensions,o=await l(e.floating);return{reference:pl(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:l}=nl(e);return{width:t,height:l}},getScale:il,isElement:St,isRTL:function(e){return"rtl"===Gt(e).direction}};function xl(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function bl(e,t,l,o){void 0===o&&(o={});const{ancestorScroll:n=!0,ancestorResize:r=!0,elementResize:i="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:c=!1}=o,s=rl(e),h=n||r?[...s?ll(s):[],...ll(t)]:[];h.forEach(e=>{n&&e.addEventListener("scroll",l,{passive:!0}),r&&e.addEventListener("resize",l)});const d=s&&a?function(e,t){let l,o=null;const n=jt(e);function r(){var e;clearTimeout(l),null==(e=o)||e.disconnect(),o=null}return function i(a,c){void 0===a&&(a=!1),void 0===c&&(c=1),r();const s=e.getBoundingClientRect(),{left:h,top:d,width:u,height:v}=s;if(a||t(),!u||!v)return;const f={rootMargin:-rt(d)+"px "+-rt(n.clientWidth-(h+u))+"px "+-rt(n.clientHeight-(d+v))+"px "+-rt(h)+"px",threshold:ot(0,lt(1,c))||1};let p=!0;function g(t){const o=t[0].intersectionRatio;if(o!==c){if(!p)return i();o?i(!1,o):l=setTimeout(()=>{i(!1,1e-7)},1e3)}1!==o||xl(s,e.getBoundingClientRect())||i(),p=!1}try{o=new IntersectionObserver(g,{...f,root:n.ownerDocument})}catch(e){o=new IntersectionObserver(g,f)}o.observe(e)}(!0),r}(s,l):null;let u,v=-1,f=null;i&&(f=new ResizeObserver(e=>{let[o]=e;o&&o.target===s&&f&&(f.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=f)||e.observe(t)})),l()}),s&&!c&&f.observe(s),f.observe(t));let p=c?sl(e):null;return c&&function t(){const o=sl(e);p&&!xl(p,o)&&l();p=o,u=requestAnimationFrame(t)}(),l(),()=>{var e;h.forEach(e=>{n&&e.removeEventListener("scroll",l),r&&e.removeEventListener("resize",l)}),null==d||d(),null==(e=f)||e.disconnect(),f=null,c&&cancelAnimationFrame(u)}}const Zl=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var l,o;const{x:n,y:r,placement:i,middlewareData:a}=t,c=await async function(e,t){const{placement:l,platform:o,elements:n}=e,r=await(null==o.isRTL?void 0:o.isRTL(n.floating)),i=dt(l),a=ut(l),c="y"===gt(l),s=Ot.has(i)?-1:1,h=r&&c?-1:1,d=ht(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:f}="number"==typeof d?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&"number"==typeof f&&(v="end"===a?-1*f:f),c?{x:v*h,y:u*s}:{x:u*s,y:v*h}}(t,e);return i===(null==(l=a.offset)?void 0:l.placement)&&null!=(o=a.arrow)&&o.alignmentOffset?{}:{x:n+c.x,y:r+c.y,data:{...c,placement:i}}}}},Cl=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:l,y:o,placement:n}=t,{mainAxis:r=!0,crossAxis:i=!1,limiter:a={fn:e=>{let{x:t,y:l}=e;return{x:t,y:l}}},...c}=ht(e,t),s={x:l,y:o},h=await zt(t,c),d=gt(dt(n)),u=vt(d);let v=s[u],f=s[d];if(r){const e="y"===u?"bottom":"right";v=st(v+h["y"===u?"top":"left"],v,v-h[e])}if(i){const e="y"===d?"bottom":"right";f=st(f+h["y"===d?"top":"left"],f,f-h[e])}const p=a.fn({...t,[u]:v,[d]:f});return{...p,data:{x:p.x-l,y:p.y-o,enabled:{[u]:r,[d]:i}}}}}},Ml=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var l,o;const{placement:n,middlewareData:r,rects:i,initialPlacement:a,platform:c,elements:s}=t,{mainAxis:h=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:p=!0,...g}=ht(e,t);if(null!=(l=r.arrow)&&l.alignmentOffset)return{};const w=dt(n),m=gt(a),_=dt(a)===a,x=await(null==c.isRTL?void 0:c.isRTL(s.floating)),b=u||(_||!p?[yt(a)]:function(e){const t=yt(e);return[_t(e),t,_t(t)]}(a)),Z="none"!==f;!u&&Z&&b.push(...Mt(a,p,f,x));const C=[a,...b],M=await zt(t,g),y=[];let V=(null==(o=r.flip)?void 0:o.overflows)||[];if(h&&y.push(M[w]),d){const e=mt(n,i,x);y.push(M[e[0]],M[e[1]])}if(V=[...V,{placement:n,overflows:y}],!y.every(e=>e<=0)){var H,P;const e=((null==(H=r.flip)?void 0:H.index)||0)+1,t=C[e];if(t){if(!("alignment"===d&&m!==gt(t))||V.every(e=>gt(e.placement)!==m||e.overflows[0]>0))return{data:{index:e,overflows:V},reset:{placement:t}}}let l=null==(P=V.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:P.placement;if(!l)switch(v){case"bestFit":{var z;const e=null==(z=V.filter(e=>{if(Z){const t=gt(e.placement);return t===m||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:z[0];e&&(l=e);break}case"initialPlacement":l=a}if(n!==l)return{reset:{placement:l}}}return{}}}},yl=(e,t,l)=>{const o=new Map,n={platform:_l,...l},r={...n.platform,_c:o};return(async(e,t,l)=>{const{placement:o="bottom",strategy:n="absolute",middleware:r=[],platform:i}=l,a=r.filter(Boolean),c=await(null==i.isRTL?void 0:i.isRTL(t));let s=await i.getElementRects({reference:e,floating:t,strategy:n}),{x:h,y:d}=Pt(s,o,c),u=o,v={},f=0;for(let l=0;l<a.length;l++){const{name:r,fn:p}=a[l],{x:g,y:w,data:m,reset:_}=await p({x:h,y:d,initialPlacement:o,placement:u,strategy:n,middlewareData:v,rects:s,platform:i,elements:{reference:e,floating:t}});h=null!=g?g:h,d=null!=w?w:d,v={...v,[r]:{...v[r],...m}},_&&f<=50&&(f++,"object"==typeof _&&(_.placement&&(u=_.placement),_.rects&&(s=!0===_.rects?await i.getElementRects({reference:e,floating:t,strategy:n}):_.rects),({x:h,y:d}=Pt(s,u,c))),l=-1)}return{x:h,y:d,placement:u,strategy:n,middlewareData:v}})(e,t,{...n,platform:r})};class Vl extends Te{constructor(){super(...arguments),this.myDropdown=Ge(),this.dropdownMenuId=function(e="",t=""){return`id-${Math.random().toString().substring(2,6)}-sit-${e}-${t}`}("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=Ge(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=bl(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const l=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},o=t.map(l),n=e.map(e=>{const n=l(e),r=o.indexOf(n);return-1!==r?t[r]:e}).concat(t.filter(t=>!e.some(e=>l(e)===l(t))));return n}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[Zl(8),this.noFlip?void 0:Ml(),Cl()].filter(Boolean);let l=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(l=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const o=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:l}),{x:n,y:r,strategy:i,placement:a}=await yl(this.myDropdown.value,this.menuRef.value,o);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:i,left:`${n}px`,top:`${r}px`})}}e([P({type:Boolean,state:!0})],Vl.prototype,"noFlip",void 0),e([P({type:Boolean,reflect:!0,state:!0})],Vl.prototype,"menuAlignRight",void 0),e([P({type:String,reflect:!0,state:!0})],Vl.prototype,"drop",void 0),e([P({type:Object})],Vl.prototype,"floatingOpts",void 0),e([P({type:Boolean,reflect:!0})],Vl.prototype,"menuIsOpen",void 0),e([P({type:Boolean,reflect:!0})],Vl.prototype,"disabled",void 0),e([P({type:Boolean,reflect:!0})],Vl.prototype,"readonly",void 0);class Hl extends Vl{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),l=t.find(t=>e.composedPath().includes(t));if(!l)return;const o=t.indexOf(l);this.nextDropdownItemNo=o+1,this.prevDropdownItemNo=o<=0?t.length-1:o-1,l.disabled||(this.emit("sit-select",{detail:{item:l}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const l=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");l&&l.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const l=(e%t.length+t.length)%t.length,o=t[l];this.emit("i-sit-option-focus",{detail:{option:o}}),this.nextDropdownItemNo=(l+1)%t.length,this.prevDropdownItemNo=(l-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===o?"0":"-1"),e===o&&t.focus()})}}function Pl(e,t){const l=Object.assign({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:n}=t;if(e in t){const r=e;t.update=function(e){if(e.has(r)){const t=e.get(r),n=this[r];t!==n&&(l.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,n))}n.call(this,e)}}}}Hl.styles=Vl.styles,e([B("ul.dropdown-menu")],Hl.prototype,"menu",void 0),e([z()],Hl.prototype,"nextDropdownItemNo",void 0),e([z()],Hl.prototype,"prevDropdownItemNo",void 0),e([P({type:Boolean,reflect:!0})],Hl.prototype,"hidden",void 0);var zl=i`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:var(--sit-elevation-surface-3);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:start;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-start-end-radius:0;border-start-start-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{inset-inline:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,Ol=i`.dropdown{display:flex;height:inherit;position:relative}.dropdown-menu{max-width:var(--sit-dimension-320)}.toggler-container{flex:1;pointer-events:none}.toggler-container ::slotted(*){pointer-events:auto}`;class kl extends Hl{constructor(){super(),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.close="default",this.menuRef=tt()}async _handleClick(e){if(this.disabled)return;const t=this._toggler[0];if(!t)return void this.toggleMenu();if(e.composedPath().includes(t))return void this.toggleMenu();if(!this.menuIsOpen)return;const l=this.menuRef.value;l&&e.composedPath().includes(l)||this.hideMenu()}_handleCloseMenu(){const e=this._toggler[0];null==e||e.focus()}async connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._handleCloseMenu)}async disconnectedCallback(){this.removeEventListener("sit-hide",this._handleCloseMenu)}async firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&await this.updateFloatingPosition(),this._handleDisabled()}_handleTogglerSlotChange(e){const t=e.target.assignedElements({flatten:!0})[0];t&&(t.setAttribute("aria-haspopup","menu"),t.setAttribute("aria-expanded",String(this.menuIsOpen)))}_handleMenuIsOpenChange(){const e=this._toggler[0];e&&e.setAttribute("aria-expanded",String(this.menuIsOpen))}_handleDisabled(){const e=this._toggler[0];e&&(this.disabled?e.setAttribute("disabled","true"):e.hasAttribute("disabled")&&e.removeAttribute("disabled"))}render(){return ce`
    ...
    `}}kl.styles=[...Hl.styles,Ol,zl],e([P({type:Boolean,reflect:!0,state:!1})],kl.prototype,"noFlip",void 0),e([P({type:Boolean,reflect:!0,state:!1})],kl.prototype,"menuAlignRight",void 0),e([P({type:String,reflect:!0,state:!1})],kl.prototype,"drop",void 0),e([P({type:String,reflect:!0,state:!1})],kl.prototype,"close",void 0),e([A({slot:"toggler",flatten:!0})],kl.prototype,"_toggler",void 0),e([Pl("menuIsOpen")],kl.prototype,"_handleMenuIsOpenChange",null),e([Pl("disabled",{waitUntilFirstUpdate:!0})],kl.prototype,"_handleDisabled",null);const Bl=Ne(
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
class extends Ue{constructor(e){if(super(e),e.type!==Ie||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const o=!!t[e];o===this._previousClasses.has(e)||this._staticClasses?.has(e)||(o?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return he}}),Al={announcement:()=>Promise.resolve().then(function(){return Kl}),archive:()=>Promise.resolve().then(function(){return Yl}),"arrow-bar-down":()=>Promise.resolve().then(function(){return Gl}),"arrow-bar-left":()=>Promise.resolve().then(function(){return eo}),"arrow-bar-right":()=>Promise.resolve().then(function(){return lo}),"arrow-bar-up":()=>Promise.resolve().then(function(){return no}),"arrow-circle-down":()=>Promise.resolve().then(function(){return io}),"arrow-circle-left":()=>Promise.resolve().then(function(){return co}),"arrow-circle-right":()=>Promise.resolve().then(function(){return ho}),"arrow-circle-up":()=>Promise.resolve().then(function(){return vo}),"arrow-clockwise":()=>Promise.resolve().then(function(){return po}),"arrow-down":()=>Promise.resolve().then(function(){return wo}),"arrow-left":()=>Promise.resolve().then(function(){return _o}),"arrow-repeat":()=>Promise.resolve().then(function(){return bo}),"arrow-right":()=>Promise.resolve().then(function(){return Co}),"arrow-square-down":()=>Promise.resolve().then(function(){return yo}),"arrow-square-left":()=>Promise.resolve().then(function(){return Ho}),"arrow-square-right":()=>Promise.resolve().then(function(){return zo}),"arrow-square-up":()=>Promise.resolve().then(function(){return ko}),"arrow-up":()=>Promise.resolve().then(function(){return Ao}),"bank-fill":()=>Promise.resolve().then(function(){return $o}),"bell-slash":()=>Promise.resolve().then(function(){return Lo}),bell:()=>Promise.resolve().then(function(){return To}),"bi-funnel":()=>Promise.resolve().then(function(){return Io}),"bookmark-fill":()=>Promise.resolve().then(function(){return No}),bookmark:()=>Promise.resolve().then(function(){return Wo}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return qo}),"box-seam":()=>Promise.resolve().then(function(){return Jo}),building:()=>Promise.resolve().then(function(){return Xo}),bus:()=>Promise.resolve().then(function(){return Qo}),calculator:()=>Promise.resolve().then(function(){return tn}),"calendar-check":()=>Promise.resolve().then(function(){return on}),"calendar-heart":()=>Promise.resolve().then(function(){return rn}),"calendar-x":()=>Promise.resolve().then(function(){return cn}),calendar:()=>Promise.resolve().then(function(){return hn}),camera:()=>Promise.resolve().then(function(){return un}),car:()=>Promise.resolve().then(function(){return fn}),"chat-dots":()=>Promise.resolve().then(function(){return gn}),"chat-left-text":()=>Promise.resolve().then(function(){return mn}),chat:()=>Promise.resolve().then(function(){return xn}),"check-circle-fill":()=>Promise.resolve().then(function(){return Zn}),"check-circle":()=>Promise.resolve().then(function(){return Mn}),check:()=>Promise.resolve().then(function(){return Vn}),"chevron-down":()=>Promise.resolve().then(function(){return Pn}),"chevron-left":()=>Promise.resolve().then(function(){return On}),"chevron-right":()=>Promise.resolve().then(function(){return Bn}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return jn}),"chevron-up":()=>Promise.resolve().then(function(){return Sn}),clock:()=>Promise.resolve().then(function(){return En}),"cloud-check":()=>Promise.resolve().then(function(){return Rn}),"cloud-download":()=>Promise.resolve().then(function(){return Dn}),"cloud-upload":()=>Promise.resolve().then(function(){return Un}),cloud:()=>Promise.resolve().then(function(){return Fn}),"code-square":()=>Promise.resolve().then(function(){return Kn}),"coins-hand":()=>Promise.resolve().then(function(){return Yn}),compass:()=>Promise.resolve().then(function(){return Gn}),copy:()=>Promise.resolve().then(function(){return er}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return lr}),cross:()=>Promise.resolve().then(function(){return nr}),"cursor-fill":()=>Promise.resolve().then(function(){return ir}),cursor:()=>Promise.resolve().then(function(){return cr}),"dash-circle":()=>Promise.resolve().then(function(){return hr}),"dash-square":()=>Promise.resolve().then(function(){return ur}),dash:()=>Promise.resolve().then(function(){return fr}),database:()=>Promise.resolve().then(function(){return gr}),dataflow:()=>Promise.resolve().then(function(){return mr}),download:()=>Promise.resolve().then(function(){return xr}),edit:()=>Promise.resolve().then(function(){return Zr}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return Mr}),"exclamation-circle":()=>Promise.resolve().then(function(){return Vr}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return Pr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return Or}),exclamation:()=>Promise.resolve().then(function(){return Br}),"eye-fill":()=>Promise.resolve().then(function(){return jr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return Sr}),"eye-slash":()=>Promise.resolve().then(function(){return Er}),eye:()=>Promise.resolve().then(function(){return Rr}),"face-smile-fill":()=>Promise.resolve().then(function(){return Dr}),"face-smile":()=>Promise.resolve().then(function(){return Ur}),facebook:()=>Promise.resolve().then(function(){return Fr}),"file-earmark-text":()=>Promise.resolve().then(function(){return Kr}),"file-pdf":()=>Promise.resolve().then(function(){return Yr}),"file-plus":()=>Promise.resolve().then(function(){return Gr}),"file-text":()=>Promise.resolve().then(function(){return ei}),file:()=>Promise.resolve().then(function(){return li}),files:()=>Promise.resolve().then(function(){return ni}),fingerprint:()=>Promise.resolve().then(function(){return ii}),flash:()=>Promise.resolve().then(function(){return ci}),"folder-check":()=>Promise.resolve().then(function(){return hi}),"folder-minus":()=>Promise.resolve().then(function(){return ui}),"folder-plus":()=>Promise.resolve().then(function(){return fi}),folder:()=>Promise.resolve().then(function(){return gi}),gear:()=>Promise.resolve().then(function(){return mi}),"geo-alt":()=>Promise.resolve().then(function(){return xi}),"geo-fill":()=>Promise.resolve().then(function(){return Zi}),geo:()=>Promise.resolve().then(function(){return Mi}),"globe-alt":()=>Promise.resolve().then(function(){return Vi}),globe:()=>Promise.resolve().then(function(){return Pi}),google:()=>Promise.resolve().then(function(){return Oi}),"grid-alt":()=>Promise.resolve().then(function(){return Bi}),"grid-fill":()=>Promise.resolve().then(function(){return ji}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return Si}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return Ei}),"hard-drive":()=>Promise.resolve().then(function(){return Ri}),heart:()=>Promise.resolve().then(function(){return Di}),"house-door":()=>Promise.resolve().then(function(){return Ui}),house:()=>Promise.resolve().then(function(){return Fi}),image:()=>Promise.resolve().then(function(){return Ki}),"in-box":()=>Promise.resolve().then(function(){return Yi}),"info-circle-fill":()=>Promise.resolve().then(function(){return Gi}),"info-circle":()=>Promise.resolve().then(function(){return ea}),instagram:()=>Promise.resolve().then(function(){return la}),key:()=>Promise.resolve().then(function(){return na}),"laptop-gear":()=>Promise.resolve().then(function(){return ia}),laptop:()=>Promise.resolve().then(function(){return ca}),layers:()=>Promise.resolve().then(function(){return ha}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return ua}),"layout-text-window":()=>Promise.resolve().then(function(){return fa}),layout:()=>Promise.resolve().then(function(){return ga}),"life-buoy":()=>Promise.resolve().then(function(){return ma}),lightbulb:()=>Promise.resolve().then(function(){return xa}),link:()=>Promise.resolve().then(function(){return Za}),linkedin:()=>Promise.resolve().then(function(){return Ma}),list:()=>Promise.resolve().then(function(){return Va}),"lock-fill":()=>Promise.resolve().then(function(){return Pa}),lock:()=>Promise.resolve().then(function(){return Oa}),login:()=>Promise.resolve().then(function(){return Ba}),logout:()=>Promise.resolve().then(function(){return ja}),luggage:()=>Promise.resolve().then(function(){return Sa}),"mail-open":()=>Promise.resolve().then(function(){return Ea}),mail:()=>Promise.resolve().then(function(){return Ra}),map:()=>Promise.resolve().then(function(){return Da}),meetup:()=>Promise.resolve().then(function(){return Ua}),menu:()=>Promise.resolve().then(function(){return Fa}),microphone:()=>Promise.resolve().then(function(){return Ka}),monitor:()=>Promise.resolve().then(function(){return Ya}),moon:()=>Promise.resolve().then(function(){return Ga}),move:()=>Promise.resolve().then(function(){return ec}),paperclip:()=>Promise.resolve().then(function(){return lc}),passcode:()=>Promise.resolve().then(function(){return nc}),passport:()=>Promise.resolve().then(function(){return ic}),pause:()=>Promise.resolve().then(function(){return cc}),pencil:()=>Promise.resolve().then(function(){return hc}),"pending-circle":()=>Promise.resolve().then(function(){return uc}),"person-dash":()=>Promise.resolve().then(function(){return fc}),"person-plus":()=>Promise.resolve().then(function(){return gc}),"person-x":()=>Promise.resolve().then(function(){return mc}),person:()=>Promise.resolve().then(function(){return xc}),phone:()=>Promise.resolve().then(function(){return Zc}),"pin-map-fill":()=>Promise.resolve().then(function(){return Mc}),pin:()=>Promise.resolve().then(function(){return Vc}),placeholder:()=>Promise.resolve().then(function(){return Pc}),plane:()=>Promise.resolve().then(function(){return Oc}),play:()=>Promise.resolve().then(function(){return Bc}),"plus-circle":()=>Promise.resolve().then(function(){return jc}),"plus-square":()=>Promise.resolve().then(function(){return Sc}),plus:()=>Promise.resolve().then(function(){return Ec}),printer:()=>Promise.resolve().then(function(){return Rc}),"question-circle":()=>Promise.resolve().then(function(){return Dc}),rocket:()=>Promise.resolve().then(function(){return Uc}),save:()=>Promise.resolve().then(function(){return Fc}),search:()=>Promise.resolve().then(function(){return Kc}),send:()=>Promise.resolve().then(function(){return Yc}),"sg-crest":()=>Promise.resolve().then(function(){return Gc}),share:()=>Promise.resolve().then(function(){return es}),"shield-tick":()=>Promise.resolve().then(function(){return ls}),"sidebar-collapse":()=>Promise.resolve().then(function(){return ns}),"sidebar-expand":()=>Promise.resolve().then(function(){return is}),"slash-circle":()=>Promise.resolve().then(function(){return cs}),"slash-divider":()=>Promise.resolve().then(function(){return hs}),sliders:()=>Promise.resolve().then(function(){return us}),"sort-ascending":()=>Promise.resolve().then(function(){return fs}),"sort-descending":()=>Promise.resolve().then(function(){return gs}),speedometer:()=>Promise.resolve().then(function(){return ms}),"star-ai":()=>Promise.resolve().then(function(){return xs}),"star-fill":()=>Promise.resolve().then(function(){return Zs}),star:()=>Promise.resolve().then(function(){return Ms}),stoplights:()=>Promise.resolve().then(function(){return Vs}),sun:()=>Promise.resolve().then(function(){return Ps}),"switch-horizontal":()=>Promise.resolve().then(function(){return Os}),"switch-vertical":()=>Promise.resolve().then(function(){return Bs}),tablet:()=>Promise.resolve().then(function(){return js}),telegram:()=>Promise.resolve().then(function(){return Ss}),telephone:()=>Promise.resolve().then(function(){return Es}),"three-dots-vertical":()=>Promise.resolve().then(function(){return Rs}),"three-dots":()=>Promise.resolve().then(function(){return Ds}),ticket:()=>Promise.resolve().then(function(){return Us}),"toggle-off":()=>Promise.resolve().then(function(){return Fs}),"toggle-on":()=>Promise.resolve().then(function(){return Ks}),train:()=>Promise.resolve().then(function(){return Ys}),translate:()=>Promise.resolve().then(function(){return Gs}),trash:()=>Promise.resolve().then(function(){return eh}),"trend-down":()=>Promise.resolve().then(function(){return lh}),"trend-up":()=>Promise.resolve().then(function(){return nh}),truck:()=>Promise.resolve().then(function(){return ih}),"twitter-x":()=>Promise.resolve().then(function(){return ch}),unlock:()=>Promise.resolve().then(function(){return hh}),upload:()=>Promise.resolve().then(function(){return uh}),"user-check":()=>Promise.resolve().then(function(){return fh}),"user-circle":()=>Promise.resolve().then(function(){return gh}),"user-pause":()=>Promise.resolve().then(function(){return mh}),"user-square":()=>Promise.resolve().then(function(){return xh}),users:()=>Promise.resolve().then(function(){return Zh}),"video-recorder":()=>Promise.resolve().then(function(){return Mh}),"volume-max":()=>Promise.resolve().then(function(){return Vh}),"volume-x":()=>Promise.resolve().then(function(){return Ph}),"window-dash":()=>Promise.resolve().then(function(){return Oh}),"window-desktop":()=>Promise.resolve().then(function(){return Bh}),"window-dock":()=>Promise.resolve().then(function(){return jh}),"window-fullscreen":()=>Promise.resolve().then(function(){return Sh}),"window-plus":()=>Promise.resolve().then(function(){return Eh}),"window-sidebar":()=>Promise.resolve().then(function(){return Rh}),"window-split":()=>Promise.resolve().then(function(){return Dh}),"window-stack":()=>Promise.resolve().then(function(){return Uh}),"window-x":()=>Promise.resolve().then(function(){return Fh}),window:()=>Promise.resolve().then(function(){return Kh}),"xcircle-fill":()=>Promise.resolve().then(function(){return Yh}),xcircle:()=>Promise.resolve().then(function(){return Gh}),youtube:()=>Promise.resolve().then(function(){return ed}),"zoom-in":()=>Promise.resolve().then(function(){return ld}),"zoom-out":()=>Promise.resolve().then(function(){return nd})};var jl=i`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const $l=new Map;class Sl extends Te{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if($l.has(e))return void(this._icon=$l.get(e));const t=Al[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();$l.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:de}}Sl.styles=[...Te.styles,jl],e([P({type:String,reflect:!0})],Sl.prototype,"name",void 0),e([P({type:String,reflect:!0})],Sl.prototype,"size",void 0),e([P({type:String})],Sl.prototype,"ariaLabel",void 0),e([z()],Sl.prototype,"_icon",void 0);var Ll=i`:host([disabled]){cursor:not-allowed}.dropdown-item{align-items:center;background-color:var(--sit-bg-transparent);clear:both;color:var(--sit-color-default);cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-sm);padding:var(--sit-padding-sm) var(--sit-padding-lg);text-align:inherit}.dropdown-item:hover{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus,.dropdown-item:focus-visible{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus-visible{outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.dropdown-item.active{background-color:var(--sit-bg-translucent-subtle);color:var(--sit-primary-color-default);text-decoration:none}.dropdown-item.disabled,.dropdown-item:disabled{opacity:var(--sit-opacity-40);pointer-events:none}::slotted(*){color:inherit!important;display:flex;gap:var(--sit-gap-sm);text-decoration:none!important}::slotted(a),::slotted(sit-checkbox){flex:1;margin:calc(var(--sit-padding-sm)*-1) calc(var(--sit-padding-lg)*-1);padding:var(--sit-padding-sm) var(--sit-padding-lg)}.dropdown-item.mainnav-dropdown-link{padding:var(--sit-padding-none)}.dropdown-item.mainnav-dropdown-link ::slotted(*){box-sizing:border-box;margin:auto;max-width:var(--sit-mainnav-max-width,1440px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x)}@media screen and (min-width:1024px){.dropdown-item.mainnav-dropdown-link ::slotted(*){padding:var(--sit-padding-sm) var(--sit-mainnav-padding-x)}}`;class El extends Te{constructor(){super(...arguments),this.active=!1,this.disabled=!1,this.ariaLabel=""}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",e=>{"Enter"===e.key&&this.anchor.length>0&&this.anchor[0].click()}),this.setAttribute("role","menuitem"),this.setAttribute("aria-disabled",`${this.disabled}`)}render(){return ce`
      <div
        class="dropdown-item ${Bl({disabled:this.disabled,active:this.active})}"
        tabindex=${this.disabled?"-1":"0"}
        aria-label=${He(this.ariaLabel||void 0)}
      >
        <slot></slot>
      </div>
    `}}El.styles=[Ol,Ll],El.dependencies={"sit-icon":Sl},e([A({flatten:!0})],El.prototype,"anchor",void 0),e([P({type:Boolean})],El.prototype,"active",void 0),e([P({type:Boolean,reflect:!0})],El.prototype,"disabled",void 0),e([P({type:String})],El.prototype,"ariaLabel",void 0);class Tl extends Te{constructor(){super(...arguments),this.size="md"}render(){return ce`
      <sit-dropdown>
...
`,Kl=Object.freeze({__proto__:null,default:ql}),Jl=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yl=Object.freeze({__proto__:null,default:Jl}),Xl=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gl=Object.freeze({__proto__:null,default:Xl}),Ql=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,eo=Object.freeze({__proto__:null,default:Ql}),to=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,lo=Object.freeze({__proto__:null,default:to}),oo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,no=Object.freeze({__proto__:null,default:oo}),ro=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,io=Object.freeze({__proto__:null,default:ro}),ao=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,co=Object.freeze({__proto__:null,default:ao}),so=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ho=Object.freeze({__proto__:null,default:so}),uo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,vo=Object.freeze({__proto__:null,default:uo}),fo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,po=Object.freeze({__proto__:null,default:fo}),go=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wo=Object.freeze({__proto__:null,default:go}),mo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_o=Object.freeze({__proto__:null,default:mo}),xo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bo=Object.freeze({__proto__:null,default:xo}),Zo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Co=Object.freeze({__proto__:null,default:Zo}),Mo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,yo=Object.freeze({__proto__:null,default:Mo}),Vo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ho=Object.freeze({__proto__:null,default:Vo}),Po=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zo=Object.freeze({__proto__:null,default:Po}),Oo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ko=Object.freeze({__proto__:null,default:Oo}),Bo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ao=Object.freeze({__proto__:null,default:Bo}),jo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$o=Object.freeze({__proto__:null,default:jo}),So=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lo=Object.freeze({__proto__:null,default:So}),Eo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,To=Object.freeze({__proto__:null,default:Eo}),Ro=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Io=Object.freeze({__proto__:null,default:Ro}),Do=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,No=Object.freeze({__proto__:null,default:Do}),Uo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wo=Object.freeze({__proto__:null,default:Uo}),Fo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qo=Object.freeze({__proto__:null,default:Fo}),Ko=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jo=Object.freeze({__proto__:null,default:Ko}),Yo=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xo=Object.freeze({__proto__:null,default:Yo}),Go=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qo=Object.freeze({__proto__:null,default:Go}),en=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,tn=Object.freeze({__proto__:null,default:en}),ln=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,on=Object.freeze({__proto__:null,default:ln}),nn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rn=Object.freeze({__proto__:null,default:nn}),an=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,cn=Object.freeze({__proto__:null,default:an}),sn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hn=Object.freeze({__proto__:null,default:sn}),dn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,un=Object.freeze({__proto__:null,default:dn}),vn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,fn=Object.freeze({__proto__:null,default:vn}),pn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gn=Object.freeze({__proto__:null,default:pn}),wn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,mn=Object.freeze({__proto__:null,default:wn}),_n=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xn=Object.freeze({__proto__:null,default:_n}),bn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zn=Object.freeze({__proto__:null,default:bn}),Cn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mn=Object.freeze({__proto__:null,default:Cn}),yn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vn=Object.freeze({__proto__:null,default:yn}),Hn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pn=Object.freeze({__proto__:null,default:Hn}),zn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,On=Object.freeze({__proto__:null,default:zn}),kn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bn=Object.freeze({__proto__:null,default:kn}),An=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jn=Object.freeze({__proto__:null,default:An}),$n=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sn=Object.freeze({__proto__:null,default:$n}),Ln=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,En=Object.freeze({__proto__:null,default:Ln}),Tn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Rn=Object.freeze({__proto__:null,default:Tn}),In=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Dn=Object.freeze({__proto__:null,default:In}),Nn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Un=Object.freeze({__proto__:null,default:Nn}),Wn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fn=Object.freeze({__proto__:null,default:Wn}),qn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kn=Object.freeze({__proto__:null,default:qn}),Jn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yn=Object.freeze({__proto__:null,default:Jn}),Xn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gn=Object.freeze({__proto__:null,default:Xn}),Qn=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,er=Object.freeze({__proto__:null,default:Qn}),tr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lr=Object.freeze({__proto__:null,default:tr}),or=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nr=Object.freeze({__proto__:null,default:or}),rr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ir=Object.freeze({__proto__:null,default:rr}),ar=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cr=Object.freeze({__proto__:null,default:ar}),sr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hr=Object.freeze({__proto__:null,default:sr}),dr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ur=Object.freeze({__proto__:null,default:dr}),vr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fr=Object.freeze({__proto__:null,default:vr}),pr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gr=Object.freeze({__proto__:null,default:pr}),wr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mr=Object.freeze({__proto__:null,default:wr}),_r=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xr=Object.freeze({__proto__:null,default:_r}),br=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zr=Object.freeze({__proto__:null,default:br}),Cr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mr=Object.freeze({__proto__:null,default:Cr}),yr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Vr=Object.freeze({__proto__:null,default:yr}),Hr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pr=Object.freeze({__proto__:null,default:Hr}),zr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Or=Object.freeze({__proto__:null,default:zr}),kr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,Br=Object.freeze({__proto__:null,default:kr}),Ar=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jr=Object.freeze({__proto__:null,default:Ar}),$r=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sr=Object.freeze({__proto__:null,default:$r}),Lr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Er=Object.freeze({__proto__:null,default:Lr}),Tr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rr=Object.freeze({__proto__:null,default:Tr}),Ir=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Dr=Object.freeze({__proto__:null,default:Ir}),Nr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ur=Object.freeze({__proto__:null,default:Nr}),Wr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fr=Object.freeze({__proto__:null,default:Wr}),qr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kr=Object.freeze({__proto__:null,default:qr}),Jr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yr=Object.freeze({__proto__:null,default:Jr}),Xr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gr=Object.freeze({__proto__:null,default:Xr}),Qr=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ei=Object.freeze({__proto__:null,default:Qr}),ti=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,li=Object.freeze({__proto__:null,default:ti}),oi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ni=Object.freeze({__proto__:null,default:oi}),ri=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ii=Object.freeze({__proto__:null,default:ri}),ai=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ci=Object.freeze({__proto__:null,default:ai}),si=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,hi=Object.freeze({__proto__:null,default:si}),di=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,ui=Object.freeze({__proto__:null,default:di}),vi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,fi=Object.freeze({__proto__:null,default:vi}),pi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gi=Object.freeze({__proto__:null,default:pi}),wi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mi=Object.freeze({__proto__:null,default:wi}),_i=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xi=Object.freeze({__proto__:null,default:_i}),bi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zi=Object.freeze({__proto__:null,default:bi}),Ci=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mi=Object.freeze({__proto__:null,default:Ci}),yi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Vi=Object.freeze({__proto__:null,default:yi}),Hi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pi=Object.freeze({__proto__:null,default:Hi}),zi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Oi=Object.freeze({__proto__:null,default:zi}),ki=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bi=Object.freeze({__proto__:null,default:ki}),Ai=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ji=Object.freeze({__proto__:null,default:Ai}),$i=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Si=Object.freeze({__proto__:null,default:$i}),Li=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ei=Object.freeze({__proto__:null,default:Li}),Ti=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ri=Object.freeze({__proto__:null,default:Ti}),Ii=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Di=Object.freeze({__proto__:null,default:Ii}),Ni=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ui=Object.freeze({__proto__:null,default:Ni}),Wi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fi=Object.freeze({__proto__:null,default:Wi}),qi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ki=Object.freeze({__proto__:null,default:qi}),Ji=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yi=Object.freeze({__proto__:null,default:Ji}),Xi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gi=Object.freeze({__proto__:null,default:Xi}),Qi=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ea=Object.freeze({__proto__:null,default:Qi}),ta=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,la=Object.freeze({__proto__:null,default:ta}),oa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,na=Object.freeze({__proto__:null,default:oa}),ra=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ia=Object.freeze({__proto__:null,default:ra}),aa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ca=Object.freeze({__proto__:null,default:aa}),sa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ha=Object.freeze({__proto__:null,default:sa}),da=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ua=Object.freeze({__proto__:null,default:da}),va=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fa=Object.freeze({__proto__:null,default:va}),pa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ga=Object.freeze({__proto__:null,default:pa}),wa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ma=Object.freeze({__proto__:null,default:wa}),_a=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xa=Object.freeze({__proto__:null,default:_a}),ba=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Za=Object.freeze({__proto__:null,default:ba}),Ca=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ma=Object.freeze({__proto__:null,default:Ca}),ya=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Va=Object.freeze({__proto__:null,default:ya}),Ha=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pa=Object.freeze({__proto__:null,default:Ha}),za=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oa=Object.freeze({__proto__:null,default:za}),ka=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ba=Object.freeze({__proto__:null,default:ka}),Aa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ja=Object.freeze({__proto__:null,default:Aa}),$a=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sa=Object.freeze({__proto__:null,default:$a}),La=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ea=Object.freeze({__proto__:null,default:La}),Ta=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ra=Object.freeze({__proto__:null,default:Ta}),Ia=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Da=Object.freeze({__proto__:null,default:Ia}),Na=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ua=Object.freeze({__proto__:null,default:Na}),Wa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fa=Object.freeze({__proto__:null,default:Wa}),qa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ka=Object.freeze({__proto__:null,default:qa}),Ja=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ya=Object.freeze({__proto__:null,default:Ja}),Xa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ga=Object.freeze({__proto__:null,default:Xa}),Qa=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ec=Object.freeze({__proto__:null,default:Qa}),tc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lc=Object.freeze({__proto__:null,default:tc}),oc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,nc=Object.freeze({__proto__:null,default:oc}),rc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ic=Object.freeze({__proto__:null,default:rc}),ac=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,cc=Object.freeze({__proto__:null,default:ac}),sc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hc=Object.freeze({__proto__:null,default:sc}),dc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,uc=Object.freeze({__proto__:null,default:dc}),vc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fc=Object.freeze({__proto__:null,default:vc}),pc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gc=Object.freeze({__proto__:null,default:pc}),wc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mc=Object.freeze({__proto__:null,default:wc}),_c=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xc=Object.freeze({__proto__:null,default:_c}),bc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zc=Object.freeze({__proto__:null,default:bc}),Cc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mc=Object.freeze({__proto__:null,default:Cc}),yc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vc=Object.freeze({__proto__:null,default:yc}),Hc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Pc=Object.freeze({__proto__:null,default:Hc}),zc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oc=Object.freeze({__proto__:null,default:zc}),kc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bc=Object.freeze({__proto__:null,default:kc}),Ac=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jc=Object.freeze({__proto__:null,default:Ac}),$c=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sc=Object.freeze({__proto__:null,default:$c}),Lc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ec=Object.freeze({__proto__:null,default:Lc}),Tc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rc=Object.freeze({__proto__:null,default:Tc}),Ic=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Dc=Object.freeze({__proto__:null,default:Ic}),Nc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Uc=Object.freeze({__proto__:null,default:Nc}),Wc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fc=Object.freeze({__proto__:null,default:Wc}),qc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kc=Object.freeze({__proto__:null,default:qc}),Jc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yc=Object.freeze({__proto__:null,default:Jc}),Xc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="#DB0000"
...
`,Gc=Object.freeze({__proto__:null,default:Xc}),Qc=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,es=Object.freeze({__proto__:null,default:Qc}),ts=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ls=Object.freeze({__proto__:null,default:ts}),os=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ns=Object.freeze({__proto__:null,default:os}),rs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,is=Object.freeze({__proto__:null,default:rs}),as=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,us=Object.freeze({__proto__:null,default:ds}),vs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,fs=Object.freeze({__proto__:null,default:vs}),ps=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gs=Object.freeze({__proto__:null,default:ps}),ws=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ms=Object.freeze({__proto__:null,default:ws}),_s=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xs=Object.freeze({__proto__:null,default:_s}),bs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zs=Object.freeze({__proto__:null,default:bs}),Cs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ms=Object.freeze({__proto__:null,default:Cs}),ys=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vs=Object.freeze({__proto__:null,default:ys}),Hs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ps=Object.freeze({__proto__:null,default:Hs}),zs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Os=Object.freeze({__proto__:null,default:zs}),ks=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bs=Object.freeze({__proto__:null,default:ks}),As=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,js=Object.freeze({__proto__:null,default:As}),$s=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ss=Object.freeze({__proto__:null,default:$s}),Ls=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Es=Object.freeze({__proto__:null,default:Ls}),Ts=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rs=Object.freeze({__proto__:null,default:Ts}),Is=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ds=Object.freeze({__proto__:null,default:Is}),Ns=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Us=Object.freeze({__proto__:null,default:Ns}),Ws=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fs=Object.freeze({__proto__:null,default:Ws}),qs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ks=Object.freeze({__proto__:null,default:qs}),Js=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ys=Object.freeze({__proto__:null,default:Js}),Xs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gs=Object.freeze({__proto__:null,default:Xs}),Qs=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,eh=Object.freeze({__proto__:null,default:Qs}),th=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,lh=Object.freeze({__proto__:null,default:th}),oh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,nh=Object.freeze({__proto__:null,default:oh}),rh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ih=Object.freeze({__proto__:null,default:rh}),ah=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ch=Object.freeze({__proto__:null,default:ah}),sh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hh=Object.freeze({__proto__:null,default:sh}),dh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,uh=Object.freeze({__proto__:null,default:dh}),vh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,fh=Object.freeze({__proto__:null,default:vh}),ph=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gh=Object.freeze({__proto__:null,default:ph}),wh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,mh=Object.freeze({__proto__:null,default:wh}),_h=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xh=Object.freeze({__proto__:null,default:_h}),bh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zh=Object.freeze({__proto__:null,default:bh}),Ch=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mh=Object.freeze({__proto__:null,default:Ch}),yh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vh=Object.freeze({__proto__:null,default:yh}),Hh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ph=Object.freeze({__proto__:null,default:Hh}),zh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Oh=Object.freeze({__proto__:null,default:zh}),kh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Bh=Object.freeze({__proto__:null,default:kh}),Ah=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jh=Object.freeze({__proto__:null,default:Ah}),$h=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sh=Object.freeze({__proto__:null,default:$h}),Lh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Eh=Object.freeze({__proto__:null,default:Lh}),Th=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rh=Object.freeze({__proto__:null,default:Th}),Ih=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Dh=Object.freeze({__proto__:null,default:Ih}),Nh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Uh=Object.freeze({__proto__:null,default:Nh}),Wh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fh=Object.freeze({__proto__:null,default:Wh}),qh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kh=Object.freeze({__proto__:null,default:qh}),Jh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yh=Object.freeze({__proto__:null,default:Jh}),Xh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gh=Object.freeze({__proto__:null,default:Xh}),Qh=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ed=Object.freeze({__proto__:null,default:Qh}),td=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ld=Object.freeze({__proto__:null,default:td}),od=ce`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nd=Object.freeze({__proto__:null,default:od})});
