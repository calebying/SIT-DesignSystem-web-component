...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */const Le=je(class extends Ae{constructor(e){if(super(e),e.type!==Se||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const i=!!t[e];i===this._previousClasses.has(e)||this._staticClasses?.has(e)||(i?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return le}}),ke=e=>e??ie;
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function Re(e){void 0!==this._$disconnectableChildren?(Ie(this),this._$parent=e,Te(this)):this._$parent=e}function De(e,t=!1,l=0){const i=this._$committedValue,o=this._$disconnectableChildren;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(i))for(let e=l;e<i.length;e++)Ee(i[e],!1),Ie(i[e]);else null!=i&&(Ee(i,!1),Ie(i));else Ee(this,e)}const Ne=e=>{e.type==Be&&(e._$notifyConnectionChanged??=De,e._$reparentDisconnectables??=Re)};class Ue extends Ae{constructor(){super(...arguments),this._$disconnectableChildren=void 0}_$initialize(e,t,l){super._$initialize(e,t,l),Te(this),this.isConnected=e._$isConnected}_$notifyDirectiveConnectionChanged(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ee(this,e),Ie(this))}setValue(e){if(void 0===this.__part.strings)this.__part._$setValue(e,this);else{if(void 0===this.__attributeIndex)throw new Error("Expected this.__attributeIndex to be a number");const t=[...this.__part._$committedValue];t[this.__attributeIndex]=e,this.__part._$setValue(t,this,0)}}disconnected(){}reconnected(){}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const Fe=()=>new We;class We{}const qe=new WeakMap;const Ke=je(class extends Ue{render(e){return ie}update(e,[t]){const l=t!==this._ref;return l&&void 0!==this._ref&&this._updateRefValue(void 0),(l||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),ie}_updateRefValue(e){if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let l=qe.get(t);void 0===l&&(l=new WeakMap,qe.set(t,l)),void 0!==l.get(this._ref)&&this._ref.call(this._context,void 0),l.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?qe.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}}),Je=Math.min,Ge=Math.max,Ye=Math.round,Xe=Math.floor,Qe=e=>({x:e,y:e}),et={left:"right",right:"left",bottom:"top",top:"bottom"},tt={start:"end",end:"start"};function lt(e,t,l){return Ge(e,Je(t,l))}function it(e,t){return"function"==typeof e?e(t):e}function ot(e){return e.split("-")[0]}function nt(e){return e.split("-")[1]}function rt(e){return"x"===e?"y":"x"}function at(e){return"y"===e?"height":"width"}const st=new Set(["top","bottom"]);function ct(e){return st.has(ot(e))?"y":"x"}function dt(e){return rt(ct(e))}function ht(e,t,l){void 0===l&&(l=!1);const i=nt(e),o=dt(e),n=at(o);let r="x"===o?i===(l?"end":"start")?"right":"left":"start"===i?"bottom":"top";return t.reference[n]>t.floating[n]&&(r=mt(r)),[r,mt(r)]}function ut(e){return e.replace(/start|end/g,e=>tt[e])}const vt=["left","right"],pt=["right","left"],ft=["top","bottom"],gt=["bottom","top"];function wt(e,t,l,i){const o=nt(e);let n=function(e,t,l){switch(e){case"top":case"bottom":return l?t?pt:vt:t?vt:pt;case"left":case"right":return t?ft:gt;default:return[]}}(ot(e),"start"===l,i);return o&&(n=n.map(e=>e+"-"+o),t&&(n=n.concat(n.map(ut)))),n}function mt(e){return e.replace(/left|right|bottom|top/g,e=>et[e])}function _t(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function bt(e){const{x:t,y:l,width:i,height:o}=e;return{width:i,height:o,top:l,left:t,right:t+i,bottom:l+o,x:t,y:l}}function xt(e,t,l){let{reference:i,floating:o}=e;const n=ct(t),r=dt(t),a=at(r),s=ot(t),c="y"===n,d=i.x+i.width/2-o.width/2,h=i.y+i.height/2-o.height/2,u=i[a]/2-o[a]/2;let v;switch(s){case"top":v={x:d,y:i.y-o.height};break;case"bottom":v={x:d,y:i.y+i.height};break;case"right":v={x:i.x+i.width,y:h};break;case"left":v={x:i.x-o.width,y:h};break;default:v={x:i.x,y:i.y}}switch(nt(t)){case"start":v[r]-=u*(l&&c?-1:1);break;case"end":v[r]+=u*(l&&c?-1:1)}return v}async function Zt(e,t){var l;void 0===t&&(t={});const{x:i,y:o,platform:n,rects:r,elements:a,strategy:s}=e,{boundary:c="clippingAncestors",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:u=!1,padding:v=0}=it(t,e),p=_t(v),f=a[u?"floating"===h?"reference":"floating":h],g=bt(await n.getClippingRect({element:null==(l=await(null==n.isElement?void 0:n.isElement(f)))||l?f:f.contextElement||await(null==n.getDocumentElement?void 0:n.getDocumentElement(a.floating)),boundary:c,rootBoundary:d,strategy:s})),w="floating"===h?{x:i,y:o,width:r.floating.width,height:r.floating.height}:r.reference,m=await(null==n.getOffsetParent?void 0:n.getOffsetParent(a.floating)),_=await(null==n.isElement?void 0:n.isElement(m))&&await(null==n.getScale?void 0:n.getScale(m))||{x:1,y:1},b=bt(n.convertOffsetParentRelativeRectToViewportRelativeRect?await n.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:m,strategy:s}):w);return{top:(g.top-b.top+p.top)/_.y,bottom:(b.bottom-g.bottom+p.bottom)/_.y,left:(g.left-b.left+p.left)/_.x,right:(b.right-g.right+p.right)/_.x}}const Ct=new Set(["left","top"]);function yt(){return"undefined"!=typeof window}function Mt(e){return Pt(e)?(e.nodeName||"").toLowerCase():"#document"}function Vt(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function Ht(e){var t;return null==(t=(Pt(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Pt(e){return!!yt()&&(e instanceof Node||e instanceof Vt(e).Node)}function Ot(e){return!!yt()&&(e instanceof Element||e instanceof Vt(e).Element)}function zt(e){return!!yt()&&(e instanceof HTMLElement||e instanceof Vt(e).HTMLElement)}function $t(e){return!(!yt()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof Vt(e).ShadowRoot)}const St=new Set(["inline","contents"]);function Bt(e){const{overflow:t,overflowX:l,overflowY:i,display:o}=Ft(e);return/auto|scroll|overlay|hidden|clip/.test(t+i+l)&&!St.has(o)}const jt=new Set(["table","td","th"]);function At(e){return jt.has(Mt(e))}const Lt=[":popover-open",":modal"];function kt(e){return Lt.some(t=>{try{return e.matches(t)}catch(e){return!1}})}const Et=["transform","translate","scale","rotate","perspective"],It=["transform","translate","scale","rotate","perspective","filter"],Tt=["paint","layout","strict","content"];function Rt(e){const t=Dt(),l=Ot(e)?Ft(e):e;return Et.some(e=>!!l[e]&&"none"!==l[e])||!!l.containerType&&"normal"!==l.containerType||!t&&!!l.backdropFilter&&"none"!==l.backdropFilter||!t&&!!l.filter&&"none"!==l.filter||It.some(e=>(l.willChange||"").includes(e))||Tt.some(e=>(l.contain||"").includes(e))}function Dt(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}const Nt=new Set(["html","body","#document"]);function Ut(e){return Nt.has(Mt(e))}function Ft(e){return Vt(e).getComputedStyle(e)}function Wt(e){return Ot(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function qt(e){if("html"===Mt(e))return e;const t=e.assignedSlot||e.parentNode||$t(e)&&e.host||Ht(e);return $t(t)?t.host:t}function Kt(e){const t=qt(e);return Ut(t)?e.ownerDocument?e.ownerDocument.body:e.body:zt(t)&&Bt(t)?t:Kt(t)}function Jt(e,t,l){var i;void 0===t&&(t=[]),void 0===l&&(l=!0);const o=Kt(e),n=o===(null==(i=e.ownerDocument)?void 0:i.body),r=Vt(o);if(n){const e=Gt(r);return t.concat(r,r.visualViewport||[],Bt(o)?o:[],e&&l?Jt(e):[])}return t.concat(o,Jt(o,[],l))}function Gt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Yt(e){const t=Ft(e);let l=parseFloat(t.width)||0,i=parseFloat(t.height)||0;const o=zt(e),n=o?e.offsetWidth:l,r=o?e.offsetHeight:i,a=Ye(l)!==n||Ye(i)!==r;return a&&(l=n,i=r),{width:l,height:i,$:a}}function Xt(e){return Ot(e)?e:e.contextElement}function Qt(e){const t=Xt(e);if(!zt(t))return Qe(1);const l=t.getBoundingClientRect(),{width:i,height:o,$:n}=Yt(t);let r=(n?Ye(l.width):l.width)/i,a=(n?Ye(l.height):l.height)/o;return r&&Number.isFinite(r)||(r=1),a&&Number.isFinite(a)||(a=1),{x:r,y:a}}const el=Qe(0);function tl(e){const t=Vt(e);return Dt()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:el}function ll(e,t,l,i){void 0===t&&(t=!1),void 0===l&&(l=!1);const o=e.getBoundingClientRect(),n=Xt(e);let r=Qe(1);t&&(i?Ot(i)&&(r=Qt(i)):r=Qt(e));const a=function(e,t,l){return void 0===t&&(t=!1),!(!l||t&&l!==Vt(e))&&t}(n,l,i)?tl(n):Qe(0);let s=(o.left+a.x)/r.x,c=(o.top+a.y)/r.y,d=o.width/r.x,h=o.height/r.y;if(n){const e=Vt(n),t=i&&Ot(i)?Vt(i):i;let l=e,o=Gt(l);for(;o&&i&&t!==l;){const e=Qt(o),t=o.getBoundingClientRect(),i=Ft(o),n=t.left+(o.clientLeft+parseFloat(i.paddingLeft))*e.x,r=t.top+(o.clientTop+parseFloat(i.paddingTop))*e.y;s*=e.x,c*=e.y,d*=e.x,h*=e.y,s+=n,c+=r,l=Vt(o),o=Gt(l)}}return bt({width:d,height:h,x:s,y:c})}function il(e,t){const l=Wt(e).scrollLeft;return t?t.left+l:ll(Ht(e)).left+l}function ol(e,t){const l=e.getBoundingClientRect();return{x:l.left+t.scrollLeft-il(e,l),y:l.top+t.scrollTop}}const nl=new Set(["absolute","fixed"]);function rl(e,t,l){let i;if("viewport"===t)i=function(e,t){const l=Vt(e),i=Ht(e),o=l.visualViewport;let n=i.clientWidth,r=i.clientHeight,a=0,s=0;if(o){n=o.width,r=o.height;const e=Dt();(!e||e&&"fixed"===t)&&(a=o.offsetLeft,s=o.offsetTop)}const c=il(i);if(c<=0){const e=i.ownerDocument,t=e.body,l=getComputedStyle(t),o="CSS1Compat"===e.compatMode&&parseFloat(l.marginLeft)+parseFloat(l.marginRight)||0,r=Math.abs(i.clientWidth-t.clientWidth-o);r<=25&&(n-=r)}else c<=25&&(n+=c);return{width:n,height:r,x:a,y:s}}(e,l);else if("document"===t)i=function(e){const t=Ht(e),l=Wt(e),i=e.ownerDocument.body,o=Ge(t.scrollWidth,t.clientWidth,i.scrollWidth,i.clientWidth),n=Ge(t.scrollHeight,t.clientHeight,i.scrollHeight,i.clientHeight);let r=-l.scrollLeft+il(e);const a=-l.scrollTop;return"rtl"===Ft(i).direction&&(r+=Ge(t.clientWidth,i.clientWidth)-o),{width:o,height:n,x:r,y:a}}(Ht(e));else if(Ot(t))i=function(e,t){const l=ll(e,!0,"fixed"===t),i=l.top+e.clientTop,o=l.left+e.clientLeft,n=zt(e)?Qt(e):Qe(1);return{width:e.clientWidth*n.x,height:e.clientHeight*n.y,x:o*n.x,y:i*n.y}}(t,l);else{const l=tl(e);i={x:t.x-l.x,y:t.y-l.y,width:t.width,height:t.height}}return bt(i)}function al(e,t){const l=qt(e);return!(l===t||!Ot(l)||Ut(l))&&("fixed"===Ft(l).position||al(l,t))}function sl(e,t,l){const i=zt(t),o=Ht(t),n="fixed"===l,r=ll(e,!0,n,t);let a={scrollLeft:0,scrollTop:0};const s=Qe(0);function c(){s.x=il(o)}if(i||!i&&!n)if(("body"!==Mt(t)||Bt(o))&&(a=Wt(t)),i){const e=ll(t,!0,n,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&c();n&&!i&&o&&c();const d=!o||i||n?Qe(0):ol(o,a);return{x:r.left+a.scrollLeft-s.x-d.x,y:r.top+a.scrollTop-s.y-d.y,width:r.width,height:r.height}}function cl(e){return"static"===Ft(e).position}function dl(e,t){if(!zt(e)||"fixed"===Ft(e).position)return null;if(t)return t(e);let l=e.offsetParent;return Ht(e)===l&&(l=l.ownerDocument.body),l}function hl(e,t){const l=Vt(e);if(kt(e))return l;if(!zt(e)){let t=qt(e);for(;t&&!Ut(t);){if(Ot(t)&&!cl(t))return t;t=qt(t)}return l}let i=dl(e,t);for(;i&&At(i)&&cl(i);)i=dl(i,t);return i&&Ut(i)&&cl(i)&&!Rt(i)?l:i||function(e){let t=qt(e);for(;zt(t)&&!Ut(t);){if(Rt(t))return t;if(kt(t))return null;t=qt(t)}return null}(e)||l}const ul={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:l,offsetParent:i,strategy:o}=e;const n="fixed"===o,r=Ht(i),a=!!t&&kt(t.floating);if(i===r||a&&n)return l;let s={scrollLeft:0,scrollTop:0},c=Qe(1);const d=Qe(0),h=zt(i);if((h||!h&&!n)&&(("body"!==Mt(i)||Bt(r))&&(s=Wt(i)),zt(i))){const e=ll(i);c=Qt(i),d.x=e.x+i.clientLeft,d.y=e.y+i.clientTop}const u=!r||h||n?Qe(0):ol(r,s);return{width:l.width*c.x,height:l.height*c.y,x:l.x*c.x-s.scrollLeft*c.x+d.x+u.x,y:l.y*c.y-s.scrollTop*c.y+d.y+u.y}},getDocumentElement:Ht,getClippingRect:function(e){let{element:t,boundary:l,rootBoundary:i,strategy:o}=e;const n=[..."clippingAncestors"===l?kt(t)?[]:function(e,t){const l=t.get(e);if(l)return l;let i=Jt(e,[],!1).filter(e=>Ot(e)&&"body"!==Mt(e)),o=null;const n="fixed"===Ft(e).position;let r=n?qt(e):e;for(;Ot(r)&&!Ut(r);){const t=Ft(r),l=Rt(r);l||"fixed"!==t.position||(o=null),(n?!l&&!o:!l&&"static"===t.position&&o&&nl.has(o.position)||Bt(r)&&!l&&al(e,r))?i=i.filter(e=>e!==r):o=t,r=qt(r)}return t.set(e,i),i}(t,this._c):[].concat(l),i],r=n[0],a=n.reduce((e,l)=>{const i=rl(t,l,o);return e.top=Ge(i.top,e.top),e.right=Je(i.right,e.right),e.bottom=Je(i.bottom,e.bottom),e.left=Ge(i.left,e.left),e},rl(t,r,o));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}},getOffsetParent:hl,getElementRects:async function(e){const t=this.getOffsetParent||hl,l=this.getDimensions,i=await l(e.floating);return{reference:sl(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:l}=Yt(e);return{width:t,height:l}},getScale:Qt,isElement:Ot,isRTL:function(e){return"rtl"===Ft(e).direction}};function vl(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function pl(e,t,l,i){void 0===i&&(i={});const{ancestorScroll:o=!0,ancestorResize:n=!0,elementResize:r="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:s=!1}=i,c=Xt(e),d=o||n?[...c?Jt(c):[],...Jt(t)]:[];d.forEach(e=>{o&&e.addEventListener("scroll",l,{passive:!0}),n&&e.addEventListener("resize",l)});const h=c&&a?function(e,t){let l,i=null;const o=Ht(e);function n(){var e;clearTimeout(l),null==(e=i)||e.disconnect(),i=null}return function r(a,s){void 0===a&&(a=!1),void 0===s&&(s=1),n();const c=e.getBoundingClientRect(),{left:d,top:h,width:u,height:v}=c;if(a||t(),!u||!v)return;const p={rootMargin:-Xe(h)+"px "+-Xe(o.clientWidth-(d+u))+"px "+-Xe(o.clientHeight-(h+v))+"px "+-Xe(d)+"px",threshold:Ge(0,Je(1,s))||1};let f=!0;function g(t){const i=t[0].intersectionRatio;if(i!==s){if(!f)return r();i?r(!1,i):l=setTimeout(()=>{r(!1,1e-7)},1e3)}1!==i||vl(c,e.getBoundingClientRect())||r(),f=!1}try{i=new IntersectionObserver(g,{...p,root:o.ownerDocument})}catch(e){i=new IntersectionObserver(g,p)}i.observe(e)}(!0),n}(c,l):null;let u,v=-1,p=null;r&&(p=new ResizeObserver(e=>{let[i]=e;i&&i.target===c&&p&&(p.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=p)||e.observe(t)})),l()}),c&&!s&&p.observe(c),p.observe(t));let f=s?ll(e):null;return s&&function t(){const i=ll(e);f&&!vl(f,i)&&l();f=i,u=requestAnimationFrame(t)}(),l(),()=>{var e;d.forEach(e=>{o&&e.removeEventListener("scroll",l),n&&e.removeEventListener("resize",l)}),null==h||h(),null==(e=p)||e.disconnect(),p=null,s&&cancelAnimationFrame(u)}}const fl=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var l,i;const{x:o,y:n,placement:r,middlewareData:a}=t,s=await async function(e,t){const{placement:l,platform:i,elements:o}=e,n=await(null==i.isRTL?void 0:i.isRTL(o.floating)),r=ot(l),a=nt(l),s="y"===ct(l),c=Ct.has(r)?-1:1,d=n&&s?-1:1,h=it(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:p}="number"==typeof h?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:h.mainAxis||0,crossAxis:h.crossAxis||0,alignmentAxis:h.alignmentAxis};return a&&"number"==typeof p&&(v="end"===a?-1*p:p),s?{x:v*d,y:u*c}:{x:u*c,y:v*d}}(t,e);return r===(null==(l=a.offset)?void 0:l.placement)&&null!=(i=a.arrow)&&i.alignmentOffset?{}:{x:o+s.x,y:n+s.y,data:{...s,placement:r}}}}},gl=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:l,y:i,placement:o}=t,{mainAxis:n=!0,crossAxis:r=!1,limiter:a={fn:e=>{let{x:t,y:l}=e;return{x:t,y:l}}},...s}=it(e,t),c={x:l,y:i},d=await Zt(t,s),h=ct(ot(o)),u=rt(h);let v=c[u],p=c[h];if(n){const e="y"===u?"bottom":"right";v=lt(v+d["y"===u?"top":"left"],v,v-d[e])}if(r){const e="y"===h?"bottom":"right";p=lt(p+d["y"===h?"top":"left"],p,p-d[e])}const f=a.fn({...t,[u]:v,[h]:p});return{...f,data:{x:f.x-l,y:f.y-i,enabled:{[u]:n,[h]:r}}}}}},wl=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var l,i;const{placement:o,middlewareData:n,rects:r,initialPlacement:a,platform:s,elements:c}=t,{mainAxis:d=!0,crossAxis:h=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:p="none",flipAlignment:f=!0,...g}=it(e,t);if(null!=(l=n.arrow)&&l.alignmentOffset)return{};const w=ot(o),m=ct(a),_=ot(a)===a,b=await(null==s.isRTL?void 0:s.isRTL(c.floating)),x=u||(_||!f?[mt(a)]:function(e){const t=mt(e);return[ut(e),t,ut(t)]}(a)),Z="none"!==p;!u&&Z&&x.push(...wt(a,f,p,b));const C=[a,...x],y=await Zt(t,g),M=[];let V=(null==(i=n.flip)?void 0:i.overflows)||[];if(d&&M.push(y[w]),h){const e=ht(o,r,b);M.push(y[e[0]],y[e[1]])}if(V=[...V,{placement:o,overflows:M}],!M.every(e=>e<=0)){var H,P;const e=((null==(H=n.flip)?void 0:H.index)||0)+1,t=C[e];if(t){if(!("alignment"===h&&m!==ct(t))||V.every(e=>ct(e.placement)!==m||e.overflows[0]>0))return{data:{index:e,overflows:V},reset:{placement:t}}}let l=null==(P=V.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:P.placement;if(!l)switch(v){case"bestFit":{var O;const e=null==(O=V.filter(e=>{if(Z){const t=ct(e.placement);return t===m||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:O[0];e&&(l=e);break}case"initialPlacement":l=a}if(o!==l)return{reset:{placement:l}}}return{}}}},ml=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var l,i;const{placement:o,rects:n,platform:r,elements:a}=t,{apply:s=()=>{},...c}=it(e,t),d=await Zt(t,c),h=ot(o),u=nt(o),v="y"===ct(o),{width:p,height:f}=n.floating;let g,w;"top"===h||"bottom"===h?(g=h,w=u===(await(null==r.isRTL?void 0:r.isRTL(a.floating))?"start":"end")?"left":"right"):(w=h,g="end"===u?"top":"bottom");const m=f-d.top-d.bottom,_=p-d.left-d.right,b=Je(f-d[g],m),x=Je(p-d[w],_),Z=!t.middlewareData.shift;let C=b,y=x;if(null!=(l=t.middlewareData.shift)&&l.enabled.x&&(y=_),null!=(i=t.middlewareData.shift)&&i.enabled.y&&(C=m),Z&&!u){const e=Ge(d.left,0),t=Ge(d.right,0),l=Ge(d.top,0),i=Ge(d.bottom,0);v?y=p-2*(0!==e||0!==t?e+t:Ge(d.left,d.right)):C=f-2*(0!==l||0!==i?l+i:Ge(d.top,d.bottom))}await s({...t,availableWidth:y,availableHeight:C});const M=await r.getDimensions(a.floating);return p!==M.width||f!==M.height?{reset:{rects:!0}}:{}}}},_l=(e,t,l)=>{const i=new Map,o={platform:ul,...l},n={...o.platform,_c:i};return(async(e,t,l)=>{const{placement:i="bottom",strategy:o="absolute",middleware:n=[],platform:r}=l,a=n.filter(Boolean),s=await(null==r.isRTL?void 0:r.isRTL(t));let c=await r.getElementRects({reference:e,floating:t,strategy:o}),{x:d,y:h}=xt(c,i,s),u=i,v={},p=0;for(let l=0;l<a.length;l++){const{name:n,fn:f}=a[l],{x:g,y:w,data:m,reset:_}=await f({x:d,y:h,initialPlacement:i,placement:u,strategy:o,middlewareData:v,rects:c,platform:r,elements:{reference:e,floating:t}});d=null!=g?g:d,h=null!=w?w:h,v={...v,[n]:{...v[n],...m}},_&&p<=50&&(p++,"object"==typeof _&&(_.placement&&(u=_.placement),_.rects&&(c=!0===_.rects?await r.getElementRects({reference:e,floating:t,strategy:o}):_.rects),({x:d,y:h}=xt(c,u,s))),l=-1)}return{x:d,y:h,placement:u,strategy:o,middlewareData:v}})(e,t,{...o,platform:n})};var bl=a`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:var(--sit-elevation-surface-3);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:start;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-start-end-radius:0;border-start-start-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{inset-inline:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,xl=a`.invalid-feedback-container{display:flex;gap:var(--sit-form-gap-sm)}.invalid-feedback,.invalid-feedback-container{color:var(--sit-form-danger-color-default);line-height:var(--sit-line-height-20)}.invalid-feedback{font-size:var(--sit-font-size-label-sm);font-weight:var(--sit-font-weight-regular)}.valid-icon{color:var(--sit-form-success-color-default)}`,Zl=a`.form-text{color:var(--sit-form-color-subtle);font-size:var(--sit-font-size-label-sm);line-height:var(--sit-line-height-2-xs)}.form-text.disabled{opacity:var(--sit-opacity-40)}`,Cl=a`.form-control-container{display:flex;flex-direction:column;gap:var(--sit-form-gap-md)}.m-width-160{min-width:var(--sit-dimension-160)}.m-width-256{min-width:var(--sit-dimension-256)}.form-label{color:var(--sit-form-color-default);font-size:var(--sit-font-size-label-md);font-weight:var(--sit-font-weight-semibold)}.form-control-group{align-items:center;background-color:var(--sit-form-surface-default);border:var(--sit-form-border-width-default) solid var(--sit-border-color-default);border-radius:var(--input-border-radius,var(--sit-form-border-radius-md));display:flex;gap:var(--sit-form-gap-md);height:var(--sit-dimension-48);justify-content:center;overflow:hidden;padding:0 var(--sit-form-padding-x);transition:border-color .15s ease-in-out,box-shadow .15s ease-in-out;width:-webkit-fill-available;width:-moz-available}.form-control{appearance:none;background-clip:padding-box;background:none;border:none;color:var(--sit-form-color-default);display:block;flex-grow:1;font-family:var(--sit-font-family-brand);font-size:var(--sit-font-size-label-md);line-height:var(--sit-line-height-xs);min-width:0;outline:none;padding:0;width:100%}.form-clearable{color:var(--sit-color-subtle);cursor:pointer}@media (prefers-reduced-motion:reduce){.form-control-group{transition:none}}.form-control-group:not(.disabled):not(.is-invalid):not(.readonly):not(:focus-within):hover{outline:var(--sit-form-border-width-thick) solid var(--sit-border-color-emphasis);outline-offset:var(--sit-form-outline-offset-focus)}.form-control-group:not(.disabled):not(.is-invalid):focus-within{outline:var(--sit-form-outline-focus);outline-offset:var(--sit-form-outline-offset-focus)}.form-control-container.disabled{opacity:var(--sit-opacity-40)}.form-control-group.disabled{background-color:var(--sit-form-surface-muted);cursor:not-allowed}.form-control-group.readonly{background-color:var(--sit-form-surface-raised)}.form-control-group.is-invalid:not(.disabled){border:var(--sit-form-border-width-default) solid var(--sit-form-danger-border-color-default)}.form-control-group:not(.disabled).is-invalid:focus-within{outline:var(--sit-border-width-2) solid var(--sit-form-danger-color-default);outline-offset:var(--sit-form-outline-offset-focus)}`;function yl(e="",t=""){return`id-${Math.random().toString().substring(2,6)}-sit-${e}-${t}`}class Ml{constructor(e,t){(this.host=e).addController(this),this._internals=e._internals||this.host.attachInternals(),this.options=Object.assign({setInvalid:(e,t)=>{e.invalid=t},value:e=>e.value,input:e=>e.input},t)}hostConnected(){this.host.addEventListener("invalid",e=>this.handleInvalid(e))}hostDisconnected(){this.host.removeEventListener("invalid",e=>this.handleInvalid(e))}handleInvalid(e){e.preventDefault(),this.options.setInvalid(this.host,!0)}handleInput(e){const t=e.target;this.options.setInvalid(this.host,!1),this.validateInput(t)}handleChange(e){const t=e.target;this.validateInput(t),this.options.setInvalid(this.host,!this.checkValidity())}get form(){return this._internals.form}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}updateInvalidState(){this.options.setInvalid(this.host,!this.checkValidity())}resetValidity(){return this._internals.setValidity({})}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}setValidity(e,t,l){return this._internals.setValidity(e,t,l)}setFormValue(){const e=this.options.value(this.host);this._internals.setFormValue(e)}validateInput(e){if(this.options.input(this.host).disabled)return this._internals.setValidity({});const t=e.validity;if(t.valid)this._internals.setValidity({});else for(const l in t)t[l]&&(this.validationError=l.toString(),this._internals.setValidity({[this.validationError]:!0},e.validationMessage,e))}}const Vl=e=>{class l extends e{constructor(...e){super(...e),this._isTouched=!1,this._internals=this.attachInternals()}connectedCallback(){var e;super.connectedCallback(),null!==(e=this.inputValidationController)&&void 0!==e||(this.inputValidationController=new Ml(this))}async firstUpdated(e){super.firstUpdated(e),this.input=this.shadowRoot.querySelector("input")||await this.sitInput||this.shadowRoot.querySelector("textarea")||await this.sitDatepickerInput,this._mixinSetFormValue(),this._mixinShouldSkipSitValidation()||this._mixinValidate(this.input)}formResetCallback(){this._mixinResetFormControl?this._mixinResetFormControl():(this.value=this.defaultValue,this._mixinResetValidity(this.input)),this._mixinSetFormValue()}_mixinHandleChange(e){this._mixinSetFormValue(),this._mixinShouldSkipSitValidation()||this.inputValidationController.handleChange(e)}_mixinHandleInputChange(e){this._mixinSetFormValue(),this._mixinShouldSkipSitValidation()||this.inputValidationController.handleInput(e)}_mixinResetValidity(e){this.inputValidationController.resetValidity(),this.inputValidationController.updateInvalidState(),this._isTouched&&(this._isTouched=!1),this._mixinShouldSkipSitValidation()||this.inputValidationController.validateInput(e)}_mixinValidate(e){this._mixinShouldSkipSitValidation()||this.inputValidationController.validateInput(e)}_mixinSetFormValue(){const e=this.value;this._internals.setFormValue(e)}_mixinCheckValidity(){return!!this._mixinShouldSkipSitValidation()||this.inputValidationController.checkValidity()}_mixinReportValidity(){return!!this._mixinShouldSkipSitValidation()||this.inputValidationController.reportValidity()}_mixinGetValidity(){return this._internals.validity}_mixinGetValidationMessage(){return this._internals.validationMessage}_mixinSetValidity(e,t,l){if(!this._mixinShouldSkipSitValidation())return this.inputValidationController.setValidity(e,t,l)}_mixinShouldSkipSitValidation(){const e=this.closest("form");return(null==e?void 0:e.noValidate)||this.noValidate}}return l.formAssociated=!0,t([$e("sit-input")],l.prototype,"sitInput",void 0),t([$e("sit-datepicker-input")],l.prototype,"sitDatepickerInput",void 0),l};var Hl=a`:host{-webkit-text-size-adjust:100%;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-font-smoothing:antialiased;color:var(--sit-body-color-default,#1a1a1a);display:block;font-family:var(--sit-font-family-brand,"Inter",system-ui,sans-serif);font-size:var(--sit-font-size-body-md,1rem);font-weight:var(--sit-font-weight-regular,400);line-height:var(--sit-line-height-xs,24px);margin:0;*,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}:disabled{cursor:not-allowed}@media (prefers-reduced-motion:no-preference){:root{scroll-behavior:smooth}}::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}::slotted(svg){vertical-align:middle}}`;class Pl extends xe{emit(e,t){const l=new CustomEvent(e,Object.assign({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(l),l}static define(e,t=this,l={}){if(customElements.get(e));else try{customElements.define(e,t,l)}catch(i){customElements.define(e,class extends t{},l)}}constructor(){super(),this.ssr=Boolean(this.shadowRoot),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}firstUpdated(e){var t;super.firstUpdated(e),this.ssr&&(null===(t=this.shadowRoot)||void 0===t||t.querySelectorAll("slot").forEach(e=>{e.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}))}}Pl.styles=[Hl],Pl.dependencies={},t([He({type:Boolean,reflect:!0})],Pl.prototype,"ssr",void 0);class Ol extends Pl{constructor(){super(...arguments),this.myDropdown=Fe(),this.dropdownMenuId=yl("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=Fe(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=pl(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const l=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},i=t.map(l),o=e.map(e=>{const o=l(e),n=i.indexOf(o);return-1!==n?t[n]:e}).concat(t.filter(t=>!e.some(e=>l(e)===l(t))));return o}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[fl(8),this.noFlip?void 0:wl(),gl()].filter(Boolean);let l=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(l=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const i=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:l}),{x:o,y:n,strategy:r,placement:a}=await _l(this.myDropdown.value,this.menuRef.value,i);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:r,left:`${o}px`,top:`${n}px`})}}t([He({type:Boolean,state:!0})],Ol.prototype,"noFlip",void 0),t([He({type:Boolean,reflect:!0,state:!0})],Ol.prototype,"menuAlignRight",void 0),t([He({type:String,reflect:!0,state:!0})],Ol.prototype,"drop",void 0),t([He({type:Object})],Ol.prototype,"floatingOpts",void 0),t([He({type:Boolean,reflect:!0})],Ol.prototype,"menuIsOpen",void 0),t([He({type:Boolean,reflect:!0})],Ol.prototype,"disabled",void 0),t([He({type:Boolean,reflect:!0})],Ol.prototype,"readonly",void 0);class zl extends Ol{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),l=t.find(t=>e.composedPath().includes(t));if(!l)return;const i=t.indexOf(l);this.nextDropdownItemNo=i+1,this.prevDropdownItemNo=i<=0?t.length-1:i-1,l.disabled||(this.emit("sit-select",{detail:{item:l}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const l=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");l&&l.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const l=(e%t.length+t.length)%t.length,i=t[l];this.emit("i-sit-option-focus",{detail:{option:i}}),this.nextDropdownItemNo=(l+1)%t.length,this.prevDropdownItemNo=(l-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===i?"0":"-1"),e===i&&t.focus()})}}var $l,Sl;zl.styles=Ol.styles,t([($l="ul.dropdown-menu",(e,t,l)=>{const i=e=>{const l=e.renderRoot?.querySelector($l)??null;if(null===l&&Sl&&!e.hasUpdated){const e="object"==typeof t?t.name:t;ze("",`@query'd field ${JSON.stringify(String(e))} with the 'cache' flag set for selector '${$l}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(Sl){const{get:o,set:n}="object"==typeof t?e:l??(()=>{const e=Symbol(`${String(t)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return Oe(e,t,{get(){let e=o.call(this);return void 0===e&&(e=i(this),(null!==e||this.hasUpdated)&&n.call(this,e)),e}})}return Oe(e,t,{get(){return i(this)}})})],zl.prototype,"menu",void 0),t([Pe()],zl.prototype,"nextDropdownItemNo",void 0),t([Pe()],zl.prototype,"prevDropdownItemNo",void 0),t([He({type:Boolean,reflect:!0})],zl.prototype,"hidden",void 0);var Bl=a`.empty-menu,.loading-menu{padding:var(--sit-padding-sm) var(--sit-padding-lg,20px);pointer-events:none}.loading-menu{align-items:center;display:flex;gap:var(--sit-gap-xs)}`;class jl extends(Vl(zl)){setInvalid(e){this.invalid=e,e?this.emit("sit-invalid"):this.emit("sit-valid")}constructor(){super(),this.label="",this.hintText="",this.autofocus=!1,this.disabled=!1,this.required=!1,this.loading=!1,this.value="",this.displayValue="",this.defaultValue="",this.hasFeedback=!1,this.invalidFeedback="",this.invalid=!1,this.autocomplete="on",this.menuList=[],this.selectedItems=[],this.filteredList=[],this._isTouched=!1,this._controlId=yl("input"),this._labelId=yl("label"),this.floatingOpts={middleware:[ml({apply({rects:e,elements:t}){t.floating.style.width=`${e.reference.width}px`}})]}}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",async e=>{var t;if(this._mixinShouldSkipSitValidation())return;const l=this.constructor.childName,i=(null===(t=e.relatedTarget)||void 0===t?void 0:t.tagName.toLowerCase())===l;this.invalid=!i&&!this._mixinReportValidity()})}reportValidity(){return this._mixinReportValidity()}setValidity(e,t,l){return this._mixinSetValidity(e,t,l)}checkValidity(){return this._mixinCheckValidity()}get validity(){return this._mixinGetValidity()}get validationMessage(){return this._mixinGetValidationMessage()}_renderFeedback(){return this.invalid&&this.hasFeedback?ee` <div class="invalid-feedback-container">
      ...
      <label
        for=${this._controlId}
        id=${this._labelId}
        class=${Le({"form-label":!0,required:this.required})}
        >${this.label}</label
      >
    `;return this.label&&e}_handleClick(){if(this.readonly)return null;this.menuIsOpen?this.hideMenu():this.showMenu()}async _getMenuListFromOptions(e){const t=e.map(async e=>(await e.updateComplete,e)),l=await Promise.all(t);return null==l?void 0:l.map(e=>{var t;return{label:e.innerText,value:e.getAttribute("value"),disabled:null!==(t=e.disabled)&&void 0!==t?t:void 0}})}_renderEmptyMenu(){return ee` <div class="empty-menu">No options</div> `}_renderLoadingMenu(){return ee`<div class="loading-menu"><sit-spinner size="xs" tone="brand"></sit-spinner>Loading...</div>`}}jl.styles=[...zl.styles,bl,Zl,xl,Cl,Bl],t([He({reflect:!0})],jl.prototype,"label",void 0),t([He({reflect:!0})],jl.prototype,"hintText",void 0),t([He({reflect:!0})],jl.prototype,"name",void 0),t([He({type:String,reflect:!0})],jl.prototype,"placeholder",void 0),t([He({type:Boolean,reflect:!0})],jl.prototype,"autofocus",void 0),t([He({type:Boolean,reflect:!0})],jl.prototype,"disabled",void 0),t([He({type:Boolean,reflect:!0})],jl.prototype,"required",void 0),t([He({type:Boolean,reflect:!0})],jl.prototype,"loading",void 0),t([He({type:String,reflect:!0})],jl.prototype,"value",void 0),t([Pe()],jl.prototype,"displayValue",void 0),t([((e="value")=>(t,l)=>{const i=t.constructor,o=i.prototype.attributeChangedCallback;i.prototype.attributeChangedCallback=function(t,n,r){var a;const s=i.getPropertyOptions(e);if(t===("string"==typeof s.attribute?s.attribute:e).toLowerCase()){const t=s.converter||Z,i=("function"==typeof t?t:null!==(a=null==t?void 0:t.fromAttribute)&&void 0!==a?a:Z.fromAttribute)(r,s.type);this[e]!==i&&(this[l]=i)}o.call(this,t,n,r)}})()],jl.prototype,"defaultValue",void 0),t([He({type:Boolean,reflect:!0})],jl.prototype,"hasFeedback",void 0),t([He({type:String,reflect:!0})],jl.prototype,"invalidFeedback",void 0),t([He({type:Boolean,reflect:!0})],jl.prototype,"invalid",void 0),t([He({type:String,reflect:!0})],jl.prototype,"autocomplete",void 0),t([He({type:Array})],jl.prototype,"menuList",void 0),t([Pe()],jl.prototype,"selectedItems",void 0),t([Pe()],jl.prototype,"filteredList",void 0),t([$e("input.form-control")],jl.prototype,"_input",void 0);const Al={announcement:()=>Promise.resolve().then(function(){return ei}),archive:()=>Promise.resolve().then(function(){return li}),"arrow-bar-down":()=>Promise.resolve().then(function(){return oi}),"arrow-bar-left":()=>Promise.resolve().then(function(){return ri}),"arrow-bar-right":()=>Promise.resolve().then(function(){return si}),"arrow-bar-up":()=>Promise.resolve().then(function(){return di}),"arrow-circle-down":()=>Promise.resolve().then(function(){return ui}),"arrow-circle-left":()=>Promise.resolve().then(function(){return pi}),"arrow-circle-right":()=>Promise.resolve().then(function(){return gi}),"arrow-circle-up":()=>Promise.resolve().then(function(){return mi}),"arrow-clockwise":()=>Promise.resolve().then(function(){return bi}),"arrow-down":()=>Promise.resolve().then(function(){return Zi}),"arrow-left":()=>Promise.resolve().then(function(){return yi}),"arrow-repeat":()=>Promise.resolve().then(function(){return Vi}),"arrow-right":()=>Promise.resolve().then(function(){return Pi}),"arrow-square-down":()=>Promise.resolve().then(function(){return zi}),"arrow-square-left":()=>Promise.resolve().then(function(){return Si}),"arrow-square-right":()=>Promise.resolve().then(function(){return ji}),"arrow-square-up":()=>Promise.resolve().then(function(){return Li}),"arrow-up":()=>Promise.resolve().then(function(){return Ei}),"bank-fill":()=>Promise.resolve().then(function(){return Ti}),"bell-slash":()=>Promise.resolve().then(function(){return Di}),bell:()=>Promise.resolve().then(function(){return Ui}),"bi-funnel":()=>Promise.resolve().then(function(){return Wi}),"bookmark-fill":()=>Promise.resolve().then(function(){return Ki}),bookmark:()=>Promise.resolve().then(function(){return Gi}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return Xi}),"box-seam":()=>Promise.resolve().then(function(){return eo}),building:()=>Promise.resolve().then(function(){return lo}),bus:()=>Promise.resolve().then(function(){return oo}),calculator:()=>Promise.resolve().then(function(){return ro}),"calendar-check":()=>Promise.resolve().then(function(){return so}),"calendar-heart":()=>Promise.resolve().then(function(){return ho}),"calendar-x":()=>Promise.resolve().then(function(){return vo}),calendar:()=>Promise.resolve().then(function(){return fo}),camera:()=>Promise.resolve().then(function(){return wo}),car:()=>Promise.resolve().then(function(){return _o}),"chat-dots":()=>Promise.resolve().then(function(){return xo}),"chat-left-text":()=>Promise.resolve().then(function(){return Co}),chat:()=>Promise.resolve().then(function(){return Mo}),"check-circle-fill":()=>Promise.resolve().then(function(){return Ho}),"check-circle":()=>Promise.resolve().then(function(){return Oo}),check:()=>Promise.resolve().then(function(){return $o}),"chevron-down":()=>Promise.resolve().then(function(){return Bo}),"chevron-left":()=>Promise.resolve().then(function(){return Ao}),"chevron-right":()=>Promise.resolve().then(function(){return ko}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return Io}),"chevron-up":()=>Promise.resolve().then(function(){return Ro}),clock:()=>Promise.resolve().then(function(){return No}),"cloud-check":()=>Promise.resolve().then(function(){return Fo}),"cloud-download":()=>Promise.resolve().then(function(){return qo}),"cloud-upload":()=>Promise.resolve().then(function(){return Jo}),cloud:()=>Promise.resolve().then(function(){return Yo}),"code-square":()=>Promise.resolve().then(function(){return Qo}),"coins-hand":()=>Promise.resolve().then(function(){return tn}),compass:()=>Promise.resolve().then(function(){return on}),copy:()=>Promise.resolve().then(function(){return rn}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return sn}),cross:()=>Promise.resolve().then(function(){return dn}),"cursor-fill":()=>Promise.resolve().then(function(){return un}),cursor:()=>Promise.resolve().then(function(){return pn}),"dash-circle":()=>Promise.resolve().then(function(){return gn}),"dash-square":()=>Promise.resolve().then(function(){return mn}),dash:()=>Promise.resolve().then(function(){return bn}),database:()=>Promise.resolve().then(function(){return Zn}),dataflow:()=>Promise.resolve().then(function(){return yn}),download:()=>Promise.resolve().then(function(){return Vn}),edit:()=>Promise.resolve().then(function(){return Pn}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return zn}),"exclamation-circle":()=>Promise.resolve().then(function(){return Sn}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return jn}),"exclamation-triangle":()=>Promise.resolve().then(function(){return Ln}),exclamation:()=>Promise.resolve().then(function(){return En}),"eye-fill":()=>Promise.resolve().then(function(){return Tn}),"eye-slash-fill":()=>Promise.resolve().then(function(){return Dn}),"eye-slash":()=>Promise.resolve().then(function(){return Un}),eye:()=>Promise.resolve().then(function(){return Wn}),"face-smile-fill":()=>Promise.resolve().then(function(){return Kn}),"face-smile":()=>Promise.resolve().then(function(){return Gn}),facebook:()=>Promise.resolve().then(function(){return Xn}),"file-earmark-text":()=>Promise.resolve().then(function(){return er}),"file-pdf":()=>Promise.resolve().then(function(){return lr}),"file-plus":()=>Promise.resolve().then(function(){return or}),"file-text":()=>Promise.resolve().then(function(){return rr}),file:()=>Promise.resolve().then(function(){return sr}),files:()=>Promise.resolve().then(function(){return dr}),fingerprint:()=>Promise.resolve().then(function(){return ur}),flash:()=>Promise.resolve().then(function(){return pr}),"folder-check":()=>Promise.resolve().then(function(){return gr}),"folder-minus":()=>Promise.resolve().then(function(){return mr}),"folder-plus":()=>Promise.resolve().then(function(){return br}),folder:()=>Promise.resolve().then(function(){return Zr}),gear:()=>Promise.resolve().then(function(){return yr}),"geo-alt":()=>Promise.resolve().then(function(){return Vr}),"geo-fill":()=>Promise.resolve().then(function(){return Pr}),geo:()=>Promise.resolve().then(function(){return zr}),"globe-alt":()=>Promise.resolve().then(function(){return Sr}),globe:()=>Promise.resolve().then(function(){return jr}),google:()=>Promise.resolve().then(function(){return Lr}),"grid-alt":()=>Promise.resolve().then(function(){return Er}),"grid-fill":()=>Promise.resolve().then(function(){return Tr}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return Dr}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return Ur}),"hard-drive":()=>Promise.resolve().then(function(){return Wr}),heart:()=>Promise.resolve().then(function(){return Kr}),"house-door":()=>Promise.resolve().then(function(){return Gr}),house:()=>Promise.resolve().then(function(){return Xr}),image:()=>Promise.resolve().then(function(){return ea}),"in-box":()=>Promise.resolve().then(function(){return la}),"info-circle-fill":()=>Promise.resolve().then(function(){return oa}),"info-circle":()=>Promise.resolve().then(function(){return ra}),instagram:()=>Promise.resolve().then(function(){return sa}),key:()=>Promise.resolve().then(function(){return da}),"laptop-gear":()=>Promise.resolve().then(function(){return ua}),laptop:()=>Promise.resolve().then(function(){return pa}),layers:()=>Promise.resolve().then(function(){return ga}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return ma}),"layout-text-window":()=>Promise.resolve().then(function(){return ba}),layout:()=>Promise.resolve().then(function(){return Za}),"life-buoy":()=>Promise.resolve().then(function(){return ya}),lightbulb:()=>Promise.resolve().then(function(){return Va}),link:()=>Promise.resolve().then(function(){return Pa}),linkedin:()=>Promise.resolve().then(function(){return za}),list:()=>Promise.resolve().then(function(){return Sa}),"lock-fill":()=>Promise.resolve().then(function(){return ja}),lock:()=>Promise.resolve().then(function(){return La}),login:()=>Promise.resolve().then(function(){return Ea}),logout:()=>Promise.resolve().then(function(){return Ta}),luggage:()=>Promise.resolve().then(function(){return Da}),"mail-open":()=>Promise.resolve().then(function(){return Ua}),mail:()=>Promise.resolve().then(function(){return Wa}),map:()=>Promise.resolve().then(function(){return Ka}),meetup:()=>Promise.resolve().then(function(){return Ga}),menu:()=>Promise.resolve().then(function(){return Xa}),microphone:()=>Promise.resolve().then(function(){return es}),monitor:()=>Promise.resolve().then(function(){return ls}),moon:()=>Promise.resolve().then(function(){return os}),move:()=>Promise.resolve().then(function(){return rs}),paperclip:()=>Promise.resolve().then(function(){return ss}),passcode:()=>Promise.resolve().then(function(){return ds}),passport:()=>Promise.resolve().then(function(){return us}),pause:()=>Promise.resolve().then(function(){return ps}),pencil:()=>Promise.resolve().then(function(){return gs}),"pending-circle":()=>Promise.resolve().then(function(){return ms}),"person-dash":()=>Promise.resolve().then(function(){return bs}),"person-plus":()=>Promise.resolve().then(function(){return Zs}),"person-x":()=>Promise.resolve().then(function(){return ys}),person:()=>Promise.resolve().then(function(){return Vs}),phone:()=>Promise.resolve().then(function(){return Ps}),"pin-map-fill":()=>Promise.resolve().then(function(){return zs}),pin:()=>Promise.resolve().then(function(){return Ss}),placeholder:()=>Promise.resolve().then(function(){return js}),plane:()=>Promise.resolve().then(function(){return Ls}),play:()=>Promise.resolve().then(function(){return Es}),"plus-circle":()=>Promise.resolve().then(function(){return Ts}),"plus-square":()=>Promise.resolve().then(function(){return Ds}),plus:()=>Promise.resolve().then(function(){return Us}),printer:()=>Promise.resolve().then(function(){return Ws}),"question-circle":()=>Promise.resolve().then(function(){return Ks}),rocket:()=>Promise.resolve().then(function(){return Gs}),save:()=>Promise.resolve().then(function(){return Xs}),search:()=>Promise.resolve().then(function(){return ec}),send:()=>Promise.resolve().then(function(){return lc}),"sg-crest":()=>Promise.resolve().then(function(){return oc}),share:()=>Promise.resolve().then(function(){return rc}),"shield-tick":()=>Promise.resolve().then(function(){return sc}),"sidebar-collapse":()=>Promise.resolve().then(function(){return dc}),"sidebar-expand":()=>Promise.resolve().then(function(){return uc}),"slash-circle":()=>Promise.resolve().then(function(){return pc}),"slash-divider":()=>Promise.resolve().then(function(){return gc}),sliders:()=>Promise.resolve().then(function(){return mc}),"sort-ascending":()=>Promise.resolve().then(function(){return bc}),"sort-descending":()=>Promise.resolve().then(function(){return Zc}),speedometer:()=>Promise.resolve().then(function(){return yc}),"star-ai":()=>Promise.resolve().then(function(){return Vc}),"star-fill":()=>Promise.resolve().then(function(){return Pc}),star:()=>Promise.resolve().then(function(){return zc}),stoplights:()=>Promise.resolve().then(function(){return Sc}),sun:()=>Promise.resolve().then(function(){return jc}),"switch-horizontal":()=>Promise.resolve().then(function(){return Lc}),"switch-vertical":()=>Promise.resolve().then(function(){return Ec}),tablet:()=>Promise.resolve().then(function(){return Tc}),telegram:()=>Promise.resolve().then(function(){return Dc}),telephone:()=>Promise.resolve().then(function(){return Uc}),"three-dots-vertical":()=>Promise.resolve().then(function(){return Wc}),"three-dots":()=>Promise.resolve().then(function(){return Kc}),ticket:()=>Promise.resolve().then(function(){return Gc}),"toggle-off":()=>Promise.resolve().then(function(){return Xc}),"toggle-on":()=>Promise.resolve().then(function(){return ed}),train:()=>Promise.resolve().then(function(){return ld}),translate:()=>Promise.resolve().then(function(){return od}),trash:()=>Promise.resolve().then(function(){return rd}),"trend-down":()=>Promise.resolve().then(function(){return sd}),"trend-up":()=>Promise.resolve().then(function(){return dd}),truck:()=>Promise.resolve().then(function(){return ud}),"twitter-x":()=>Promise.resolve().then(function(){return pd}),unlock:()=>Promise.resolve().then(function(){return gd}),upload:()=>Promise.resolve().then(function(){return md}),"user-check":()=>Promise.resolve().then(function(){return bd}),"user-circle":()=>Promise.resolve().then(function(){return Zd}),"user-pause":()=>Promise.resolve().then(function(){return yd}),"user-square":()=>Promise.resolve().then(function(){return Vd}),users:()=>Promise.resolve().then(function(){return Pd}),"video-recorder":()=>Promise.resolve().then(function(){return zd}),"volume-max":()=>Promise.resolve().then(function(){return Sd}),"volume-x":()=>Promise.resolve().then(function(){return jd}),"window-dash":()=>Promise.resolve().then(function(){return Ld}),"window-desktop":()=>Promise.resolve().then(function(){return Ed}),"window-dock":()=>Promise.resolve().then(function(){return Td}),"window-fullscreen":()=>Promise.resolve().then(function(){return Dd}),"window-plus":()=>Promise.resolve().then(function(){return Ud}),"window-sidebar":()=>Promise.resolve().then(function(){return Wd}),"window-split":()=>Promise.resolve().then(function(){return Kd}),"window-stack":()=>Promise.resolve().then(function(){return Gd}),"window-x":()=>Promise.resolve().then(function(){return Xd}),window:()=>Promise.resolve().then(function(){return eh}),"xcircle-fill":()=>Promise.resolve().then(function(){return lh}),xcircle:()=>Promise.resolve().then(function(){return oh}),youtube:()=>Promise.resolve().then(function(){return rh}),"zoom-in":()=>Promise.resolve().then(function(){return sh}),"zoom-out":()=>Promise.resolve().then(function(){return dh})};var Ll=a`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const kl=new Map;class El extends Pl{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(kl.has(e))return void(this._icon=kl.get(e));const t=Al[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();kl.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:ie}}El.styles=[...Pl.styles,Ll],t([He({type:String,reflect:!0})],El.prototype,"name",void 0),t([He({type:String,reflect:!0})],El.prototype,"size",void 0),t([He({type:String})],El.prototype,"ariaLabel",void 0),t([Pe()],El.prototype,"_icon",void 0);var Il=a`:host{display:block;position:relative}input.form-control{caret-color:transparent;cursor:default}.dropdown{display:flex;height:100%}.dropdown-menu{box-sizing:border-box;max-height:10rem;overflow-x:hidden;overflow-y:auto}slot[id=default].is-loading,slot[id=default].is-loading::slotted(*){display:none}`,Tl=a`:host([active]) .dropdown-item{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item{background-color:var(--sit-bg-transparent);clear:both;color:var(--sit-form-color-default);cursor:pointer;font-size:var(--sit-font-size-label-md);height:100%;overflow-wrap:anywhere;padding:var(--sit-padding-sm) var(--sit-padding-md);text-align:inherit;white-space:normal}.dropdown-item.disabled{opacity:var(--sit-opacity-40);pointer-events:none}.dropdown-item .normal-item-content{align-items:center;display:flex;justify-content:space-between}:host([active]) .dropdown-item .normal-item-content{color:var(--sit-form-primary-color-default)}.dropdown-item:hover{background:var(--sit-bg-translucent-subtle)}.dropdown-item:focus-visible{background:var(--sit-bg-translucent-subtle);outline:var(--sit-form-outline-focus);outline-offset:var(--sit-form-outline-offset-focus)}`;class Rl extends Pl{constructor(){super(...arguments),this.active=!1,this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-disabled",`${this.disabled}`),this.setAttribute("aria-selected",`${this.active}`)}updated(e){super.updated(e),e.has("active")&&this.setAttribute("aria-selected",`${this.active}`),e.has("disabled")&&this.setAttribute("aria-disabled",`${this.disabled}`)}render(){const e={disabled:this.disabled,active:this.active};return ee`
      <div class="dropdown-item ${Le(e)}" tabindex=${this.disabled?"-1":"0"}>
        ${this._renderItemContent()}
      </div>
    `}}Rl.styles=[Tl],t([He({type:Boolean,reflect:!0})],Rl.prototype,"active",void 0),t([He({type:Boolean,reflect:!0})],Rl.prototype,"disabled",void 0),t([He({type:String,reflect:!0})],Rl.prototype,"value",void 0);class Dl extends Rl{constructor(){super(...arguments),this._renderItemContent=()=>ee`<div class="normal-item-content" role="presentation">
      <slot></slot>
      ${this.active?ee` <sit-icon name="check"></sit-icon> `:ie}
    </div>`}}Dl.dependencies={"sit-icon":El};
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const Nl=Symbol.for(""),Ul=e=>{if(e?.r===Nl)return e?._$litStatic$},Fl=new Map,Wl=(ql=ee,(e,...t)=>{const l=t.length;let i,o;const n=[],r=[];let a,s=0,c=!1;for(;s<l;){for(a=e[s];s<l&&void 0!==(o=t[s],i=Ul(o));)a+=i+e[++s],c=!0;s!==l&&r.push(o),n.push(a),s++}if(s===l&&n.push(e[l]),c){const l=n.join("$$lit$$");void 0===(e=Fl.get(l))&&(n.raw=n,Fl.set(l,e=n)),t=r}return ql(e,...t)});var ql,Kl,Jl=a`:host{--sit-spinner-bg:var(--sit-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sit-spinner-bg:var(--sit-neutral-surface-default)}:host([tone=neutral]){--sit-spinner-bg:var(--sit-surface-inverse)}:host([tone=inverse]){--sit-spinner-bg:var(--sit-surface-default)}:host([tone=fixed-light]){--sit-spinner-bg:var(--sit-surface-fixed-light)}:host([tone=fixed-dark]){--sit-spinner-bg:var(--sit-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sit-gap-2-xs)}.spinner-wrapper.spinner-wrapper--horizontal{flex-direction:row}.spinner-wrapper__spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sit-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sit-spinner-bg);color:var(--sit-spinner-color);display:inline-flex;height:var(--sit-dimension-32);width:var(--sit-dimension-32)}.spinner-wrapper__spinner--xs{--border-thickness:2px;height:var(--sit-dimension-16);width:var(--sit-dimension-16)}.spinner-wrapper__spinner--sm{--border-thickness:3px;height:var(--sit-dimension-24);width:var(--sit-dimension-24)}.spinner-wrapper__spinner--lg{--border-thickness:6px;height:var(--sit-dimension-48);width:var(--sit-dimension-48)}.spinner-wrapper__spinner--xl{--border-thickness:8px;height:var(--sit-dimension-64);width:var(--sit-dimension-64)}.spinner-wrapper__label{color:var(--sit-neutral-color-default);font-size:var(--sit-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner-wrapper__spinner{animation-duration:1.5s}}

/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,Gl=a`.text-primary{color:var(--sit-primary-rgb)!important}.text-secondary{color:var(--sit-secondary-rgb)!important}.text-success{color:var(--sit-success-rgb)!important}.text-info{color:var(--sit-info-rgb)!important}.text-warning{color:var(--sit-warning-rgb)!important}.text-danger{color:var(--sit-danger-rgb)!important}.text-light{color:var(--sit-light-rgb)!important}.text-dark{color:var(--sit-dark-rgb)!important}.text-muted{color:var(--sit-secondary-color)!important}`;class Yl extends Pl{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Wl`
      <div
        class="spinner-wrapper ${Le({"spinner-wrapper--horizontal":"horizontal"===this.orientation})}"
      >
        <div
          class="spinner-wrapper__spinner ${Le({[`spinner-wrapper__spinner--${this.size}`]:this.size})}"
          role="status"
        >
          ${this.label?ie:Wl`<span class="sr-only">Loading...</span>`}
        </div>
        ${this.label?Wl`<span class="spinner-wrapper__label">${this.label}</span>`:ie}
      </div>
    `}}Yl.styles=[...Pl.styles,Gl,Jl],t([He({type:String,reflect:!0})],Yl.prototype,"variant",void 0),t([He({type:String,reflect:!0})],Yl.prototype,"tone",void 0),t([He({type:String,reflect:!0})],Yl.prototype,"size",void 0),t([He({reflect:!0,type:String})],Yl.prototype,"label",void 0),t([He({type:String,reflect:!0})],Yl.prototype,"orientation",void 0);class Xl extends jl{constructor(){super(...arguments),this.noValidate=!1,this._blockInputKeydown=e=>{"Tab"!==e.key&&e.preventDefault()}}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",async()=>{(await this._input).focus()})}async firstUpdated(e){super.firstUpdated(e),this._updateDisplayValue(),this.input=await this._input,this._mixinValidate(this.input),this.menuIsOpen&&await this.updateFloatingPosition()}async _handleSlotChange(e){const t=e.target.assignedElements({flatten:!0});t.forEach(e=>e.addEventListener("click",e=>{e.target.disabled||this._handleItemSelected(e)})),t.forEach(e=>e.addEventListener("keydown",e=>{"Enter"===e.key&&this._handleItemSelected(e)})),this.menuList=await this._getMenuListFromOptions(t),this._updateDisplayValue(),this.input=await this._input,this._mixinValidate(this.input)}_updateDisplayValue(){if(this.value&&this.menuList.length>0){const e=this.menuList.filter(({value:e})=>e===this.value);this.displayValue=e[0].label,this._setActiveToOption()}}_setActiveToOption(){const e=this.menuList.findIndex(e=>e.value.toString()===this.value);this.options.forEach((t,l)=>{t.active=l===e})}async _handleValueChange(){this._setActiveToOption(),this.emit("sit-change"),this.value&&this.emit("sit-select");const e=await this._input;this._mixinSetFormValue(),this._mixinValidate(e),this._updateDisplayValue(),(this._isTouched||""!==this.value)&&(this._mixinShouldSkipSitValidation()||(this.invalid=!this._mixinReportValidity()))}async _handleItemSelected(e){var t,l,i;const o=e.target,n=null!==(l=null===(t=o.textContent)||void 0===t?void 0:t.trim())&&void 0!==l?l:"",r={label:n,value:null!==(i=o.getAttribute("value"))&&void 0!==i?i:n};this.value=r.value.toString(),this.displayValue=r.label,this.hideMenu()}_handleFocus(){this.emit("sit-focus")}async _handleInputBlur(e){e.preventDefault(),this.emit("sit-blur")}async _mixinResetFormControl(){this.value=this.defaultValue;const e=this.menuList.filter(({value:e})=>e===this.value);e.length<=0?this.displayValue="":this.displayValue=e[0].label,this._mixinResetValidity(await this._input)}_renderMenu(){const e=this.menuList.map(e=>{const t=e.value===this.value;return ee`
        <sit-select-option
          ?active=${t}
          value=${e.value}
          ?disabled=${e.disabled}
    ...
    `}render(){return ee`
      <div
        class=${Le({disabled:this.disabled,select:!0,"form-control-container":!0,"m-width-160":!0})}
      >
        ${this._renderLabel()}
        <!-- The input -->
        ...
        <div
          ...
          ${Ke(this.menuRef)}
        >
          <slot id="default" class=${Le({"is-loading":this.loading})} @slotchange=${this._handleSlotChange}
            >${this._renderMenu()}</slot
          >
          ${this.loading?this._renderLoadingMenu():ie}
        </div>
      </div>
    `}}Xl.styles=[...jl.styles,Cl,Il],Xl.childName="sit-select-option",Xl.dependencies={"sit-icon":El,"sit-spinner":Yl,[Xl.childName]:Dl},t([He({type:Boolean,reflect:!0})],Xl.prototype,"noValidate",void 0),t([(Kl={flatten:!0,selector:"sit-select-option"},(e,t)=>{const{slot:l,selector:i}=Kl??{},o="slot"+(l?`[name=${l}]`:":not([name])");return Oe(e,t,{get(){const e=this.renderRoot?.querySelector(o),t=e?.assignedElements(Kl)??[];return void 0===i?t:t.filter(e=>e.matches(i))}})})],Xl.prototype,"options",void 0),t([function(e,t){const l=Object.assign({waitUntilFirstUpdate:!1},t);return(t,i)=>{const{update:o}=t;if(e in t){const n=e;t.update=function(e){if(e.has(n)){const t=e.get(n),o=this[n];t!==o&&(l.waitUntilFirstUpdate&&!this.hasUpdated||this[i](t,o))}o.call(this,e)}}}}("value",{waitUntilFirstUpdate:!0})],Xl.prototype,"_handleValueChange",null),e("sit-select",Xl),e("sit-select-option",Dl);var Ql=ee`
...
`,ei=Object.freeze({__proto__:null,default:Ql}),ti=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,li=Object.freeze({__proto__:null,default:ti}),ii=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oi=Object.freeze({__proto__:null,default:ii}),ni=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ri=Object.freeze({__proto__:null,default:ni}),ai=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,si=Object.freeze({__proto__:null,default:ai}),ci=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,di=Object.freeze({__proto__:null,default:ci}),hi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ui=Object.freeze({__proto__:null,default:hi}),vi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pi=Object.freeze({__proto__:null,default:vi}),fi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gi=Object.freeze({__proto__:null,default:fi}),wi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,mi=Object.freeze({__proto__:null,default:wi}),_i=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bi=Object.freeze({__proto__:null,default:_i}),xi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zi=Object.freeze({__proto__:null,default:xi}),Ci=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yi=Object.freeze({__proto__:null,default:Ci}),Mi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vi=Object.freeze({__proto__:null,default:Mi}),Hi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pi=Object.freeze({__proto__:null,default:Hi}),Oi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zi=Object.freeze({__proto__:null,default:Oi}),$i=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Si=Object.freeze({__proto__:null,default:$i}),Bi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Li=Object.freeze({__proto__:null,default:Ai}),ki=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ei=Object.freeze({__proto__:null,default:ki}),Ii=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ti=Object.freeze({__proto__:null,default:Ii}),Ri=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Di=Object.freeze({__proto__:null,default:Ri}),Ni=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ui=Object.freeze({__proto__:null,default:Ni}),Fi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wi=Object.freeze({__proto__:null,default:Fi}),qi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ki=Object.freeze({__proto__:null,default:qi}),Ji=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gi=Object.freeze({__proto__:null,default:Ji}),Yi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xi=Object.freeze({__proto__:null,default:Yi}),Qi=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,eo=Object.freeze({__proto__:null,default:Qi}),to=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lo=Object.freeze({__proto__:null,default:to}),io=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oo=Object.freeze({__proto__:null,default:io}),no=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ro=Object.freeze({__proto__:null,default:no}),ao=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,so=Object.freeze({__proto__:null,default:ao}),co=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ho=Object.freeze({__proto__:null,default:co}),uo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,vo=Object.freeze({__proto__:null,default:uo}),po=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fo=Object.freeze({__proto__:null,default:po}),go=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wo=Object.freeze({__proto__:null,default:go}),mo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,_o=Object.freeze({__proto__:null,default:mo}),bo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xo=Object.freeze({__proto__:null,default:bo}),Zo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Co=Object.freeze({__proto__:null,default:Zo}),yo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mo=Object.freeze({__proto__:null,default:yo}),Vo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ho=Object.freeze({__proto__:null,default:Vo}),Po=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oo=Object.freeze({__proto__:null,default:Po}),zo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$o=Object.freeze({__proto__:null,default:zo}),So=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bo=Object.freeze({__proto__:null,default:So}),jo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ao=Object.freeze({__proto__:null,default:jo}),Lo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ko=Object.freeze({__proto__:null,default:Lo}),Eo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Io=Object.freeze({__proto__:null,default:Eo}),To=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ro=Object.freeze({__proto__:null,default:To}),Do=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,No=Object.freeze({__proto__:null,default:Do}),Uo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fo=Object.freeze({__proto__:null,default:Uo}),Wo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qo=Object.freeze({__proto__:null,default:Wo}),Ko=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jo=Object.freeze({__proto__:null,default:Ko}),Go=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yo=Object.freeze({__proto__:null,default:Go}),Xo=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qo=Object.freeze({__proto__:null,default:Xo}),en=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,tn=Object.freeze({__proto__:null,default:en}),ln=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,on=Object.freeze({__proto__:null,default:ln}),nn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rn=Object.freeze({__proto__:null,default:nn}),an=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sn=Object.freeze({__proto__:null,default:an}),cn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dn=Object.freeze({__proto__:null,default:cn}),hn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,un=Object.freeze({__proto__:null,default:hn}),vn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pn=Object.freeze({__proto__:null,default:vn}),fn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gn=Object.freeze({__proto__:null,default:fn}),wn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mn=Object.freeze({__proto__:null,default:wn}),_n=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bn=Object.freeze({__proto__:null,default:_n}),xn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zn=Object.freeze({__proto__:null,default:xn}),Cn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yn=Object.freeze({__proto__:null,default:Cn}),Mn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vn=Object.freeze({__proto__:null,default:Mn}),Hn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pn=Object.freeze({__proto__:null,default:Hn}),On=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zn=Object.freeze({__proto__:null,default:On}),$n=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sn=Object.freeze({__proto__:null,default:$n}),Bn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ln=Object.freeze({__proto__:null,default:An}),kn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,En=Object.freeze({__proto__:null,default:kn}),In=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tn=Object.freeze({__proto__:null,default:In}),Rn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Dn=Object.freeze({__proto__:null,default:Rn}),Nn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Un=Object.freeze({__proto__:null,default:Nn}),Fn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wn=Object.freeze({__proto__:null,default:Fn}),qn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kn=Object.freeze({__proto__:null,default:qn}),Jn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gn=Object.freeze({__proto__:null,default:Jn}),Yn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xn=Object.freeze({__proto__:null,default:Yn}),Qn=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,er=Object.freeze({__proto__:null,default:Qn}),tr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lr=Object.freeze({__proto__:null,default:tr}),ir=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,or=Object.freeze({__proto__:null,default:ir}),nr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rr=Object.freeze({__proto__:null,default:nr}),ar=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sr=Object.freeze({__proto__:null,default:ar}),cr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,dr=Object.freeze({__proto__:null,default:cr}),hr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ur=Object.freeze({__proto__:null,default:hr}),vr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pr=Object.freeze({__proto__:null,default:vr}),fr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gr=Object.freeze({__proto__:null,default:fr}),wr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,mr=Object.freeze({__proto__:null,default:wr}),_r=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,br=Object.freeze({__proto__:null,default:_r}),xr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zr=Object.freeze({__proto__:null,default:xr}),Cr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yr=Object.freeze({__proto__:null,default:Cr}),Mr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vr=Object.freeze({__proto__:null,default:Mr}),Hr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pr=Object.freeze({__proto__:null,default:Hr}),Or=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zr=Object.freeze({__proto__:null,default:Or}),$r=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Sr=Object.freeze({__proto__:null,default:$r}),Br=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lr=Object.freeze({__proto__:null,default:Ar}),kr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Er=Object.freeze({__proto__:null,default:kr}),Ir=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Tr=Object.freeze({__proto__:null,default:Ir}),Rr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Dr=Object.freeze({__proto__:null,default:Rr}),Nr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ur=Object.freeze({__proto__:null,default:Nr}),Fr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wr=Object.freeze({__proto__:null,default:Fr}),qr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kr=Object.freeze({__proto__:null,default:qr}),Jr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gr=Object.freeze({__proto__:null,default:Jr}),Yr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xr=Object.freeze({__proto__:null,default:Yr}),Qr=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ea=Object.freeze({__proto__:null,default:Qr}),ta=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,la=Object.freeze({__proto__:null,default:ta}),ia=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oa=Object.freeze({__proto__:null,default:ia}),na=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ra=Object.freeze({__proto__:null,default:na}),aa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sa=Object.freeze({__proto__:null,default:aa}),ca=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,da=Object.freeze({__proto__:null,default:ca}),ha=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ua=Object.freeze({__proto__:null,default:ha}),va=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pa=Object.freeze({__proto__:null,default:va}),fa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ga=Object.freeze({__proto__:null,default:fa}),wa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ma=Object.freeze({__proto__:null,default:wa}),_a=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ba=Object.freeze({__proto__:null,default:_a}),xa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Za=Object.freeze({__proto__:null,default:xa}),Ca=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ya=Object.freeze({__proto__:null,default:Ca}),Ma=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Va=Object.freeze({__proto__:null,default:Ma}),Ha=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pa=Object.freeze({__proto__:null,default:Ha}),Oa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,za=Object.freeze({__proto__:null,default:Oa}),$a=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sa=Object.freeze({__proto__:null,default:$a}),Ba=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,La=Object.freeze({__proto__:null,default:Aa}),ka=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ea=Object.freeze({__proto__:null,default:ka}),Ia=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ta=Object.freeze({__proto__:null,default:Ia}),Ra=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Da=Object.freeze({__proto__:null,default:Ra}),Na=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ua=Object.freeze({__proto__:null,default:Na}),Fa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wa=Object.freeze({__proto__:null,default:Fa}),qa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ka=Object.freeze({__proto__:null,default:qa}),Ja=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ga=Object.freeze({__proto__:null,default:Ja}),Ya=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xa=Object.freeze({__proto__:null,default:Ya}),Qa=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,es=Object.freeze({__proto__:null,default:Qa}),ts=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ls=Object.freeze({__proto__:null,default:ts}),is=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,os=Object.freeze({__proto__:null,default:is}),ns=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rs=Object.freeze({__proto__:null,default:ns}),as=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ss=Object.freeze({__proto__:null,default:as}),cs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ds=Object.freeze({__proto__:null,default:cs}),hs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,us=Object.freeze({__proto__:null,default:hs}),vs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ps=Object.freeze({__proto__:null,default:vs}),fs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gs=Object.freeze({__proto__:null,default:fs}),ws=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ms=Object.freeze({__proto__:null,default:ws}),_s=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bs=Object.freeze({__proto__:null,default:_s}),xs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zs=Object.freeze({__proto__:null,default:xs}),Cs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ys=Object.freeze({__proto__:null,default:Cs}),Ms=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vs=Object.freeze({__proto__:null,default:Ms}),Hs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ps=Object.freeze({__proto__:null,default:Hs}),Os=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zs=Object.freeze({__proto__:null,default:Os}),$s=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ss=Object.freeze({__proto__:null,default:$s}),Bs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ls=Object.freeze({__proto__:null,default:As}),ks=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Es=Object.freeze({__proto__:null,default:ks}),Is=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ts=Object.freeze({__proto__:null,default:Is}),Rs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ds=Object.freeze({__proto__:null,default:Rs}),Ns=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Us=Object.freeze({__proto__:null,default:Ns}),Fs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ws=Object.freeze({__proto__:null,default:Fs}),qs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ks=Object.freeze({__proto__:null,default:qs}),Js=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gs=Object.freeze({__proto__:null,default:Js}),Ys=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xs=Object.freeze({__proto__:null,default:Ys}),Qs=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ec=Object.freeze({__proto__:null,default:Qs}),tc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lc=Object.freeze({__proto__:null,default:tc}),ic=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="#DB0000"
...
`,oc=Object.freeze({__proto__:null,default:ic}),nc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rc=Object.freeze({__proto__:null,default:nc}),ac=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sc=Object.freeze({__proto__:null,default:ac}),cc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dc=Object.freeze({__proto__:null,default:cc}),hc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,uc=Object.freeze({__proto__:null,default:hc}),vc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mc=Object.freeze({__proto__:null,default:wc}),_c=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bc=Object.freeze({__proto__:null,default:_c}),xc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zc=Object.freeze({__proto__:null,default:xc}),Cc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yc=Object.freeze({__proto__:null,default:Cc}),Mc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vc=Object.freeze({__proto__:null,default:Mc}),Hc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pc=Object.freeze({__proto__:null,default:Hc}),Oc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zc=Object.freeze({__proto__:null,default:Oc}),$c=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sc=Object.freeze({__proto__:null,default:$c}),Bc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Lc=Object.freeze({__proto__:null,default:Ac}),kc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ec=Object.freeze({__proto__:null,default:kc}),Ic=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Tc=Object.freeze({__proto__:null,default:Ic}),Rc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Dc=Object.freeze({__proto__:null,default:Rc}),Nc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Uc=Object.freeze({__proto__:null,default:Nc}),Fc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wc=Object.freeze({__proto__:null,default:Fc}),qc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kc=Object.freeze({__proto__:null,default:qc}),Jc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gc=Object.freeze({__proto__:null,default:Jc}),Yc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xc=Object.freeze({__proto__:null,default:Yc}),Qc=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ed=Object.freeze({__proto__:null,default:Qc}),td=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ld=Object.freeze({__proto__:null,default:td}),id=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,od=Object.freeze({__proto__:null,default:id}),nd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rd=Object.freeze({__proto__:null,default:nd}),ad=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sd=Object.freeze({__proto__:null,default:ad}),cd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,dd=Object.freeze({__proto__:null,default:cd}),hd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ud=Object.freeze({__proto__:null,default:hd}),vd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pd=Object.freeze({__proto__:null,default:vd}),fd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gd=Object.freeze({__proto__:null,default:fd}),wd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,md=Object.freeze({__proto__:null,default:wd}),_d=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bd=Object.freeze({__proto__:null,default:_d}),xd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zd=Object.freeze({__proto__:null,default:xd}),Cd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,yd=Object.freeze({__proto__:null,default:Cd}),Md=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vd=Object.freeze({__proto__:null,default:Md}),Hd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pd=Object.freeze({__proto__:null,default:Hd}),Od=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zd=Object.freeze({__proto__:null,default:Od}),$d=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sd=Object.freeze({__proto__:null,default:$d}),Bd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ld=Object.freeze({__proto__:null,default:Ad}),kd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Ed=Object.freeze({__proto__:null,default:kd}),Id=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Td=Object.freeze({__proto__:null,default:Id}),Rd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Dd=Object.freeze({__proto__:null,default:Rd}),Nd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ud=Object.freeze({__proto__:null,default:Nd}),Fd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wd=Object.freeze({__proto__:null,default:Fd}),qd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kd=Object.freeze({__proto__:null,default:qd}),Jd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gd=Object.freeze({__proto__:null,default:Jd}),Yd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xd=Object.freeze({__proto__:null,default:Yd}),Qd=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,eh=Object.freeze({__proto__:null,default:Qd}),th=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lh=Object.freeze({__proto__:null,default:th}),ih=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oh=Object.freeze({__proto__:null,default:ih}),nh=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rh=Object.freeze({__proto__:null,default:nh}),ah=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sh=Object.freeze({__proto__:null,default:ah}),ch=ee`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dh=Object.freeze({__proto__:null,default:ch})});
