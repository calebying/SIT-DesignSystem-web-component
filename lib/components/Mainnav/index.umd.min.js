!function(e){"function"==typeof define&&define.amd?define(e):e()}(function(){"use strict";function e(e,t,n,o){var i,l=arguments.length,r=l<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,n,o);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(r=(l<3?i(r):l>3?i(t,n,r):i(t,n))||r);return l>3&&r&&Object.defineProperty(t,n,r),r}"function"==typeof SuppressedError&&SuppressedError;
/**
   * @license
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */let Le;function Ae(e,t){return(n,o,i)=>{const l=n=>{const i=n.renderRoot?.querySelector(e)??null;if(null===i&&t&&!n.hasUpdated){const t="object"==typeof o?o.name:o;Le("",`@query'd field ${JSON.stringify(String(t))} with the 'cache' flag set for selector '${e}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return i};if(t){const{get:e,set:t}="object"==typeof o?n:i??(()=>{const e=Symbol(`${String(o)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return je(n,o,{get(){let n=e.call(this);return void 0===n&&(n=l(this),(null!==n||this.hasUpdated)&&t.call(this,n)),n}})}return je(n,o,{get(){return l(this)}})}}
/**
   * @license
   * Copyright 2021 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function Ee(e){return(t,n)=>{const{slot:o,selector:i}=e??{},l="slot"+(o?`[name=${o}]`:":not([name])");return je(t,n,{get(){const t=this.renderRoot?.querySelector(l),n=t?.assignedElements(e)??[];return void 0===i?n:n.filter(e=>e.matches(i))}})}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */const Ie=Ne(class extends De{constructor(e){if(super(e),e.type!==Re||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const n=e.element.classList;for(const e of this._previousClasses)e in t||(n.remove(e),this._previousClasses.delete(e));for(const e in t){const o=!!t[e];o===this._previousClasses.has(e)||this._staticClasses?.has(e)||(o?(n.add(e),this._previousClasses.add(e)):(n.remove(e),this._previousClasses.delete(e)))}return se}});var Ue=v`:host{-webkit-text-size-adjust:100%;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-font-smoothing:antialiased;color:var(--sit-body-color-default,#1a1a1a);display:block;font-family:var(--sit-font-family-brand,"Inter",system-ui,sans-serif);font-size:var(--sit-font-size-body-md,1rem);font-weight:var(--sit-font-weight-regular,400);line-height:var(--sit-line-height-xs,24px);margin:0;*,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}:disabled{cursor:not-allowed}@media (prefers-reduced-motion:no-preference){:root{scroll-behavior:smooth}}::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}::slotted(svg){vertical-align:middle}}`;class qe extends Ve{emit(e,t){const n=new CustomEvent(e,Object.assign({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){if(customElements.get(e));else try{customElements.define(e,t,n)}catch(o){customElements.define(e,class extends t{},n)}}constructor(){super(),this.ssr=Boolean(this.shadowRoot),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}firstUpdated(e){var t;super.firstUpdated(e),this.ssr&&(null===(t=this.shadowRoot)||void 0===t||t.querySelectorAll("slot").forEach(e=>{e.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}))}}function We(e,t,n){return new Promise(o=>{if((null==n?void 0:n.duration)===1/0)throw new Error("Promise-based animations must be finite.");const i=e.animate(t,Object.assign(Object.assign({},n),{duration:Fe()?0:null==n?void 0:n.duration}));i.addEventListener("cancel",o,{once:!0}),i.addEventListener("finish",o,{once:!0})})}function Fe(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Ke(e,t){return e.map(e=>Object.assign(Object.assign({},e),{height:"auto"===e.height?`${t}px`:e.height}))}function Xe(e){return Promise.all(e.getAnimations().map(e=>new Promise(t=>{const n=requestAnimationFrame(t);e.addEventListener("cancel",()=>n,{once:!0}),e.addEventListener("finish",()=>n,{once:!0}),e.cancel()})))}qe.styles=[Ue],qe.dependencies={},e([Se({type:Boolean,reflect:!0})],qe.prototype,"ssr",void 0);const Je=new Map,Ye=new WeakMap;function Ge(e,t){const n=Ye.get(e);if(null==n?void 0:n[t])return n[t];const o=Je.get(t);return o||{keyframes:[],options:{duration:0}}}function Qe(e,t){Je.set(e,function(e){return null!=e?e:{keyframes:[],options:{duration:0}}}(t))}function et(e,t){return new Promise(n=>{e.addEventListener(t,function o(i){i.target===e&&(e.removeEventListener(t,o),n())})})}function tt(e="",t=""){return`id-${Math.random().toString().substring(2,6)}-sit-${e}-${t}`}function nt(e,t){const n=Object.assign({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:i}=t;if(e in t){const l=e;t.update=function(e){if(e.has(l)){const t=e.get(l),i=this[l];t!==i&&(n.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,i))}i.call(this,e)}}}}
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const ot=e=>e??ce,it=Symbol.for(""),lt=e=>{if(e?.r===it)return e?._$litStatic$},rt=(e,...t)=>({_$litStatic$:t.reduce((t,n,o)=>t+(e=>{if(void 0!==e._$litStatic$)return e._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(n)+e[o+1],e[0]),r:it}),at=new Map,st=(ct=re,(e,...t)=>{const n=t.length;let o,i;const l=[],r=[];let a,s=0,c=!1;for(;s<n;){for(a=e[s];s<n&&void 0!==(i=t[s],o=lt(i));)a+=o+e[++s],c=!0;s!==n&&r.push(i),l.push(a),s++}if(s===n&&l.push(e[n]),c){const n=l.join("$$lit$$");void 0===(e=at.get(n))&&(l.raw=l,at.set(n,e=l)),t=r}return ct(e,...t)});
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */var ct,dt=v`:host{--btn-font-weight:var(--sit-font-weight-regular);--btn-color:var(--sit-color-fixed-light);--btn-bg:var(--sit-primary-surface-default);--btn-hover-bg:var(--sit-primary-surface-emphasis);--btn-border-radius:var(--sit-border-radius-md);--btn-opacity:var(--sit-opacity-100,1)}:host([variant=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=brand]){--btn-bg:var(--sit-primary-surface-default);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline]){--btn-border-width:var(--sit-border-width-1)}:host([variant=outline][tone=brand]){--btn-border-color:var(--sit-primary-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-color:var(--sit-primary-color-default);--btn-hover-bg:var(--sit-primary-bg-translucent)}:host([variant=ghost][tone=brand]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-primary-surface-translucent);--btn-color:var(--sit-primary-color-default)}:host([variant=primary][tone=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline][tone=danger]){--btn-border-color:var(--sit-danger-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=ghost][tone=danger]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=primary][tone=fixed-light]){--btn-bg:var(--sit-surface-fixed-light);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 0%,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 100%),var(--sit-surface-fixed-light,#fff);--btn-color:var(--sit-color-fixed-dark)}:host([variant=outline][tone=fixed-light]){--btn-border-color:var(--sit-border-color-fixed-light);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=ghost][tone=fixed-light]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=neutral]){--btn-bg:var(--sit-surface-inverse);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-surface-inverse);--btn-color:var(--sit-color-inverse)}:host([variant=outline][tone=neutral]){--btn-border-color:var(--sit-border-color-emphasis);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost][tone=neutral]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost]) .btn,:host([variant=outline]) .btn,:host([variant=primary]) .btn{color:var(--btn-color)}:host([variant=outline]) .btn{border:var(--btn-border-width) solid var(--btn-border-color)}:host([size=lg]) .btn{font-size:var(--sit-font-size-label-lg);height:var(--sit-dimension-56);line-height:var(--sit-line-height-md);min-width:var(--sit-dimension-112);padding:var(--sit-padding-none) var(--sit-padding-xl)}:host([size=sm]) .btn{font-size:var(--sit-font-size-label-sm);height:var(--sit-dimension-40);line-height:var(--sit-line-height-2-xs);min-width:var(--sit-dimension-80);padding:var(--sit-padding-none) var(--sit-padding-md)}:host([size=xs]) .btn{font-size:var(--sit-font-size-label-xs);height:var(--sit-dimension-32);line-height:var(--sit-line-height-3-xs);min-width:var(--sit-dimension-64);padding:var(--sit-padding-none) var(--sit-padding-sm)}.btn{align-items:center;background-color:var(--btn-bg);border:var(--sit-border-width-1) solid var(--sit-border-color-transparent);border-radius:var(--btn-border-radius);color:var(--sit-color-fixed-light);cursor:pointer;display:inline-flex;font-size:var(--sit-font-size-label-md);font-weight:var(--btn-font-weight);gap:var(--sit-gap-2-xs);height:var(--sit-dimension-48);justify-content:center;line-height:var(--sit-line-height-xs);min-width:var(--sit-dimension-96);opacity:var(--btn-opacity);padding:var(--sit-padding-none) var(--sit-padding-lg);text-align:center;text-decoration:none;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;user-select:none;vertical-align:middle;white-space:nowrap;width:inherit}@media (prefers-reduced-motion:reduce){.btn{transition:none}}.btn.active,.btn:hover{background:var(--btn-hover-bg)}.btn:focus-visible{background:var(--btn-hover-bg);border-color:transparent;outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.btn.disabled,.btn:disabled{color:var(--btn-color);cursor:not-allowed;opacity:var(--sit-opacity-40)}.btn.loading{cursor:default}.btn slot::slotted(*){color:var(--btn-color)}`;class ht extends qe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.active=!1,this.disabled=!1,this.target="_self"}focus(e){this.button.focus(e)}click(){this.button.click()}blur(){this.button.blur()}_handleBlur(){this.emit("sit-blur")}_handleFocus(){this.emit("sit-focus")}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation()}_handleKeydown(e){if("Enter"===e.key&&this.loading)return e.preventDefault(),void e.stopPropagation()}_assignSpinnerSize(e){return"xs"===e||"sm"===e?"xs":"md"===e||"lg"===e?"sm":void 0}_assignSpinnerTone(e,t){return"fixed-light"===e&&"primary"===t?"fixed-dark":"neutral"===e&&"primary"===t?"inverse":"fixed-light"===e||"primary"===t?"fixed-light":"neutral"!==e||"outline"!==t&&"ghost"!==t?"brand":"neutral"}}ht.styles=[...qe.styles,dt],e([Ae(".btn")],ht.prototype,"button",void 0),e([Se({reflect:!0})],ht.prototype,"variant",void 0),e([Se({reflect:!0})],ht.prototype,"tone",void 0),e([Se({reflect:!0})],ht.prototype,"size",void 0),e([Se({type:Boolean,reflect:!0})],ht.prototype,"active",void 0),e([Se({type:Boolean,reflect:!0})],ht.prototype,"disabled",void 0),e([Se({type:String,reflect:!0})],ht.prototype,"href",void 0),e([Se({type:String,reflect:!0})],ht.prototype,"target",void 0),e([Se({type:String,reflect:!0})],ht.prototype,"download",void 0),e([Se({type:String})],ht.prototype,"ariaLabel",void 0),e([Se({type:Boolean})],ht.prototype,"loading",void 0);const ut={announcement:()=>Promise.resolve().then(function(){return mo}),archive:()=>Promise.resolve().then(function(){return bo}),"arrow-bar-down":()=>Promise.resolve().then(function(){return xo}),"arrow-bar-left":()=>Promise.resolve().then(function(){return Zo}),"arrow-bar-right":()=>Promise.resolve().then(function(){return Mo}),"arrow-bar-up":()=>Promise.resolve().then(function(){return Vo}),"arrow-circle-down":()=>Promise.resolve().then(function(){return zo}),"arrow-circle-left":()=>Promise.resolve().then(function(){return ko}),"arrow-circle-right":()=>Promise.resolve().then(function(){return So}),"arrow-circle-up":()=>Promise.resolve().then(function(){return jo}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Ao}),"arrow-down":()=>Promise.resolve().then(function(){return Ro}),"arrow-left":()=>Promise.resolve().then(function(){return No}),"arrow-repeat":()=>Promise.resolve().then(function(){return Io}),"arrow-right":()=>Promise.resolve().then(function(){return qo}),"arrow-square-down":()=>Promise.resolve().then(function(){return Fo}),"arrow-square-left":()=>Promise.resolve().then(function(){return Xo}),"arrow-square-right":()=>Promise.resolve().then(function(){return Yo}),"arrow-square-up":()=>Promise.resolve().then(function(){return Qo}),"arrow-up":()=>Promise.resolve().then(function(){return ti}),"bank-fill":()=>Promise.resolve().then(function(){return oi}),"bell-slash":()=>Promise.resolve().then(function(){return li}),bell:()=>Promise.resolve().then(function(){return ai}),"bi-funnel":()=>Promise.resolve().then(function(){return ci}),"bookmark-fill":()=>Promise.resolve().then(function(){return hi}),bookmark:()=>Promise.resolve().then(function(){return vi}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return fi}),"box-seam":()=>Promise.resolve().then(function(){return mi}),building:()=>Promise.resolve().then(function(){return bi}),bus:()=>Promise.resolve().then(function(){return xi}),calculator:()=>Promise.resolve().then(function(){return Zi}),"calendar-check":()=>Promise.resolve().then(function(){return Mi}),"calendar-heart":()=>Promise.resolve().then(function(){return Vi}),"calendar-x":()=>Promise.resolve().then(function(){return zi}),calendar:()=>Promise.resolve().then(function(){return ki}),camera:()=>Promise.resolve().then(function(){return Si}),car:()=>Promise.resolve().then(function(){return ji}),"chat-dots":()=>Promise.resolve().then(function(){return Ai}),"chat-left-text":()=>Promise.resolve().then(function(){return Ri}),chat:()=>Promise.resolve().then(function(){return Ni}),"check-circle-fill":()=>Promise.resolve().then(function(){return Ii}),"check-circle":()=>Promise.resolve().then(function(){return qi}),check:()=>Promise.resolve().then(function(){return Fi}),"chevron-down":()=>Promise.resolve().then(function(){return Xi}),"chevron-left":()=>Promise.resolve().then(function(){return Yi}),"chevron-right":()=>Promise.resolve().then(function(){return Qi}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return tl}),"chevron-up":()=>Promise.resolve().then(function(){return ol}),clock:()=>Promise.resolve().then(function(){return ll}),"cloud-check":()=>Promise.resolve().then(function(){return al}),"cloud-download":()=>Promise.resolve().then(function(){return cl}),"cloud-upload":()=>Promise.resolve().then(function(){return hl}),cloud:()=>Promise.resolve().then(function(){return vl}),"code-square":()=>Promise.resolve().then(function(){return fl}),"coins-hand":()=>Promise.resolve().then(function(){return ml}),compass:()=>Promise.resolve().then(function(){return bl}),copy:()=>Promise.resolve().then(function(){return xl}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return Zl}),cross:()=>Promise.resolve().then(function(){return Ml}),"cursor-fill":()=>Promise.resolve().then(function(){return Vl}),cursor:()=>Promise.resolve().then(function(){return zl}),"dash-circle":()=>Promise.resolve().then(function(){return kl}),"dash-square":()=>Promise.resolve().then(function(){return Sl}),dash:()=>Promise.resolve().then(function(){return jl}),database:()=>Promise.resolve().then(function(){return Al}),dataflow:()=>Promise.resolve().then(function(){return Rl}),download:()=>Promise.resolve().then(function(){return Nl}),edit:()=>Promise.resolve().then(function(){return Il}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return ql}),"exclamation-circle":()=>Promise.resolve().then(function(){return Fl}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return Xl}),"exclamation-triangle":()=>Promise.resolve().then(function(){return Yl}),exclamation:()=>Promise.resolve().then(function(){return Ql}),"eye-fill":()=>Promise.resolve().then(function(){return tr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return or}),"eye-slash":()=>Promise.resolve().then(function(){return lr}),eye:()=>Promise.resolve().then(function(){return ar}),"face-smile-fill":()=>Promise.resolve().then(function(){return cr}),"face-smile":()=>Promise.resolve().then(function(){return hr}),facebook:()=>Promise.resolve().then(function(){return vr}),"file-earmark-text":()=>Promise.resolve().then(function(){return fr}),"file-pdf":()=>Promise.resolve().then(function(){return mr}),"file-plus":()=>Promise.resolve().then(function(){return br}),"file-text":()=>Promise.resolve().then(function(){return xr}),file:()=>Promise.resolve().then(function(){return Zr}),files:()=>Promise.resolve().then(function(){return Mr}),fingerprint:()=>Promise.resolve().then(function(){return Vr}),flash:()=>Promise.resolve().then(function(){return zr}),"folder-check":()=>Promise.resolve().then(function(){return kr}),"folder-minus":()=>Promise.resolve().then(function(){return Sr}),"folder-plus":()=>Promise.resolve().then(function(){return jr}),folder:()=>Promise.resolve().then(function(){return Ar}),gear:()=>Promise.resolve().then(function(){return Rr}),"geo-alt":()=>Promise.resolve().then(function(){return Nr}),"geo-fill":()=>Promise.resolve().then(function(){return Ir}),geo:()=>Promise.resolve().then(function(){return qr}),"globe-alt":()=>Promise.resolve().then(function(){return Fr}),globe:()=>Promise.resolve().then(function(){return Xr}),google:()=>Promise.resolve().then(function(){return Yr}),"grid-alt":()=>Promise.resolve().then(function(){return Qr}),"grid-fill":()=>Promise.resolve().then(function(){return ta}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return oa}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return la}),"hard-drive":()=>Promise.resolve().then(function(){return aa}),heart:()=>Promise.resolve().then(function(){return ca}),"house-door":()=>Promise.resolve().then(function(){return ha}),house:()=>Promise.resolve().then(function(){return va}),image:()=>Promise.resolve().then(function(){return fa}),"in-box":()=>Promise.resolve().then(function(){return ma}),"info-circle-fill":()=>Promise.resolve().then(function(){return ba}),"info-circle":()=>Promise.resolve().then(function(){return xa}),instagram:()=>Promise.resolve().then(function(){return Za}),key:()=>Promise.resolve().then(function(){return Ma}),"laptop-gear":()=>Promise.resolve().then(function(){return Va}),laptop:()=>Promise.resolve().then(function(){return za}),layers:()=>Promise.resolve().then(function(){return ka}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return Sa}),"layout-text-window":()=>Promise.resolve().then(function(){return ja}),layout:()=>Promise.resolve().then(function(){return Aa}),"life-buoy":()=>Promise.resolve().then(function(){return Ra}),lightbulb:()=>Promise.resolve().then(function(){return Na}),link:()=>Promise.resolve().then(function(){return Ia}),linkedin:()=>Promise.resolve().then(function(){return qa}),list:()=>Promise.resolve().then(function(){return Fa}),"lock-fill":()=>Promise.resolve().then(function(){return Xa}),lock:()=>Promise.resolve().then(function(){return Ya}),login:()=>Promise.resolve().then(function(){return Qa}),logout:()=>Promise.resolve().then(function(){return ts}),luggage:()=>Promise.resolve().then(function(){return os}),"mail-open":()=>Promise.resolve().then(function(){return ls}),mail:()=>Promise.resolve().then(function(){return as}),map:()=>Promise.resolve().then(function(){return cs}),meetup:()=>Promise.resolve().then(function(){return hs}),menu:()=>Promise.resolve().then(function(){return vs}),microphone:()=>Promise.resolve().then(function(){return fs}),monitor:()=>Promise.resolve().then(function(){return ms}),moon:()=>Promise.resolve().then(function(){return bs}),move:()=>Promise.resolve().then(function(){return xs}),paperclip:()=>Promise.resolve().then(function(){return Zs}),passcode:()=>Promise.resolve().then(function(){return Ms}),passport:()=>Promise.resolve().then(function(){return Vs}),pause:()=>Promise.resolve().then(function(){return zs}),pencil:()=>Promise.resolve().then(function(){return ks}),"pending-circle":()=>Promise.resolve().then(function(){return Ss}),"person-dash":()=>Promise.resolve().then(function(){return js}),"person-plus":()=>Promise.resolve().then(function(){return As}),"person-x":()=>Promise.resolve().then(function(){return Rs}),person:()=>Promise.resolve().then(function(){return Ns}),phone:()=>Promise.resolve().then(function(){return Is}),"pin-map-fill":()=>Promise.resolve().then(function(){return qs}),pin:()=>Promise.resolve().then(function(){return Fs}),placeholder:()=>Promise.resolve().then(function(){return Xs}),plane:()=>Promise.resolve().then(function(){return Ys}),play:()=>Promise.resolve().then(function(){return Qs}),"plus-circle":()=>Promise.resolve().then(function(){return tc}),"plus-square":()=>Promise.resolve().then(function(){return oc}),plus:()=>Promise.resolve().then(function(){return lc}),printer:()=>Promise.resolve().then(function(){return ac}),"question-circle":()=>Promise.resolve().then(function(){return cc}),rocket:()=>Promise.resolve().then(function(){return hc}),save:()=>Promise.resolve().then(function(){return vc}),search:()=>Promise.resolve().then(function(){return fc}),send:()=>Promise.resolve().then(function(){return mc}),"sg-crest":()=>Promise.resolve().then(function(){return bc}),share:()=>Promise.resolve().then(function(){return xc}),"shield-tick":()=>Promise.resolve().then(function(){return Zc}),"sidebar-collapse":()=>Promise.resolve().then(function(){return Mc}),"sidebar-expand":()=>Promise.resolve().then(function(){return Vc}),"slash-circle":()=>Promise.resolve().then(function(){return zc}),"slash-divider":()=>Promise.resolve().then(function(){return kc}),sliders:()=>Promise.resolve().then(function(){return Sc}),"sort-ascending":()=>Promise.resolve().then(function(){return jc}),"sort-descending":()=>Promise.resolve().then(function(){return Ac}),speedometer:()=>Promise.resolve().then(function(){return Rc}),"star-ai":()=>Promise.resolve().then(function(){return Nc}),"star-fill":()=>Promise.resolve().then(function(){return Ic}),star:()=>Promise.resolve().then(function(){return qc}),stoplights:()=>Promise.resolve().then(function(){return Fc}),sun:()=>Promise.resolve().then(function(){return Xc}),"switch-horizontal":()=>Promise.resolve().then(function(){return Yc}),"switch-vertical":()=>Promise.resolve().then(function(){return Qc}),tablet:()=>Promise.resolve().then(function(){return td}),telegram:()=>Promise.resolve().then(function(){return od}),telephone:()=>Promise.resolve().then(function(){return ld}),"three-dots-vertical":()=>Promise.resolve().then(function(){return ad}),"three-dots":()=>Promise.resolve().then(function(){return cd}),ticket:()=>Promise.resolve().then(function(){return hd}),"toggle-off":()=>Promise.resolve().then(function(){return vd}),"toggle-on":()=>Promise.resolve().then(function(){return fd}),train:()=>Promise.resolve().then(function(){return md}),translate:()=>Promise.resolve().then(function(){return bd}),trash:()=>Promise.resolve().then(function(){return xd}),"trend-down":()=>Promise.resolve().then(function(){return Zd}),"trend-up":()=>Promise.resolve().then(function(){return Md}),truck:()=>Promise.resolve().then(function(){return Vd}),"twitter-x":()=>Promise.resolve().then(function(){return zd}),unlock:()=>Promise.resolve().then(function(){return kd}),upload:()=>Promise.resolve().then(function(){return Sd}),"user-check":()=>Promise.resolve().then(function(){return jd}),"user-circle":()=>Promise.resolve().then(function(){return Ad}),"user-pause":()=>Promise.resolve().then(function(){return Rd}),"user-square":()=>Promise.resolve().then(function(){return Nd}),users:()=>Promise.resolve().then(function(){return Id}),"video-recorder":()=>Promise.resolve().then(function(){return qd}),"volume-max":()=>Promise.resolve().then(function(){return Fd}),"volume-x":()=>Promise.resolve().then(function(){return Xd}),"window-dash":()=>Promise.resolve().then(function(){return Yd}),"window-desktop":()=>Promise.resolve().then(function(){return Qd}),"window-dock":()=>Promise.resolve().then(function(){return th}),"window-fullscreen":()=>Promise.resolve().then(function(){return oh}),"window-plus":()=>Promise.resolve().then(function(){return lh}),"window-sidebar":()=>Promise.resolve().then(function(){return ah}),"window-split":()=>Promise.resolve().then(function(){return ch}),"window-stack":()=>Promise.resolve().then(function(){return hh}),"window-x":()=>Promise.resolve().then(function(){return vh}),window:()=>Promise.resolve().then(function(){return fh}),"xcircle-fill":()=>Promise.resolve().then(function(){return mh}),xcircle:()=>Promise.resolve().then(function(){return bh}),youtube:()=>Promise.resolve().then(function(){return xh}),"zoom-in":()=>Promise.resolve().then(function(){return Zh}),"zoom-out":()=>Promise.resolve().then(function(){return Mh})};var vt=v`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const pt=new Map;class ft extends qe{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(pt.has(e))return void(this._icon=pt.get(e));const t=ut[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const n=await t();pt.set(e,n.default),this._icon=n.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:ce}}ft.styles=[...qe.styles,vt],e([Se({type:String,reflect:!0})],ft.prototype,"name",void 0),e([Se({type:String,reflect:!0})],ft.prototype,"size",void 0),e([Se({type:String})],ft.prototype,"ariaLabel",void 0),e([Be()],ft.prototype,"_icon",void 0);var gt=v`:host{--sit-spinner-bg:var(--sit-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sit-spinner-bg:var(--sit-neutral-surface-default)}:host([tone=neutral]){--sit-spinner-bg:var(--sit-surface-inverse)}:host([tone=inverse]){--sit-spinner-bg:var(--sit-surface-default)}:host([tone=fixed-light]){--sit-spinner-bg:var(--sit-surface-fixed-light)}:host([tone=fixed-dark]){--sit-spinner-bg:var(--sit-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sit-gap-2-xs)}.spinner-wrapper.horizontal{flex-direction:row}.spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sit-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sit-spinner-bg);color:var(--sit-spinner-color);display:inline-flex;height:var(--sit-dimension-32);width:var(--sit-dimension-32)}.spinner-xs{--border-thickness:2px;height:var(--sit-dimension-16);width:var(--sit-dimension-16)}.spinner-sm{--border-thickness:3px;height:var(--sit-dimension-24);width:var(--sit-dimension-24)}.spinner-lg{--border-thickness:6px;height:var(--sit-dimension-48);width:var(--sit-dimension-48)}.spinner-xl{--border-thickness:8px;height:var(--sit-dimension-64);width:var(--sit-dimension-64)}.spinner-label{color:var(--sit-neutral-color-default);font-size:var(--sit-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner{animation-duration:1.5s}}

/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,mt=v`.text-primary{color:var(--sit-primary-rgb)!important}.text-secondary{color:var(--sit-secondary-rgb)!important}.text-success{color:var(--sit-success-rgb)!important}.text-info{color:var(--sit-info-rgb)!important}.text-warning{color:var(--sit-warning-rgb)!important}.text-danger{color:var(--sit-danger-rgb)!important}.text-light{color:var(--sit-light-rgb)!important}.text-dark{color:var(--sit-dark-rgb)!important}.text-muted{color:var(--sit-secondary-color)!important}`;class wt extends qe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return st`
      <div
        ...
        <div class="navbar ${this._expandClass()}">
          ...
          <div class="navbar-body navbar-collapse" id=${this.collapseId}>
            <div class="navbar-nav navbar-nav-scroll">
              ...
              <slot
                name="end"
                class=${Ie({"slot-end":!this.breakpointReached})}
    ...
    `}_expandClass(){switch(this.expand){case"always":return"navbar-expand";case"never":break;default:return`navbar-expand-${this.expand}`}}}Ht.styles=[...qe.styles,Zt],Ht.dependencies={"sit-icon-button":_t},e([r({context:xt}),Be()],Ht.prototype,"_breakpointReached",void 0),e([r({context:yt}),Be()],Ht.prototype,"expanded",void 0),e([Be()],Ht.prototype,"expanding",void 0),e([Ae("nav")],Ht.prototype,"nav",void 0),e([Ae(".navbar")],Ht.prototype,"navbar",void 0),e([Ae(".navbar-toggler")],Ht.prototype,"header",void 0),e([Ae(".navbar-body")],Ht.prototype,"body",void 0),e([Ae(".navbar-nav-scroll")],Ht.prototype,"navScroll",void 0),e([Ae("slot[name='non-collapsible']")],Ht.prototype,"nonCollapsibleSlot",void 0),e([Se({type:Boolean})],Ht.prototype,"hasNonCollapsibleSlot",void 0),e([Se({type:String})],Ht.prototype,"brandHref",void 0),e([Se({type:String})],Ht.prototype,"expand",void 0),e([Se({type:Boolean,reflect:!0})],Ht.prototype,"fluid",void 0),e([Be()],Ht.prototype,"breakpointReached",void 0),e([Ee()],Ht.prototype,"defaultNodes",void 0),e([Ee({slot:"end"})],Ht.prototype,"endNodes",void 0),e([nt("expanding",{waitUntilFirstUpdate:!0})],Ht.prototype,"handleOpenChange",null),Qe("mainnav.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:200,easing:"ease-in-out"}}),Qe("mainnav.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:200,easing:"ease-in-out"}});const Vt=Math.min,Pt=Math.max,zt=Math.round,Ot=Math.floor,kt=e=>({x:e,y:e}),$t={left:"right",right:"left",bottom:"top",top:"bottom"};function St(e,t,n){return Pt(e,Vt(t,n))}function Bt(e,t){return"function"==typeof e?e(t):e}function jt(e){return e.split("-")[0]}function Lt(e){return e.split("-")[1]}function At(e){return"x"===e?"y":"x"}function Et(e){return"y"===e?"height":"width"}function Rt(e){const t=e[0];return"t"===t||"b"===t?"y":"x"}function Tt(e){return At(Rt(e))}function Nt(e,t,n){void 0===n&&(n=!1);const o=Lt(e),i=Tt(e),l=Et(i);let r="x"===i?o===(n?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[l]>t.floating[l]&&(r=Kt(r)),[r,Kt(r)]}function Dt(e){return e.includes("start")?e.replace("start","end"):e.replace("end","start")}const It=["left","right"],Ut=["right","left"],qt=["top","bottom"],Wt=["bottom","top"];function Ft(e,t,n,o){const i=Lt(e);let l=function(e,t,n){switch(e){case"top":case"bottom":return n?t?Ut:It:t?It:Ut;case"left":case"right":return t?qt:Wt;default:return[]}}(jt(e),"start"===n,o);return i&&(l=l.map(e=>e+"-"+i),t&&(l=l.concat(l.map(Dt)))),l}function Kt(e){const t=jt(e);return $t[t]+e.slice(t.length)}function Xt(e){return"number"!=typeof e?function(e){var t,n,o,i;return{top:null!=(t=e.top)?t:0,right:null!=(n=e.right)?n:0,bottom:null!=(o=e.bottom)?o:0,left:null!=(i=e.left)?i:0}}(e):{top:e,right:e,bottom:e,left:e}}function Jt(e){const{x:t,y:n,width:o,height:i}=e;return{width:o,height:i,top:n,left:t,right:t+o,bottom:n+i,x:t,y:n}}function Yt(e,t,n){let{reference:o,floating:i}=e;const l=Rt(t),r=Tt(t),a=Et(r),s=jt(t),c="y"===l,d=o.x+o.width/2-i.width/2,h=o.y+o.height/2-i.height/2,u=o[a]/2-i[a]/2;let v;switch(s){case"top":v={x:d,y:o.y-i.height};break;case"bottom":v={x:d,y:o.y+o.height};break;case"right":v={x:o.x+o.width,y:h};break;case"left":v={x:o.x-i.width,y:h};break;default:v={x:o.x,y:o.y}}const p=Lt(t);return p&&(v[r]+=u*("end"===p?1:-1)*(n&&c?-1:1)),v}async function Gt(e,t){var n;void 0===t&&(t={});const{x:o,y:i,platform:l,rects:r,elements:a,strategy:s}=e,{boundary:c="clippingAncestors",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:u=!1,padding:v=0}=Bt(t,e),p=Xt(v),f=a[u?"floating"===h?"reference":"floating":h],g=Jt(await l.getClippingRect({element:null==(n=await(null==l.isElement?void 0:l.isElement(f)))||n?f:f.contextElement||await(null==l.getDocumentElement?void 0:l.getDocumentElement(a.floating)),boundary:c,rootBoundary:d,strategy:s})),m="floating"===h?{x:o,y:i,width:r.floating.width,height:r.floating.height}:r.reference,w=await(null==l.getOffsetParent?void 0:l.getOffsetParent(a.floating)),b=await(null==l.isElement?void 0:l.isElement(w))&&await(null==l.getScale?void 0:l.getScale(w))||{x:1,y:1},_=Jt(l.convertOffsetParentRelativeRectToViewportRelativeRect?await l.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:m,offsetParent:w,strategy:s}):m);return{top:(g.top-_.top+p.top)/b.y,bottom:(_.bottom-g.bottom+p.bottom)/b.y,left:(g.left-_.left+p.left)/b.x,right:(_.right-g.right+p.right)/b.x}}const Qt=new Set(["left","top"]);function en(){return"undefined"!=typeof window}function tn(e){return ln(e)?(e.nodeName||"").toLowerCase():"#document"}function nn(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function on(e){var t;return null==(t=(ln(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function ln(e){return!!en()&&(e instanceof Node||e instanceof nn(e).Node)}function rn(e){return!!en()&&(e instanceof Element||e instanceof nn(e).Element)}function an(e){return!!en()&&(e instanceof HTMLElement||e instanceof nn(e).HTMLElement)}function sn(e){return!(!en()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof nn(e).ShadowRoot)}function cn(e){const{overflow:t,overflowX:n,overflowY:o,display:i}=bn(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+n)&&"inline"!==i&&"contents"!==i}function dn(e){return/^(table|td|th)$/.test(tn(e))}function hn(e){try{if(e.matches(":popover-open"))return!0}catch(e){}try{return e.matches(":modal")}catch(e){return!1}}const un=/transform|translate|scale|rotate|perspective|filter/,vn=/paint|layout|strict|content/,pn=e=>!!e&&"none"!==e;let fn;function gn(e){const t=rn(e)?bn(e):e;return pn(t.transform)||pn(t.translate)||pn(t.scale)||pn(t.rotate)||pn(t.perspective)||!mn()&&(pn(t.backdropFilter)||pn(t.filter))||un.test(t.willChange||"")||vn.test(t.contain||"")}function mn(){return null==fn&&(fn="undefined"!=typeof CSS&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),fn}function wn(e){return/^(html|body|#document)$/.test(tn(e))}function bn(e){return nn(e).getComputedStyle(e)}function _n(e){return rn(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function xn(e){if("html"===tn(e))return e;const t=e.assignedSlot||e.parentNode||sn(e)&&e.host||on(e);return sn(t)?t.host:t}function yn(e){const t=xn(e);return wn(t)?(e.ownerDocument||e).body:an(t)&&cn(t)?t:yn(t)}function Zn(e,t,n){var o;void 0===t&&(t=[]),void 0===n&&(n=!0);const i=yn(e),l=i===(null==(o=e.ownerDocument)?void 0:o.body),r=nn(i);if(l){const e=Cn(r);return t.concat(r,r.visualViewport||[],cn(i)?i:[],e&&n?Zn(e):[])}return t.concat(i,Zn(i,[],n))}function Cn(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Mn(e){const t=bn(e);let n=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const i=an(e),l=i?e.offsetWidth:n,r=i?e.offsetHeight:o,a=zt(n)!==l||zt(o)!==r;return a&&(n=l,o=r),{width:n,height:o,$:a}}function Hn(e){return rn(e)?e:e.contextElement}function Vn(e){const t=Hn(e);if(!an(t))return kt(1);const n=t.getBoundingClientRect(),{width:o,height:i,$:l}=Mn(t);let r=(l?zt(n.width):n.width)/o,a=(l?zt(n.height):n.height)/i;return r&&Number.isFinite(r)||(r=1),a&&Number.isFinite(a)||(a=1),{x:r,y:a}}const Pn=kt(0);function zn(e){const t=nn(e);return mn()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Pn}function On(e,t,n,o){void 0===t&&(t=!1),void 0===n&&(n=!1);const i=e.getBoundingClientRect(),l=Hn(e);let r=kt(1);t&&(o?rn(o)&&(r=Vn(o)):r=Vn(e));const a=function(e,t,n){return void 0===t&&(t=!1),!!n&&t&&n===nn(e)}(l,n,o)?zn(l):kt(0);let s=(i.left+a.x)/r.x,c=(i.top+a.y)/r.y,d=i.width/r.x,h=i.height/r.y;if(l&&o){const e=nn(l),t=rn(o)?nn(o):o;let n=e,i=Cn(n);for(;i&&t!==n;){const e=Vn(i),t=i.getBoundingClientRect(),o=bn(i),l=t.left+(i.clientLeft+parseFloat(o.paddingLeft))*e.x,r=t.top+(i.clientTop+parseFloat(o.paddingTop))*e.y;s*=e.x,c*=e.y,d*=e.x,h*=e.y,s+=l,c+=r,n=nn(i),i=Cn(n)}}return Jt({width:d,height:h,x:s,y:c})}function kn(e,t){const n=_n(e).scrollLeft;return t?t.left+n:On(on(e)).left+n}function $n(e,t){const n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-kn(e,n),y:n.top+t.scrollTop}}function Sn(e,t,n){let o;if("viewport"===t||"layoutViewport"===t)o=function(e,t,n){void 0===n&&(n="viewport");const o="layoutViewport"===n,i=nn(e),l=on(e),r=i.visualViewport;let a=l.clientWidth,s=l.clientHeight,c=0,d=0;if(r){const e=!mn()||"fixed"===t;o?e||(c=-r.offsetLeft,d=-r.offsetTop):(a=r.width,s=r.height,e&&(c=r.offsetLeft,d=r.offsetTop))}if(kn(l)<=0){const e=l.ownerDocument,t=e.body,n=getComputedStyle(t),o="CSS1Compat"===e.compatMode&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,i=Math.abs(l.clientWidth-t.clientWidth-o),r="stable both-edges"===getComputedStyle(l).scrollbarGutter?i/2:i;r<=25&&(a-=r)}return{width:a,height:s,x:c,y:d}}(e,n,t);else if("document"===t)o=function(e){const t=_n(e),n=e.ownerDocument.body,o=Pt(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),i=Pt(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight);let l=-t.scrollLeft+kn(e);const r=-t.scrollTop;return"rtl"===bn(n).direction&&(l+=Pt(e.clientWidth,n.clientWidth)-o),{width:o,height:i,x:l,y:r}}(on(e));else if(rn(t))o=function(e,t){const n=On(e,!0,"fixed"===t),o=n.top+e.clientTop,i=n.left+e.clientLeft,l=Vn(e);return{width:e.clientWidth*l.x,height:e.clientHeight*l.y,x:i*l.x,y:o*l.y}}(t,n);else{const n=zn(e);o={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return Jt(o)}function Bn(e,t,n){const o=an(t),i=on(t),l="fixed"===n,r=On(e,!0,l,t);let a={scrollLeft:0,scrollTop:0};const s=kt(0);if((o||!l)&&(("body"!==tn(t)||cn(i))&&(a=_n(t)),o)){const e=On(t,!0,l,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}!o&&i&&(s.x=kn(i));const c=!i||o||l?kt(0):$n(i,a);return{x:r.left+a.scrollLeft-s.x-c.x,y:r.top+a.scrollTop-s.y-c.y,width:r.width,height:r.height}}function jn(e){return"static"===bn(e).position}function Ln(e,t){if(!an(e)||"fixed"===bn(e).position)return null;if(t)return t(e);let n=e.offsetParent;return on(e)===n&&(n=n.ownerDocument.body),n}function An(e,t){const n=nn(e);if(hn(e))return n;if(!an(e)){let t=xn(e);for(;t&&!wn(t);){if(rn(t)&&!jn(t))return t;t=xn(t)}return n}let o=Ln(e,t);for(;o&&dn(o)&&jn(o);)o=Ln(o,t);return o&&wn(o)&&jn(o)&&!gn(o)?n:o||function(e){let t=xn(e);for(;an(t)&&!wn(t);){if(gn(t))return t;if(hn(t))return null;t=xn(t)}return null}(e)||n}const En={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:n,offsetParent:o,strategy:i}=e;const l="fixed"===i,r=on(o),a=!!t&&hn(t.floating);if(o===r||a&&l)return n;let s={scrollLeft:0,scrollTop:0},c=kt(1);const d=kt(0),h=an(o);if((h||!l)&&(("body"!==tn(o)||cn(r))&&(s=_n(o)),h)){const e=On(o);c=Vn(o),d.x=e.x+o.clientLeft,d.y=e.y+o.clientTop}const u=!r||h||l?kt(0):$n(r,s);return{width:n.width*c.x,height:n.height*c.y,x:n.x*c.x-s.scrollLeft*c.x+d.x+u.x,y:n.y*c.y-s.scrollTop*c.y+d.y+u.y}},getDocumentElement:on,getClippingRect:function(e){let{element:t,boundary:n,rootBoundary:o,strategy:i}=e;const l=[..."clippingAncestors"===n?hn(t)?[]:function(e,t){const n=t.get(e);if(n)return n;let o=Zn(e,[],!1).filter(e=>rn(e)&&"body"!==tn(e)),i=null;const l="fixed"===bn(e).position;let r=l?xn(e):e;for(;rn(r)&&!wn(r);){const e=bn(r),t=gn(r),n=i?i.position:l?"fixed":"";t||"fixed"!==n&&("absolute"!==n||"static"!==e.position)?i=e:o=o.filter(e=>e!==r),r=xn(r)}return t.set(e,o),o}(t,this._c):[].concat(n),o],r=Sn(t,l[0],i);let a=r.top,s=r.right,c=r.bottom,d=r.left;for(let e=1;e<l.length;e++){const n=Sn(t,l[e],i);a=Pt(n.top,a),s=Vt(n.right,s),c=Vt(n.bottom,c),d=Pt(n.left,d)}return{width:s-d,height:c-a,x:d,y:a}},getOffsetParent:An,getElementRects:async function(e){const t=this.getOffsetParent||An,n=this.getDimensions,o=await n(e.floating);return{reference:Bn(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return e.getClientRects?Array.from(e.getClientRects()):[]},getDimensions:function(e){const{width:t,height:n}=Mn(e);return{width:t,height:n}},getScale:Vn,isElement:rn,isRTL:function(e){return"rtl"===bn(e).direction}};function Rn(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Tn(e,t,n,o){void 0===o&&(o={});const{ancestorScroll:i=!0,ancestorResize:l=!0,elementResize:r="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:s=!1}=o,c=Hn(e),d=i||l?[...c?Zn(c):[],...t?Zn(t):[]]:[];d.forEach(e=>{i&&e.addEventListener("scroll",n),l&&e.addEventListener("resize",n)});const h=c&&a?function(e,t,n){let o,i=null;const l=on(e);function r(){var e;clearTimeout(o),null==(e=i)||e.disconnect(),i=null}function a(n,s){void 0===n&&(n=!1),void 0===s&&(s=1),r();const c=e.getBoundingClientRect(),{left:d,top:h,width:u,height:v}=c;if(n||t(),!u||!v)return;const p={rootMargin:-Ot(h)+"px "+-Ot(l.clientWidth-(d+u))+"px "+-Ot(l.clientHeight-(h+v))+"px "+-Ot(d)+"px",threshold:Pt(0,Vt(1,s))||1};let f=!0;function g(t){const n=t[0].intersectionRatio;if(!Rn(c,e.getBoundingClientRect()))return a();if(n!==s){if(!f)return a();n?a(!1,n):o=setTimeout(()=>{a(!1,1e-7)},1e3)}f=!1}try{i=new IntersectionObserver(g,{...p,root:l.ownerDocument})}catch(e){i=new IntersectionObserver(g,p)}i.observe(e)}const s=nn(e),c=()=>a(n);return s.addEventListener("resize",c),a(!0),()=>{s.removeEventListener("resize",c),r()}}(c,n,l):null;let u,v=-1,p=null;r&&(p=new ResizeObserver(e=>{let[o]=e;o&&o.target===c&&p&&t&&(p.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=p)||e.observe(t)})),n()}),c&&!s&&p.observe(c),t&&p.observe(t));let f=s?On(e):null;return s&&function t(){const o=On(e);f&&!Rn(f,o)&&n();f=o,u=requestAnimationFrame(t)}(),n(),()=>{var e;d.forEach(e=>{i&&e.removeEventListener("scroll",n),l&&e.removeEventListener("resize",n)}),null==h||h(),null==(e=p)||e.disconnect(),p=null,s&&cancelAnimationFrame(u)}}const Nn=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var n,o;const{x:i,y:l,placement:r,middlewareData:a}=t,s=await async function(e,t){const{placement:n,platform:o,elements:i}=e,l=await(null==o.isRTL?void 0:o.isRTL(i.floating)),r=jt(n),a=Lt(n),s="y"===Rt(n),c=Qt.has(r)?-1:1,d=l&&s?-1:1,h=Bt(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:p}="number"==typeof h?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:h.mainAxis||0,crossAxis:h.crossAxis||0,alignmentAxis:h.alignmentAxis};return a&&"number"==typeof p&&(v="end"===a?-1*p:p),s?{x:v*d,y:u*c}:{x:u*c,y:v*d}}(t,e);return r===(null==(n=a.offset)?void 0:n.placement)&&null!=(o=a.arrow)&&o.alignmentOffset?{}:{x:i+s.x,y:l+s.y,data:{...s,placement:r}}}}},Dn=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:n,y:o,placement:i,platform:l}=t,{mainAxis:r=!0,crossAxis:a=!1,limiter:s={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...c}=Bt(e,t),d={x:n,y:o},h=await l.detectOverflow(t,c),u=Rt(i),v=At(u);let p=d[v],f=d[u];const g=(e,t)=>St(t+h["y"===e?"top":"left"],t,t-h["y"===e?"bottom":"right"]);r&&(p=g(v,p)),a&&(f=g(u,f));const m=s.fn({...t,[v]:p,[u]:f});return{...m,data:{x:m.x-n,y:m.y-o,enabled:{[v]:r,[u]:a}}}}}},In=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var n,o;const{placement:i,middlewareData:l,rects:r,initialPlacement:a,platform:s,elements:c}=t,{mainAxis:d=!0,crossAxis:h=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:p="none",flipAlignment:f=!0,...g}=Bt(e,t);if(null!=(n=l.arrow)&&n.alignmentOffset)return{};const m=jt(i),w=Rt(a),b=jt(a)===a,_=await(null==s.isRTL?void 0:s.isRTL(c.floating)),x=u||(b||!f?[Kt(a)]:function(e){const t=Kt(e);return[Dt(e),t,Dt(t)]}(a)),y="none"!==p;!u&&y&&x.push(...Ft(a,f,p,_));const Z=[a,...x],C=await s.detectOverflow(t,g),M=[];let H=(null==(o=l.flip)?void 0:o.overflows)||[];if(d&&M.push(C[m]),h){const e=Nt(i,r,_);M.push(C[e[0]],C[e[1]])}if(H=[...H,{placement:i,overflows:M}],!M.every(e=>e<=0)){var V,P;const e=((null==(V=l.flip)?void 0:V.index)||0)+1,t=Z[e];if(t){if(!("alignment"===h&&w!==Rt(t))||H.every(e=>Rt(e.placement)!==w||e.overflows[0]>0))return{data:{index:e,overflows:H},reset:{placement:t}}}let n=null==(P=H.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:P.placement;if(!n)switch(v){case"bestFit":{var z;const e=null==(z=H.filter(e=>{if(y){const t=Rt(e.placement);return t===w||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:z[0];e&&(n=e);break}case"initialPlacement":n=a}if(i!==n)return{reset:{placement:n}}}return{}}}},Un=(e,t,n)=>{const o=new Map,i=null!=n?n:{},l={...En,...i.platform,_c:o};return(async(e,t,n)=>{const{placement:o="bottom",strategy:i="absolute",middleware:l=[],platform:r}=n,a=r.detectOverflow?r:{...r,detectOverflow:Gt},s=await(null==r.isRTL?void 0:r.isRTL(t));let c=await r.getElementRects({reference:e,floating:t,strategy:i}),{x:d,y:h}=Yt(c,o,s),u=o,v=0;const p={};for(let n=0;n<l.length;n++){const f=l[n];if(!f)continue;const{name:g,fn:m}=f,{x:w,y:b,data:_,reset:x}=await m({x:d,y:h,initialPlacement:o,placement:u,strategy:i,middlewareData:p,rects:c,platform:a,elements:{reference:e,floating:t}});d=null!=w?w:d,h=null!=b?b:h,p[g]={...p[g],..._},x&&v<50&&(v++,"object"==typeof x&&(x.placement&&(u=x.placement),x.rects&&(c=!0===x.rects?await r.getElementRects({reference:e,floating:t,strategy:i}):x.rects),({x:d,y:h}=Yt(c,u,s))),n=-1)}return{x:d,y:h,placement:u,strategy:i,middlewareData:p}})(e,t,{...i,platform:l})};var qn=v`.dropdown{display:flex;height:inherit;position:relative}.dropdown-menu{max-width:var(--sit-dimension-320)}.toggler-container{flex:1;pointer-events:none}.toggler-container ::slotted(*){pointer-events:auto}`,Wn=v`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:0 0 1px 0 hsla(0,0%,5%,.12),0 4px 8px 0 hsla(0,0%,5%,.12);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:left;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-top-left-radius:0;border-top-right-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{left:0;right:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,Fn=v`:host([expand=always]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}@media (min-width:512px){:host([expand=sm]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:768px){:host([expand=md]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:1024px){:host(:not([expand])) .nav-link,:host([expand=lg]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:1280px){:host([expand=xl]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:1440px){:host([expand=xxl]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}.nav-link{align-items:center;box-sizing:border-box;cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-xs);line-height:var(--sit-line-height-2-xs,20px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x);text-decoration:none}.nav-link.show,.nav-link:not(.disabled).active{border-color:var(--sit-primary-border-color-default);color:var(--sit-primary-color-default)}.nav-link:not(.disabled):hover{color:var(--sit-primary-color-default)}.nav-link:not(.disabled):focus-visible{color:var(--sit-primary-color-default);outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.nav-link.disabled{cursor:not-allowed;opacity:var(--sit-opacity-40)}.dropdown-items{background-color:var(--sit-surface-default);height:100%;left:100%;overflow-y:auto;padding:var(--sit-padding-md) 0;position:absolute;top:0;width:100%}.dropdown-items a{align-items:center;color:var(--sit-color-default);cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-xs);line-height:var(--sit-line-height-2-xs,20px);margin:auto;max-width:var(--sit-mainnav-max-width,1440px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x);text-decoration:none}.dropdown-items a:hover{color:var(--sit-primary-color-default)}.dropdown-items a:focus-visible{color:var(--sit-primary-color-default);outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus);outline-offset:-5px}slot[name=toggler]::slotted(*){flex:1}sit-dropdown{display:block;height:100%}@media screen and (min-width:1024px){.dropdown-items a,.nav-link{padding:var(--sit-padding-sm) var(--sit-mainnav-padding-x)}}`
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */;window.ShadyDOM?.inUse&&!0===window.ShadyDOM?.noPatch&&window.ShadyDOM.wrap;const Kn=(e,t)=>{const n=e._$disconnectableChildren;if(void 0===n)return!1;for(const e of n)e._$notifyDirectiveConnectionChanged?.(t,!1),Kn(e,t);return!0},Xn=e=>{let t,n;do{if(void 0===(t=e._$parent))break;n=t._$disconnectableChildren,n.delete(e),e=t}while(0===n?.size)},Jn=e=>{for(let t;t=e._$parent;e=t){let n=t._$disconnectableChildren;if(void 0===n)t._$disconnectableChildren=n=new Set;else if(n.has(e))break;n.add(e),Qn(t)}};
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function Yn(e){void 0!==this._$disconnectableChildren?(Xn(this),this._$parent=e,Jn(this)):this._$parent=e}function Gn(e,t=!1,n=0){const o=this._$committedValue,i=this._$disconnectableChildren;if(void 0!==i&&0!==i.size)if(t)if(Array.isArray(o))for(let e=n;e<o.length;e++)Kn(o[e],!1),Xn(o[e]);else null!=o&&(Kn(o,!1),Xn(o));else Kn(this,e)}const Qn=e=>{e.type==Te&&(e._$notifyConnectionChanged??=Gn,e._$reparentDisconnectables??=Yn)};class eo extends De{constructor(){super(...arguments),this._$disconnectableChildren=void 0}_$initialize(e,t,n){super._$initialize(e,t,n),Jn(this),this.isConnected=e._$isConnected}_$notifyDirectiveConnectionChanged(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Kn(this,e),Xn(this))}setValue(e){if(void 0===this.__part.strings)this.__part._$setValue(e,this);else{if(void 0===this.__attributeIndex)throw new Error("Expected this.__attributeIndex to be a number");const t=[...this.__part._$committedValue];t[this.__attributeIndex]=e,this.__part._$setValue(t,this,0)}}disconnected(){}reconnected(){}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const to=()=>new no;class no{}const oo=new WeakMap;const io=Ne(class extends eo{render(e){return ce}update(e,[t]){const n=t!==this._ref;return n&&this._updateRefValue(void 0),(n||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),ce}_updateRefValue(e){if(void 0!==this._ref)if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let n=oo.get(t);void 0===n&&(n=new WeakMap,oo.set(t,n)),void 0!==n.get(this._ref)&&this._ref.call(this._context,void 0),n.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?oo.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}});class lo extends qe{constructor(){super(...arguments),this.myDropdown=to(),this.dropdownMenuId=tt("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=to(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=Tn(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const n=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},o=t.map(n),i=e.map(e=>{const i=n(e),l=o.indexOf(i);return-1!==l?t[l]:e}).concat(t.filter(t=>!e.some(e=>n(e)===n(t))));return i}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[Nn(8),this.noFlip?void 0:In(),Dn()].filter(Boolean);let n=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(n=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const o=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:n}),{x:i,y:l,strategy:r,placement:a}=await Un(this.myDropdown.value,this.menuRef.value,o);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:r,left:`${i}px`,top:`${l}px`})}}e([Se({type:Boolean,state:!0})],lo.prototype,"noFlip",void 0),e([Se({type:Boolean,reflect:!0,state:!0})],lo.prototype,"menuAlignRight",void 0),e([Se({type:String,reflect:!0,state:!0})],lo.prototype,"drop",void 0),e([Se({type:Object})],lo.prototype,"floatingOpts",void 0),e([Se({type:Boolean,reflect:!0})],lo.prototype,"menuIsOpen",void 0),e([Se({type:Boolean,reflect:!0})],lo.prototype,"disabled",void 0),e([Se({type:Boolean,reflect:!0})],lo.prototype,"readonly",void 0);class ro extends lo{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),n=t.find(t=>e.composedPath().includes(t));if(!n)return;const o=t.indexOf(n);this.nextDropdownItemNo=o+1,this.prevDropdownItemNo=o<=0?t.length-1:o-1,n.disabled||(this.emit("sit-select",{detail:{item:n}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const n=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");n&&n.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const n=(e%t.length+t.length)%t.length,o=t[n];this.emit("i-sit-option-focus",{detail:{option:o}}),this.nextDropdownItemNo=(n+1)%t.length,this.prevDropdownItemNo=(n-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===o?"0":"-1"),e===o&&t.focus()})}}ro.styles=lo.styles,e([Ae("ul.dropdown-menu")],ro.prototype,"menu",void 0),e([Be()],ro.prototype,"nextDropdownItemNo",void 0),e([Be()],ro.prototype,"prevDropdownItemNo",void 0),e([Se({type:Boolean,reflect:!0})],ro.prototype,"hidden",void 0);class ao extends ro{constructor(){super(),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.close="default",this.menuRef=io()}async _handleClick(e){if(this.disabled)return;const t=this._toggler[0];if(!t)return void this.toggleMenu();if(e.composedPath().includes(t))return void this.toggleMenu();if(!this.menuIsOpen)return;const n=this.menuRef.value;n&&e.composedPath().includes(n)||this.hideMenu()}_handleCloseMenu(){const e=this._toggler[0];null==e||e.focus()}async connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._handleCloseMenu)}async disconnectedCallback(){this.removeEventListener("sit-hide",this._handleCloseMenu)}async firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&await this.updateFloatingPosition(),this._handleDisabled()}_handleTogglerSlotChange(e){const t=e.target.assignedElements({flatten:!0})[0];t&&(t.setAttribute("aria-haspopup","menu"),t.setAttribute("aria-expanded",String(this.menuIsOpen)))}_handleMenuIsOpenChange(){const e=this._toggler[0];e&&e.setAttribute("aria-expanded",String(this.menuIsOpen))}_handleDisabled(){const e=this._toggler[0];e&&(this.disabled?e.setAttribute("disabled","true"):e.hasAttribute("disabled")&&e.removeAttribute("disabled"))}render(){return re`
      <div class="dropdown" @click=${this._handleClick}>
        <div class="toggler-container" ${io(this.myDropdown)}>
          <slot name="toggler" @slotchange=${this._handleTogglerSlotChange}></slot>
        </div>
        <div class="dropdown-menu" role="menu" ${io(this.menuRef)}>
          <slot id="default" @click=${this.handleSelectSlot}></slot>
        </div>
      </div>
    `}}ao.styles=[...ro.styles,qn,Wn],e([Se({type:Boolean,reflect:!0,state:!1})],ao.prototype,"noFlip",void 0),e([Se({type:Boolean,reflect:!0,state:!1})],ao.prototype,"menuAlignRight",void 0),e([Se({type:String,reflect:!0,state:!1})],ao.prototype,"drop",void 0),e([Se({type:String,reflect:!0,state:!1})],ao.prototype,"close",void 0),e([Ee({slot:"toggler",flatten:!0})],ao.prototype,"_toggler",void 0),e([nt("menuIsOpen")],ao.prototype,"_handleMenuIsOpenChange",null),e([nt("disabled",{waitUntilFirstUpdate:!0})],ao.prototype,"_handleDisabled",null);var so=v`:host([disabled]){cursor:not-allowed}.dropdown-item{align-items:center;background-color:var(--sit-bg-transparent);clear:both;color:var(--sit-color-default);cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-sm);padding:var(--sit-padding-sm) var(--sit-padding-lg);text-align:inherit}.dropdown-item:hover{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus,.dropdown-item:focus-visible{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus-visible{outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.dropdown-item.active{background-color:var(--sit-bg-translucent-subtle);color:var(--sit-primary-color-default);text-decoration:none}.dropdown-item.disabled,.dropdown-item:disabled{opacity:var(--sit-opacity-40);pointer-events:none}::slotted(*){color:inherit!important;display:flex;gap:var(--sit-gap-sm);text-decoration:none!important}::slotted(a),::slotted(sit-checkbox){flex:1;margin:calc(var(--sit-padding-sm)*-1) calc(var(--sit-padding-lg)*-1);padding:var(--sit-padding-sm) var(--sit-padding-lg)}.dropdown-item.mainnav-dropdown-link{padding:var(--sit-padding-none)}.dropdown-item.mainnav-dropdown-link ::slotted(*){box-sizing:border-box;margin:auto;max-width:var(--sit-mainnav-max-width,1440px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x)}@media screen and (min-width:1024px){.dropdown-item.mainnav-dropdown-link ::slotted(*){padding:var(--sit-padding-sm) var(--sit-mainnav-padding-x)}}`;class co extends qe{constructor(){super(...arguments),this.active=!1,this.disabled=!1,this.ariaLabel=""}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",e=>{"Enter"===e.key&&this.anchor.length>0&&this.anchor[0].click()}),this.setAttribute("role","menuitem"),this.setAttribute("aria-disabled",`${this.disabled}`)}render(){return re`
      <div
    ...
    `}}co.styles=[qn,so],co.dependencies={"sit-icon":ft},e([Ee({flatten:!0})],co.prototype,"anchor",void 0),e([Se({type:Boolean})],co.prototype,"active",void 0),e([Se({type:Boolean,reflect:!0})],co.prototype,"disabled",void 0),e([Se({type:String})],co.prototype,"ariaLabel",void 0);const ho="Enter";class uo extends qe{constructor(){super(...arguments),this._breakpointReached=!0,this.togglerId=tt("dropdown","button"),this.active=!1,this.disabled=!1}get defaultSlotItems(){return[...this.defaultNodes||[]].filter(e=>void 0!==e.tagName)}updated(){this._breakpointReached&&(this._copyTextToMenu(),this._resetDropdownMenu(),this._hideDropdownMenuItems())}_handleSlotChange(e){e.target.assignedElements({flatten:!0}).forEach(e=>{var t;e.addEventListener("keydown",this._handleKeyboardMenuItemsEvent.bind(this));const n=e.shadowRoot.querySelector(".dropdown-item");n.classList.add("mainnav-dropdown-link");const o=(null===(t=e.shadowRoot)||void 0===t?void 0:t.querySelector("a"))||e.querySelector("a");o.tabIndex=-1,n.classList.contains("disabled")?(o.setAttribute("href","javascript:void(0)"),o.setAttribute("tabindex","-1")):o.addEventListener("click",e=>{e.target.closest("sit-mainnav").hide()})})}_handleDesktopSlotChange(e){e.target.assignedElements({flatten:!0}).forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.classList.remove("mainnav-dropdown-link");e.shadowRoot.querySelector(".dropdown-item slot").assignedElements({flatten:!0}).forEach(e=>{t.classList.contains("disabled")&&(e.setAttribute("href","javascript:void(0)"),e.setAttribute("tabindex","-1"))})})}_handleKeyboardMenuItemsEvent(e){if(!this._breakpointReached)return;const t=this.defaultSlotItems.filter(e=>!e.hasAttribute("disabled")),n=[this.menuHeaderButton,...t],o=n.length;if(0===o)return;const i=n[0],l=n[o-1].shadowRoot.querySelector(".dropdown-item");let r=document.activeElement;if(r===this&&(r=this.shadowRoot.activeElement),"Tab"===e.key)if(e.shiftKey)r===i&&(e.preventDefault(),setTimeout(()=>{l.focus()},0));else{const t=r.shadowRoot?r.shadowRoot.querySelector(".dropdown-item"):null;t&&t===l&&(e.preventDefault(),i.focus())}}_copyTextToMenu(){this.menuHeaderText.innerHTML=this.togglerNodes[0].innerHTML}_hideDropdownMenuItems(){this.dropdownItems.style.display="none",this.dropdownItems.setAttribute("aria-hidden","true")}_resetDropdownMenu(){const e=this._getNavbarBody();return e?new Promise(t=>{const n=o=>{"transform"===o.propertyName&&(e.removeEventListener("transitionend",n),t())};getComputedStyle(e).transitionProperty.includes("transform")?(e.addEventListener("transitionend",n),e.style.removeProperty("transform")):(e.style.removeProperty("transform"),t())}):Promise.resolve()}_handleKeyboardOpen(e){this.disabled||e.key!==ho&&" "!==e.key||(e.preventDefault(),this._openMenu())}_getNavbarBody(){const e=document.querySelector("sit-mainnav");if(!(null==e?void 0:e.shadowRoot))return void console.warn("sit-mainnav or its shadowRoot not found");const t=e.shadowRoot.querySelector(".navbar-body");if(t)return t;console.warn(".navbar-body not found in sit-mainnav")}_openMenu(){this._getNavbarBody().style.transform="translateX(-100%)",this.dropdownItems.style.removeProperty("display"),this.dropdownItems.setAttribute("aria-hidden","false"),setTimeout(()=>{this.menuHeaderButton.focus()},50)}_handleHeaderKeyboardEvent(e){switch(e.key){case"Tab":this._handleKeyboardMenuItemsEvent(e);break;case ho:case" ":e.preventDefault(),this._closeMenu()}}async _closeMenu(){await this._resetDropdownMenu(),this._hideDropdownMenuItems(),this.navLink.focus()}render(){const e=re`
      <a
...
`,mo=Object.freeze({__proto__:null,default:go}),wo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bo=Object.freeze({__proto__:null,default:wo}),_o=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xo=Object.freeze({__proto__:null,default:_o}),yo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zo=Object.freeze({__proto__:null,default:yo}),Co=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Mo=Object.freeze({__proto__:null,default:Co}),Ho=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Vo=Object.freeze({__proto__:null,default:Ho}),Po=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zo=Object.freeze({__proto__:null,default:Po}),Oo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ko=Object.freeze({__proto__:null,default:Oo}),$o=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,So=Object.freeze({__proto__:null,default:$o}),Bo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jo=Object.freeze({__proto__:null,default:Bo}),Lo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ao=Object.freeze({__proto__:null,default:Lo}),Eo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ro=Object.freeze({__proto__:null,default:Eo}),To=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,No=Object.freeze({__proto__:null,default:To}),Do=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Io=Object.freeze({__proto__:null,default:Do}),Uo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qo=Object.freeze({__proto__:null,default:Uo}),Wo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fo=Object.freeze({__proto__:null,default:Wo}),Ko=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xo=Object.freeze({__proto__:null,default:Ko}),Jo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yo=Object.freeze({__proto__:null,default:Jo}),Go=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qo=Object.freeze({__proto__:null,default:Go}),ei=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ti=Object.freeze({__proto__:null,default:ei}),ni=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oi=Object.freeze({__proto__:null,default:ni}),ii=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,li=Object.freeze({__proto__:null,default:ii}),ri=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ai=Object.freeze({__proto__:null,default:ri}),si=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ci=Object.freeze({__proto__:null,default:si}),di=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hi=Object.freeze({__proto__:null,default:di}),ui=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vi=Object.freeze({__proto__:null,default:ui}),pi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fi=Object.freeze({__proto__:null,default:pi}),gi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mi=Object.freeze({__proto__:null,default:gi}),wi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bi=Object.freeze({__proto__:null,default:wi}),_i=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xi=Object.freeze({__proto__:null,default:_i}),yi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zi=Object.freeze({__proto__:null,default:yi}),Ci=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Mi=Object.freeze({__proto__:null,default:Ci}),Hi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vi=Object.freeze({__proto__:null,default:Hi}),Pi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zi=Object.freeze({__proto__:null,default:Pi}),Oi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ki=Object.freeze({__proto__:null,default:Oi}),$i=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Si=Object.freeze({__proto__:null,default:$i}),Bi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ji=Object.freeze({__proto__:null,default:Bi}),Li=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ai=Object.freeze({__proto__:null,default:Li}),Ei=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ri=Object.freeze({__proto__:null,default:Ei}),Ti=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ni=Object.freeze({__proto__:null,default:Ti}),Di=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ii=Object.freeze({__proto__:null,default:Di}),Ui=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qi=Object.freeze({__proto__:null,default:Ui}),Wi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fi=Object.freeze({__proto__:null,default:Wi}),Ki=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xi=Object.freeze({__proto__:null,default:Ki}),Ji=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yi=Object.freeze({__proto__:null,default:Ji}),Gi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qi=Object.freeze({__proto__:null,default:Gi}),el=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,tl=Object.freeze({__proto__:null,default:el}),nl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ol=Object.freeze({__proto__:null,default:nl}),il=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ll=Object.freeze({__proto__:null,default:il}),rl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,al=Object.freeze({__proto__:null,default:rl}),sl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cl=Object.freeze({__proto__:null,default:sl}),dl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hl=Object.freeze({__proto__:null,default:dl}),ul=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vl=Object.freeze({__proto__:null,default:ul}),pl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,fl=Object.freeze({__proto__:null,default:pl}),gl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ml=Object.freeze({__proto__:null,default:gl}),wl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bl=Object.freeze({__proto__:null,default:wl}),_l=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xl=Object.freeze({__proto__:null,default:_l}),yl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zl=Object.freeze({__proto__:null,default:yl}),Cl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ml=Object.freeze({__proto__:null,default:Cl}),Hl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vl=Object.freeze({__proto__:null,default:Hl}),Pl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zl=Object.freeze({__proto__:null,default:Pl}),Ol=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kl=Object.freeze({__proto__:null,default:Ol}),$l=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sl=Object.freeze({__proto__:null,default:$l}),Bl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jl=Object.freeze({__proto__:null,default:Bl}),Ll=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Al=Object.freeze({__proto__:null,default:Ll}),El=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rl=Object.freeze({__proto__:null,default:El}),Tl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nl=Object.freeze({__proto__:null,default:Tl}),Dl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Il=Object.freeze({__proto__:null,default:Dl}),Ul=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ql=Object.freeze({__proto__:null,default:Ul}),Wl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fl=Object.freeze({__proto__:null,default:Wl}),Kl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xl=Object.freeze({__proto__:null,default:Kl}),Jl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yl=Object.freeze({__proto__:null,default:Jl}),Gl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,Ql=Object.freeze({__proto__:null,default:Gl}),er=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,tr=Object.freeze({__proto__:null,default:er}),nr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,or=Object.freeze({__proto__:null,default:nr}),ir=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lr=Object.freeze({__proto__:null,default:ir}),rr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ar=Object.freeze({__proto__:null,default:rr}),sr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cr=Object.freeze({__proto__:null,default:sr}),dr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,hr=Object.freeze({__proto__:null,default:dr}),ur=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,vr=Object.freeze({__proto__:null,default:ur}),pr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fr=Object.freeze({__proto__:null,default:pr}),gr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mr=Object.freeze({__proto__:null,default:gr}),wr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,br=Object.freeze({__proto__:null,default:wr}),_r=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xr=Object.freeze({__proto__:null,default:_r}),yr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zr=Object.freeze({__proto__:null,default:yr}),Cr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Mr=Object.freeze({__proto__:null,default:Cr}),Hr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Vr=Object.freeze({__proto__:null,default:Hr}),Pr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zr=Object.freeze({__proto__:null,default:Pr}),Or=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,kr=Object.freeze({__proto__:null,default:Or}),$r=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Sr=Object.freeze({__proto__:null,default:$r}),Br=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jr=Object.freeze({__proto__:null,default:Br}),Lr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ar=Object.freeze({__proto__:null,default:Lr}),Er=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rr=Object.freeze({__proto__:null,default:Er}),Tr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nr=Object.freeze({__proto__:null,default:Tr}),Dr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ir=Object.freeze({__proto__:null,default:Dr}),Ur=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qr=Object.freeze({__proto__:null,default:Ur}),Wr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Fr=Object.freeze({__proto__:null,default:Wr}),Kr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xr=Object.freeze({__proto__:null,default:Kr}),Jr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yr=Object.freeze({__proto__:null,default:Jr}),Gr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qr=Object.freeze({__proto__:null,default:Gr}),ea=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ta=Object.freeze({__proto__:null,default:ea}),na=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oa=Object.freeze({__proto__:null,default:na}),ia=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,la=Object.freeze({__proto__:null,default:ia}),ra=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,aa=Object.freeze({__proto__:null,default:ra}),sa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ca=Object.freeze({__proto__:null,default:sa}),da=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ha=Object.freeze({__proto__:null,default:da}),ua=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,va=Object.freeze({__proto__:null,default:ua}),pa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fa=Object.freeze({__proto__:null,default:pa}),ga=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ma=Object.freeze({__proto__:null,default:ga}),wa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ba=Object.freeze({__proto__:null,default:wa}),_a=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xa=Object.freeze({__proto__:null,default:_a}),ya=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Za=Object.freeze({__proto__:null,default:ya}),Ca=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Ma=Object.freeze({__proto__:null,default:Ca}),Ha=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Va=Object.freeze({__proto__:null,default:Ha}),Pa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,za=Object.freeze({__proto__:null,default:Pa}),Oa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ka=Object.freeze({__proto__:null,default:Oa}),$a=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sa=Object.freeze({__proto__:null,default:$a}),Ba=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ja=Object.freeze({__proto__:null,default:Ba}),La=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Aa=Object.freeze({__proto__:null,default:La}),Ea=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ra=Object.freeze({__proto__:null,default:Ea}),Ta=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Na=Object.freeze({__proto__:null,default:Ta}),Da=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ia=Object.freeze({__proto__:null,default:Da}),Ua=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,qa=Object.freeze({__proto__:null,default:Ua}),Wa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fa=Object.freeze({__proto__:null,default:Wa}),Ka=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xa=Object.freeze({__proto__:null,default:Ka}),Ja=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ya=Object.freeze({__proto__:null,default:Ja}),Ga=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qa=Object.freeze({__proto__:null,default:Ga}),es=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ts=Object.freeze({__proto__:null,default:es}),ns=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,os=Object.freeze({__proto__:null,default:ns}),is=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ls=Object.freeze({__proto__:null,default:is}),rs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,as=Object.freeze({__proto__:null,default:rs}),ss=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cs=Object.freeze({__proto__:null,default:ss}),ds=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,hs=Object.freeze({__proto__:null,default:ds}),us=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,vs=Object.freeze({__proto__:null,default:us}),ps=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fs=Object.freeze({__proto__:null,default:ps}),gs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ms=Object.freeze({__proto__:null,default:gs}),ws=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bs=Object.freeze({__proto__:null,default:ws}),_s=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xs=Object.freeze({__proto__:null,default:_s}),ys=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zs=Object.freeze({__proto__:null,default:ys}),Cs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ms=Object.freeze({__proto__:null,default:Cs}),Hs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vs=Object.freeze({__proto__:null,default:Hs}),Ps=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zs=Object.freeze({__proto__:null,default:Ps}),Os=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ks=Object.freeze({__proto__:null,default:Os}),$s=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ss=Object.freeze({__proto__:null,default:$s}),Bs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,js=Object.freeze({__proto__:null,default:Bs}),Ls=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,As=Object.freeze({__proto__:null,default:Ls}),Es=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rs=Object.freeze({__proto__:null,default:Es}),Ts=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ns=Object.freeze({__proto__:null,default:Ts}),Ds=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Is=Object.freeze({__proto__:null,default:Ds}),Us=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qs=Object.freeze({__proto__:null,default:Us}),Ws=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fs=Object.freeze({__proto__:null,default:Ws}),Ks=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xs=Object.freeze({__proto__:null,default:Ks}),Js=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ys=Object.freeze({__proto__:null,default:Js}),Gs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qs=Object.freeze({__proto__:null,default:Gs}),ec=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,tc=Object.freeze({__proto__:null,default:ec}),nc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oc=Object.freeze({__proto__:null,default:nc}),ic=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lc=Object.freeze({__proto__:null,default:ic}),rc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ac=Object.freeze({__proto__:null,default:rc}),sc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,cc=Object.freeze({__proto__:null,default:sc}),dc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hc=Object.freeze({__proto__:null,default:dc}),uc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vc=Object.freeze({__proto__:null,default:uc}),pc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fc=Object.freeze({__proto__:null,default:pc}),gc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mc=Object.freeze({__proto__:null,default:gc}),wc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="#DB0000"
...
`,bc=Object.freeze({__proto__:null,default:wc}),_c=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xc=Object.freeze({__proto__:null,default:_c}),yc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zc=Object.freeze({__proto__:null,default:yc}),Cc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mc=Object.freeze({__proto__:null,default:Cc}),Hc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vc=Object.freeze({__proto__:null,default:Hc}),Pc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sc=Object.freeze({__proto__:null,default:$c}),Bc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jc=Object.freeze({__proto__:null,default:Bc}),Lc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ac=Object.freeze({__proto__:null,default:Lc}),Ec=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rc=Object.freeze({__proto__:null,default:Ec}),Tc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nc=Object.freeze({__proto__:null,default:Tc}),Dc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ic=Object.freeze({__proto__:null,default:Dc}),Uc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qc=Object.freeze({__proto__:null,default:Uc}),Wc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fc=Object.freeze({__proto__:null,default:Wc}),Kc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xc=Object.freeze({__proto__:null,default:Kc}),Jc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yc=Object.freeze({__proto__:null,default:Jc}),Gc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qc=Object.freeze({__proto__:null,default:Gc}),ed=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,td=Object.freeze({__proto__:null,default:ed}),nd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,od=Object.freeze({__proto__:null,default:nd}),id=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ld=Object.freeze({__proto__:null,default:id}),rd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ad=Object.freeze({__proto__:null,default:rd}),sd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cd=Object.freeze({__proto__:null,default:sd}),dd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,hd=Object.freeze({__proto__:null,default:dd}),ud=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vd=Object.freeze({__proto__:null,default:ud}),pd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fd=Object.freeze({__proto__:null,default:pd}),gd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,md=Object.freeze({__proto__:null,default:gd}),wd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bd=Object.freeze({__proto__:null,default:wd}),_d=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,xd=Object.freeze({__proto__:null,default:_d}),yd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zd=Object.freeze({__proto__:null,default:yd}),Cd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Md=Object.freeze({__proto__:null,default:Cd}),Hd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vd=Object.freeze({__proto__:null,default:Hd}),Pd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zd=Object.freeze({__proto__:null,default:Pd}),Od=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kd=Object.freeze({__proto__:null,default:Od}),$d=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sd=Object.freeze({__proto__:null,default:$d}),Bd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jd=Object.freeze({__proto__:null,default:Bd}),Ld=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ad=Object.freeze({__proto__:null,default:Ld}),Ed=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Rd=Object.freeze({__proto__:null,default:Ed}),Td=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nd=Object.freeze({__proto__:null,default:Td}),Dd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Id=Object.freeze({__proto__:null,default:Dd}),Ud=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qd=Object.freeze({__proto__:null,default:Ud}),Wd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fd=Object.freeze({__proto__:null,default:Wd}),Kd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xd=Object.freeze({__proto__:null,default:Kd}),Jd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Yd=Object.freeze({__proto__:null,default:Jd}),Gd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Qd=Object.freeze({__proto__:null,default:Gd}),eh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,th=Object.freeze({__proto__:null,default:eh}),nh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,oh=Object.freeze({__proto__:null,default:nh}),ih=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,lh=Object.freeze({__proto__:null,default:ih}),rh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ah=Object.freeze({__proto__:null,default:rh}),sh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ch=Object.freeze({__proto__:null,default:sh}),dh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,hh=Object.freeze({__proto__:null,default:dh}),uh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,vh=Object.freeze({__proto__:null,default:uh}),ph=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fh=Object.freeze({__proto__:null,default:ph}),gh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mh=Object.freeze({__proto__:null,default:gh}),wh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bh=Object.freeze({__proto__:null,default:wh}),_h=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xh=Object.freeze({__proto__:null,default:_h}),yh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zh=Object.freeze({__proto__:null,default:yh}),Ch=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mh=Object.freeze({__proto__:null,default:Ch})});
