...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */var ct,dt=v`:host{--btn-font-weight:var(--sit-font-weight-regular);--btn-color:var(--sit-color-fixed-light);--btn-bg:var(--sit-primary-surface-default);--btn-hover-bg:var(--sit-primary-surface-emphasis);--btn-border-radius:var(--sit-border-radius-md);--btn-opacity:var(--sit-opacity-100,1)}:host([variant=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=brand]){--btn-bg:var(--sit-primary-surface-default);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline]){--btn-border-width:var(--sit-border-width-1)}:host([variant=outline][tone=brand]){--btn-border-color:var(--sit-primary-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-color:var(--sit-primary-color-default);--btn-hover-bg:var(--sit-primary-bg-translucent)}:host([variant=ghost][tone=brand]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-primary-surface-translucent);--btn-color:var(--sit-primary-color-default)}:host([variant=primary][tone=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline][tone=danger]){--btn-border-color:var(--sit-danger-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=ghost][tone=danger]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=primary][tone=fixed-light]){--btn-bg:var(--sit-surface-fixed-light);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 0%,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 100%),var(--sit-surface-fixed-light,#fff);--btn-color:var(--sit-color-fixed-dark)}:host([variant=outline][tone=fixed-light]){--btn-border-color:var(--sit-border-color-fixed-light);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=ghost][tone=fixed-light]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=neutral]){--btn-bg:var(--sit-surface-inverse);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-surface-inverse);--btn-color:var(--sit-color-inverse)}:host([variant=outline][tone=neutral]){--btn-border-color:var(--sit-border-color-emphasis);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost][tone=neutral]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost]) .btn,:host([variant=outline]) .btn,:host([variant=primary]) .btn{color:var(--btn-color)}:host([variant=outline]) .btn{border:var(--btn-border-width) solid var(--btn-border-color)}:host([size=lg]) .btn{font-size:var(--sit-font-size-label-lg);height:var(--sit-dimension-56);line-height:var(--sit-line-height-md);min-width:var(--sit-dimension-112);padding:var(--sit-padding-none) var(--sit-padding-xl)}:host([size=sm]) .btn{font-size:var(--sit-font-size-label-sm);height:var(--sit-dimension-40);line-height:var(--sit-line-height-2-xs);min-width:var(--sit-dimension-80);padding:var(--sit-padding-none) var(--sit-padding-md)}:host([size=xs]) .btn{font-size:var(--sit-font-size-label-xs);height:var(--sit-dimension-32);line-height:var(--sit-line-height-3-xs);min-width:var(--sit-dimension-64);padding:var(--sit-padding-none) var(--sit-padding-sm)}.btn{align-items:center;background-color:var(--btn-bg);border:var(--sit-border-width-1) solid var(--sit-border-color-transparent);border-radius:var(--btn-border-radius);color:var(--sit-color-fixed-light);cursor:pointer;display:inline-flex;font-size:var(--sit-font-size-label-md);font-weight:var(--btn-font-weight);gap:var(--sit-gap-2-xs);height:var(--sit-dimension-48);justify-content:center;line-height:var(--sit-line-height-xs);min-width:var(--sit-dimension-96);opacity:var(--btn-opacity);padding:var(--sit-padding-none) var(--sit-padding-lg);text-align:center;text-decoration:none;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;user-select:none;vertical-align:middle;white-space:nowrap;width:inherit}@media (prefers-reduced-motion:reduce){.btn{transition:none}}.btn.active,.btn:hover{background:var(--btn-hover-bg)}.btn:focus-visible{background:var(--btn-hover-bg);border-color:transparent;outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.btn.disabled,.btn:disabled{color:var(--btn-color);cursor:not-allowed;opacity:var(--sit-opacity-40)}.btn.loading{cursor:default}.btn slot::slotted(*){color:var(--btn-color)}`;class ht extends qe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.active=!1,this.disabled=!1,this.target="_self"}focus(e){this.button.focus(e)}click(){this.button.click()}blur(){this.button.blur()}_handleBlur(){this.emit("sit-blur")}_handleFocus(){this.emit("sit-focus")}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation()}_handleKeydown(e){if("Enter"===e.key&&this.loading)return e.preventDefault(),void e.stopPropagation()}_assignSpinnerSize(e){return"xs"===e||"sm"===e?"xs":"md"===e||"lg"===e?"sm":void 0}_assignSpinnerTone(e,t){return"fixed-light"===e&&"primary"===t?"fixed-dark":"neutral"===e&&"primary"===t?"inverse":"fixed-light"===e||"primary"===t?"fixed-light":"neutral"!==e||"outline"!==t&&"ghost"!==t?"brand":"neutral"}}ht.styles=[...qe.styles,dt],e([Ae(".btn")],ht.prototype,"button",void 0),e([Se({reflect:!0})],ht.prototype,"variant",void 0),e([Se({reflect:!0})],ht.prototype,"tone",void 0),e([Se({reflect:!0})],ht.prototype,"size",void 0),e([Se({type:Boolean,reflect:!0})],ht.prototype,"active",void 0),e([Se({type:Boolean,reflect:!0})],ht.prototype,"disabled",void 0),e([Se({type:String,reflect:!0})],ht.prototype,"href",void 0),e([Se({type:String,reflect:!0})],ht.prototype,"target",void 0),e([Se({type:String,reflect:!0})],ht.prototype,"download",void 0),e([Se({type:String})],ht.prototype,"ariaLabel",void 0),e([Se({type:Boolean})],ht.prototype,"loading",void 0);const ut={announcement:()=>Promise.resolve().then(function(){return Co}),archive:()=>Promise.resolve().then(function(){return Ho}),"arrow-bar-down":()=>Promise.resolve().then(function(){return Po}),"arrow-bar-left":()=>Promise.resolve().then(function(){return Oo}),"arrow-bar-right":()=>Promise.resolve().then(function(){return $o}),"arrow-bar-up":()=>Promise.resolve().then(function(){return Bo}),"arrow-circle-down":()=>Promise.resolve().then(function(){return Lo}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Eo}),"arrow-circle-right":()=>Promise.resolve().then(function(){return Ro}),"arrow-circle-up":()=>Promise.resolve().then(function(){return Do}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Uo}),"arrow-down":()=>Promise.resolve().then(function(){return Wo}),"arrow-left":()=>Promise.resolve().then(function(){return Ko}),"arrow-repeat":()=>Promise.resolve().then(function(){return Jo}),"arrow-right":()=>Promise.resolve().then(function(){return Go}),"arrow-square-down":()=>Promise.resolve().then(function(){return ei}),"arrow-square-left":()=>Promise.resolve().then(function(){return ni}),"arrow-square-right":()=>Promise.resolve().then(function(){return ii}),"arrow-square-up":()=>Promise.resolve().then(function(){return ri}),"arrow-up":()=>Promise.resolve().then(function(){return si}),"bank-fill":()=>Promise.resolve().then(function(){return di}),"bell-slash":()=>Promise.resolve().then(function(){return ui}),bell:()=>Promise.resolve().then(function(){return pi}),"bi-funnel":()=>Promise.resolve().then(function(){return gi}),"bookmark-fill":()=>Promise.resolve().then(function(){return wi}),bookmark:()=>Promise.resolve().then(function(){return bi}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return yi}),"box-seam":()=>Promise.resolve().then(function(){return Ci}),building:()=>Promise.resolve().then(function(){return Hi}),bus:()=>Promise.resolve().then(function(){return Pi}),calculator:()=>Promise.resolve().then(function(){return Oi}),"calendar-check":()=>Promise.resolve().then(function(){return $i}),"calendar-heart":()=>Promise.resolve().then(function(){return Bi}),"calendar-x":()=>Promise.resolve().then(function(){return Li}),calendar:()=>Promise.resolve().then(function(){return Ei}),camera:()=>Promise.resolve().then(function(){return Ri}),car:()=>Promise.resolve().then(function(){return Di}),"chat-dots":()=>Promise.resolve().then(function(){return Ui}),"chat-left-text":()=>Promise.resolve().then(function(){return Wi}),chat:()=>Promise.resolve().then(function(){return Ki}),"check-circle-fill":()=>Promise.resolve().then(function(){return Ji}),"check-circle":()=>Promise.resolve().then(function(){return Gi}),check:()=>Promise.resolve().then(function(){return el}),"chevron-down":()=>Promise.resolve().then(function(){return nl}),"chevron-left":()=>Promise.resolve().then(function(){return il}),"chevron-right":()=>Promise.resolve().then(function(){return rl}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return sl}),"chevron-up":()=>Promise.resolve().then(function(){return dl}),clock:()=>Promise.resolve().then(function(){return ul}),"cloud-check":()=>Promise.resolve().then(function(){return pl}),"cloud-download":()=>Promise.resolve().then(function(){return gl}),"cloud-upload":()=>Promise.resolve().then(function(){return wl}),cloud:()=>Promise.resolve().then(function(){return bl}),"code-square":()=>Promise.resolve().then(function(){return yl}),"coins-hand":()=>Promise.resolve().then(function(){return Cl}),compass:()=>Promise.resolve().then(function(){return Hl}),copy:()=>Promise.resolve().then(function(){return Pl}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return Ol}),cross:()=>Promise.resolve().then(function(){return $l}),"cursor-fill":()=>Promise.resolve().then(function(){return Bl}),cursor:()=>Promise.resolve().then(function(){return Ll}),"dash-circle":()=>Promise.resolve().then(function(){return El}),"dash-square":()=>Promise.resolve().then(function(){return Rl}),dash:()=>Promise.resolve().then(function(){return Dl}),database:()=>Promise.resolve().then(function(){return Ul}),dataflow:()=>Promise.resolve().then(function(){return Wl}),download:()=>Promise.resolve().then(function(){return Kl}),edit:()=>Promise.resolve().then(function(){return Jl}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return Gl}),"exclamation-circle":()=>Promise.resolve().then(function(){return er}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return nr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return ir}),exclamation:()=>Promise.resolve().then(function(){return rr}),"eye-fill":()=>Promise.resolve().then(function(){return sr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return dr}),"eye-slash":()=>Promise.resolve().then(function(){return ur}),eye:()=>Promise.resolve().then(function(){return pr}),"face-smile-fill":()=>Promise.resolve().then(function(){return gr}),"face-smile":()=>Promise.resolve().then(function(){return wr}),facebook:()=>Promise.resolve().then(function(){return br}),"file-earmark-text":()=>Promise.resolve().then(function(){return yr}),"file-pdf":()=>Promise.resolve().then(function(){return Cr}),"file-plus":()=>Promise.resolve().then(function(){return Hr}),"file-text":()=>Promise.resolve().then(function(){return Pr}),file:()=>Promise.resolve().then(function(){return Or}),files:()=>Promise.resolve().then(function(){return $r}),fingerprint:()=>Promise.resolve().then(function(){return Br}),flash:()=>Promise.resolve().then(function(){return Lr}),"folder-check":()=>Promise.resolve().then(function(){return Er}),"folder-minus":()=>Promise.resolve().then(function(){return Rr}),"folder-plus":()=>Promise.resolve().then(function(){return Dr}),folder:()=>Promise.resolve().then(function(){return Ur}),gear:()=>Promise.resolve().then(function(){return Wr}),"geo-alt":()=>Promise.resolve().then(function(){return Kr}),"geo-fill":()=>Promise.resolve().then(function(){return Jr}),geo:()=>Promise.resolve().then(function(){return Gr}),"globe-alt":()=>Promise.resolve().then(function(){return ea}),globe:()=>Promise.resolve().then(function(){return na}),google:()=>Promise.resolve().then(function(){return ia}),"grid-alt":()=>Promise.resolve().then(function(){return ra}),"grid-fill":()=>Promise.resolve().then(function(){return sa}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return da}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return ua}),"hard-drive":()=>Promise.resolve().then(function(){return pa}),heart:()=>Promise.resolve().then(function(){return ga}),"house-door":()=>Promise.resolve().then(function(){return wa}),house:()=>Promise.resolve().then(function(){return ba}),image:()=>Promise.resolve().then(function(){return ya}),"in-box":()=>Promise.resolve().then(function(){return Ca}),"info-circle-fill":()=>Promise.resolve().then(function(){return Ha}),"info-circle":()=>Promise.resolve().then(function(){return Pa}),instagram:()=>Promise.resolve().then(function(){return Oa}),key:()=>Promise.resolve().then(function(){return $a}),"laptop-gear":()=>Promise.resolve().then(function(){return Ba}),laptop:()=>Promise.resolve().then(function(){return La}),layers:()=>Promise.resolve().then(function(){return Ea}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return Ra}),"layout-text-window":()=>Promise.resolve().then(function(){return Da}),layout:()=>Promise.resolve().then(function(){return Ua}),"life-buoy":()=>Promise.resolve().then(function(){return Wa}),lightbulb:()=>Promise.resolve().then(function(){return Ka}),link:()=>Promise.resolve().then(function(){return Ja}),linkedin:()=>Promise.resolve().then(function(){return Ga}),list:()=>Promise.resolve().then(function(){return es}),"lock-fill":()=>Promise.resolve().then(function(){return ns}),lock:()=>Promise.resolve().then(function(){return is}),login:()=>Promise.resolve().then(function(){return rs}),logout:()=>Promise.resolve().then(function(){return ss}),luggage:()=>Promise.resolve().then(function(){return ds}),"mail-open":()=>Promise.resolve().then(function(){return us}),mail:()=>Promise.resolve().then(function(){return ps}),map:()=>Promise.resolve().then(function(){return gs}),meetup:()=>Promise.resolve().then(function(){return ws}),menu:()=>Promise.resolve().then(function(){return bs}),microphone:()=>Promise.resolve().then(function(){return ys}),monitor:()=>Promise.resolve().then(function(){return Cs}),moon:()=>Promise.resolve().then(function(){return Hs}),move:()=>Promise.resolve().then(function(){return Ps}),paperclip:()=>Promise.resolve().then(function(){return Os}),passcode:()=>Promise.resolve().then(function(){return $s}),passport:()=>Promise.resolve().then(function(){return Bs}),pause:()=>Promise.resolve().then(function(){return Ls}),pencil:()=>Promise.resolve().then(function(){return Es}),"pending-circle":()=>Promise.resolve().then(function(){return Rs}),"person-dash":()=>Promise.resolve().then(function(){return Ds}),"person-plus":()=>Promise.resolve().then(function(){return Us}),"person-x":()=>Promise.resolve().then(function(){return Ws}),person:()=>Promise.resolve().then(function(){return Ks}),phone:()=>Promise.resolve().then(function(){return Js}),"pin-map-fill":()=>Promise.resolve().then(function(){return Gs}),pin:()=>Promise.resolve().then(function(){return ec}),placeholder:()=>Promise.resolve().then(function(){return nc}),plane:()=>Promise.resolve().then(function(){return ic}),play:()=>Promise.resolve().then(function(){return rc}),"plus-circle":()=>Promise.resolve().then(function(){return sc}),"plus-square":()=>Promise.resolve().then(function(){return dc}),plus:()=>Promise.resolve().then(function(){return uc}),printer:()=>Promise.resolve().then(function(){return pc}),"question-circle":()=>Promise.resolve().then(function(){return gc}),rocket:()=>Promise.resolve().then(function(){return wc}),save:()=>Promise.resolve().then(function(){return bc}),search:()=>Promise.resolve().then(function(){return yc}),send:()=>Promise.resolve().then(function(){return Cc}),"sg-crest":()=>Promise.resolve().then(function(){return Hc}),share:()=>Promise.resolve().then(function(){return Pc}),"shield-tick":()=>Promise.resolve().then(function(){return Oc}),"sidebar-collapse":()=>Promise.resolve().then(function(){return $c}),"sidebar-expand":()=>Promise.resolve().then(function(){return Bc}),"slash-circle":()=>Promise.resolve().then(function(){return Lc}),"slash-divider":()=>Promise.resolve().then(function(){return Ec}),sliders:()=>Promise.resolve().then(function(){return Rc}),"sort-ascending":()=>Promise.resolve().then(function(){return Dc}),"sort-descending":()=>Promise.resolve().then(function(){return Uc}),speedometer:()=>Promise.resolve().then(function(){return Wc}),"star-ai":()=>Promise.resolve().then(function(){return Kc}),"star-fill":()=>Promise.resolve().then(function(){return Jc}),star:()=>Promise.resolve().then(function(){return Gc}),stoplights:()=>Promise.resolve().then(function(){return ed}),sun:()=>Promise.resolve().then(function(){return nd}),"switch-horizontal":()=>Promise.resolve().then(function(){return id}),"switch-vertical":()=>Promise.resolve().then(function(){return rd}),tablet:()=>Promise.resolve().then(function(){return sd}),telegram:()=>Promise.resolve().then(function(){return dd}),telephone:()=>Promise.resolve().then(function(){return ud}),"three-dots-vertical":()=>Promise.resolve().then(function(){return pd}),"three-dots":()=>Promise.resolve().then(function(){return gd}),ticket:()=>Promise.resolve().then(function(){return wd}),"toggle-off":()=>Promise.resolve().then(function(){return bd}),"toggle-on":()=>Promise.resolve().then(function(){return yd}),train:()=>Promise.resolve().then(function(){return Cd}),translate:()=>Promise.resolve().then(function(){return Hd}),trash:()=>Promise.resolve().then(function(){return Pd}),"trend-down":()=>Promise.resolve().then(function(){return Od}),"trend-up":()=>Promise.resolve().then(function(){return $d}),truck:()=>Promise.resolve().then(function(){return Bd}),"twitter-x":()=>Promise.resolve().then(function(){return Ld}),unlock:()=>Promise.resolve().then(function(){return Ed}),upload:()=>Promise.resolve().then(function(){return Rd}),"user-check":()=>Promise.resolve().then(function(){return Dd}),"user-circle":()=>Promise.resolve().then(function(){return Ud}),"user-pause":()=>Promise.resolve().then(function(){return Wd}),"user-square":()=>Promise.resolve().then(function(){return Kd}),users:()=>Promise.resolve().then(function(){return Jd}),"video-recorder":()=>Promise.resolve().then(function(){return Gd}),"volume-max":()=>Promise.resolve().then(function(){return eh}),"volume-x":()=>Promise.resolve().then(function(){return nh}),"window-dash":()=>Promise.resolve().then(function(){return ih}),"window-desktop":()=>Promise.resolve().then(function(){return rh}),"window-dock":()=>Promise.resolve().then(function(){return sh}),"window-fullscreen":()=>Promise.resolve().then(function(){return dh}),"window-plus":()=>Promise.resolve().then(function(){return uh}),"window-sidebar":()=>Promise.resolve().then(function(){return ph}),"window-split":()=>Promise.resolve().then(function(){return gh}),"window-stack":()=>Promise.resolve().then(function(){return wh}),"window-x":()=>Promise.resolve().then(function(){return bh}),window:()=>Promise.resolve().then(function(){return yh}),"xcircle-fill":()=>Promise.resolve().then(function(){return Ch}),xcircle:()=>Promise.resolve().then(function(){return Hh}),youtube:()=>Promise.resolve().then(function(){return Ph}),"zoom-in":()=>Promise.resolve().then(function(){return Oh}),"zoom-out":()=>Promise.resolve().then(function(){return $h})};var vt=v`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const pt=new Map;class ft extends qe{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(pt.has(e))return void(this._icon=pt.get(e));const t=ut[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const n=await t();pt.set(e,n.default),this._icon=n.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:ce}}ft.styles=[...qe.styles,vt],e([Se({type:String,reflect:!0})],ft.prototype,"name",void 0),e([Se({type:String,reflect:!0})],ft.prototype,"size",void 0),e([Se({type:String})],ft.prototype,"ariaLabel",void 0),e([Be()],ft.prototype,"_icon",void 0);var gt=v`:host{--sit-spinner-bg:var(--sit-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sit-spinner-bg:var(--sit-neutral-surface-default)}:host([tone=neutral]){--sit-spinner-bg:var(--sit-surface-inverse)}:host([tone=inverse]){--sit-spinner-bg:var(--sit-surface-default)}:host([tone=fixed-light]){--sit-spinner-bg:var(--sit-surface-fixed-light)}:host([tone=fixed-dark]){--sit-spinner-bg:var(--sit-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sit-gap-2-xs)}.spinner-wrapper.spinner-wrapper--horizontal{flex-direction:row}.spinner-wrapper__spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sit-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sit-spinner-bg);color:var(--sit-spinner-color);display:inline-flex;height:var(--sit-dimension-32);width:var(--sit-dimension-32)}.spinner-wrapper__spinner--xs{--border-thickness:2px;height:var(--sit-dimension-16);width:var(--sit-dimension-16)}.spinner-wrapper__spinner--sm{--border-thickness:3px;height:var(--sit-dimension-24);width:var(--sit-dimension-24)}.spinner-wrapper__spinner--lg{--border-thickness:6px;height:var(--sit-dimension-48);width:var(--sit-dimension-48)}.spinner-wrapper__spinner--xl{--border-thickness:8px;height:var(--sit-dimension-64);width:var(--sit-dimension-64)}.spinner-wrapper__label{color:var(--sit-neutral-color-default);font-size:var(--sit-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner-wrapper__spinner{animation-duration:1.5s}}
...
/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,mt=v`.text-primary{color:var(--sit-primary-rgb)!important}.text-secondary{color:var(--sit-secondary-rgb)!important}.text-success{color:var(--sit-success-rgb)!important}.text-info{color:var(--sit-info-rgb)!important}.text-warning{color:var(--sit-warning-rgb)!important}.text-danger{color:var(--sit-danger-rgb)!important}.text-light{color:var(--sit-light-rgb)!important}.text-dark{color:var(--sit-dark-rgb)!important}.text-muted{color:var(--sit-secondary-color)!important}`;class wt extends qe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return st`
      <div
        class="spinner-wrapper ${Ie({"spinner-wrapper--horizontal":"horizontal"===this.orientation})}"
      >
        <div
          class="spinner-wrapper__spinner ${Ie({[`spinner-wrapper__spinner--${this.size}`]:this.size})}"
          role="status"
        >
          ${this.label?ce:st`<span class="sr-only">Loading...</span>`}
        </div>
        ${this.label?st`<span class="spinner-wrapper__label">${this.label}</span>`:ce}
      </div>
    `}}wt.styles=[...qe.styles,mt,gt],e([Se({type:String,reflect:!0})],wt.prototype,"variant",void 0),e([Se({type:String,reflect:!0})],wt.prototype,"tone",void 0),e([Se({type:String,reflect:!0})],wt.prototype,"size",void 0),e([Se({reflect:!0,type:String})],wt.prototype,"label",void 0),e([Se({type:String,reflect:!0})],wt.prototype,"orientation",void 0);var _t=v`:host{display:inline-block}.btn.btn-icon{display:flex;height:var(--sit-dimension-48,56px);min-width:unset;padding:0;width:var(--sit-dimension-48,56px)}.btn.btn-icon.btn-lg{height:var(--sit-dimension-56);min-width:unset;padding:0;width:var(--sit-dimension-56)}.btn.btn-icon.btn-sm{height:var(--sit-dimension-40);min-width:unset;padding:0;width:var(--sit-dimension-40)}.btn.btn-icon.btn-xs{height:var(--sit-dimension-32);min-width:unset;padding:0;width:var(--sit-dimension-32)}`;class bt extends ht{_assignIconSize(e){return"xs"===e?"sm":"sm"===e?"md":"md"===e?"lg":"lg"===e?"xl":void 0}render(){const e=this.href,t=e?rt`a`:rt`button`;return st`
          <${t}
    ...
    `}_expandClass(){switch(this.expand){case"always":return"navbar-expand";case"never":break;default:return`navbar-expand-${this.expand}`}}}Ht.styles=[...qe.styles,Zt],Ht.dependencies={"sit-icon-button":bt},e([r({context:xt}),Be()],Ht.prototype,"_breakpointReached",void 0),e([r({context:yt}),Be()],Ht.prototype,"expanded",void 0),e([Be()],Ht.prototype,"expanding",void 0),e([Ae("nav")],Ht.prototype,"nav",void 0),e([Ae(".navbar")],Ht.prototype,"navbar",void 0),e([Ae(".navbar-toggler")],Ht.prototype,"header",void 0),e([Ae(".navbar-body")],Ht.prototype,"body",void 0),e([Ae(".navbar-nav-scroll")],Ht.prototype,"navScroll",void 0),e([Ae("slot[name='non-collapsible']")],Ht.prototype,"nonCollapsibleSlot",void 0),e([Se({type:Boolean})],Ht.prototype,"hasNonCollapsibleSlot",void 0),e([Se({type:String})],Ht.prototype,"brandHref",void 0),e([Se({type:String})],Ht.prototype,"expand",void 0),e([Se({type:Boolean,reflect:!0})],Ht.prototype,"fluid",void 0),e([Be()],Ht.prototype,"breakpointReached",void 0),e([Ee()],Ht.prototype,"defaultNodes",void 0),e([Ee({slot:"end"})],Ht.prototype,"endNodes",void 0),e([nt("expanding",{waitUntilFirstUpdate:!0})],Ht.prototype,"handleOpenChange",null),Qe("mainnav.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:200,easing:"ease-in-out"}}),Qe("mainnav.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:200,easing:"ease-in-out"}});const Vt=Math.min,Pt=Math.max,zt=Math.round,Ot=Math.floor,kt=e=>({x:e,y:e}),$t={left:"right",right:"left",bottom:"top",top:"bottom"},St={start:"end",end:"start"};function Bt(e,t,n){return Pt(e,Vt(t,n))}function jt(e,t){return"function"==typeof e?e(t):e}function Lt(e){return e.split("-")[0]}function At(e){return e.split("-")[1]}function Et(e){return"x"===e?"y":"x"}function Tt(e){return"y"===e?"height":"width"}const Rt=new Set(["top","bottom"]);function Nt(e){return Rt.has(Lt(e))?"y":"x"}function Dt(e){return Et(Nt(e))}function It(e,t,n){void 0===n&&(n=!1);const o=At(e),i=Dt(e),l=Tt(i);let r="x"===i?o===(n?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[l]>t.floating[l]&&(r=Jt(r)),[r,Jt(r)]}function Ut(e){return e.replace(/start|end/g,e=>St[e])}const qt=["left","right"],Wt=["right","left"],Ft=["top","bottom"],Kt=["bottom","top"];function Xt(e,t,n,o){const i=At(e);let l=function(e,t,n){switch(e){case"top":case"bottom":return n?t?Wt:qt:t?qt:Wt;case"left":case"right":return t?Ft:Kt;default:return[]}}(Lt(e),"start"===n,o);return i&&(l=l.map(e=>e+"-"+i),t&&(l=l.concat(l.map(Ut)))),l}function Jt(e){return e.replace(/left|right|bottom|top/g,e=>$t[e])}function Yt(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function Gt(e){const{x:t,y:n,width:o,height:i}=e;return{width:o,height:i,top:n,left:t,right:t+o,bottom:n+i,x:t,y:n}}function Qt(e,t,n){let{reference:o,floating:i}=e;const l=Nt(t),r=Dt(t),a=Tt(r),s=Lt(t),c="y"===l,d=o.x+o.width/2-i.width/2,h=o.y+o.height/2-i.height/2,u=o[a]/2-i[a]/2;let v;switch(s){case"top":v={x:d,y:o.y-i.height};break;case"bottom":v={x:d,y:o.y+o.height};break;case"right":v={x:o.x+o.width,y:h};break;case"left":v={x:o.x-i.width,y:h};break;default:v={x:o.x,y:o.y}}switch(At(t)){case"start":v[r]-=u*(n&&c?-1:1);break;case"end":v[r]+=u*(n&&c?-1:1)}return v}async function en(e,t){var n;void 0===t&&(t={});const{x:o,y:i,platform:l,rects:r,elements:a,strategy:s}=e,{boundary:c="clippingAncestors",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:u=!1,padding:v=0}=jt(t,e),p=Yt(v),f=a[u?"floating"===h?"reference":"floating":h],g=Gt(await l.getClippingRect({element:null==(n=await(null==l.isElement?void 0:l.isElement(f)))||n?f:f.contextElement||await(null==l.getDocumentElement?void 0:l.getDocumentElement(a.floating)),boundary:c,rootBoundary:d,strategy:s})),m="floating"===h?{x:o,y:i,width:r.floating.width,height:r.floating.height}:r.reference,w=await(null==l.getOffsetParent?void 0:l.getOffsetParent(a.floating)),_=await(null==l.isElement?void 0:l.isElement(w))&&await(null==l.getScale?void 0:l.getScale(w))||{x:1,y:1},b=Gt(l.convertOffsetParentRelativeRectToViewportRelativeRect?await l.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:m,offsetParent:w,strategy:s}):m);return{top:(g.top-b.top+p.top)/_.y,bottom:(b.bottom-g.bottom+p.bottom)/_.y,left:(g.left-b.left+p.left)/_.x,right:(b.right-g.right+p.right)/_.x}}const tn=new Set(["left","top"]);function nn(){return"undefined"!=typeof window}function on(e){return an(e)?(e.nodeName||"").toLowerCase():"#document"}function ln(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function rn(e){var t;return null==(t=(an(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function an(e){return!!nn()&&(e instanceof Node||e instanceof ln(e).Node)}function sn(e){return!!nn()&&(e instanceof Element||e instanceof ln(e).Element)}function cn(e){return!!nn()&&(e instanceof HTMLElement||e instanceof ln(e).HTMLElement)}function dn(e){return!(!nn()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof ln(e).ShadowRoot)}const hn=new Set(["inline","contents"]);function un(e){const{overflow:t,overflowX:n,overflowY:o,display:i}=Cn(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+n)&&!hn.has(i)}const vn=new Set(["table","td","th"]);function pn(e){return vn.has(on(e))}const fn=[":popover-open",":modal"];function gn(e){return fn.some(t=>{try{return e.matches(t)}catch(e){return!1}})}const mn=["transform","translate","scale","rotate","perspective"],wn=["transform","translate","scale","rotate","perspective","filter"],_n=["paint","layout","strict","content"];function bn(e){const t=xn(),n=sn(e)?Cn(e):e;return mn.some(e=>!!n[e]&&"none"!==n[e])||!!n.containerType&&"normal"!==n.containerType||!t&&!!n.backdropFilter&&"none"!==n.backdropFilter||!t&&!!n.filter&&"none"!==n.filter||wn.some(e=>(n.willChange||"").includes(e))||_n.some(e=>(n.contain||"").includes(e))}function xn(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}const yn=new Set(["html","body","#document"]);function Zn(e){return yn.has(on(e))}function Cn(e){return ln(e).getComputedStyle(e)}function Mn(e){return sn(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Hn(e){if("html"===on(e))return e;const t=e.assignedSlot||e.parentNode||dn(e)&&e.host||rn(e);return dn(t)?t.host:t}function Vn(e){const t=Hn(e);return Zn(t)?e.ownerDocument?e.ownerDocument.body:e.body:cn(t)&&un(t)?t:Vn(t)}function Pn(e,t,n){var o;void 0===t&&(t=[]),void 0===n&&(n=!0);const i=Vn(e),l=i===(null==(o=e.ownerDocument)?void 0:o.body),r=ln(i);if(l){const e=zn(r);return t.concat(r,r.visualViewport||[],un(i)?i:[],e&&n?Pn(e):[])}return t.concat(i,Pn(i,[],n))}function zn(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function On(e){const t=Cn(e);let n=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const i=cn(e),l=i?e.offsetWidth:n,r=i?e.offsetHeight:o,a=zt(n)!==l||zt(o)!==r;return a&&(n=l,o=r),{width:n,height:o,$:a}}function kn(e){return sn(e)?e:e.contextElement}function $n(e){const t=kn(e);if(!cn(t))return kt(1);const n=t.getBoundingClientRect(),{width:o,height:i,$:l}=On(t);let r=(l?zt(n.width):n.width)/o,a=(l?zt(n.height):n.height)/i;return r&&Number.isFinite(r)||(r=1),a&&Number.isFinite(a)||(a=1),{x:r,y:a}}const Sn=kt(0);function Bn(e){const t=ln(e);return xn()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Sn}function jn(e,t,n,o){void 0===t&&(t=!1),void 0===n&&(n=!1);const i=e.getBoundingClientRect(),l=kn(e);let r=kt(1);t&&(o?sn(o)&&(r=$n(o)):r=$n(e));const a=function(e,t,n){return void 0===t&&(t=!1),!(!n||t&&n!==ln(e))&&t}(l,n,o)?Bn(l):kt(0);let s=(i.left+a.x)/r.x,c=(i.top+a.y)/r.y,d=i.width/r.x,h=i.height/r.y;if(l){const e=ln(l),t=o&&sn(o)?ln(o):o;let n=e,i=zn(n);for(;i&&o&&t!==n;){const e=$n(i),t=i.getBoundingClientRect(),o=Cn(i),l=t.left+(i.clientLeft+parseFloat(o.paddingLeft))*e.x,r=t.top+(i.clientTop+parseFloat(o.paddingTop))*e.y;s*=e.x,c*=e.y,d*=e.x,h*=e.y,s+=l,c+=r,n=ln(i),i=zn(n)}}return Gt({width:d,height:h,x:s,y:c})}function Ln(e,t){const n=Mn(e).scrollLeft;return t?t.left+n:jn(rn(e)).left+n}function An(e,t){const n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-Ln(e,n),y:n.top+t.scrollTop}}const En=new Set(["absolute","fixed"]);function Tn(e,t,n){let o;if("viewport"===t)o=function(e,t){const n=ln(e),o=rn(e),i=n.visualViewport;let l=o.clientWidth,r=o.clientHeight,a=0,s=0;if(i){l=i.width,r=i.height;const e=xn();(!e||e&&"fixed"===t)&&(a=i.offsetLeft,s=i.offsetTop)}const c=Ln(o);if(c<=0){const e=o.ownerDocument,t=e.body,n=getComputedStyle(t),i="CSS1Compat"===e.compatMode&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,r=Math.abs(o.clientWidth-t.clientWidth-i);r<=25&&(l-=r)}else c<=25&&(l+=c);return{width:l,height:r,x:a,y:s}}(e,n);else if("document"===t)o=function(e){const t=rn(e),n=Mn(e),o=e.ownerDocument.body,i=Pt(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),l=Pt(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let r=-n.scrollLeft+Ln(e);const a=-n.scrollTop;return"rtl"===Cn(o).direction&&(r+=Pt(t.clientWidth,o.clientWidth)-i),{width:i,height:l,x:r,y:a}}(rn(e));else if(sn(t))o=function(e,t){const n=jn(e,!0,"fixed"===t),o=n.top+e.clientTop,i=n.left+e.clientLeft,l=cn(e)?$n(e):kt(1);return{width:e.clientWidth*l.x,height:e.clientHeight*l.y,x:i*l.x,y:o*l.y}}(t,n);else{const n=Bn(e);o={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return Gt(o)}function Rn(e,t){const n=Hn(e);return!(n===t||!sn(n)||Zn(n))&&("fixed"===Cn(n).position||Rn(n,t))}function Nn(e,t,n){const o=cn(t),i=rn(t),l="fixed"===n,r=jn(e,!0,l,t);let a={scrollLeft:0,scrollTop:0};const s=kt(0);function c(){s.x=Ln(i)}if(o||!o&&!l)if(("body"!==on(t)||un(i))&&(a=Mn(t)),o){const e=jn(t,!0,l,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else i&&c();l&&!o&&i&&c();const d=!i||o||l?kt(0):An(i,a);return{x:r.left+a.scrollLeft-s.x-d.x,y:r.top+a.scrollTop-s.y-d.y,width:r.width,height:r.height}}function Dn(e){return"static"===Cn(e).position}function In(e,t){if(!cn(e)||"fixed"===Cn(e).position)return null;if(t)return t(e);let n=e.offsetParent;return rn(e)===n&&(n=n.ownerDocument.body),n}function Un(e,t){const n=ln(e);if(gn(e))return n;if(!cn(e)){let t=Hn(e);for(;t&&!Zn(t);){if(sn(t)&&!Dn(t))return t;t=Hn(t)}return n}let o=In(e,t);for(;o&&pn(o)&&Dn(o);)o=In(o,t);return o&&Zn(o)&&Dn(o)&&!bn(o)?n:o||function(e){let t=Hn(e);for(;cn(t)&&!Zn(t);){if(bn(t))return t;if(gn(t))return null;t=Hn(t)}return null}(e)||n}const qn={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:n,offsetParent:o,strategy:i}=e;const l="fixed"===i,r=rn(o),a=!!t&&gn(t.floating);if(o===r||a&&l)return n;let s={scrollLeft:0,scrollTop:0},c=kt(1);const d=kt(0),h=cn(o);if((h||!h&&!l)&&(("body"!==on(o)||un(r))&&(s=Mn(o)),cn(o))){const e=jn(o);c=$n(o),d.x=e.x+o.clientLeft,d.y=e.y+o.clientTop}const u=!r||h||l?kt(0):An(r,s);return{width:n.width*c.x,height:n.height*c.y,x:n.x*c.x-s.scrollLeft*c.x+d.x+u.x,y:n.y*c.y-s.scrollTop*c.y+d.y+u.y}},getDocumentElement:rn,getClippingRect:function(e){let{element:t,boundary:n,rootBoundary:o,strategy:i}=e;const l=[..."clippingAncestors"===n?gn(t)?[]:function(e,t){const n=t.get(e);if(n)return n;let o=Pn(e,[],!1).filter(e=>sn(e)&&"body"!==on(e)),i=null;const l="fixed"===Cn(e).position;let r=l?Hn(e):e;for(;sn(r)&&!Zn(r);){const t=Cn(r),n=bn(r);n||"fixed"!==t.position||(i=null),(l?!n&&!i:!n&&"static"===t.position&&i&&En.has(i.position)||un(r)&&!n&&Rn(e,r))?o=o.filter(e=>e!==r):i=t,r=Hn(r)}return t.set(e,o),o}(t,this._c):[].concat(n),o],r=l[0],a=l.reduce((e,n)=>{const o=Tn(t,n,i);return e.top=Pt(o.top,e.top),e.right=Vt(o.right,e.right),e.bottom=Vt(o.bottom,e.bottom),e.left=Pt(o.left,e.left),e},Tn(t,r,i));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}},getOffsetParent:Un,getElementRects:async function(e){const t=this.getOffsetParent||Un,n=this.getDimensions,o=await n(e.floating);return{reference:Nn(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:n}=On(e);return{width:t,height:n}},getScale:$n,isElement:sn,isRTL:function(e){return"rtl"===Cn(e).direction}};function Wn(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Fn(e,t,n,o){void 0===o&&(o={});const{ancestorScroll:i=!0,ancestorResize:l=!0,elementResize:r="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:s=!1}=o,c=kn(e),d=i||l?[...c?Pn(c):[],...Pn(t)]:[];d.forEach(e=>{i&&e.addEventListener("scroll",n,{passive:!0}),l&&e.addEventListener("resize",n)});const h=c&&a?function(e,t){let n,o=null;const i=rn(e);function l(){var e;clearTimeout(n),null==(e=o)||e.disconnect(),o=null}return function r(a,s){void 0===a&&(a=!1),void 0===s&&(s=1),l();const c=e.getBoundingClientRect(),{left:d,top:h,width:u,height:v}=c;if(a||t(),!u||!v)return;const p={rootMargin:-Ot(h)+"px "+-Ot(i.clientWidth-(d+u))+"px "+-Ot(i.clientHeight-(h+v))+"px "+-Ot(d)+"px",threshold:Pt(0,Vt(1,s))||1};let f=!0;function g(t){const o=t[0].intersectionRatio;if(o!==s){if(!f)return r();o?r(!1,o):n=setTimeout(()=>{r(!1,1e-7)},1e3)}1!==o||Wn(c,e.getBoundingClientRect())||r(),f=!1}try{o=new IntersectionObserver(g,{...p,root:i.ownerDocument})}catch(e){o=new IntersectionObserver(g,p)}o.observe(e)}(!0),l}(c,n):null;let u,v=-1,p=null;r&&(p=new ResizeObserver(e=>{let[o]=e;o&&o.target===c&&p&&(p.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=p)||e.observe(t)})),n()}),c&&!s&&p.observe(c),p.observe(t));let f=s?jn(e):null;return s&&function t(){const o=jn(e);f&&!Wn(f,o)&&n();f=o,u=requestAnimationFrame(t)}(),n(),()=>{var e;d.forEach(e=>{i&&e.removeEventListener("scroll",n),l&&e.removeEventListener("resize",n)}),null==h||h(),null==(e=p)||e.disconnect(),p=null,s&&cancelAnimationFrame(u)}}const Kn=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var n,o;const{x:i,y:l,placement:r,middlewareData:a}=t,s=await async function(e,t){const{placement:n,platform:o,elements:i}=e,l=await(null==o.isRTL?void 0:o.isRTL(i.floating)),r=Lt(n),a=At(n),s="y"===Nt(n),c=tn.has(r)?-1:1,d=l&&s?-1:1,h=jt(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:p}="number"==typeof h?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:h.mainAxis||0,crossAxis:h.crossAxis||0,alignmentAxis:h.alignmentAxis};return a&&"number"==typeof p&&(v="end"===a?-1*p:p),s?{x:v*d,y:u*c}:{x:u*c,y:v*d}}(t,e);return r===(null==(n=a.offset)?void 0:n.placement)&&null!=(o=a.arrow)&&o.alignmentOffset?{}:{x:i+s.x,y:l+s.y,data:{...s,placement:r}}}}},Xn=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:n,y:o,placement:i}=t,{mainAxis:l=!0,crossAxis:r=!1,limiter:a={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...s}=jt(e,t),c={x:n,y:o},d=await en(t,s),h=Nt(Lt(i)),u=Et(h);let v=c[u],p=c[h];if(l){const e="y"===u?"bottom":"right";v=Bt(v+d["y"===u?"top":"left"],v,v-d[e])}if(r){const e="y"===h?"bottom":"right";p=Bt(p+d["y"===h?"top":"left"],p,p-d[e])}const f=a.fn({...t,[u]:v,[h]:p});return{...f,data:{x:f.x-n,y:f.y-o,enabled:{[u]:l,[h]:r}}}}}},Jn=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var n,o;const{placement:i,middlewareData:l,rects:r,initialPlacement:a,platform:s,elements:c}=t,{mainAxis:d=!0,crossAxis:h=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:p="none",flipAlignment:f=!0,...g}=jt(e,t);if(null!=(n=l.arrow)&&n.alignmentOffset)return{};const m=Lt(i),w=Nt(a),_=Lt(a)===a,b=await(null==s.isRTL?void 0:s.isRTL(c.floating)),x=u||(_||!f?[Jt(a)]:function(e){const t=Jt(e);return[Ut(e),t,Ut(t)]}(a)),y="none"!==p;!u&&y&&x.push(...Xt(a,f,p,b));const Z=[a,...x],C=await en(t,g),M=[];let H=(null==(o=l.flip)?void 0:o.overflows)||[];if(d&&M.push(C[m]),h){const e=It(i,r,b);M.push(C[e[0]],C[e[1]])}if(H=[...H,{placement:i,overflows:M}],!M.every(e=>e<=0)){var V,P;const e=((null==(V=l.flip)?void 0:V.index)||0)+1,t=Z[e];if(t){if(!("alignment"===h&&w!==Nt(t))||H.every(e=>Nt(e.placement)!==w||e.overflows[0]>0))return{data:{index:e,overflows:H},reset:{placement:t}}}let n=null==(P=H.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:P.placement;if(!n)switch(v){case"bestFit":{var z;const e=null==(z=H.filter(e=>{if(y){const t=Nt(e.placement);return t===w||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:z[0];e&&(n=e);break}case"initialPlacement":n=a}if(i!==n)return{reset:{placement:n}}}return{}}}},Yn=(e,t,n)=>{const o=new Map,i={platform:qn,...n},l={...i.platform,_c:o};return(async(e,t,n)=>{const{placement:o="bottom",strategy:i="absolute",middleware:l=[],platform:r}=n,a=l.filter(Boolean),s=await(null==r.isRTL?void 0:r.isRTL(t));let c=await r.getElementRects({reference:e,floating:t,strategy:i}),{x:d,y:h}=Qt(c,o,s),u=o,v={},p=0;for(let n=0;n<a.length;n++){const{name:l,fn:f}=a[n],{x:g,y:m,data:w,reset:_}=await f({x:d,y:h,initialPlacement:o,placement:u,strategy:i,middlewareData:v,rects:c,platform:r,elements:{reference:e,floating:t}});d=null!=g?g:d,h=null!=m?m:h,v={...v,[l]:{...v[l],...w}},_&&p<=50&&(p++,"object"==typeof _&&(_.placement&&(u=_.placement),_.rects&&(c=!0===_.rects?await r.getElementRects({reference:e,floating:t,strategy:i}):_.rects),({x:d,y:h}=Qt(c,u,s))),n=-1)}return{x:d,y:h,placement:u,strategy:i,middlewareData:v}})(e,t,{...i,platform:l})};var Gn=v`.dropdown{display:flex;height:inherit;position:relative}.dropdown-menu{max-width:var(--sit-dimension-320)}.toggler-container{flex:1;pointer-events:none}.toggler-container ::slotted(*){pointer-events:auto}`,Qn=v`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:var(--sit-elevation-surface-3);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:start;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-start-end-radius:0;border-start-start-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{inset-inline:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,eo=v`:host([expand=always]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}@media (min-width:512px){:host([expand=sm]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:768px){:host([expand=md]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:1024px){:host(:not([expand])) .nav-link,:host([expand=lg]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:1280px){:host([expand=xl]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}@media (min-width:1440px){:host([expand=xxl]) .nav-link{border-bottom:var(--sit-border-width-4) solid transparent;min-height:100%;padding:0 var(--sit-padding-md)}}.nav-link{align-items:center;box-sizing:border-box;cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-xs);line-height:var(--sit-line-height-2-xs,20px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x);text-decoration:none}.nav-link.show,.nav-link:not(.disabled).active{border-color:var(--sit-primary-border-color-default);color:var(--sit-primary-color-default)}.nav-link:not(.disabled):hover{color:var(--sit-primary-color-default)}.nav-link:not(.disabled):focus-visible{color:var(--sit-primary-color-default);outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.nav-link.disabled{cursor:not-allowed;opacity:var(--sit-opacity-40)}.dropdown-items{background-color:var(--sit-surface-default);height:100%;left:100%;overflow-y:auto;padding:var(--sit-padding-md) 0;position:absolute;top:0;width:100%}.dropdown-items a{align-items:center;color:var(--sit-color-default);cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-xs);line-height:var(--sit-line-height-2-xs,20px);margin:auto;max-width:var(--sit-mainnav-max-width,1440px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x);text-decoration:none}.dropdown-items a:hover{color:var(--sit-primary-color-default)}.dropdown-items a:focus-visible{color:var(--sit-primary-color-default);outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus);outline-offset:-5px}slot[name=toggler]::slotted(*){flex:1}sit-dropdown{display:block;height:100%}@media screen and (min-width:1024px){.dropdown-items a,.nav-link{padding:var(--sit-padding-sm) var(--sit-mainnav-padding-x)}}`
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */;window.ShadyDOM?.inUse&&!0===window.ShadyDOM?.noPatch&&window.ShadyDOM.wrap;const to=(e,t)=>{const n=e._$disconnectableChildren;if(void 0===n)return!1;for(const e of n)e._$notifyDirectiveConnectionChanged?.(t,!1),to(e,t);return!0},no=e=>{let t,n;do{if(void 0===(t=e._$parent))break;n=t._$disconnectableChildren,n.delete(e),e=t}while(0===n?.size)},oo=e=>{for(let t;t=e._$parent;e=t){let n=t._$disconnectableChildren;if(void 0===n)t._$disconnectableChildren=n=new Set;else if(n.has(e))break;n.add(e),ro(t)}};
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function io(e){void 0!==this._$disconnectableChildren?(no(this),this._$parent=e,oo(this)):this._$parent=e}function lo(e,t=!1,n=0){const o=this._$committedValue,i=this._$disconnectableChildren;if(void 0!==i&&0!==i.size)if(t)if(Array.isArray(o))for(let e=n;e<o.length;e++)to(o[e],!1),no(o[e]);else null!=o&&(to(o,!1),no(o));else to(this,e)}const ro=e=>{e.type==Re&&(e._$notifyConnectionChanged??=lo,e._$reparentDisconnectables??=io)};class ao extends De{constructor(){super(...arguments),this._$disconnectableChildren=void 0}_$initialize(e,t,n){super._$initialize(e,t,n),oo(this),this.isConnected=e._$isConnected}_$notifyDirectiveConnectionChanged(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(to(this,e),no(this))}setValue(e){if(void 0===this.__part.strings)this.__part._$setValue(e,this);else{if(void 0===this.__attributeIndex)throw new Error("Expected this.__attributeIndex to be a number");const t=[...this.__part._$committedValue];t[this.__attributeIndex]=e,this.__part._$setValue(t,this,0)}}disconnected(){}reconnected(){}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const so=()=>new co;class co{}const ho=new WeakMap;const uo=Ne(class extends ao{render(e){return ce}update(e,[t]){const n=t!==this._ref;return n&&void 0!==this._ref&&this._updateRefValue(void 0),(n||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),ce}_updateRefValue(e){if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let n=ho.get(t);void 0===n&&(n=new WeakMap,ho.set(t,n)),void 0!==n.get(this._ref)&&this._ref.call(this._context,void 0),n.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?ho.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}});class vo extends qe{constructor(){super(...arguments),this.myDropdown=so(),this.dropdownMenuId=tt("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=so(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=Fn(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const n=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},o=t.map(n),i=e.map(e=>{const i=n(e),l=o.indexOf(i);return-1!==l?t[l]:e}).concat(t.filter(t=>!e.some(e=>n(e)===n(t))));return i}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[Kn(8),this.noFlip?void 0:Jn(),Xn()].filter(Boolean);let n=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(n=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const o=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:n}),{x:i,y:l,strategy:r,placement:a}=await Yn(this.myDropdown.value,this.menuRef.value,o);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:r,left:`${i}px`,top:`${l}px`})}}e([Se({type:Boolean,state:!0})],vo.prototype,"noFlip",void 0),e([Se({type:Boolean,reflect:!0,state:!0})],vo.prototype,"menuAlignRight",void 0),e([Se({type:String,reflect:!0,state:!0})],vo.prototype,"drop",void 0),e([Se({type:Object})],vo.prototype,"floatingOpts",void 0),e([Se({type:Boolean,reflect:!0})],vo.prototype,"menuIsOpen",void 0),e([Se({type:Boolean,reflect:!0})],vo.prototype,"disabled",void 0),e([Se({type:Boolean,reflect:!0})],vo.prototype,"readonly",void 0);class po extends vo{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),n=t.find(t=>e.composedPath().includes(t));if(!n)return;const o=t.indexOf(n);this.nextDropdownItemNo=o+1,this.prevDropdownItemNo=o<=0?t.length-1:o-1,n.disabled||(this.emit("sit-select",{detail:{item:n}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const n=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");n&&n.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const n=(e%t.length+t.length)%t.length,o=t[n];this.emit("i-sit-option-focus",{detail:{option:o}}),this.nextDropdownItemNo=(n+1)%t.length,this.prevDropdownItemNo=(n-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===o?"0":"-1"),e===o&&t.focus()})}}po.styles=vo.styles,e([Ae("ul.dropdown-menu")],po.prototype,"menu",void 0),e([Be()],po.prototype,"nextDropdownItemNo",void 0),e([Be()],po.prototype,"prevDropdownItemNo",void 0),e([Se({type:Boolean,reflect:!0})],po.prototype,"hidden",void 0);class fo extends po{constructor(){super(),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.close="default",this.menuRef=uo()}async _handleClick(e){if(this.disabled)return;const t=this._toggler[0];if(!t)return void this.toggleMenu();if(e.composedPath().includes(t))return void this.toggleMenu();if(!this.menuIsOpen)return;const n=this.menuRef.value;n&&e.composedPath().includes(n)||this.hideMenu()}_handleCloseMenu(){const e=this._toggler[0];null==e||e.focus()}async connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._handleCloseMenu)}async disconnectedCallback(){this.removeEventListener("sit-hide",this._handleCloseMenu)}async firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&await this.updateFloatingPosition(),this._handleDisabled()}_handleTogglerSlotChange(e){const t=e.target.assignedElements({flatten:!0})[0];t&&(t.setAttribute("aria-haspopup","menu"),t.setAttribute("aria-expanded",String(this.menuIsOpen)))}_handleMenuIsOpenChange(){const e=this._toggler[0];e&&e.setAttribute("aria-expanded",String(this.menuIsOpen))}_handleDisabled(){const e=this._toggler[0];e&&(this.disabled?e.setAttribute("disabled","true"):e.hasAttribute("disabled")&&e.removeAttribute("disabled"))}render(){return re`
...
`,Co=Object.freeze({__proto__:null,default:Zo}),Mo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ho=Object.freeze({__proto__:null,default:Mo}),Vo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Po=Object.freeze({__proto__:null,default:Vo}),zo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Oo=Object.freeze({__proto__:null,default:zo}),ko=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$o=Object.freeze({__proto__:null,default:ko}),So=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bo=Object.freeze({__proto__:null,default:So}),jo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Lo=Object.freeze({__proto__:null,default:jo}),Ao=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Eo=Object.freeze({__proto__:null,default:Ao}),To=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ro=Object.freeze({__proto__:null,default:To}),No=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Do=Object.freeze({__proto__:null,default:No}),Io=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Uo=Object.freeze({__proto__:null,default:Io}),qo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wo=Object.freeze({__proto__:null,default:qo}),Fo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ko=Object.freeze({__proto__:null,default:Fo}),Xo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jo=Object.freeze({__proto__:null,default:Xo}),Yo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Go=Object.freeze({__proto__:null,default:Yo}),Qo=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ei=Object.freeze({__proto__:null,default:Qo}),ti=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ni=Object.freeze({__proto__:null,default:ti}),oi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ii=Object.freeze({__proto__:null,default:oi}),li=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ri=Object.freeze({__proto__:null,default:li}),ai=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,si=Object.freeze({__proto__:null,default:ai}),ci=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,di=Object.freeze({__proto__:null,default:ci}),hi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ui=Object.freeze({__proto__:null,default:hi}),vi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pi=Object.freeze({__proto__:null,default:vi}),fi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gi=Object.freeze({__proto__:null,default:fi}),mi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wi=Object.freeze({__proto__:null,default:mi}),_i=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bi=Object.freeze({__proto__:null,default:_i}),xi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hi=Object.freeze({__proto__:null,default:Mi}),Vi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Pi=Object.freeze({__proto__:null,default:Vi}),zi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oi=Object.freeze({__proto__:null,default:zi}),ki=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$i=Object.freeze({__proto__:null,default:ki}),Si=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ui=Object.freeze({__proto__:null,default:Ii}),qi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wi=Object.freeze({__proto__:null,default:qi}),Fi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ki=Object.freeze({__proto__:null,default:Fi}),Xi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ji=Object.freeze({__proto__:null,default:Xi}),Yi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gi=Object.freeze({__proto__:null,default:Yi}),Qi=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,el=Object.freeze({__proto__:null,default:Qi}),tl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nl=Object.freeze({__proto__:null,default:tl}),ol=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,il=Object.freeze({__proto__:null,default:ol}),ll=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rl=Object.freeze({__proto__:null,default:ll}),al=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sl=Object.freeze({__proto__:null,default:al}),cl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dl=Object.freeze({__proto__:null,default:cl}),hl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ul=Object.freeze({__proto__:null,default:hl}),vl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pl=Object.freeze({__proto__:null,default:vl}),fl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gl=Object.freeze({__proto__:null,default:fl}),ml=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wl=Object.freeze({__proto__:null,default:ml}),_l=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bl=Object.freeze({__proto__:null,default:_l}),xl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Hl=Object.freeze({__proto__:null,default:Ml}),Vl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Pl=Object.freeze({__proto__:null,default:Vl}),zl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ol=Object.freeze({__proto__:null,default:zl}),kl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$l=Object.freeze({__proto__:null,default:kl}),Sl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ul=Object.freeze({__proto__:null,default:Il}),ql=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wl=Object.freeze({__proto__:null,default:ql}),Fl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kl=Object.freeze({__proto__:null,default:Fl}),Xl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jl=Object.freeze({__proto__:null,default:Xl}),Yl=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gl=Object.freeze({__proto__:null,default:Yl}),Ql=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,er=Object.freeze({__proto__:null,default:Ql}),tr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nr=Object.freeze({__proto__:null,default:tr}),or=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ir=Object.freeze({__proto__:null,default:or}),lr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,rr=Object.freeze({__proto__:null,default:lr}),ar=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sr=Object.freeze({__proto__:null,default:ar}),cr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dr=Object.freeze({__proto__:null,default:cr}),hr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ur=Object.freeze({__proto__:null,default:hr}),vr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pr=Object.freeze({__proto__:null,default:vr}),fr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gr=Object.freeze({__proto__:null,default:fr}),mr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wr=Object.freeze({__proto__:null,default:mr}),_r=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,br=Object.freeze({__proto__:null,default:_r}),xr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hr=Object.freeze({__proto__:null,default:Mr}),Vr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pr=Object.freeze({__proto__:null,default:Vr}),zr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Or=Object.freeze({__proto__:null,default:zr}),kr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$r=Object.freeze({__proto__:null,default:kr}),Sr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ur=Object.freeze({__proto__:null,default:Ir}),qr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wr=Object.freeze({__proto__:null,default:qr}),Fr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kr=Object.freeze({__proto__:null,default:Fr}),Xr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jr=Object.freeze({__proto__:null,default:Xr}),Yr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gr=Object.freeze({__proto__:null,default:Yr}),Qr=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,ea=Object.freeze({__proto__:null,default:Qr}),ta=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,na=Object.freeze({__proto__:null,default:ta}),oa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ia=Object.freeze({__proto__:null,default:oa}),la=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ra=Object.freeze({__proto__:null,default:la}),aa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sa=Object.freeze({__proto__:null,default:aa}),ca=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,da=Object.freeze({__proto__:null,default:ca}),ha=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ua=Object.freeze({__proto__:null,default:ha}),va=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pa=Object.freeze({__proto__:null,default:va}),fa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ga=Object.freeze({__proto__:null,default:fa}),ma=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wa=Object.freeze({__proto__:null,default:ma}),_a=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ba=Object.freeze({__proto__:null,default:_a}),xa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ha=Object.freeze({__proto__:null,default:Ma}),Va=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pa=Object.freeze({__proto__:null,default:Va}),za=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Oa=Object.freeze({__proto__:null,default:za}),ka=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,$a=Object.freeze({__proto__:null,default:ka}),Sa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ua=Object.freeze({__proto__:null,default:Ia}),qa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wa=Object.freeze({__proto__:null,default:qa}),Fa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ka=Object.freeze({__proto__:null,default:Fa}),Xa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ja=Object.freeze({__proto__:null,default:Xa}),Ya=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ga=Object.freeze({__proto__:null,default:Ya}),Qa=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,es=Object.freeze({__proto__:null,default:Qa}),ts=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ns=Object.freeze({__proto__:null,default:ts}),os=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,is=Object.freeze({__proto__:null,default:os}),ls=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rs=Object.freeze({__proto__:null,default:ls}),as=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ss=Object.freeze({__proto__:null,default:as}),cs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ds=Object.freeze({__proto__:null,default:cs}),hs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,us=Object.freeze({__proto__:null,default:hs}),vs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ps=Object.freeze({__proto__:null,default:vs}),fs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gs=Object.freeze({__proto__:null,default:fs}),ms=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ws=Object.freeze({__proto__:null,default:ms}),_s=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bs=Object.freeze({__proto__:null,default:_s}),xs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hs=Object.freeze({__proto__:null,default:Ms}),Vs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ps=Object.freeze({__proto__:null,default:Vs}),zs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Os=Object.freeze({__proto__:null,default:zs}),ks=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$s=Object.freeze({__proto__:null,default:ks}),Ss=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Us=Object.freeze({__proto__:null,default:Is}),qs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ws=Object.freeze({__proto__:null,default:qs}),Fs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ks=Object.freeze({__proto__:null,default:Fs}),Xs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Js=Object.freeze({__proto__:null,default:Xs}),Ys=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gs=Object.freeze({__proto__:null,default:Ys}),Qs=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ec=Object.freeze({__proto__:null,default:Qs}),tc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,nc=Object.freeze({__proto__:null,default:tc}),oc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ic=Object.freeze({__proto__:null,default:oc}),lc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rc=Object.freeze({__proto__:null,default:lc}),ac=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sc=Object.freeze({__proto__:null,default:ac}),cc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dc=Object.freeze({__proto__:null,default:cc}),hc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,uc=Object.freeze({__proto__:null,default:hc}),vc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pc=Object.freeze({__proto__:null,default:vc}),fc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gc=Object.freeze({__proto__:null,default:fc}),mc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wc=Object.freeze({__proto__:null,default:mc}),_c=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bc=Object.freeze({__proto__:null,default:_c}),xc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hc=Object.freeze({__proto__:null,default:Mc}),Vc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pc=Object.freeze({__proto__:null,default:Vc}),zc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Oc=Object.freeze({__proto__:null,default:zc}),kc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$c=Object.freeze({__proto__:null,default:kc}),Sc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Uc=Object.freeze({__proto__:null,default:Ic}),qc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wc=Object.freeze({__proto__:null,default:qc}),Fc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kc=Object.freeze({__proto__:null,default:Fc}),Xc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jc=Object.freeze({__proto__:null,default:Xc}),Yc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gc=Object.freeze({__proto__:null,default:Yc}),Qc=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ed=Object.freeze({__proto__:null,default:Qc}),td=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,nd=Object.freeze({__proto__:null,default:td}),od=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,id=Object.freeze({__proto__:null,default:od}),ld=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rd=Object.freeze({__proto__:null,default:ld}),ad=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,sd=Object.freeze({__proto__:null,default:ad}),cd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,dd=Object.freeze({__proto__:null,default:cd}),hd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ud=Object.freeze({__proto__:null,default:hd}),vd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pd=Object.freeze({__proto__:null,default:vd}),fd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gd=Object.freeze({__proto__:null,default:fd}),md=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wd=Object.freeze({__proto__:null,default:md}),_d=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bd=Object.freeze({__proto__:null,default:_d}),xd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hd=Object.freeze({__proto__:null,default:Md}),Vd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pd=Object.freeze({__proto__:null,default:Vd}),zd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Od=Object.freeze({__proto__:null,default:zd}),kd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$d=Object.freeze({__proto__:null,default:kd}),Sd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ud=Object.freeze({__proto__:null,default:Id}),qd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wd=Object.freeze({__proto__:null,default:qd}),Fd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kd=Object.freeze({__proto__:null,default:Fd}),Xd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jd=Object.freeze({__proto__:null,default:Xd}),Yd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gd=Object.freeze({__proto__:null,default:Yd}),Qd=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,eh=Object.freeze({__proto__:null,default:Qd}),th=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nh=Object.freeze({__proto__:null,default:th}),oh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,ih=Object.freeze({__proto__:null,default:oh}),lh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,rh=Object.freeze({__proto__:null,default:lh}),ah=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sh=Object.freeze({__proto__:null,default:ah}),ch=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,dh=Object.freeze({__proto__:null,default:ch}),hh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,uh=Object.freeze({__proto__:null,default:hh}),vh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ph=Object.freeze({__proto__:null,default:vh}),fh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gh=Object.freeze({__proto__:null,default:fh}),mh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wh=Object.freeze({__proto__:null,default:mh}),_h=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bh=Object.freeze({__proto__:null,default:_h}),xh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hh=Object.freeze({__proto__:null,default:Mh}),Vh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ph=Object.freeze({__proto__:null,default:Vh}),zh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oh=Object.freeze({__proto__:null,default:zh}),kh=re`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
