...
/**
   ...
   */var Ie,De,Re,We=n`:host{--btn-font-weight:var(--sit-font-weight-regular);--btn-color:var(--sit-color-fixed-light);--btn-bg:var(--sit-primary-surface-default);--btn-hover-bg:var(--sit-primary-surface-emphasis);--btn-border-radius:var(--sit-border-radius-md);--btn-opacity:var(--sit-opacity-100,1)}:host([variant=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=brand]){--btn-bg:var(--sit-primary-surface-default);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline]){--btn-border-width:var(--sit-border-width-1)}:host([variant=outline][tone=brand]){--btn-border-color:var(--sit-primary-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-color:var(--sit-primary-color-default);--btn-hover-bg:var(--sit-primary-bg-translucent)}:host([variant=ghost][tone=brand]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-primary-surface-translucent);--btn-color:var(--sit-primary-color-default)}:host([variant=primary][tone=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline][tone=danger]){--btn-border-color:var(--sit-danger-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=ghost][tone=danger]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=primary][tone=fixed-light]){--btn-bg:var(--sit-surface-fixed-light);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 0%,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 100%),var(--sit-surface-fixed-light,#fff);--btn-color:var(--sit-color-fixed-dark)}:host([variant=outline][tone=fixed-light]){--btn-border-color:var(--sit-border-color-fixed-light);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=ghost][tone=fixed-light]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=neutral]){--btn-bg:var(--sit-surface-inverse);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-surface-inverse);--btn-color:var(--sit-color-inverse)}:host([variant=outline][tone=neutral]){--btn-border-color:var(--sit-border-color-emphasis);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost][tone=neutral]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost]) .btn,:host([variant=outline]) .btn,:host([variant=primary]) .btn{color:var(--btn-color)}:host([variant=outline]) .btn{border:var(--btn-border-width) solid var(--btn-border-color)}:host([size=lg]) .btn{font-size:var(--sit-font-size-label-lg);height:var(--sit-dimension-56);line-height:var(--sit-line-height-md);min-width:var(--sit-dimension-112);padding:var(--sit-padding-none) var(--sit-padding-xl)}:host([size=sm]) .btn{font-size:var(--sit-font-size-label-sm);height:var(--sit-dimension-40);line-height:var(--sit-line-height-2-xs);min-width:var(--sit-dimension-80);padding:var(--sit-padding-none) var(--sit-padding-md)}:host([size=xs]) .btn{font-size:var(--sit-font-size-label-xs);height:var(--sit-dimension-32);line-height:var(--sit-line-height-3-xs);min-width:var(--sit-dimension-64);padding:var(--sit-padding-none) var(--sit-padding-sm)}.btn{align-items:center;background-color:var(--btn-bg);border:var(--sit-border-width-1) solid var(--sit-border-color-transparent);border-radius:var(--btn-border-radius);color:var(--sit-color-fixed-light);cursor:pointer;display:inline-flex;font-size:var(--sit-font-size-label-md);font-weight:var(--btn-font-weight);gap:var(--sit-gap-2-xs);height:var(--sit-dimension-48);justify-content:center;line-height:var(--sit-line-height-xs);min-width:var(--sit-dimension-96);opacity:var(--btn-opacity);padding:var(--sit-padding-none) var(--sit-padding-lg);text-align:center;text-decoration:none;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;user-select:none;vertical-align:middle;white-space:nowrap;width:inherit}@media (prefers-reduced-motion:reduce){.btn{transition:none}}.btn.active,.btn:hover{background:var(--btn-hover-bg)}.btn:focus-visible{background:var(--btn-hover-bg);border-color:transparent;outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.btn.disabled,.btn:disabled{color:var(--btn-color);cursor:not-allowed;opacity:var(--sit-opacity-40)}.btn.loading{cursor:default}.btn slot::slotted(*){color:var(--btn-color)}`;class qe extends Oe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.active=!1,this.disabled=!1,this.target="_self"}focus(e){this.button.focus(e)}click(){this.button.click()}blur(){this.button.blur()}_handleBlur(){this.emit("sit-blur")}_handleFocus(){this.emit("sit-focus")}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation()}_handleKeydown(e){if("Enter"===e.key&&this.loading)return e.preventDefault(),void e.stopPropagation()}_assignSpinnerSize(e){return"xs"===e||"sm"===e?"xs":"md"===e||"lg"===e?"sm":void 0}_assignSpinnerTone(e,t){return"fixed-light"===e&&"primary"===t?"fixed-dark":"neutral"===e&&"primary"===t?"inverse":"fixed-light"===e||"primary"===t?"fixed-light":"neutral"!==e||"outline"!==t&&"ghost"!==t?"brand":"neutral"}}qe.styles=[...Oe.styles,We],e([(De=".btn",(e,t,l)=>{const r=e=>{const l=e.renderRoot?.querySelector(De)??null;if(null===l&&Re&&!e.hasUpdated){const e="object"==typeof t?t.name:t;ze("",`@query'd field ${JSON.stringify(String(e))} with the 'cache' flag set for selector '${De}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(Re){const{get:i,set:o}="object"==typeof t?e:l??(()=>{const e=Symbol(`${String(t)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return Ve(e,t,{get(){let e=i.call(this);return void 0===e&&(e=r(this),(null!==e||this.hasUpdated)&&o.call(this,e)),e}})}return Ve(e,t,{get(){return r(this)}})})],qe.prototype,"button",void 0),e([Pe({reflect:!0})],qe.prototype,"variant",void 0),e([Pe({reflect:!0})],qe.prototype,"tone",void 0),e([Pe({reflect:!0})],qe.prototype,"size",void 0),e([Pe({type:Boolean,reflect:!0})],qe.prototype,"active",void 0),e([Pe({type:Boolean,reflect:!0})],qe.prototype,"disabled",void 0),e([Pe({type:String,reflect:!0})],qe.prototype,"href",void 0),e([Pe({type:String,reflect:!0})],qe.prototype,"target",void 0),e([Pe({type:String,reflect:!0})],qe.prototype,"download",void 0),e([Pe({type:String})],qe.prototype,"ariaLabel",void 0),e([Pe({type:Boolean})],qe.prototype,"loading",void 0);class Fe{constructor(e,...t){this.slotNames=[],(this.host=e).addController(this),this.slotNames=t,this.handleSlotChange=this.handleSlotChange.bind(this)}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{var t;if(e.nodeType===e.TEXT_NODE&&""!==(null===(t=e.textContent)||void 0===t?void 0:t.trim()))return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if("sl-visually-hidden"===t.tagName.toLowerCase())return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return null!==this.host.querySelector(`:scope > [slot="${e}"]`)}test(e){return"[default]"===e?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){var e;null===(e=this.host.shadowRoot)||void 0===e||e.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){var e;null===(e=this.host.shadowRoot)||void 0===e||e.removeEventListener("slotchange",this.handleSlotChange)}handleSlotChange(e){const t=e.target;(this.slotNames.includes("[default]")&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()}}class Ke{constructor(e,t){(this.host=e).addController(this),this.options=Object.assign({form:e=>e.closest("form")},t)}hostConnected(){this.form=this.options.form(this.host)}hostDisconnected(){this.form&&(this.form=void 0)}doAction(e,t){if(this.form){const l=document.createElement("button");l.type=e,l.style.position="absolute",l.style.width="0",l.style.height="0",l.style.clipPath="inset(50%)",l.style.overflow="hidden",l.style.whiteSpace="nowrap",t&&(["formaction","formmethod","formnovalidate","formtarget"].forEach(e=>{t.hasAttribute(e)&&l.setAttribute(e,t.getAttribute(e))}),"submit"===e&&t.hasAttribute("name")&&(l.name=t.getAttribute("name"),l.value=t.getAttribute("value")||"")),this.form.append(l),l.click(),l.remove()}}reset(e){this.doAction("reset",e)}submit(e){this.doAction("submit",e)}}var Je=n`::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}`,Ge=n`:host{display:inline-block}:host([fullWidth]),:host([fullWidth]) .btn{width:100%}:host([fullWidth]) .btn.has-left-icon{justify-content:flex-start}:host([fullWidth]) .btn.has-right-icon{justify-content:space-between}:host([fullWidth]) .btn.has-left-icon.has-right-icon{justify-content:center}.btn span{padding:0 var(--sit-padding-2-xs)}.btn.no-icon{gap:var(--sit-gap-none)}.loading{cursor:default}`;class Xe extends qe{constructor(){super(...arguments),this.formSubmitController=new Ke(this,{form:e=>{if(e.hasAttribute("form")){const t=e.getRootNode(),l=e.getAttribute("form");return t.getElementById(l)}return e.closest("form")}}),this.type="button",this.fullWidth=!1,this.hasLeftIconSlot=!1,this.hasRightIconSlot=!1,this.hasSlotController=new Fe(this,"leftIcon","rightIcon"),this._clickHandler=()=>{"submit"===this.type&&this.formSubmitController.submit(this),"reset"===this.type&&this.formSubmitController.reset(this)}}updated(){this.hasLeftIconSlot||(this.hasLeftIconSlot=this.hasSlotController.test("leftIcon")),this.hasRightIconSlot||(this.hasRightIconSlot=this.hasSlotController.test("rightIcon"))}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation();this.removeEventListener("click",this._clickHandler),this.addEventListener("click",this._clickHandler)}render(){const e=this.href,t=e?Ne`a`:Ne`button`,l=!this.hasLeftIconSlot&&!this.hasRightIconSlot;return Ue`
      <${t}
        ...
        rel=${ke(e&&"_blank"===this.target?"noreferrer noopener":void 0)}
        role=${ke(e?"button":void 0)}
        ...
        aria-label=${ke(this.loading?"Loading":this.ariaLabel)}
      >
       ${this.loading?Ue`<sit-spinner
               size=${ke(this._assignSpinnerSize(this.size))}
               tone=${ke(this._assignSpinnerTone(this.tone,this.variant))}
             ></sit-spinner>`:Ue`<slot name="leftIcon"></slot>
               <span><slot></slot></span>
               <slot name="rightIcon"></slot>`}
      
      </${t}>
    `}}Xe.styles=[...qe.styles,Je,Ge],e([Pe({type:String,reflect:!0})],Xe.prototype,"name",void 0),e([Pe({type:String,reflect:!0})],Xe.prototype,"value",void 0),e([Pe({type:String,reflect:!0})],Xe.prototype,"type",void 0),e([Pe({type:String,reflect:!0})],Xe.prototype,"form",void 0),e([Pe({type:String,reflect:!0,attribute:"formaction"})],Xe.prototype,"formAction",void 0),e([Pe({type:String,reflect:!0,attribute:"formmethod"})],Xe.prototype,"formMethod",void 0),e([Pe({attribute:"formnovalidate",type:Boolean,reflect:!0})],Xe.prototype,"formNoValidate",void 0),e([Pe({type:String,reflect:!0,attribute:"formtarget"})],Xe.prototype,"formTarget",void 0),e([Pe({type:Boolean,reflect:!0})],Xe.prototype,"fullWidth",void 0),e([Pe({type:Boolean})],Xe.prototype,"hasLeftIconSlot",void 0),e([Pe({type:Boolean})],Xe.prototype,"hasRightIconSlot",void 0);const Ye={announcement:()=>Promise.resolve().then(function(){return vt}),archive:()=>Promise.resolve().then(function(){return pt}),"arrow-bar-down":()=>Promise.resolve().then(function(){return gt}),"arrow-bar-left":()=>Promise.resolve().then(function(){return mt}),"arrow-bar-right":()=>Promise.resolve().then(function(){return bt}),"arrow-bar-up":()=>Promise.resolve().then(function(){return xt}),"arrow-circle-down":()=>Promise.resolve().then(function(){return Mt}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Pt}),"arrow-circle-right":()=>Promise.resolve().then(function(){return Vt}),"arrow-circle-up":()=>Promise.resolve().then(function(){return $t}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Bt}),"arrow-down":()=>Promise.resolve().then(function(){return St}),"arrow-left":()=>Promise.resolve().then(function(){return kt}),"arrow-repeat":()=>Promise.resolve().then(function(){return Et}),"arrow-right":()=>Promise.resolve().then(function(){return Tt}),"arrow-square-down":()=>Promise.resolve().then(function(){return It}),"arrow-square-left":()=>Promise.resolve().then(function(){return Rt}),"arrow-square-right":()=>Promise.resolve().then(function(){return qt}),"arrow-square-up":()=>Promise.resolve().then(function(){return Kt}),"arrow-up":()=>Promise.resolve().then(function(){return Gt}),"bank-fill":()=>Promise.resolve().then(function(){return Yt}),"bell-slash":()=>Promise.resolve().then(function(){return el}),bell:()=>Promise.resolve().then(function(){return ll}),"bi-funnel":()=>Promise.resolve().then(function(){return il}),"bookmark-fill":()=>Promise.resolve().then(function(){return nl}),bookmark:()=>Promise.resolve().then(function(){return cl}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return hl}),"box-seam":()=>Promise.resolve().then(function(){return vl}),building:()=>Promise.resolve().then(function(){return pl}),bus:()=>Promise.resolve().then(function(){return gl}),calculator:()=>Promise.resolve().then(function(){return ml}),"calendar-check":()=>Promise.resolve().then(function(){return bl}),"calendar-heart":()=>Promise.resolve().then(function(){return xl}),"calendar-x":()=>Promise.resolve().then(function(){return Ml}),calendar:()=>Promise.resolve().then(function(){return Pl}),camera:()=>Promise.resolve().then(function(){return Vl}),car:()=>Promise.resolve().then(function(){return $l}),"chat-dots":()=>Promise.resolve().then(function(){return Bl}),"chat-left-text":()=>Promise.resolve().then(function(){return Sl}),chat:()=>Promise.resolve().then(function(){return kl}),"check-circle-fill":()=>Promise.resolve().then(function(){return El}),"check-circle":()=>Promise.resolve().then(function(){return Tl}),check:()=>Promise.resolve().then(function(){return Il}),"chevron-down":()=>Promise.resolve().then(function(){return Rl}),"chevron-left":()=>Promise.resolve().then(function(){return ql}),"chevron-right":()=>Promise.resolve().then(function(){return Kl}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return Gl}),"chevron-up":()=>Promise.resolve().then(function(){return Yl}),clock:()=>Promise.resolve().then(function(){return er}),"cloud-check":()=>Promise.resolve().then(function(){return lr}),"cloud-download":()=>Promise.resolve().then(function(){return ir}),"cloud-upload":()=>Promise.resolve().then(function(){return nr}),cloud:()=>Promise.resolve().then(function(){return cr}),"code-square":()=>Promise.resolve().then(function(){return hr}),"coins-hand":()=>Promise.resolve().then(function(){return vr}),compass:()=>Promise.resolve().then(function(){return pr}),copy:()=>Promise.resolve().then(function(){return gr}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return mr}),cross:()=>Promise.resolve().then(function(){return br}),"cursor-fill":()=>Promise.resolve().then(function(){return xr}),cursor:()=>Promise.resolve().then(function(){return Mr}),"dash-circle":()=>Promise.resolve().then(function(){return Pr}),"dash-square":()=>Promise.resolve().then(function(){return Vr}),dash:()=>Promise.resolve().then(function(){return $r}),database:()=>Promise.resolve().then(function(){return Br}),dataflow:()=>Promise.resolve().then(function(){return Sr}),download:()=>Promise.resolve().then(function(){return kr}),edit:()=>Promise.resolve().then(function(){return Er}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return Tr}),"exclamation-circle":()=>Promise.resolve().then(function(){return Ir}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return Rr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return qr}),exclamation:()=>Promise.resolve().then(function(){return Kr}),"eye-fill":()=>Promise.resolve().then(function(){return Gr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return Yr}),"eye-slash":()=>Promise.resolve().then(function(){return ei}),eye:()=>Promise.resolve().then(function(){return li}),"face-smile-fill":()=>Promise.resolve().then(function(){return ii}),"face-smile":()=>Promise.resolve().then(function(){return ni}),facebook:()=>Promise.resolve().then(function(){return ci}),"file-earmark-text":()=>Promise.resolve().then(function(){return hi}),"file-pdf":()=>Promise.resolve().then(function(){return vi}),"file-plus":()=>Promise.resolve().then(function(){return pi}),"file-text":()=>Promise.resolve().then(function(){return gi}),file:()=>Promise.resolve().then(function(){return mi}),files:()=>Promise.resolve().then(function(){return bi}),fingerprint:()=>Promise.resolve().then(function(){return xi}),flash:()=>Promise.resolve().then(function(){return Mi}),"folder-check":()=>Promise.resolve().then(function(){return Pi}),"folder-minus":()=>Promise.resolve().then(function(){return Vi}),"folder-plus":()=>Promise.resolve().then(function(){return $i}),folder:()=>Promise.resolve().then(function(){return Bi}),gear:()=>Promise.resolve().then(function(){return Si}),"geo-alt":()=>Promise.resolve().then(function(){return ki}),"geo-fill":()=>Promise.resolve().then(function(){return Ei}),geo:()=>Promise.resolve().then(function(){return Ti}),"globe-alt":()=>Promise.resolve().then(function(){return Ii}),globe:()=>Promise.resolve().then(function(){return Ri}),google:()=>Promise.resolve().then(function(){return qi}),"grid-alt":()=>Promise.resolve().then(function(){return Ki}),"grid-fill":()=>Promise.resolve().then(function(){return Gi}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return Yi}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return eo}),"hard-drive":()=>Promise.resolve().then(function(){return lo}),heart:()=>Promise.resolve().then(function(){return io}),"house-door":()=>Promise.resolve().then(function(){return no}),house:()=>Promise.resolve().then(function(){return co}),image:()=>Promise.resolve().then(function(){return ho}),"in-box":()=>Promise.resolve().then(function(){return uo}),"info-circle-fill":()=>Promise.resolve().then(function(){return fo}),"info-circle":()=>Promise.resolve().then(function(){return wo}),instagram:()=>Promise.resolve().then(function(){return _o}),key:()=>Promise.resolve().then(function(){return Zo}),"laptop-gear":()=>Promise.resolve().then(function(){return Co}),laptop:()=>Promise.resolve().then(function(){return yo}),layers:()=>Promise.resolve().then(function(){return Ho}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return zo}),"layout-text-window":()=>Promise.resolve().then(function(){return Oo}),layout:()=>Promise.resolve().then(function(){return jo}),"life-buoy":()=>Promise.resolve().then(function(){return Lo}),lightbulb:()=>Promise.resolve().then(function(){return Ao}),link:()=>Promise.resolve().then(function(){return No}),linkedin:()=>Promise.resolve().then(function(){return Uo}),list:()=>Promise.resolve().then(function(){return Do}),"lock-fill":()=>Promise.resolve().then(function(){return Wo}),lock:()=>Promise.resolve().then(function(){return Fo}),login:()=>Promise.resolve().then(function(){return Jo}),logout:()=>Promise.resolve().then(function(){return Xo}),luggage:()=>Promise.resolve().then(function(){return Qo}),"mail-open":()=>Promise.resolve().then(function(){return tn}),mail:()=>Promise.resolve().then(function(){return rn}),map:()=>Promise.resolve().then(function(){return nn}),meetup:()=>Promise.resolve().then(function(){return cn}),menu:()=>Promise.resolve().then(function(){return hn}),microphone:()=>Promise.resolve().then(function(){return vn}),monitor:()=>Promise.resolve().then(function(){return pn}),moon:()=>Promise.resolve().then(function(){return gn}),move:()=>Promise.resolve().then(function(){return mn}),paperclip:()=>Promise.resolve().then(function(){return bn}),passcode:()=>Promise.resolve().then(function(){return xn}),passport:()=>Promise.resolve().then(function(){return Mn}),pause:()=>Promise.resolve().then(function(){return Pn}),pencil:()=>Promise.resolve().then(function(){return Vn}),"pending-circle":()=>Promise.resolve().then(function(){return $n}),"person-dash":()=>Promise.resolve().then(function(){return Bn}),"person-plus":()=>Promise.resolve().then(function(){return Sn}),"person-x":()=>Promise.resolve().then(function(){return kn}),person:()=>Promise.resolve().then(function(){return En}),phone:()=>Promise.resolve().then(function(){return Tn}),"pin-map-fill":()=>Promise.resolve().then(function(){return In}),pin:()=>Promise.resolve().then(function(){return Rn}),placeholder:()=>Promise.resolve().then(function(){return qn}),plane:()=>Promise.resolve().then(function(){return Kn}),play:()=>Promise.resolve().then(function(){return Gn}),"plus-circle":()=>Promise.resolve().then(function(){return Yn}),"plus-square":()=>Promise.resolve().then(function(){return ea}),plus:()=>Promise.resolve().then(function(){return la}),printer:()=>Promise.resolve().then(function(){return ia}),"question-circle":()=>Promise.resolve().then(function(){return na}),rocket:()=>Promise.resolve().then(function(){return ca}),save:()=>Promise.resolve().then(function(){return ha}),search:()=>Promise.resolve().then(function(){return va}),send:()=>Promise.resolve().then(function(){return pa}),"sg-crest":()=>Promise.resolve().then(function(){return ga}),share:()=>Promise.resolve().then(function(){return ma}),"shield-tick":()=>Promise.resolve().then(function(){return ba}),"sidebar-collapse":()=>Promise.resolve().then(function(){return xa}),"sidebar-expand":()=>Promise.resolve().then(function(){return Ma}),"slash-circle":()=>Promise.resolve().then(function(){return Pa}),"slash-divider":()=>Promise.resolve().then(function(){return Va}),sliders:()=>Promise.resolve().then(function(){return $a}),"sort-ascending":()=>Promise.resolve().then(function(){return Ba}),"sort-descending":()=>Promise.resolve().then(function(){return Sa}),speedometer:()=>Promise.resolve().then(function(){return ka}),"star-ai":()=>Promise.resolve().then(function(){return Ea}),"star-fill":()=>Promise.resolve().then(function(){return Ta}),star:()=>Promise.resolve().then(function(){return Ia}),stoplights:()=>Promise.resolve().then(function(){return Ra}),sun:()=>Promise.resolve().then(function(){return qa}),"switch-horizontal":()=>Promise.resolve().then(function(){return Ka}),"switch-vertical":()=>Promise.resolve().then(function(){return Ga}),tablet:()=>Promise.resolve().then(function(){return Ya}),telegram:()=>Promise.resolve().then(function(){return ec}),telephone:()=>Promise.resolve().then(function(){return lc}),"three-dots-vertical":()=>Promise.resolve().then(function(){return ic}),"three-dots":()=>Promise.resolve().then(function(){return nc}),ticket:()=>Promise.resolve().then(function(){return cc}),"toggle-off":()=>Promise.resolve().then(function(){return hc}),"toggle-on":()=>Promise.resolve().then(function(){return vc}),train:()=>Promise.resolve().then(function(){return pc}),translate:()=>Promise.resolve().then(function(){return gc}),trash:()=>Promise.resolve().then(function(){return mc}),"trend-down":()=>Promise.resolve().then(function(){return bc}),"trend-up":()=>Promise.resolve().then(function(){return xc}),truck:()=>Promise.resolve().then(function(){return Mc}),"twitter-x":()=>Promise.resolve().then(function(){return Pc}),unlock:()=>Promise.resolve().then(function(){return Vc}),upload:()=>Promise.resolve().then(function(){return $c}),"user-check":()=>Promise.resolve().then(function(){return Bc}),"user-circle":()=>Promise.resolve().then(function(){return Sc}),"user-pause":()=>Promise.resolve().then(function(){return kc}),"user-square":()=>Promise.resolve().then(function(){return Ec}),users:()=>Promise.resolve().then(function(){return Tc}),"video-recorder":()=>Promise.resolve().then(function(){return Ic}),"volume-max":()=>Promise.resolve().then(function(){return Rc}),"volume-x":()=>Promise.resolve().then(function(){return qc}),"window-dash":()=>Promise.resolve().then(function(){return Kc}),"window-desktop":()=>Promise.resolve().then(function(){return Gc}),"window-dock":()=>Promise.resolve().then(function(){return Yc}),"window-fullscreen":()=>Promise.resolve().then(function(){return es}),"window-plus":()=>Promise.resolve().then(function(){return ls}),"window-sidebar":()=>Promise.resolve().then(function(){return is}),"window-split":()=>Promise.resolve().then(function(){return ns}),"window-stack":()=>Promise.resolve().then(function(){return cs}),"window-x":()=>Promise.resolve().then(function(){return hs}),window:()=>Promise.resolve().then(function(){return vs}),"xcircle-fill":()=>Promise.resolve().then(function(){return ps}),xcircle:()=>Promise.resolve().then(function(){return gs}),youtube:()=>Promise.resolve().then(function(){return ms}),"zoom-in":()=>Promise.resolve().then(function(){return bs}),"zoom-out":()=>Promise.resolve().then(function(){return xs})};var Qe=n`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const et=new Map;class tt extends Oe{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(et.has(e))return void(this._icon=et.get(e));const t=Ye[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();et.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:le}}tt.styles=[...Oe.styles,Qe],e([Pe({type:String,reflect:!0})],tt.prototype,"name",void 0),e([Pe({type:String,reflect:!0})],tt.prototype,"size",void 0),e([Pe({type:String})],tt.prototype,"ariaLabel",void 0),e([He()],tt.prototype,"_icon",void 0);var lt=n`:host{--sit-spinner-bg:var(--sit-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sit-spinner-bg:var(--sit-neutral-surface-default)}:host([tone=neutral]){--sit-spinner-bg:var(--sit-surface-inverse)}:host([tone=inverse]){--sit-spinner-bg:var(--sit-surface-default)}:host([tone=fixed-light]){--sit-spinner-bg:var(--sit-surface-fixed-light)}:host([tone=fixed-dark]){--sit-spinner-bg:var(--sit-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sit-gap-2-xs)}.spinner-wrapper.spinner-wrapper--horizontal{flex-direction:row}.spinner-wrapper__spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sit-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sit-spinner-bg);color:var(--sit-spinner-color);display:inline-flex;height:var(--sit-dimension-32);width:var(--sit-dimension-32)}.spinner-wrapper__spinner--xs{--border-thickness:2px;height:var(--sit-dimension-16);width:var(--sit-dimension-16)}.spinner-wrapper__spinner--sm{--border-thickness:3px;height:var(--sit-dimension-24);width:var(--sit-dimension-24)}.spinner-wrapper__spinner--lg{--border-thickness:6px;height:var(--sit-dimension-48);width:var(--sit-dimension-48)}.spinner-wrapper__spinner--xl{--border-thickness:8px;height:var(--sit-dimension-64);width:var(--sit-dimension-64)}.spinner-wrapper__label{color:var(--sit-neutral-color-default);font-size:var(--sit-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner-wrapper__spinner{animation-duration:1.5s}}

/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,rt=n`.text-primary{color:var(--sit-primary-rgb)!important}.text-secondary{color:var(--sit-secondary-rgb)!important}.text-success{color:var(--sit-success-rgb)!important}.text-info{color:var(--sit-info-rgb)!important}.text-warning{color:var(--sit-warning-rgb)!important}.text-danger{color:var(--sit-danger-rgb)!important}.text-light{color:var(--sit-light-rgb)!important}.text-dark{color:var(--sit-dark-rgb)!important}.text-muted{color:var(--sit-secondary-color)!important}`;class it extends Oe{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Ue`
      <div
        class="spinner-wrapper ${Se({"spinner-wrapper--horizontal":"horizontal"===this.orientation})}"
      >
        <div
          class="spinner-wrapper__spinner ${Se({[`spinner-wrapper__spinner--${this.size}`]:this.size})}"
          role="status"
        >
          ${this.label?le:Ue`<span class="sr-only">Loading...</span>`}
        </div>
        ${this.label?Ue`<span class="spinner-wrapper__label">${this.label}</span>`:le}
      </div>
    `}}it.styles=[...Oe.styles,rt,lt],e([Pe({type:String,reflect:!0})],it.prototype,"variant",void 0),e([Pe({type:String,reflect:!0})],it.prototype,"tone",void 0),e([Pe({type:String,reflect:!0})],it.prototype,"size",void 0),e([Pe({reflect:!0,type:String})],it.prototype,"label",void 0),e([Pe({type:String,reflect:!0})],it.prototype,"orientation",void 0);var ot=n`:host{display:inline-block}.btn.btn-icon{display:flex;height:var(--sit-dimension-48,56px);min-width:unset;padding:0;width:var(--sit-dimension-48,56px)}.btn.btn-icon.btn-lg{height:var(--sit-dimension-56);min-width:unset;padding:0;width:var(--sit-dimension-56)}.btn.btn-icon.btn-sm{height:var(--sit-dimension-40);min-width:unset;padding:0;width:var(--sit-dimension-40)}.btn.btn-icon.btn-xs{height:var(--sit-dimension-32);min-width:unset;padding:0;width:var(--sit-dimension-32)}`;class nt extends qe{_assignIconSize(e){return"xs"===e?"sm":"sm"===e?"md":"md"===e?"lg":"lg"===e?"xl":void 0}render(){const e=this.href,t=e?Ne`a`:Ne`button`;return Ue`
          <${t}
  ...
  `,this._renderFirstEllipsis=()=>this.pages.length<=7||!(this.pages.length!==this._limit&&this.currentPage>4)?null:Q`
    ...
    `,this._getNavButton=(e,t,l)=>{const r=Q`<sit-icon
      size=${this.size}
      name=${"Prev"===e?"arrow-left":"arrow-right"}
    ...
    ></sit-icon>`;return Q`
      <sit-button
        ...
        >${r}${e}</sit-button
      >
    `}}_handleValueChange(){return this.emit("sit-page-change",{detail:{currentPage:this.currentPage}}),this.pages.length<=7?this._limit=5:this.pages.length-this.currentPage<=3?this._limit=4:this.currentPage>4?this._limit=3:this._limit=4}_handlePageClick(e){const t=e.target.closest(".page-item");if(t){const e=Number(t.getAttribute("key"));e!==this.currentPage&&(this.currentPage=e)}}_handleNextButton(){this.currentPage=this.currentPage+1}_handlePrevButton(){this.currentPage=this.currentPage-1}get pages(){const e=[];for(let t=1;t<=Math.ceil(this.dataLength/this.itemsPerPage);t++)e.push(t);return e}_handleKeyDown(e,t,l,r){if(" "===e.key&&e.preventDefault(),"Enter"===e.key||" "===e.key)switch(t){case"pageNumber":this.currentPage=l;break;case"directionButton":r?this._handlePrevButton():this._handleNextButton()}}_renderFirstPage(){return Q`
    ...
    `}_getAllPageNumbers(){const e=[];for(let t=1;t<=this.pages.length;t++)e.push(t);return e}_getPageNumbers(){const e=[];let t,l=2;3===this._limit&&(l=this.currentPage-Math.floor(this._limit/2)),4===this._limit&&(l=this.currentPage-Math.floor(this._limit/2),this.currentPage+this._limit>this.pages.length&&(l=this.pages.length-this._limit)),l<=1&&(l=2),t=l+this._limit-1,t>=this.pages.length&&(t=this.pages.length-1);for(let r=l;r<=t;r++)e.push(r);return e}_renderPgNumbers(e){return e.map(e=>Q`
        <div key=${e} class="page-item ${this.currentPage===e?"active":""}">
          <span
            role="button"
            class="page-link"
            tabindex="0"
            aria-label=${this.currentPage===e?`Current Page, Page ${e}`:`Go to Page ${e}`}
            aria-current="${this.currentPage===e}"
            @click=${this._handlePageClick}
            @keydown=${t=>this._handleKeyDown(t,"pageNumber",e)}
            >${e}</span
          >
        </div>
      `)}_renderLastEllipsis(){const e=this.pages.length!==this._limit;return this.pages.length<=7||!e||this._limit>=this.pages.length||this.pages.length-this.currentPage<this._limit?null:Q`
      <div class="page-item">
        <span class="page-link ellipsis ">${this.ellipsisContent}</span>
      </div>
    `}_renderLastPage(){return Q`
    ...
    `}_renderDirectionButton(e,t){const l=this.currentPage===this.pages.length||this.pages.length<=1,r=1===this.currentPage,i="Prev"===e?r:l;return"button"===this.navigation?Q`${this._getNavButton(e,t,i)}`:"icon-button"===this.navigation?Q`${this._getIconButton(e,t,i)}`:Q`${le}`}_getIconButton(e,t,l){return Q`
      <sit-icon-button
        tone="neutral"
        ariaLabel=${"Prev"===e?"Previous":"Next"}
        size=${this.size}
        ...
        name=${"Prev"===e?"arrow-left":"arrow-right"}
      ></sit-icon-button>
    `}_renderDescriptionPagination(){return Q`
    ...
    `}_renderDefaultPagination(){return Q`
      ...
      ${this.pages.length<=1?le:this._renderLastPage()}
      ${this._renderDirectionButton("Next",this._handleNextButton)}
    `}_renderNumberPagination(){return Q` ${this._renderPgNumbers(this._getAllPageNumbers())} `}_renderButtonPagination(){return Q`
      ${this._renderDirectionButton("Prev",this._handlePrevButton)}
      ${this._renderDirectionButton("Next",this._handleNextButton)}
    `}render(){return Q`
      <nav aria-label="pagination" role="navigation">
        <div class="pagination pagination-${this.size}">
          ${"description"===this.variant?this._renderDescriptionPagination():le}
          ${"default"===this.variant?this._renderDefaultPagination():le}
          ${"number"===this.variant?this._renderNumberPagination():le}
          ${"button"===this.variant?this._renderButtonPagination():le}
        </div>
      </nav>
    `}}ht.styles=[...Oe.styles,st],ht.dependencies={"sit-icon-button":nt,"sit-button":Xe,"sit-icon":tt},e([Pe({type:Number})],ht.prototype,"dataLength",void 0),e([Pe({type:Number})],ht.prototype,"currentPage",void 0),e([Pe({type:Number})],ht.prototype,"itemsPerPage",void 0),e([Pe({type:String})],ht.prototype,"variant",void 0),e([Pe({type:String})],ht.prototype,"navigation",void 0),e([Pe({type:String})],ht.prototype,"size",void 0),e([He()],ht.prototype,"_limit",void 0),e([function(e,t){const l=Object.assign({waitUntilFirstUpdate:!1},t);return(t,r)=>{const{update:i}=t;if(e in t){const o=e;t.update=function(e){if(e.has(o)){const t=e.get(o),i=this[o];t!==i&&(l.waitUntilFirstUpdate&&!this.hasUpdated||this[r](t,i))}i.call(this,e)}}}}("currentPage",{waitUntilFirstUpdate:!1})],ht.prototype,"_handleValueChange",null),at="sit-pagination",ct=ht,customElements.get(at)||customElements.define(at,ct);var dt=Q`
...
`,vt=Object.freeze({__proto__:null,default:dt}),ut=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pt=Object.freeze({__proto__:null,default:ut}),ft=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gt=Object.freeze({__proto__:null,default:ft}),wt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bt=Object.freeze({__proto__:null,default:_t}),Zt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xt=Object.freeze({__proto__:null,default:Zt}),Ct=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Pt=Object.freeze({__proto__:null,default:yt}),Ht=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Vt=Object.freeze({__proto__:null,default:Ht}),zt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$t=Object.freeze({__proto__:null,default:zt}),Ot=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bt=Object.freeze({__proto__:null,default:Ot}),jt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,St=Object.freeze({__proto__:null,default:jt}),Lt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kt=Object.freeze({__proto__:null,default:Lt}),At=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Et=Object.freeze({__proto__:null,default:At}),Nt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tt=Object.freeze({__proto__:null,default:Nt}),Ut=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,It=Object.freeze({__proto__:null,default:Ut}),Dt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Rt=Object.freeze({__proto__:null,default:Dt}),Wt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,qt=Object.freeze({__proto__:null,default:Wt}),Ft=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kt=Object.freeze({__proto__:null,default:Ft}),Jt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gt=Object.freeze({__proto__:null,default:Jt}),Xt=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cl=Object.freeze({__proto__:null,default:al}),sl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pl=Object.freeze({__proto__:null,default:yl}),Hl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vl=Object.freeze({__proto__:null,default:Hl}),zl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$l=Object.freeze({__proto__:null,default:zl}),Ol=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bl=Object.freeze({__proto__:null,default:Ol}),jl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sl=Object.freeze({__proto__:null,default:jl}),Ll=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kl=Object.freeze({__proto__:null,default:Ll}),Al=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,El=Object.freeze({__proto__:null,default:Al}),Nl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tl=Object.freeze({__proto__:null,default:Nl}),Ul=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Il=Object.freeze({__proto__:null,default:Ul}),Dl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rl=Object.freeze({__proto__:null,default:Dl}),Wl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ql=Object.freeze({__proto__:null,default:Wl}),Fl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kl=Object.freeze({__proto__:null,default:Fl}),Jl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gl=Object.freeze({__proto__:null,default:Jl}),Xl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pr=Object.freeze({__proto__:null,default:yr}),Hr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vr=Object.freeze({__proto__:null,default:Hr}),zr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$r=Object.freeze({__proto__:null,default:zr}),Or=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Br=Object.freeze({__proto__:null,default:Or}),jr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sr=Object.freeze({__proto__:null,default:jr}),Lr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kr=Object.freeze({__proto__:null,default:Lr}),Ar=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Er=Object.freeze({__proto__:null,default:Ar}),Nr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tr=Object.freeze({__proto__:null,default:Nr}),Ur=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ir=Object.freeze({__proto__:null,default:Ur}),Dr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rr=Object.freeze({__proto__:null,default:Dr}),Wr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kr=Object.freeze({__proto__:null,default:Fr}),Jr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gr=Object.freeze({__proto__:null,default:Jr}),Xr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pi=Object.freeze({__proto__:null,default:yi}),Hi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Vi=Object.freeze({__proto__:null,default:Hi}),zi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$i=Object.freeze({__proto__:null,default:zi}),Oi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bi=Object.freeze({__proto__:null,default:Oi}),ji=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Si=Object.freeze({__proto__:null,default:ji}),Li=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ki=Object.freeze({__proto__:null,default:Li}),Ai=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ei=Object.freeze({__proto__:null,default:Ai}),Ni=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ti=Object.freeze({__proto__:null,default:Ni}),Ui=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Ii=Object.freeze({__proto__:null,default:Ui}),Di=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ri=Object.freeze({__proto__:null,default:Di}),Wi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ki=Object.freeze({__proto__:null,default:Fi}),Ji=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gi=Object.freeze({__proto__:null,default:Ji}),Xi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ho=Object.freeze({__proto__:null,default:so}),vo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yo=Object.freeze({__proto__:null,default:Mo}),Po=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ho=Object.freeze({__proto__:null,default:Po}),Vo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zo=Object.freeze({__proto__:null,default:Vo}),$o=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oo=Object.freeze({__proto__:null,default:$o}),Bo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jo=Object.freeze({__proto__:null,default:Bo}),So=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lo=Object.freeze({__proto__:null,default:So}),ko=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ao=Object.freeze({__proto__:null,default:ko}),Eo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,No=Object.freeze({__proto__:null,default:Eo}),To=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Uo=Object.freeze({__proto__:null,default:To}),Io=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Do=Object.freeze({__proto__:null,default:Io}),Ro=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wo=Object.freeze({__proto__:null,default:Ro}),qo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fo=Object.freeze({__proto__:null,default:qo}),Ko=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Jo=Object.freeze({__proto__:null,default:Ko}),Go=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xo=Object.freeze({__proto__:null,default:Go}),Yo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qo=Object.freeze({__proto__:null,default:Yo}),en=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pn=Object.freeze({__proto__:null,default:yn}),Hn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vn=Object.freeze({__proto__:null,default:Hn}),zn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$n=Object.freeze({__proto__:null,default:zn}),On=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bn=Object.freeze({__proto__:null,default:On}),jn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sn=Object.freeze({__proto__:null,default:jn}),Ln=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kn=Object.freeze({__proto__:null,default:Ln}),An=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,En=Object.freeze({__proto__:null,default:An}),Nn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Tn=Object.freeze({__proto__:null,default:Nn}),Un=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,In=Object.freeze({__proto__:null,default:Un}),Dn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rn=Object.freeze({__proto__:null,default:Dn}),Wn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kn=Object.freeze({__proto__:null,default:Fn}),Jn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gn=Object.freeze({__proto__:null,default:Jn}),Xn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$a=Object.freeze({__proto__:null,default:za}),Oa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sa=Object.freeze({__proto__:null,default:ja}),La=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ka=Object.freeze({__proto__:null,default:La}),Aa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ea=Object.freeze({__proto__:null,default:Aa}),Na=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ta=Object.freeze({__proto__:null,default:Na}),Ua=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ia=Object.freeze({__proto__:null,default:Ua}),Da=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ra=Object.freeze({__proto__:null,default:Da}),Wa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ka=Object.freeze({__proto__:null,default:Fa}),Ja=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ga=Object.freeze({__proto__:null,default:Ja}),Xa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Pc=Object.freeze({__proto__:null,default:yc}),Hc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vc=Object.freeze({__proto__:null,default:Hc}),zc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$c=Object.freeze({__proto__:null,default:zc}),Oc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bc=Object.freeze({__proto__:null,default:Oc}),jc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sc=Object.freeze({__proto__:null,default:jc}),Lc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,kc=Object.freeze({__proto__:null,default:Lc}),Ac=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ec=Object.freeze({__proto__:null,default:Ac}),Nc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tc=Object.freeze({__proto__:null,default:Nc}),Uc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ic=Object.freeze({__proto__:null,default:Uc}),Dc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rc=Object.freeze({__proto__:null,default:Dc}),Wc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kc=Object.freeze({__proto__:null,default:Fc}),Jc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Gc=Object.freeze({__proto__:null,default:Jc}),Xc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yc=Object.freeze({__proto__:null,default:Xc}),Qc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xs=Object.freeze({__proto__:null,default:Zs})});
