...
import css_248z from './tab-group.js';
 ...
 *
 */
class SitTabGroup extends SitElement {
    constructor() {
        super(...arguments);
        this._tabs = [];
        this._panels = [];
...
SitTabGroup.styles = [...SitElement.styles, css_248z];
__decorate([
    query(".tab-group")
...
export { SitTabGroup, SitTabGroup as default };
//# sourceMappingURL=sit-tab-group.js.map
