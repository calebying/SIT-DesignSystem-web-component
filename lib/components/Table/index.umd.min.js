...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */({context:It}),Ct()],Bt.prototype,"_headerBackground",void 0);var Ht=n`:host{border-bottom:var(--sit-border-width-1) solid var(--sit-border-color-muted);display:table-cell;vertical-align:middle}:host([headerBackground]){background-color:var(--sit-surface-raised)}.table-head{align-items:center;display:flex;font-weight:var(--sit-font-weight-semibold);min-height:var(--sit-dimension-56);padding:var(--sit-padding-sm) var(--sit-padding-md)}`;class qt extends Ut{constructor(){super(...arguments),this._headerBackground=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","columnheader")}_handleHeaderBackground(){this._headerBackground?this.setAttribute("headerBackground","true"):this.removeAttribute("headerBackground")}render(){return Q`<div
      class=${Nt({"table-head":!0,"header-background":this._headerBackground})}
    >
      <slot></slot>
    </div>`}}qt.styles=[...Ut.styles,Ht],t([function({context:t,subscribe:e}){return(s,i)=>{"object"==typeof i?i.addInitializer(function(){new At(this,{context:t,callback:t=>{s.set.call(this,t)},subscribe:e})}):s.constructor.addInitializer(s=>{new At(s,{context:t,callback:t=>{s[i]=t},subscribe:e})})}}({context:It,subscribe:!0}),Ct()],qt.prototype,"_headerBackground",void 0),t([function(t,e){const s=Object.assign({waitUntilFirstUpdate:!1},e);return(e,i)=>{const{update:o}=e;if(t in e){const r=t;e.update=function(t){if(t.has(r)){const e=t.get(r),o=this[r];e!==o&&(s.waitUntilFirstUpdate&&!this.hasUpdated||this[i](e,o))}o.call(this,t)}}}}("_headerBackground")],qt.prototype,"_handleHeaderBackground",null);var Ft=n`:host{display:table-row;width:100%}`;class Zt extends Ut{connectedCallback(){super.connectedCallback(),this.setAttribute("role","row")}render(){return Q`<slot class="table-row"></slot>`}}Zt.styles=[...Ut.styles,Ft];var Jt=n`:host{border-bottom:var(--sit-border-width-1) solid var(--sit-border-color-muted);display:table-cell;vertical-align:middle}.table-cell{align-items:center;display:flex;min-height:var(--sit-dimension-56);padding:var(--sit-padding-sm) var(--sit-padding-md)}`;class Xt extends Ut{connectedCallback(){super.connectedCallback(),this.setAttribute("role","cell")}render(){return Q`<div class="table-cell"><slot></slot></div>`}}Xt.styles=[...Ut.styles,Jt],jt("sit-table",Bt),jt("sit-table-head",qt),jt("sit-table-row",Zt),jt("sit-table-cell",Xt)});
