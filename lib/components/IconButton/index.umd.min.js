...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
const z=(e,t,l)=>(l.configurable=!0,l.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,l),l);
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */let O;globalThis.litIssuedWarnings??=new Set,O=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))};
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const j=globalThis,B=e=>{j.emitLitDebugLogEvents&&j.dispatchEvent(new CustomEvent("lit-debug",{detail:e}))};let $,S=0;j.litIssuedWarnings??=new Set,$=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",j.litIssuedWarnings.has(t)||j.litIssuedWarnings.has(e)||(console.warn(t),j.litIssuedWarnings.add(t))},queueMicrotask(()=>{$("dev-mode","Lit is in dev mode. Not recommended for production!")});const L=j.ShadyDOM?.inUse&&!0===j.ShadyDOM?.noPatch?j.ShadyDOM.wrap:e=>e,A=j.trustedTypes,k=A?A.createPolicy("lit-html",{createHTML:e=>e}):void 0,E=e=>e,T=(e,t,l)=>E,N=e=>{if(de!==T)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");de=e},U=()=>{de=T},I=(e,t,l)=>de(e,t,l),R="$lit$",D=`lit$${Math.random().toFixed(9).slice(2)}$`,W="?"+D,q=`<${W}>`,F=document,J=()=>F.createComment(""),K=e=>null===e||"object"!=typeof e&&"function"!=typeof e,Y=Array.isArray,X="[ \t\n\f\r]",G=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Q=/-->/g,ee=/>/g,te=new RegExp(`>|${X}(?:([^\\s"'>=/]+)(${X}*=${X}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),le=/'/g,re=/"/g,oe=/^(?:script|style|textarea|title)$/i,ne=(ie=1,(e,...t)=>(e.some(e=>void 0===e)&&console.warn("Some template strings are undefined.\nThis is probably caused by illegal octal escape sequences."),t.some(e=>e?._$litStatic$)&&$("","Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.\nPlease use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions"),{_$litType$:ie,strings:e,values:t}));var ie;const ae=Symbol.for("lit-noChange"),ce=Symbol.for("lit-nothing"),se=new WeakMap,he=F.createTreeWalker(F,129);let de=T;function ve(e,t){if(!Y(e)||!e.hasOwnProperty("raw")){let e="invalid template strings array";throw e="\n          Internal Error: expected template strings to be an array\n          with a 'raw' field. Faking a template strings array by\n          calling html or svg like an ordinary function is effectively\n          the same as calling unsafeHtml and can lead to major security\n          issues, e.g. opening your code up to XSS attacks.\n          If you're using the html or svg tagged template functions normally\n          and still seeing this error, please file a bug at\n          https://github.com/lit/lit/issues/new?template=bug_report.md\n          and include information about your build tooling, if any.\n        ".trim().replace(/\n */g,"\n"),new Error(e)}return void 0!==k?k.createHTML(t):t}class ue{constructor({strings:e,_$litType$:t},l){let r;this.parts=[];let o=0,n=0;const i=e.length-1,a=this.parts,[c,s]=((e,t)=>{const l=e.length-1,r=[];let o,n=2===t?"<svg>":3===t?"<math>":"",i=G;for(let t=0;t<l;t++){const l=e[t];let a,c,s=-1,h=0;for(;h<l.length&&(i.lastIndex=h,c=i.exec(l),null!==c);)if(h=i.lastIndex,i===G){if("!--"===c[1])i=Q;else if(void 0!==c[1])i=ee;else if(void 0!==c[2])oe.test(c[2])&&(o=new RegExp(`</${c[2]}`,"g")),i=te;else if(void 0!==c[3])throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else i===te?">"===c[0]?(i=o??G,s=-1):void 0===c[1]?s=-2:(s=i.lastIndex-c[2].length,a=c[1],i=void 0===c[3]?te:'"'===c[3]?re:le):i===re||i===le?i=te:i===Q||i===ee?i=G:(i=te,o=void 0);console.assert(-1===s||i===te||i===le||i===re,"unexpected parse state B");const d=i===te&&e[t+1].startsWith("/>")?" ":"";n+=i===G?l+q:s>=0?(r.push(a),l.slice(0,s)+R+l.slice(s)+D+d):l+D+(-2===s?t:d)}return[ve(e,n+(e[l]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),r]})(e,t);if(this.el=ue.createElement(c,l),he.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(r=he.nextNode())&&a.length<i;){if(1===r.nodeType){{const e=r.localName;if(/^(?:textarea|template)$/i.test(e)&&r.innerHTML.includes(D)){const t=`Expressions are not supported inside \`${e}\` elements. See https://lit.dev/msg/expression-in-${e} for more information.`;if("template"===e)throw new Error(t);$("",t)}}if(r.hasAttributes())for(const e of r.getAttributeNames())if(e.endsWith(R)){const t=s[n++],l=r.getAttribute(e).split(D),i=/([.?@])?(.*)/.exec(t);a.push({type:1,index:o,name:i[2],strings:l,ctor:"."===i[1]?me:"?"===i[1]?_e:"@"===i[1]?Ze:we}),r.removeAttribute(e)}else e.startsWith(D)&&(a.push({type:6,index:o}),r.removeAttribute(e));if(oe.test(r.tagName)){const e=r.textContent.split(D),t=e.length-1;if(t>0){r.textContent=A?A.emptyScript:"";for(let l=0;l<t;l++)r.append(e[l],J()),he.nextNode(),a.push({type:2,index:++o});r.append(e[t],J())}}}else if(8===r.nodeType){if(r.data===W)a.push({type:2,index:o});else{let e=-1;for(;-1!==(e=r.data.indexOf(D,e+1));)a.push({type:7,index:o}),e+=D.length-1}}o++}if(s.length!==n)throw new Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+e.join("${...}")+"`");B&&B({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const l=F.createElement("template");return l.innerHTML=e,l}}function fe(e,t,l=e,r){if(t===ae)return t;let o=void 0!==r?l.__directives?.[r]:l.__directive;const n=K(t)?void 0:t._$litDirective$;return o?.constructor!==n&&(o?._$notifyDirectiveConnectionChanged?.(!1),void 0===n?o=void 0:(o=new n(e),o._$initialize(e,l,r)),void 0!==r?(l.__directives??=[])[r]=o:l.__directive=o),void 0!==o&&(t=fe(e,o._$resolve(e,t.values),o,r)),t}class pe{constructor(e,t){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){const{el:{content:t},parts:l}=this._$template,r=(e?.creationScope??F).importNode(t,!0);he.currentNode=r;let o=he.nextNode(),n=0,i=0,a=l[0];for(;void 0!==a;){if(n===a.index){let t;2===a.type?t=new ge(o,o.nextSibling,this,e):1===a.type?t=new a.ctor(o,a.name,a.strings,this,e):6===a.type&&(t=new be(o,this,e)),this._$parts.push(t),a=l[++i]}n!==a?.index&&(o=he.nextNode(),n++)}return he.currentNode=F,r}_update(e){let t=0;for(const l of this._$parts)void 0!==l&&(B&&B({kind:"set part",part:l,value:e[t],valueIndex:t,values:e,templateInstance:this}),void 0!==l.strings?(l._$setValue(e,l,t),t+=l.strings.length-2):l._$setValue(e[t])),t++}}class ge{get _$isConnected(){return this._$parent?._$isConnected??this.__isConnected}constructor(e,t,l,r){this.type=2,this._$committedValue=ce,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=l,this.options=r,this.__isConnected=r?.isConnected??!0,this._textSanitizer=void 0}get parentNode(){let e=L(this._$startNode).parentNode;const t=this._$parent;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){if(null===this.parentNode)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=fe(this,e,t),K(e))e===ce||null==e||""===e?(this._$committedValue!==ce&&(B&&B({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=ce):e!==this._$committedValue&&e!==ae&&this._commitText(e);else if(void 0!==e._$litType$)this._commitTemplateResult(e);else if(void 0!==e.nodeType){if(this.options?.host===e)return this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),void console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");this._commitNode(e)}else(e=>Y(e)||"function"==typeof e?.[Symbol.iterator])(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return L(L(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){if(this._$committedValue!==e){if(this._$clear(),de!==T){const e=this._$startNode.parentNode?.nodeName;if("STYLE"===e||"SCRIPT"===e){let t="Forbidden";throw t="STYLE"===e?"Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":"Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(t)}}B&&B({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==ce&&K(this._$committedValue)){const t=L(this._$startNode).nextSibling;void 0===this._textSanitizer&&(this._textSanitizer=I(t,"data","property")),e=this._textSanitizer(e),B&&B({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=F.createTextNode("");this._commitNode(t),void 0===this._textSanitizer&&(this._textSanitizer=I(t,"data","property")),e=this._textSanitizer(e),B&&B({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){const{values:t,_$litType$:l}=e,r="number"==typeof l?this._$getTemplate(e):(void 0===l.el&&(l.el=ue.createElement(ve(l.h,l.h[0]),this.options)),l);if(this._$committedValue?._$template===r)B&&B({kind:"template updating",template:r,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:t}),this._$committedValue._update(t);else{const e=new pe(r,this),l=e._clone(this.options);B&&B({kind:"template instantiated",template:r,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),e._update(t),B&&B({kind:"template instantiated and updated",template:r,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),this._commitNode(l),this._$committedValue=e}}_$getTemplate(e){let t=se.get(e.strings);return void 0===t&&se.set(e.strings,t=new ue(e)),t}_commitIterable(e){Y(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let l,r=0;for(const o of e)r===t.length?t.push(l=new ge(this._insert(J()),this._insert(J()),this,this.options)):l=t[r],l._$setValue(o),r++;r<t.length&&(this._$clear(l&&L(l._$endNode).nextSibling,r),t.length=r)}_$clear(e=L(this._$startNode).nextSibling,t){for(this._$notifyConnectionChanged?.(!1,!0,t);e!==this._$endNode;){const t=L(e).nextSibling;L(e).remove(),e=t}}setConnected(e){if(void 0!==this._$parent)throw new Error("part.setConnected() may only be called on a RootPart returned from render().");this.__isConnected=e,this._$notifyConnectionChanged?.(e)}}class we{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(e,t,l,r,o){this.type=1,this._$committedValue=ce,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=r,this.options=o,l.length>2||""!==l[0]||""!==l[1]?(this._$committedValue=new Array(l.length-1).fill(new String),this.strings=l):this._$committedValue=ce,this._sanitizer=void 0}_$setValue(e,t=this,l,r){const o=this.strings;let n=!1;if(void 0===o)e=fe(this,e,t,0),n=!K(e)||e!==this._$committedValue&&e!==ae,n&&(this._$committedValue=e);else{const r=e;let i,a;for(e=o[0],i=0;i<o.length-1;i++)a=fe(this,r[l+i],t,i),a===ae&&(a=this._$committedValue[i]),n||=!K(a)||a!==this._$committedValue[i],a===ce?e=ce:e!==ce&&(e+=(a??"")+o[i+1]),this._$committedValue[i]=a}n&&!r&&this._commitValue(e)}_commitValue(e){e===ce?L(this.element).removeAttribute(this.name):(void 0===this._sanitizer&&(this._sanitizer=de(this.element,this.name,"attribute")),e=this._sanitizer(e??""),B&&B({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),L(this.element).setAttribute(this.name,e??""))}}class me extends we{constructor(){super(...arguments),this.type=3}_commitValue(e){void 0===this._sanitizer&&(this._sanitizer=de(this.element,this.name,"property")),e=this._sanitizer(e),B&&B({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===ce?void 0:e}}class _e extends we{constructor(){super(...arguments),this.type=4}_commitValue(e){B&&B({kind:"commit boolean attribute",element:this.element,name:this.name,value:!(!e||e===ce),options:this.options}),L(this.element).toggleAttribute(this.name,!!e&&e!==ce)}}class Ze extends we{constructor(e,t,l,r,o){if(super(e,t,l,r,o),this.type=5,void 0!==this.strings)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){if((e=fe(this,e,t,0)??ce)===ae)return;const l=this._$committedValue,r=e===ce&&l!==ce||e.capture!==l.capture||e.once!==l.once||e.passive!==l.passive,o=e!==ce&&(l===ce||r);B&&B({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:r,addListener:o,oldListener:l}),r&&this.element.removeEventListener(this.name,this,l),o&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){"function"==typeof this._$committedValue?this._$committedValue.call(this.options?.host??this.element,e):this._$committedValue.handleEvent(e)}}class be{constructor(e,t,l){this.element=e,this.type=6,this._$disconnectableChildren=void 0,this._$parent=t,this.options=l}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){B&&B({kind:"commit to element binding",element:this.element,value:e,options:this.options}),fe(this,e)}}const xe=j.litHtmlPolyfillSupportDevMode;xe?.(ue,ge),(j.litHtmlVersions??=[]).push("3.3.2"),j.litHtmlVersions.length>1&&queueMicrotask(()=>{$("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});const Ce=(e,t,l)=>{if(null==t)throw new TypeError(`The container to render into may not be ${t}`);const r=S++,o=l?.renderBefore??t;let n=o._$litPart$;if(B&&B({kind:"begin render",id:r,value:e,container:t,options:l,part:n}),void 0===n){const e=l?.renderBefore??null;o._$litPart$=n=new ge(t.insertBefore(J(),e),e,void 0,l??{})}return n._$setValue(e),B&&B({kind:"end render",id:r,value:e,container:t,options:l,part:n}),n};Ce.setSanitizer=N,Ce.createSanitizer=I,Ce._testOnlyClearSanitizerFactoryDoNotCallOrElse=U;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const Me=1;class ye{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,l){this.__part=e,this._$parent=t,this.__attributeIndex=l}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const Ve=(He=class extends ye{constructor(e){if(super(e),e.type!==Me||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const r=!!t[e];r===this._previousClasses.has(e)||this._staticClasses?.has(e)||(r?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return ae}},(...e)=>({_$litDirective$:He,values:e}));
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */var He;const Pe=e=>e??ce,ze=Symbol.for(""),Oe=e=>{if(e?.r===ze)return e?._$litStatic$},je=(e,...t)=>({_$litStatic$:t.reduce((t,l,r)=>t+(e=>{if(void 0!==e._$litStatic$)return e._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(l)+e[r+1],e[0]),r:ze}),Be=new Map,$e=(Se=ne,(e,...t)=>{const l=t.length;let r,o;const n=[],i=[];let a,c=0,s=!1;for(;c<l;){for(a=e[c];c<l&&void 0!==(o=t[c],r=Oe(o));)a+=r+e[++c],s=!0;c!==l&&i.push(o),n.push(a),c++}if(c===l&&n.push(e[l]),s){const l=n.join("$$lit$$");void 0===(e=Be.get(l))&&(n.raw=n,Be.set(l,e=n)),t=i}return Se(e,...t)});
/**
   * @license
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
const Le=globalThis;let Ae;Le.litIssuedWarnings??=new Set,Ae=(e,t)=>{t+=` See https://lit.dev/msg/${e} for more information.`,Le.litIssuedWarnings.has(t)||Le.litIssuedWarnings.has(e)||(console.warn(t),Le.litIssuedWarnings.add(t))};class ke extends M{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=Ce(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.__childPart?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.__childPart?.setConnected(!1)}render(){return ae}}var Ee;ke._$litElement$=!0,ke[(Ee="finalized",Ee)]=!0,Le.litElementHydrateSupport?.({LitElement:ke});const Te=Le.litElementPolyfillSupportDevMode;Te?.({LitElement:ke}),(Le.litElementVersions??=[]).push("4.2.2"),Le.litElementVersions.length>1&&queueMicrotask(()=>{Ae("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var Ne=i`:host{-webkit-text-size-adjust:100%;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-font-smoothing:antialiased;color:var(--sit-body-color-default,#1a1a1a);display:block;font-family:var(--sit-font-family-brand,"Inter",system-ui,sans-serif);font-size:var(--sit-font-size-body-md,1rem);font-weight:var(--sit-font-weight-regular,400);line-height:var(--sit-line-height-xs,24px);margin:0;*,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}:disabled{cursor:not-allowed}@media (prefers-reduced-motion:no-preference){:root{scroll-behavior:smooth}}::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}::slotted(svg){vertical-align:middle}}`;class Ue extends ke{emit(e,t){const l=new CustomEvent(e,Object.assign({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(l),l}static define(e,t=this,l={}){if(customElements.get(e));else try{customElements.define(e,t,l)}catch(r){customElements.define(e,class extends t{},l)}}constructor(){super(),this.ssr=Boolean(this.shadowRoot),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}firstUpdated(e){var t;super.firstUpdated(e),this.ssr&&(null===(t=this.shadowRoot)||void 0===t||t.querySelectorAll("slot").forEach(e=>{e.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}))}}Ue.styles=[Ne],Ue.dependencies={},e([P({type:Boolean,reflect:!0})],Ue.prototype,"ssr",void 0);var Ie,Re,De=i`:host{--btn-font-weight:var(--sit-font-weight-regular);--btn-color:var(--sit-color-fixed-light);--btn-bg:var(--sit-primary-surface-default);--btn-hover-bg:var(--sit-primary-surface-emphasis);--btn-border-radius:var(--sit-border-radius-md);--btn-opacity:var(--sit-opacity-100,1)}:host([variant=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=brand]){--btn-bg:var(--sit-primary-surface-default);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline]){--btn-border-width:var(--sit-border-width-1)}:host([variant=outline][tone=brand]){--btn-border-color:var(--sit-primary-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-color:var(--sit-primary-color-default);--btn-hover-bg:var(--sit-primary-bg-translucent)}:host([variant=ghost][tone=brand]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-primary-surface-translucent);--btn-color:var(--sit-primary-color-default)}:host([variant=primary][tone=danger]){--btn-bg:var(--sit-danger-surface-default);--btn-hover-bg:var(--sit-danger-surface-emphasis);--btn-color:var(--sit-color-fixed-light)}:host([variant=outline][tone=danger]){--btn-border-color:var(--sit-danger-border-color-default);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=ghost][tone=danger]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-danger-surface-translucent);--btn-color:var(--sit-danger-color-default)}:host([variant=primary][tone=fixed-light]){--btn-bg:var(--sit-surface-fixed-light);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 0%,var(--sit-bg-translucent-fixed-dark,hsla(0,0%,5%,.2)) 100%),var(--sit-surface-fixed-light,#fff);--btn-color:var(--sit-color-fixed-dark)}:host([variant=outline][tone=fixed-light]){--btn-border-color:var(--sit-border-color-fixed-light);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=ghost][tone=fixed-light]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-fixed-dark) 0%,var(--sit-bg-translucent-fixed-dark) 100%),var(--sit-bg-transparent);--btn-color:var(--sit-color-fixed-light)}:host([variant=primary][tone=neutral]){--btn-bg:var(--sit-surface-inverse);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-surface-inverse);--btn-color:var(--sit-color-inverse)}:host([variant=outline][tone=neutral]){--btn-border-color:var(--sit-border-color-emphasis);--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:linear-gradient(0deg,var(--sit-bg-translucent-inverse) 0%,var(--sit-bg-translucent-inverse) 100%),var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost][tone=neutral]){--btn-bg:var(--sit-bg-transparent);--btn-hover-bg:var(--sit-bg-translucent-subtle);--btn-color:var(--sit-color-default)}:host([variant=ghost]) .btn,:host([variant=outline]) .btn,:host([variant=primary]) .btn{color:var(--btn-color)}:host([variant=outline]) .btn{border:var(--btn-border-width) solid var(--btn-border-color)}:host([size=lg]) .btn{font-size:var(--sit-font-size-label-lg);height:var(--sit-dimension-56);line-height:var(--sit-line-height-md);min-width:var(--sit-dimension-112);padding:var(--sit-padding-none) var(--sit-padding-xl)}:host([size=sm]) .btn{font-size:var(--sit-font-size-label-sm);height:var(--sit-dimension-40);line-height:var(--sit-line-height-2-xs);min-width:var(--sit-dimension-80);padding:var(--sit-padding-none) var(--sit-padding-md)}:host([size=xs]) .btn{font-size:var(--sit-font-size-label-xs);height:var(--sit-dimension-32);line-height:var(--sit-line-height-3-xs);min-width:var(--sit-dimension-64);padding:var(--sit-padding-none) var(--sit-padding-sm)}.btn{align-items:center;background-color:var(--btn-bg);border:var(--sit-border-width-1) solid var(--sit-border-color-transparent);border-radius:var(--btn-border-radius);color:var(--sit-color-fixed-light);cursor:pointer;display:inline-flex;font-size:var(--sit-font-size-label-md);font-weight:var(--btn-font-weight);gap:var(--sit-gap-2-xs);height:var(--sit-dimension-48);justify-content:center;line-height:var(--sit-line-height-xs);min-width:var(--sit-dimension-96);opacity:var(--btn-opacity);padding:var(--sit-padding-none) var(--sit-padding-lg);text-align:center;text-decoration:none;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;user-select:none;vertical-align:middle;white-space:nowrap;width:inherit}@media (prefers-reduced-motion:reduce){.btn{transition:none}}.btn.active,.btn:hover{background:var(--btn-hover-bg)}.btn:focus-visible{background:var(--btn-hover-bg);border-color:transparent;outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.btn.disabled,.btn:disabled{color:var(--btn-color);cursor:not-allowed;opacity:var(--sit-opacity-40)}.btn.loading{cursor:default}.btn slot::slotted(*){color:var(--btn-color)}`;class We extends Ue{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.active=!1,this.disabled=!1,this.target="_self"}focus(e){this.button.focus(e)}click(){this.button.click()}blur(){this.button.blur()}_handleBlur(){this.emit("sit-blur")}_handleFocus(){this.emit("sit-focus")}_handleClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation()}_handleKeydown(e){if("Enter"===e.key&&this.loading)return e.preventDefault(),void e.stopPropagation()}_assignSpinnerSize(e){return"xs"===e||"sm"===e?"xs":"md"===e||"lg"===e?"sm":void 0}_assignSpinnerTone(e,t){return"fixed-light"===e&&"primary"===t?"fixed-dark":"neutral"===e&&"primary"===t?"inverse":"fixed-light"===e||"primary"===t?"fixed-light":"neutral"!==e||"outline"!==t&&"ghost"!==t?"brand":"neutral"}}We.styles=[...Ue.styles,De],e([(Ie=".btn",(e,t,l)=>{const r=e=>{const l=e.renderRoot?.querySelector(Ie)??null;if(null===l&&Re&&!e.hasUpdated){const e="object"==typeof t?t.name:t;O("",`@query'd field ${JSON.stringify(String(e))} with the 'cache' flag set for selector '${Ie}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(Re){const{get:o,set:n}="object"==typeof t?e:l??(()=>{const e=Symbol(`${String(t)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return z(e,t,{get(){let e=o.call(this);return void 0===e&&(e=r(this),(null!==e||this.hasUpdated)&&n.call(this,e)),e}})}return z(e,t,{get(){return r(this)}})})],We.prototype,"button",void 0),e([P({reflect:!0})],We.prototype,"variant",void 0),e([P({reflect:!0})],We.prototype,"tone",void 0),e([P({reflect:!0})],We.prototype,"size",void 0),e([P({type:Boolean,reflect:!0})],We.prototype,"active",void 0),e([P({type:Boolean,reflect:!0})],We.prototype,"disabled",void 0),e([P({type:String,reflect:!0})],We.prototype,"href",void 0),e([P({type:String,reflect:!0})],We.prototype,"target",void 0),e([P({type:String,reflect:!0})],We.prototype,"download",void 0),e([P({type:String})],We.prototype,"ariaLabel",void 0),e([P({type:Boolean})],We.prototype,"loading",void 0);const qe={announcement:()=>Promise.resolve().then(function(){return nt}),archive:()=>Promise.resolve().then(function(){return at}),"arrow-bar-down":()=>Promise.resolve().then(function(){return st}),"arrow-bar-left":()=>Promise.resolve().then(function(){return dt}),"arrow-bar-right":()=>Promise.resolve().then(function(){return ut}),"arrow-bar-up":()=>Promise.resolve().then(function(){return pt}),"arrow-circle-down":()=>Promise.resolve().then(function(){return wt}),"arrow-circle-left":()=>Promise.resolve().then(function(){return _t}),"arrow-circle-right":()=>Promise.resolve().then(function(){return bt}),"arrow-circle-up":()=>Promise.resolve().then(function(){return Ct}),"arrow-clockwise":()=>Promise.resolve().then(function(){return yt}),"arrow-down":()=>Promise.resolve().then(function(){return Ht}),"arrow-left":()=>Promise.resolve().then(function(){return zt}),"arrow-repeat":()=>Promise.resolve().then(function(){return jt}),"arrow-right":()=>Promise.resolve().then(function(){return $t}),"arrow-square-down":()=>Promise.resolve().then(function(){return Lt}),"arrow-square-left":()=>Promise.resolve().then(function(){return kt}),"arrow-square-right":()=>Promise.resolve().then(function(){return Tt}),"arrow-square-up":()=>Promise.resolve().then(function(){return Ut}),"arrow-up":()=>Promise.resolve().then(function(){return Rt}),"bank-fill":()=>Promise.resolve().then(function(){return Wt}),"bell-slash":()=>Promise.resolve().then(function(){return Ft}),bell:()=>Promise.resolve().then(function(){return Kt}),"bi-funnel":()=>Promise.resolve().then(function(){return Xt}),"bookmark-fill":()=>Promise.resolve().then(function(){return Qt}),bookmark:()=>Promise.resolve().then(function(){return tl}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return rl}),"box-seam":()=>Promise.resolve().then(function(){return nl}),building:()=>Promise.resolve().then(function(){return al}),bus:()=>Promise.resolve().then(function(){return sl}),calculator:()=>Promise.resolve().then(function(){return dl}),"calendar-check":()=>Promise.resolve().then(function(){return ul}),"calendar-heart":()=>Promise.resolve().then(function(){return pl}),"calendar-x":()=>Promise.resolve().then(function(){return wl}),calendar:()=>Promise.resolve().then(function(){return _l}),camera:()=>Promise.resolve().then(function(){return bl}),car:()=>Promise.resolve().then(function(){return Cl}),"chat-dots":()=>Promise.resolve().then(function(){return yl}),"chat-left-text":()=>Promise.resolve().then(function(){return Hl}),chat:()=>Promise.resolve().then(function(){return zl}),"check-circle-fill":()=>Promise.resolve().then(function(){return jl}),"check-circle":()=>Promise.resolve().then(function(){return $l}),check:()=>Promise.resolve().then(function(){return Ll}),"chevron-down":()=>Promise.resolve().then(function(){return kl}),"chevron-left":()=>Promise.resolve().then(function(){return Tl}),"chevron-right":()=>Promise.resolve().then(function(){return Ul}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return Rl}),"chevron-up":()=>Promise.resolve().then(function(){return Wl}),clock:()=>Promise.resolve().then(function(){return Fl}),"cloud-check":()=>Promise.resolve().then(function(){return Kl}),"cloud-download":()=>Promise.resolve().then(function(){return Xl}),"cloud-upload":()=>Promise.resolve().then(function(){return Ql}),cloud:()=>Promise.resolve().then(function(){return tr}),"code-square":()=>Promise.resolve().then(function(){return rr}),"coins-hand":()=>Promise.resolve().then(function(){return nr}),compass:()=>Promise.resolve().then(function(){return ar}),copy:()=>Promise.resolve().then(function(){return sr}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return dr}),cross:()=>Promise.resolve().then(function(){return ur}),"cursor-fill":()=>Promise.resolve().then(function(){return pr}),cursor:()=>Promise.resolve().then(function(){return wr}),"dash-circle":()=>Promise.resolve().then(function(){return _r}),"dash-square":()=>Promise.resolve().then(function(){return br}),dash:()=>Promise.resolve().then(function(){return Cr}),database:()=>Promise.resolve().then(function(){return yr}),dataflow:()=>Promise.resolve().then(function(){return Hr}),download:()=>Promise.resolve().then(function(){return zr}),edit:()=>Promise.resolve().then(function(){return jr}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return $r}),"exclamation-circle":()=>Promise.resolve().then(function(){return Lr}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return kr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return Tr}),exclamation:()=>Promise.resolve().then(function(){return Ur}),"eye-fill":()=>Promise.resolve().then(function(){return Rr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return Wr}),"eye-slash":()=>Promise.resolve().then(function(){return Fr}),eye:()=>Promise.resolve().then(function(){return Kr}),"face-smile-fill":()=>Promise.resolve().then(function(){return Xr}),"face-smile":()=>Promise.resolve().then(function(){return Qr}),facebook:()=>Promise.resolve().then(function(){return to}),"file-earmark-text":()=>Promise.resolve().then(function(){return ro}),"file-pdf":()=>Promise.resolve().then(function(){return no}),"file-plus":()=>Promise.resolve().then(function(){return ao}),"file-text":()=>Promise.resolve().then(function(){return so}),file:()=>Promise.resolve().then(function(){return vo}),files:()=>Promise.resolve().then(function(){return fo}),fingerprint:()=>Promise.resolve().then(function(){return go}),flash:()=>Promise.resolve().then(function(){return mo}),"folder-check":()=>Promise.resolve().then(function(){return Zo}),"folder-minus":()=>Promise.resolve().then(function(){return xo}),"folder-plus":()=>Promise.resolve().then(function(){return Mo}),folder:()=>Promise.resolve().then(function(){return Vo}),gear:()=>Promise.resolve().then(function(){return Po}),"geo-alt":()=>Promise.resolve().then(function(){return Oo}),"geo-fill":()=>Promise.resolve().then(function(){return Bo}),geo:()=>Promise.resolve().then(function(){return So}),"globe-alt":()=>Promise.resolve().then(function(){return Ao}),globe:()=>Promise.resolve().then(function(){return Eo}),google:()=>Promise.resolve().then(function(){return No}),"grid-alt":()=>Promise.resolve().then(function(){return Io}),"grid-fill":()=>Promise.resolve().then(function(){return Do}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return qo}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return Jo}),"hard-drive":()=>Promise.resolve().then(function(){return Yo}),heart:()=>Promise.resolve().then(function(){return Go}),"house-door":()=>Promise.resolve().then(function(){return en}),house:()=>Promise.resolve().then(function(){return ln}),image:()=>Promise.resolve().then(function(){return on}),"in-box":()=>Promise.resolve().then(function(){return an}),"info-circle-fill":()=>Promise.resolve().then(function(){return sn}),"info-circle":()=>Promise.resolve().then(function(){return dn}),instagram:()=>Promise.resolve().then(function(){return un}),key:()=>Promise.resolve().then(function(){return pn}),"laptop-gear":()=>Promise.resolve().then(function(){return wn}),laptop:()=>Promise.resolve().then(function(){return _n}),layers:()=>Promise.resolve().then(function(){return bn}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return Cn}),"layout-text-window":()=>Promise.resolve().then(function(){return yn}),layout:()=>Promise.resolve().then(function(){return Hn}),"life-buoy":()=>Promise.resolve().then(function(){return zn}),lightbulb:()=>Promise.resolve().then(function(){return jn}),link:()=>Promise.resolve().then(function(){return $n}),linkedin:()=>Promise.resolve().then(function(){return Ln}),list:()=>Promise.resolve().then(function(){return kn}),"lock-fill":()=>Promise.resolve().then(function(){return Tn}),lock:()=>Promise.resolve().then(function(){return Un}),login:()=>Promise.resolve().then(function(){return Rn}),logout:()=>Promise.resolve().then(function(){return Wn}),luggage:()=>Promise.resolve().then(function(){return Fn}),"mail-open":()=>Promise.resolve().then(function(){return Kn}),mail:()=>Promise.resolve().then(function(){return Xn}),map:()=>Promise.resolve().then(function(){return Qn}),meetup:()=>Promise.resolve().then(function(){return ti}),menu:()=>Promise.resolve().then(function(){return ri}),microphone:()=>Promise.resolve().then(function(){return ni}),monitor:()=>Promise.resolve().then(function(){return ai}),moon:()=>Promise.resolve().then(function(){return si}),move:()=>Promise.resolve().then(function(){return di}),paperclip:()=>Promise.resolve().then(function(){return ui}),passcode:()=>Promise.resolve().then(function(){return pi}),passport:()=>Promise.resolve().then(function(){return wi}),pause:()=>Promise.resolve().then(function(){return _i}),pencil:()=>Promise.resolve().then(function(){return bi}),"pending-circle":()=>Promise.resolve().then(function(){return Ci}),"person-dash":()=>Promise.resolve().then(function(){return yi}),"person-plus":()=>Promise.resolve().then(function(){return Hi}),"person-x":()=>Promise.resolve().then(function(){return zi}),person:()=>Promise.resolve().then(function(){return ji}),phone:()=>Promise.resolve().then(function(){return $i}),"pin-map-fill":()=>Promise.resolve().then(function(){return Li}),pin:()=>Promise.resolve().then(function(){return ki}),placeholder:()=>Promise.resolve().then(function(){return Ti}),plane:()=>Promise.resolve().then(function(){return Ui}),play:()=>Promise.resolve().then(function(){return Ri}),"plus-circle":()=>Promise.resolve().then(function(){return Wi}),"plus-square":()=>Promise.resolve().then(function(){return Fi}),plus:()=>Promise.resolve().then(function(){return Ki}),printer:()=>Promise.resolve().then(function(){return Xi}),"question-circle":()=>Promise.resolve().then(function(){return Qi}),rocket:()=>Promise.resolve().then(function(){return ta}),save:()=>Promise.resolve().then(function(){return ra}),search:()=>Promise.resolve().then(function(){return na}),send:()=>Promise.resolve().then(function(){return aa}),"sg-crest":()=>Promise.resolve().then(function(){return sa}),share:()=>Promise.resolve().then(function(){return da}),"shield-tick":()=>Promise.resolve().then(function(){return ua}),"sidebar-collapse":()=>Promise.resolve().then(function(){return pa}),"sidebar-expand":()=>Promise.resolve().then(function(){return wa}),"slash-circle":()=>Promise.resolve().then(function(){return _a}),"slash-divider":()=>Promise.resolve().then(function(){return ba}),sliders:()=>Promise.resolve().then(function(){return Ca}),"sort-ascending":()=>Promise.resolve().then(function(){return ya}),"sort-descending":()=>Promise.resolve().then(function(){return Ha}),speedometer:()=>Promise.resolve().then(function(){return za}),"star-ai":()=>Promise.resolve().then(function(){return ja}),"star-fill":()=>Promise.resolve().then(function(){return $a}),star:()=>Promise.resolve().then(function(){return La}),stoplights:()=>Promise.resolve().then(function(){return ka}),sun:()=>Promise.resolve().then(function(){return Ta}),"switch-horizontal":()=>Promise.resolve().then(function(){return Ua}),"switch-vertical":()=>Promise.resolve().then(function(){return Ra}),tablet:()=>Promise.resolve().then(function(){return Wa}),telegram:()=>Promise.resolve().then(function(){return Fa}),telephone:()=>Promise.resolve().then(function(){return Ka}),"three-dots-vertical":()=>Promise.resolve().then(function(){return Xa}),"three-dots":()=>Promise.resolve().then(function(){return Qa}),ticket:()=>Promise.resolve().then(function(){return tc}),"toggle-off":()=>Promise.resolve().then(function(){return rc}),"toggle-on":()=>Promise.resolve().then(function(){return nc}),train:()=>Promise.resolve().then(function(){return ac}),translate:()=>Promise.resolve().then(function(){return sc}),trash:()=>Promise.resolve().then(function(){return dc}),"trend-down":()=>Promise.resolve().then(function(){return uc}),"trend-up":()=>Promise.resolve().then(function(){return pc}),truck:()=>Promise.resolve().then(function(){return wc}),"twitter-x":()=>Promise.resolve().then(function(){return _c}),unlock:()=>Promise.resolve().then(function(){return bc}),upload:()=>Promise.resolve().then(function(){return Cc}),"user-check":()=>Promise.resolve().then(function(){return yc}),"user-circle":()=>Promise.resolve().then(function(){return Hc}),"user-pause":()=>Promise.resolve().then(function(){return zc}),"user-square":()=>Promise.resolve().then(function(){return jc}),users:()=>Promise.resolve().then(function(){return $c}),"video-recorder":()=>Promise.resolve().then(function(){return Lc}),"volume-max":()=>Promise.resolve().then(function(){return kc}),"volume-x":()=>Promise.resolve().then(function(){return Tc}),"window-dash":()=>Promise.resolve().then(function(){return Uc}),"window-desktop":()=>Promise.resolve().then(function(){return Rc}),"window-dock":()=>Promise.resolve().then(function(){return Wc}),"window-fullscreen":()=>Promise.resolve().then(function(){return Fc}),"window-plus":()=>Promise.resolve().then(function(){return Kc}),"window-sidebar":()=>Promise.resolve().then(function(){return Xc}),"window-split":()=>Promise.resolve().then(function(){return Qc}),"window-stack":()=>Promise.resolve().then(function(){return ts}),"window-x":()=>Promise.resolve().then(function(){return rs}),window:()=>Promise.resolve().then(function(){return ns}),"xcircle-fill":()=>Promise.resolve().then(function(){return as}),xcircle:()=>Promise.resolve().then(function(){return ss}),youtube:()=>Promise.resolve().then(function(){return ds}),"zoom-in":()=>Promise.resolve().then(function(){return us}),"zoom-out":()=>Promise.resolve().then(function(){return ps})};var Fe=i`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const Je=new Map;class Ke extends Ue{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(Je.has(e))return void(this._icon=Je.get(e));const t=qe[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();Je.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:ce}}var Ye;Ke.styles=[...Ue.styles,Fe],e([P({type:String,reflect:!0})],Ke.prototype,"name",void 0),e([P({type:String,reflect:!0})],Ke.prototype,"size",void 0),e([P({type:String})],Ke.prototype,"ariaLabel",void 0),e([P({...Ye,state:!0,attribute:!1})],Ke.prototype,"_icon",void 0);var Xe=i`:host{--sit-spinner-bg:var(--sit-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sit-spinner-bg:var(--sit-neutral-surface-default)}:host([tone=neutral]){--sit-spinner-bg:var(--sit-surface-inverse)}:host([tone=inverse]){--sit-spinner-bg:var(--sit-surface-default)}:host([tone=fixed-light]){--sit-spinner-bg:var(--sit-surface-fixed-light)}:host([tone=fixed-dark]){--sit-spinner-bg:var(--sit-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sit-gap-2-xs)}.spinner-wrapper.spinner-wrapper--horizontal{flex-direction:row}.spinner-wrapper__spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sit-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sit-spinner-bg);color:var(--sit-spinner-color);display:inline-flex;height:var(--sit-dimension-32);width:var(--sit-dimension-32)}.spinner-wrapper__spinner--xs{--border-thickness:2px;height:var(--sit-dimension-16);width:var(--sit-dimension-16)}.spinner-wrapper__spinner--sm{--border-thickness:3px;height:var(--sit-dimension-24);width:var(--sit-dimension-24)}.spinner-wrapper__spinner--lg{--border-thickness:6px;height:var(--sit-dimension-48);width:var(--sit-dimension-48)}.spinner-wrapper__spinner--xl{--border-thickness:8px;height:var(--sit-dimension-64);width:var(--sit-dimension-64)}.spinner-wrapper__label{color:var(--sit-neutral-color-default);font-size:var(--sit-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner-wrapper__spinner{animation-duration:1.5s}}

/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,Ge=i`.text-primary{color:var(--sit-primary-rgb)!important}.text-secondary{color:var(--sit-secondary-rgb)!important}.text-success{color:var(--sit-success-rgb)!important}.text-info{color:var(--sit-info-rgb)!important}.text-warning{color:var(--sit-warning-rgb)!important}.text-danger{color:var(--sit-danger-rgb)!important}.text-light{color:var(--sit-light-rgb)!important}.text-dark{color:var(--sit-dark-rgb)!important}.text-muted{color:var(--sit-secondary-color)!important}`;class Qe extends Ue{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return $e`
      <div
        class="spinner-wrapper ${Ve({"spinner-wrapper--horizontal":"horizontal"===this.orientation})}"
      >
        <div
          class="spinner-wrapper__spinner ${Ve({[`spinner-wrapper__spinner--${this.size}`]:this.size})}"
          role="status"
        >
          ${this.label?ce:$e`<span class="sr-only">Loading...</span>`}
        </div>
        ${this.label?$e`<span class="spinner-wrapper__label">${this.label}</span>`:ce}
      </div>
    `}}Qe.styles=[...Ue.styles,Ge,Xe],e([P({type:String,reflect:!0})],Qe.prototype,"variant",void 0),e([P({type:String,reflect:!0})],Qe.prototype,"tone",void 0),e([P({type:String,reflect:!0})],Qe.prototype,"size",void 0),e([P({reflect:!0,type:String})],Qe.prototype,"label",void 0),e([P({type:String,reflect:!0})],Qe.prototype,"orientation",void 0);var et,tt,lt=i`:host{display:inline-block}.btn.btn-icon{display:flex;height:var(--sit-dimension-48,56px);min-width:unset;padding:0;width:var(--sit-dimension-48,56px)}.btn.btn-icon.btn-lg{height:var(--sit-dimension-56);min-width:unset;padding:0;width:var(--sit-dimension-56)}.btn.btn-icon.btn-sm{height:var(--sit-dimension-40);min-width:unset;padding:0;width:var(--sit-dimension-40)}.btn.btn-icon.btn-xs{height:var(--sit-dimension-32);min-width:unset;padding:0;width:var(--sit-dimension-32)}`;class rt extends We{_assignIconSize(e){return"xs"===e?"sm":"sm"===e?"md":"md"===e?"lg":"lg"===e?"xl":void 0}render(){const e=this.href,t=e?je`a`:je`button`;return $e`
          <${t}
            class="btn btn-icon${Ve({disabled:this.disabled,active:this.active,[`btn-${this.variant}`]:this.variant,[`btn-${this.size}`]:this.size,loading:this.loading})}"
            ...
            rel=${Pe(e&&"_blank"===this.target?"noreferrer noopener":void 0)}
            role=${Pe(e?"button":void 0)}
            ...
            aria-label=${Pe(this.loading?"Loading":this.ariaLabel)}
          >
            ${this.loading?$e`<sit-spinner
                    size=${Pe(this._assignSpinnerSize(this.size))}
                    tone=${Pe(this._assignSpinnerTone(this.tone,this.variant))}
                  ></sit-spinner>`:$e`<sit-icon
                    name=${Pe(this.name)}
                    size=${Pe(this._assignIconSize(this.size))}
                  ></sit-icon>`}
          </${t}>
        `}}rt.styles=[...We.styles,lt],rt.dependencies={"sit-icon":Ke,"sit-spinner":Qe},e([P({type:String,reflect:!0})],rt.prototype,"name",void 0),et="sit-icon-button",tt=rt,customElements.get(et)||customElements.define(et,tt);var ot=ne`
...
`,nt=Object.freeze({__proto__:null,default:ot}),it=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,at=Object.freeze({__proto__:null,default:it}),ct=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,st=Object.freeze({__proto__:null,default:ct}),ht=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,dt=Object.freeze({__proto__:null,default:ht}),vt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ut=Object.freeze({__proto__:null,default:vt}),ft=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pt=Object.freeze({__proto__:null,default:ft}),gt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wt=Object.freeze({__proto__:null,default:gt}),mt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,_t=Object.freeze({__proto__:null,default:mt}),Zt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bt=Object.freeze({__proto__:null,default:Zt}),xt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ct=Object.freeze({__proto__:null,default:xt}),Mt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yt=Object.freeze({__proto__:null,default:Mt}),Vt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ht=Object.freeze({__proto__:null,default:Vt}),Pt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zt=Object.freeze({__proto__:null,default:Pt}),Ot=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jt=Object.freeze({__proto__:null,default:Ot}),Bt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$t=Object.freeze({__proto__:null,default:Bt}),St=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Lt=Object.freeze({__proto__:null,default:St}),At=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,kt=Object.freeze({__proto__:null,default:At}),Et=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Tt=Object.freeze({__proto__:null,default:Et}),Nt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ut=Object.freeze({__proto__:null,default:Nt}),It=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rt=Object.freeze({__proto__:null,default:It}),Dt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wt=Object.freeze({__proto__:null,default:Dt}),qt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ft=Object.freeze({__proto__:null,default:qt}),Jt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kt=Object.freeze({__proto__:null,default:Jt}),Yt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xt=Object.freeze({__proto__:null,default:Yt}),Gt=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qt=Object.freeze({__proto__:null,default:Gt}),el=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,tl=Object.freeze({__proto__:null,default:el}),ll=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rl=Object.freeze({__proto__:null,default:ll}),ol=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nl=Object.freeze({__proto__:null,default:ol}),il=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,al=Object.freeze({__proto__:null,default:il}),cl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sl=Object.freeze({__proto__:null,default:cl}),hl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dl=Object.freeze({__proto__:null,default:hl}),vl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ul=Object.freeze({__proto__:null,default:vl}),fl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pl=Object.freeze({__proto__:null,default:fl}),gl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wl=Object.freeze({__proto__:null,default:gl}),ml=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_l=Object.freeze({__proto__:null,default:ml}),Zl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bl=Object.freeze({__proto__:null,default:Zl}),xl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Cl=Object.freeze({__proto__:null,default:xl}),Ml=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,yl=Object.freeze({__proto__:null,default:Ml}),Vl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Hl=Object.freeze({__proto__:null,default:Vl}),Pl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zl=Object.freeze({__proto__:null,default:Pl}),Ol=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jl=Object.freeze({__proto__:null,default:Ol}),Bl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$l=Object.freeze({__proto__:null,default:Bl}),Sl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ll=Object.freeze({__proto__:null,default:Sl}),Al=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kl=Object.freeze({__proto__:null,default:Al}),El=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tl=Object.freeze({__proto__:null,default:El}),Nl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ul=Object.freeze({__proto__:null,default:Nl}),Il=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Rl=Object.freeze({__proto__:null,default:Il}),Dl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wl=Object.freeze({__proto__:null,default:Dl}),ql=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fl=Object.freeze({__proto__:null,default:ql}),Jl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kl=Object.freeze({__proto__:null,default:Jl}),Yl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xl=Object.freeze({__proto__:null,default:Yl}),Gl=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ql=Object.freeze({__proto__:null,default:Gl}),er=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,tr=Object.freeze({__proto__:null,default:er}),lr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rr=Object.freeze({__proto__:null,default:lr}),or=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,nr=Object.freeze({__proto__:null,default:or}),ir=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ar=Object.freeze({__proto__:null,default:ir}),cr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sr=Object.freeze({__proto__:null,default:cr}),hr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dr=Object.freeze({__proto__:null,default:hr}),vr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ur=Object.freeze({__proto__:null,default:vr}),fr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pr=Object.freeze({__proto__:null,default:fr}),gr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wr=Object.freeze({__proto__:null,default:gr}),mr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_r=Object.freeze({__proto__:null,default:mr}),Zr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,br=Object.freeze({__proto__:null,default:Zr}),xr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Cr=Object.freeze({__proto__:null,default:xr}),Mr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yr=Object.freeze({__proto__:null,default:Mr}),Vr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hr=Object.freeze({__proto__:null,default:Vr}),Pr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zr=Object.freeze({__proto__:null,default:Pr}),Or=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jr=Object.freeze({__proto__:null,default:Or}),Br=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$r=Object.freeze({__proto__:null,default:Br}),Sr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Lr=Object.freeze({__proto__:null,default:Sr}),Ar=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kr=Object.freeze({__proto__:null,default:Ar}),Er=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Tr=Object.freeze({__proto__:null,default:Er}),Nr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,Ur=Object.freeze({__proto__:null,default:Nr}),Ir=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Rr=Object.freeze({__proto__:null,default:Ir}),Dr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wr=Object.freeze({__proto__:null,default:Dr}),qr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fr=Object.freeze({__proto__:null,default:qr}),Jr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kr=Object.freeze({__proto__:null,default:Jr}),Yr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xr=Object.freeze({__proto__:null,default:Yr}),Gr=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qr=Object.freeze({__proto__:null,default:Gr}),eo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,to=Object.freeze({__proto__:null,default:eo}),lo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ro=Object.freeze({__proto__:null,default:lo}),oo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,no=Object.freeze({__proto__:null,default:oo}),io=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ao=Object.freeze({__proto__:null,default:io}),co=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,so=Object.freeze({__proto__:null,default:co}),ho=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,vo=Object.freeze({__proto__:null,default:ho}),uo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,fo=Object.freeze({__proto__:null,default:uo}),po=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,go=Object.freeze({__proto__:null,default:po}),wo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,mo=Object.freeze({__proto__:null,default:wo}),_o=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zo=Object.freeze({__proto__:null,default:_o}),bo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,xo=Object.freeze({__proto__:null,default:bo}),Co=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Mo=Object.freeze({__proto__:null,default:Co}),yo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vo=Object.freeze({__proto__:null,default:yo}),Ho=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Po=Object.freeze({__proto__:null,default:Ho}),zo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oo=Object.freeze({__proto__:null,default:zo}),jo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bo=Object.freeze({__proto__:null,default:jo}),$o=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,So=Object.freeze({__proto__:null,default:$o}),Lo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Ao=Object.freeze({__proto__:null,default:Lo}),ko=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Eo=Object.freeze({__proto__:null,default:ko}),To=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,No=Object.freeze({__proto__:null,default:To}),Uo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Io=Object.freeze({__proto__:null,default:Uo}),Ro=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Do=Object.freeze({__proto__:null,default:Ro}),Wo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,qo=Object.freeze({__proto__:null,default:Wo}),Fo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Jo=Object.freeze({__proto__:null,default:Fo}),Ko=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yo=Object.freeze({__proto__:null,default:Ko}),Xo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Go=Object.freeze({__proto__:null,default:Xo}),Qo=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,en=Object.freeze({__proto__:null,default:Qo}),tn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ln=Object.freeze({__proto__:null,default:tn}),rn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,on=Object.freeze({__proto__:null,default:rn}),nn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,an=Object.freeze({__proto__:null,default:nn}),cn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,sn=Object.freeze({__proto__:null,default:cn}),hn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dn=Object.freeze({__proto__:null,default:hn}),vn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,un=Object.freeze({__proto__:null,default:vn}),fn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,pn=Object.freeze({__proto__:null,default:fn}),gn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wn=Object.freeze({__proto__:null,default:gn}),mn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,_n=Object.freeze({__proto__:null,default:mn}),Zn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bn=Object.freeze({__proto__:null,default:Zn}),xn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Cn=Object.freeze({__proto__:null,default:xn}),Mn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yn=Object.freeze({__proto__:null,default:Mn}),Vn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hn=Object.freeze({__proto__:null,default:Vn}),Pn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zn=Object.freeze({__proto__:null,default:Pn}),On=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jn=Object.freeze({__proto__:null,default:On}),Bn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$n=Object.freeze({__proto__:null,default:Bn}),Sn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ln=Object.freeze({__proto__:null,default:Sn}),An=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,kn=Object.freeze({__proto__:null,default:An}),En=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tn=Object.freeze({__proto__:null,default:En}),Nn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Un=Object.freeze({__proto__:null,default:Nn}),In=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Rn=Object.freeze({__proto__:null,default:In}),Dn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wn=Object.freeze({__proto__:null,default:Dn}),qn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fn=Object.freeze({__proto__:null,default:qn}),Jn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kn=Object.freeze({__proto__:null,default:Jn}),Yn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xn=Object.freeze({__proto__:null,default:Yn}),Gn=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qn=Object.freeze({__proto__:null,default:Gn}),ei=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ti=Object.freeze({__proto__:null,default:ei}),li=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ri=Object.freeze({__proto__:null,default:li}),oi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ni=Object.freeze({__proto__:null,default:oi}),ii=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ai=Object.freeze({__proto__:null,default:ii}),ci=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,si=Object.freeze({__proto__:null,default:ci}),hi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,di=Object.freeze({__proto__:null,default:hi}),vi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ui=Object.freeze({__proto__:null,default:vi}),fi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pi=Object.freeze({__proto__:null,default:fi}),gi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wi=Object.freeze({__proto__:null,default:gi}),mi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,_i=Object.freeze({__proto__:null,default:mi}),Zi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bi=Object.freeze({__proto__:null,default:Zi}),xi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ci=Object.freeze({__proto__:null,default:xi}),Mi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yi=Object.freeze({__proto__:null,default:Mi}),Vi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hi=Object.freeze({__proto__:null,default:Vi}),Pi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zi=Object.freeze({__proto__:null,default:Pi}),Oi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ji=Object.freeze({__proto__:null,default:Oi}),Bi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$i=Object.freeze({__proto__:null,default:Bi}),Si=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Li=Object.freeze({__proto__:null,default:Si}),Ai=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ki=Object.freeze({__proto__:null,default:Ai}),Ei=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ti=Object.freeze({__proto__:null,default:Ei}),Ni=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ui=Object.freeze({__proto__:null,default:Ni}),Ii=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ri=Object.freeze({__proto__:null,default:Ii}),Di=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wi=Object.freeze({__proto__:null,default:Di}),qi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fi=Object.freeze({__proto__:null,default:qi}),Ji=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ki=Object.freeze({__proto__:null,default:Ji}),Yi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xi=Object.freeze({__proto__:null,default:Yi}),Gi=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Qi=Object.freeze({__proto__:null,default:Gi}),ea=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ta=Object.freeze({__proto__:null,default:ea}),la=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ra=Object.freeze({__proto__:null,default:la}),oa=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,na=Object.freeze({__proto__:null,default:oa}),ia=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,aa=Object.freeze({__proto__:null,default:ia}),ca=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="#DB0000"
...
`,sa=Object.freeze({__proto__:null,default:ca}),ha=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,da=Object.freeze({__proto__:null,default:ha}),va=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ua=Object.freeze({__proto__:null,default:va}),fa=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,pa=Object.freeze({__proto__:null,default:fa}),ga=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wa=Object.freeze({__proto__:null,default:ga}),ma=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ca=Object.freeze({__proto__:null,default:xa}),Ma=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ya=Object.freeze({__proto__:null,default:Ma}),Va=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ha=Object.freeze({__proto__:null,default:Va}),Pa=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,za=Object.freeze({__proto__:null,default:Pa}),Oa=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ja=Object.freeze({__proto__:null,default:Oa}),Ba=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$a=Object.freeze({__proto__:null,default:Ba}),Sa=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,La=Object.freeze({__proto__:null,default:Sa}),Aa=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ka=Object.freeze({__proto__:null,default:Aa}),Ea=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ta=Object.freeze({__proto__:null,default:Ea}),Na=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ua=Object.freeze({__proto__:null,default:Na}),Ia=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ra=Object.freeze({__proto__:null,default:Ia}),Da=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Wa=Object.freeze({__proto__:null,default:Da}),qa=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fa=Object.freeze({__proto__:null,default:qa}),Ja=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ka=Object.freeze({__proto__:null,default:Ja}),Ya=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xa=Object.freeze({__proto__:null,default:Ya}),Ga=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qa=Object.freeze({__proto__:null,default:Ga}),ec=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,tc=Object.freeze({__proto__:null,default:ec}),lc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rc=Object.freeze({__proto__:null,default:lc}),oc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nc=Object.freeze({__proto__:null,default:oc}),ic=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ac=Object.freeze({__proto__:null,default:ic}),cc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,sc=Object.freeze({__proto__:null,default:cc}),hc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,dc=Object.freeze({__proto__:null,default:hc}),vc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,uc=Object.freeze({__proto__:null,default:vc}),fc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,pc=Object.freeze({__proto__:null,default:fc}),gc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wc=Object.freeze({__proto__:null,default:gc}),mc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,_c=Object.freeze({__proto__:null,default:mc}),Zc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bc=Object.freeze({__proto__:null,default:Zc}),xc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Cc=Object.freeze({__proto__:null,default:xc}),Mc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,yc=Object.freeze({__proto__:null,default:Mc}),Vc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Hc=Object.freeze({__proto__:null,default:Vc}),Pc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zc=Object.freeze({__proto__:null,default:Pc}),Oc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jc=Object.freeze({__proto__:null,default:Oc}),Bc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$c=Object.freeze({__proto__:null,default:Bc}),Sc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lc=Object.freeze({__proto__:null,default:Sc}),Ac=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,kc=Object.freeze({__proto__:null,default:Ac}),Ec=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Tc=Object.freeze({__proto__:null,default:Ec}),Nc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Uc=Object.freeze({__proto__:null,default:Nc}),Ic=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Rc=Object.freeze({__proto__:null,default:Ic}),Dc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wc=Object.freeze({__proto__:null,default:Dc}),qc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fc=Object.freeze({__proto__:null,default:qc}),Jc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kc=Object.freeze({__proto__:null,default:Jc}),Yc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xc=Object.freeze({__proto__:null,default:Yc}),Gc=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qc=Object.freeze({__proto__:null,default:Gc}),es=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ts=Object.freeze({__proto__:null,default:es}),ls=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rs=Object.freeze({__proto__:null,default:ls}),os=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ns=Object.freeze({__proto__:null,default:os}),is=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,as=Object.freeze({__proto__:null,default:is}),cs=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ss=Object.freeze({__proto__:null,default:cs}),hs=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ds=Object.freeze({__proto__:null,default:hs}),vs=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,us=Object.freeze({__proto__:null,default:vs}),fs=ne`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ps=Object.freeze({__proto__:null,default:fs})});
