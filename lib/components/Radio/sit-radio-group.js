 ...
 *
 */
class SitRadioGroup extends SitFormValidatorMixin(FormControlElement) {
    constructor() {
        super(...arguments);
        /**@internal */
        this.defaultValue = "";
...
SitRadioGroup.styles = [...FormControlElement.styles, css_248z];
__decorate([
    query("slot:not([name])")
...
export { SitRadioGroup, SitRadioGroup as default };
//# sourceMappingURL=sit-radio-group.js.map
