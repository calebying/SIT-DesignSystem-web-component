...
import { SitInput } from '../Input/sit-input.js';
import css_248z$3 from './quantity-toggle.js';
import css_248z$2 from '../../styles/form-text-control.js';
 ...
 *
 */
class SitQuantityToggle extends SitFormValidatorMixin(FormControlElement) {
    constructor() {
        super(...arguments);
...
__decorate([
    query("sit-icon-button[ariaLabel^='increase by']")
], SitQuantityToggle.prototype, "plusBtn", void 0);
__decorate([
    query("sit-icon-button[ariaLabel^='decrease by']")
...
__decorate([
    queryAsync("sit-input")
], SitQuantityToggle.prototype, "_sitInput", void 0);

export { SitQuantityToggle, SitQuantityToggle as default };
//# sourceMappingURL=sit-quantity-toggle.js.map
