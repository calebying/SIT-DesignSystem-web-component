...
/**
   ...
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const Xe=()=>new Qe;class Qe{}const et=new WeakMap;const tt=Ue(class extends Je{render(e){return ie}update(e,[t]){const l=t!==this._ref;return l&&this._updateRefValue(void 0),(l||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),ie}_updateRefValue(e){if(void 0!==this._ref)if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let l=et.get(t);void 0===l&&(l=new WeakMap,et.set(t,l)),void 0!==l.get(this._ref)&&this._ref.call(this._context,void 0),l.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?et.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}}),lt=(e,t,l)=>{const i=new Map;for(let r=t;r<=l;r++)i.set(e[r],r);return i};
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,Ut=a`.text-primary{color:var(--sit-primary-rgb)!important}.text-secondary{color:var(--sit-secondary-rgb)!important}.text-success{color:var(--sit-success-rgb)!important}.text-info{color:var(--sit-info-rgb)!important}.text-warning{color:var(--sit-warning-rgb)!important}.text-danger{color:var(--sit-danger-rgb)!important}.text-light{color:var(--sit-light-rgb)!important}.text-dark{color:var(--sit-dark-rgb)!important}.text-muted{color:var(--sit-secondary-color)!important}`;class Rt extends ut{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return ht`
      <div
        class="spinner-wrapper ${rt({horizontal:"horizontal"===this.orientation})}"
      >
        <div
          class="spinner ${rt({[`spinner-${this.size}`]:this.size})}"
          role="status"
        >
          ${this.label?ie:ht`<span class="sr-only">Loading...</span>`}
        </div>
        ${this.label?ht`<span class="spinner-label">${this.label}</span>`:ie}
      </div>
