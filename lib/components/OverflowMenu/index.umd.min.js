...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
function Be(e){return(t,l)=>{const{slot:o,selector:n}=e??{},r="slot"+(o?`[name=${o}]`:":not([name])");return Oe(t,l,{get(){const t=this.renderRoot?.querySelector(r),l=t?.assignedElements(e)??[];return void 0===n?l:l.filter(e=>e.matches(n))}})}}globalThis.litIssuedWarnings??=new Set,ze=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))};class je extends Ze{emit(e,t){const l=new CustomEvent(e,Object.assign({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(l),l}static define(e,t=this,l={}){if(customElements.get(e));else try{customElements.define(e,t,l)}catch(o){customElements.define(e,class extends t{},l)}}constructor(){super(),this.ssr=Boolean(this.shadowRoot),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}firstUpdated(e){var t;super.firstUpdated(e),this.ssr&&(null===(t=this.shadowRoot)||void 0===t||t.querySelectorAll("slot").forEach(e=>{e.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}))}}je.styles=[Ce],je.dependencies={},e([He({type:Boolean,reflect:!0})],je.prototype,"ssr",void 0);var Ae=i`:host([size=sm]) .overflow-btn{height:var(--sit-dimension-24);width:var(--sit-dimension-24)}.overflow-btn{align-items:center;background-color:var(--sit-bg-transparent);border:0;border-radius:var(--sit-border-radius-sm);cursor:pointer;display:flex;height:var(--sit-dimension-32);justify-content:center;padding:0;position:relative;width:var(--sit-dimension-32)}.overflow-btn:hover{background-color:var(--sit-bg-translucent-subtle)}.overflow-btn:focus-visible{background-color:var(--sit-bg-translucent-subtle);outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}`
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */;window.ShadyDOM?.inUse&&!0===window.ShadyDOM?.noPatch&&window.ShadyDOM.wrap;const $e=1,Le=2,Se=e=>(...t)=>({_$litDirective$:e,values:t});
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class ke{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,l){this.__part=e,this._$parent=t,this.__attributeIndex=l}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const Ee=(e,t)=>{const l=e._$disconnectableChildren;if(void 0===l)return!1;for(const e of l)e._$notifyDirectiveConnectionChanged?.(t,!1),Ee(e,t);return!0},Te=e=>{let t,l;do{if(void 0===(t=e._$parent))break;l=t._$disconnectableChildren,l.delete(e),e=t}while(0===l?.size)},Re=e=>{for(let t;t=e._$parent;e=t){let l=t._$disconnectableChildren;if(void 0===l)t._$disconnectableChildren=l=new Set;else if(l.has(e))break;l.add(e),Ne(t)}};function Ie(e){void 0!==this._$disconnectableChildren?(Te(this),this._$parent=e,Re(this)):this._$parent=e}function De(e,t=!1,l=0){const o=this._$committedValue,n=this._$disconnectableChildren;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(o))for(let e=l;e<o.length;e++)Ee(o[e],!1),Te(o[e]);else null!=o&&(Ee(o,!1),Te(o));else Ee(this,e)}const Ne=e=>{e.type==Le&&(e._$notifyConnectionChanged??=De,e._$reparentDisconnectables??=Ie)};class Ue extends ke{constructor(){super(...arguments),this._$disconnectableChildren=void 0}_$initialize(e,t,l){super._$initialize(e,t,l),Re(this),this.isConnected=e._$isConnected}_$notifyDirectiveConnectionChanged(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ee(this,e),Te(this))}setValue(e){if(void 0===this.__part.strings)this.__part._$setValue(e,this);else{if(void 0===this.__attributeIndex)throw new Error("Expected this.__attributeIndex to be a number");const t=[...this.__part._$committedValue];t[this.__attributeIndex]=e,this.__part._$setValue(t,this,0)}}disconnected(){}reconnected(){}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const We=()=>new Fe;class Fe{}const qe=new WeakMap;const Ke=Se(class extends Ue{render(e){return le}update(e,[t]){const l=t!==this._ref;return l&&this._updateRefValue(void 0),(l||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),le}_updateRefValue(e){if(void 0!==this._ref)if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let l=qe.get(t);void 0===l&&(l=new WeakMap,qe.set(t,l)),void 0!==l.get(this._ref)&&this._ref.call(this._context,void 0),l.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?qe.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}}),Je=Math.min,Ye=Math.max,Xe=Math.round,Ge=Math.floor,Qe=e=>({x:e,y:e}),et={left:"right",right:"left",bottom:"top",top:"bottom"};function tt(e,t,l){return Ye(e,Je(t,l))}function lt(e,t){return"function"==typeof e?e(t):e}function ot(e){return e.split("-")[0]}function nt(e){return e.split("-")[1]}function rt(e){return"x"===e?"y":"x"}function it(e){return"y"===e?"height":"width"}function at(e){const t=e[0];return"t"===t||"b"===t?"y":"x"}function ct(e){return rt(at(e))}function st(e,t,l){void 0===l&&(l=!1);const o=nt(e),n=ct(e),r=it(n);let i="x"===n?o===(l?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[r]>t.floating[r]&&(i=gt(i)),[i,gt(i)]}function ht(e){return e.includes("start")?e.replace("start","end"):e.replace("end","start")}const dt=["left","right"],ut=["right","left"],vt=["top","bottom"],ft=["bottom","top"];function pt(e,t,l,o){const n=nt(e);let r=function(e,t,l){switch(e){case"top":case"bottom":return l?t?ut:dt:t?dt:ut;case"left":case"right":return t?vt:ft;default:return[]}}(ot(e),"start"===l,o);return n&&(r=r.map(e=>e+"-"+n),t&&(r=r.concat(r.map(ht)))),r}function gt(e){const t=ot(e);return et[t]+e.slice(t.length)}function wt(e){return"number"!=typeof e?function(e){var t,l,o,n;return{top:null!=(t=e.top)?t:0,right:null!=(l=e.right)?l:0,bottom:null!=(o=e.bottom)?o:0,left:null!=(n=e.left)?n:0}}(e):{top:e,right:e,bottom:e,left:e}}function mt(e){const{x:t,y:l,width:o,height:n}=e;return{width:o,height:n,top:l,left:t,right:t+o,bottom:l+n,x:t,y:l}}function _t(e,t,l){let{reference:o,floating:n}=e;const r=at(t),i=ct(t),a=it(i),c=ot(t),s="y"===r,h=o.x+o.width/2-n.width/2,d=o.y+o.height/2-n.height/2,u=o[a]/2-n[a]/2;let v;switch(c){case"top":v={x:h,y:o.y-n.height};break;case"bottom":v={x:h,y:o.y+o.height};break;case"right":v={x:o.x+o.width,y:d};break;case"left":v={x:o.x-n.width,y:d};break;default:v={x:o.x,y:o.y}}const f=nt(t);return f&&(v[i]+=u*("end"===f?1:-1)*(l&&s?-1:1)),v}async function Zt(e,t){var l;void 0===t&&(t={});const{x:o,y:n,platform:r,rects:i,elements:a,strategy:c}=e,{boundary:s="clippingAncestors",rootBoundary:h="viewport",elementContext:d="floating",altBoundary:u=!1,padding:v=0}=lt(t,e),f=wt(v),p=a[u?"floating"===d?"reference":"floating":d],g=mt(await r.getClippingRect({element:null==(l=await(null==r.isElement?void 0:r.isElement(p)))||l?p:p.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(a.floating)),boundary:s,rootBoundary:h,strategy:c})),w="floating"===d?{x:o,y:n,width:i.floating.width,height:i.floating.height}:i.reference,m=await(null==r.getOffsetParent?void 0:r.getOffsetParent(a.floating)),_=await(null==r.isElement?void 0:r.isElement(m))&&await(null==r.getScale?void 0:r.getScale(m))||{x:1,y:1},Z=mt(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:m,strategy:c}):w);return{top:(g.top-Z.top+f.top)/_.y,bottom:(Z.bottom-g.bottom+f.bottom)/_.y,left:(g.left-Z.left+f.left)/_.x,right:(Z.right-g.right+f.right)/_.x}}const xt=new Set(["left","top"]);function bt(){return"undefined"!=typeof window}function Ct(e){return Vt(e)?(e.nodeName||"").toLowerCase():"#document"}function Mt(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function yt(e){var t;return null==(t=(Vt(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Vt(e){return!!bt()&&(e instanceof Node||e instanceof Mt(e).Node)}function Ht(e){return!!bt()&&(e instanceof Element||e instanceof Mt(e).Element)}function Pt(e){return!!bt()&&(e instanceof HTMLElement||e instanceof Mt(e).HTMLElement)}function Ot(e){return!(!bt()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof Mt(e).ShadowRoot)}function zt(e){const{overflow:t,overflowX:l,overflowY:o,display:n}=Rt(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+l)&&"inline"!==n&&"contents"!==n}function Bt(e){return/^(table|td|th)$/.test(Ct(e))}function jt(e){try{if(e.matches(":popover-open"))return!0}catch(e){}try{return e.matches(":modal")}catch(e){return!1}}const At=/transform|translate|scale|rotate|perspective|filter/,$t=/paint|layout|strict|content/,Lt=e=>!!e&&"none"!==e;let St;function kt(e){const t=Ht(e)?Rt(e):e;return Lt(t.transform)||Lt(t.translate)||Lt(t.scale)||Lt(t.rotate)||Lt(t.perspective)||!Et()&&(Lt(t.backdropFilter)||Lt(t.filter))||At.test(t.willChange||"")||$t.test(t.contain||"")}function Et(){return null==St&&(St="undefined"!=typeof CSS&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),St}function Tt(e){return/^(html|body|#document)$/.test(Ct(e))}function Rt(e){return Mt(e).getComputedStyle(e)}function It(e){return Ht(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Dt(e){if("html"===Ct(e))return e;const t=e.assignedSlot||e.parentNode||Ot(e)&&e.host||yt(e);return Ot(t)?t.host:t}function Nt(e){const t=Dt(e);return Tt(t)?(e.ownerDocument||e).body:Pt(t)&&zt(t)?t:Nt(t)}function Ut(e,t,l){var o;void 0===t&&(t=[]),void 0===l&&(l=!0);const n=Nt(e),r=n===(null==(o=e.ownerDocument)?void 0:o.body),i=Mt(n);if(r){const e=Wt(i);return t.concat(i,i.visualViewport||[],zt(n)?n:[],e&&l?Ut(e):[])}return t.concat(n,Ut(n,[],l))}function Wt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ft(e){const t=Rt(e);let l=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const n=Pt(e),r=n?e.offsetWidth:l,i=n?e.offsetHeight:o,a=Xe(l)!==r||Xe(o)!==i;return a&&(l=r,o=i),{width:l,height:o,$:a}}function qt(e){return Ht(e)?e:e.contextElement}function Kt(e){const t=qt(e);if(!Pt(t))return Qe(1);const l=t.getBoundingClientRect(),{width:o,height:n,$:r}=Ft(t);let i=(r?Xe(l.width):l.width)/o,a=(r?Xe(l.height):l.height)/n;return i&&Number.isFinite(i)||(i=1),a&&Number.isFinite(a)||(a=1),{x:i,y:a}}const Jt=Qe(0);function Yt(e){const t=Mt(e);return Et()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Jt}function Xt(e,t,l,o){void 0===t&&(t=!1),void 0===l&&(l=!1);const n=e.getBoundingClientRect(),r=qt(e);let i=Qe(1);t&&(o?Ht(o)&&(i=Kt(o)):i=Kt(e));const a=function(e,t,l){return void 0===t&&(t=!1),!!l&&t&&l===Mt(e)}(r,l,o)?Yt(r):Qe(0);let c=(n.left+a.x)/i.x,s=(n.top+a.y)/i.y,h=n.width/i.x,d=n.height/i.y;if(r&&o){const e=Mt(r),t=Ht(o)?Mt(o):o;let l=e,n=Wt(l);for(;n&&t!==l;){const e=Kt(n),t=n.getBoundingClientRect(),o=Rt(n),r=t.left+(n.clientLeft+parseFloat(o.paddingLeft))*e.x,i=t.top+(n.clientTop+parseFloat(o.paddingTop))*e.y;c*=e.x,s*=e.y,h*=e.x,d*=e.y,c+=r,s+=i,l=Mt(n),n=Wt(l)}}return mt({width:h,height:d,x:c,y:s})}function Gt(e,t){const l=It(e).scrollLeft;return t?t.left+l:Xt(yt(e)).left+l}function Qt(e,t){const l=e.getBoundingClientRect();return{x:l.left+t.scrollLeft-Gt(e,l),y:l.top+t.scrollTop}}function el(e,t,l){let o;if("viewport"===t||"layoutViewport"===t)o=function(e,t,l){void 0===l&&(l="viewport");const o="layoutViewport"===l,n=Mt(e),r=yt(e),i=n.visualViewport;let a=r.clientWidth,c=r.clientHeight,s=0,h=0;if(i){const e=!Et()||"fixed"===t;o?e||(s=-i.offsetLeft,h=-i.offsetTop):(a=i.width,c=i.height,e&&(s=i.offsetLeft,h=i.offsetTop))}if(Gt(r)<=0){const e=r.ownerDocument,t=e.body,l=getComputedStyle(t),o="CSS1Compat"===e.compatMode&&parseFloat(l.marginLeft)+parseFloat(l.marginRight)||0,n=Math.abs(r.clientWidth-t.clientWidth-o),i="stable both-edges"===getComputedStyle(r).scrollbarGutter?n/2:n;i<=25&&(a-=i)}return{width:a,height:c,x:s,y:h}}(e,l,t);else if("document"===t)o=function(e){const t=It(e),l=e.ownerDocument.body,o=Ye(e.scrollWidth,e.clientWidth,l.scrollWidth,l.clientWidth),n=Ye(e.scrollHeight,e.clientHeight,l.scrollHeight,l.clientHeight);let r=-t.scrollLeft+Gt(e);const i=-t.scrollTop;return"rtl"===Rt(l).direction&&(r+=Ye(e.clientWidth,l.clientWidth)-o),{width:o,height:n,x:r,y:i}}(yt(e));else if(Ht(t))o=function(e,t){const l=Xt(e,!0,"fixed"===t),o=l.top+e.clientTop,n=l.left+e.clientLeft,r=Kt(e);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:n*r.x,y:o*r.y}}(t,l);else{const l=Yt(e);o={x:t.x-l.x,y:t.y-l.y,width:t.width,height:t.height}}return mt(o)}function tl(e,t,l){const o=Pt(t),n=yt(t),r="fixed"===l,i=Xt(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const c=Qe(0);if((o||!r)&&(("body"!==Ct(t)||zt(n))&&(a=It(t)),o)){const e=Xt(t,!0,r,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}!o&&n&&(c.x=Gt(n));const s=!n||o||r?Qe(0):Qt(n,a);return{x:i.left+a.scrollLeft-c.x-s.x,y:i.top+a.scrollTop-c.y-s.y,width:i.width,height:i.height}}function ll(e){return"static"===Rt(e).position}function ol(e,t){if(!Pt(e)||"fixed"===Rt(e).position)return null;if(t)return t(e);let l=e.offsetParent;return yt(e)===l&&(l=l.ownerDocument.body),l}function nl(e,t){const l=Mt(e);if(jt(e))return l;if(!Pt(e)){let t=Dt(e);for(;t&&!Tt(t);){if(Ht(t)&&!ll(t))return t;t=Dt(t)}return l}let o=ol(e,t);for(;o&&Bt(o)&&ll(o);)o=ol(o,t);return o&&Tt(o)&&ll(o)&&!kt(o)?l:o||function(e){let t=Dt(e);for(;Pt(t)&&!Tt(t);){if(kt(t))return t;if(jt(t))return null;t=Dt(t)}return null}(e)||l}const rl={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:l,offsetParent:o,strategy:n}=e;const r="fixed"===n,i=yt(o),a=!!t&&jt(t.floating);if(o===i||a&&r)return l;let c={scrollLeft:0,scrollTop:0},s=Qe(1);const h=Qe(0),d=Pt(o);if((d||!r)&&(("body"!==Ct(o)||zt(i))&&(c=It(o)),d)){const e=Xt(o);s=Kt(o),h.x=e.x+o.clientLeft,h.y=e.y+o.clientTop}const u=!i||d||r?Qe(0):Qt(i,c);return{width:l.width*s.x,height:l.height*s.y,x:l.x*s.x-c.scrollLeft*s.x+h.x+u.x,y:l.y*s.y-c.scrollTop*s.y+h.y+u.y}},getDocumentElement:yt,getClippingRect:function(e){let{element:t,boundary:l,rootBoundary:o,strategy:n}=e;const r=[..."clippingAncestors"===l?jt(t)?[]:function(e,t){const l=t.get(e);if(l)return l;let o=Ut(e,[],!1).filter(e=>Ht(e)&&"body"!==Ct(e)),n=null;const r="fixed"===Rt(e).position;let i=r?Dt(e):e;for(;Ht(i)&&!Tt(i);){const e=Rt(i),t=kt(i),l=n?n.position:r?"fixed":"";t||"fixed"!==l&&("absolute"!==l||"static"!==e.position)?n=e:o=o.filter(e=>e!==i),i=Dt(i)}return t.set(e,o),o}(t,this._c):[].concat(l),o],i=el(t,r[0],n);let a=i.top,c=i.right,s=i.bottom,h=i.left;for(let e=1;e<r.length;e++){const l=el(t,r[e],n);a=Ye(l.top,a),c=Je(l.right,c),s=Je(l.bottom,s),h=Ye(l.left,h)}return{width:c-h,height:s-a,x:h,y:a}},getOffsetParent:nl,getElementRects:async function(e){const t=this.getOffsetParent||nl,l=this.getDimensions,o=await l(e.floating);return{reference:tl(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return e.getClientRects?Array.from(e.getClientRects()):[]},getDimensions:function(e){const{width:t,height:l}=Ft(e);return{width:t,height:l}},getScale:Kt,isElement:Ht,isRTL:function(e){return"rtl"===Rt(e).direction}};function il(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function al(e,t,l,o){void 0===o&&(o={});const{ancestorScroll:n=!0,ancestorResize:r=!0,elementResize:i="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:c=!1}=o,s=qt(e),h=n||r?[...s?Ut(s):[],...t?Ut(t):[]]:[];h.forEach(e=>{n&&e.addEventListener("scroll",l),r&&e.addEventListener("resize",l)});const d=s&&a?function(e,t,l){let o,n=null;const r=yt(e);function i(){var e;clearTimeout(o),null==(e=n)||e.disconnect(),n=null}function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),i();const s=e.getBoundingClientRect(),{left:h,top:d,width:u,height:v}=s;if(l||t(),!u||!v)return;const f={rootMargin:-Ge(d)+"px "+-Ge(r.clientWidth-(h+u))+"px "+-Ge(r.clientHeight-(d+v))+"px "+-Ge(h)+"px",threshold:Ye(0,Je(1,c))||1};let p=!0;function g(t){const l=t[0].intersectionRatio;if(!il(s,e.getBoundingClientRect()))return a();if(l!==c){if(!p)return a();l?a(!1,l):o=setTimeout(()=>{a(!1,1e-7)},1e3)}p=!1}try{n=new IntersectionObserver(g,{...f,root:r.ownerDocument})}catch(e){n=new IntersectionObserver(g,f)}n.observe(e)}const c=Mt(e),s=()=>a(l);return c.addEventListener("resize",s),a(!0),()=>{c.removeEventListener("resize",s),i()}}(s,l,r):null;let u,v=-1,f=null;i&&(f=new ResizeObserver(e=>{let[o]=e;o&&o.target===s&&f&&t&&(f.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=f)||e.observe(t)})),l()}),s&&!c&&f.observe(s),t&&f.observe(t));let p=c?Xt(e):null;return c&&function t(){const o=Xt(e);p&&!il(p,o)&&l();p=o,u=requestAnimationFrame(t)}(),l(),()=>{var e;h.forEach(e=>{n&&e.removeEventListener("scroll",l),r&&e.removeEventListener("resize",l)}),null==d||d(),null==(e=f)||e.disconnect(),f=null,c&&cancelAnimationFrame(u)}}const cl=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var l,o;const{x:n,y:r,placement:i,middlewareData:a}=t,c=await async function(e,t){const{placement:l,platform:o,elements:n}=e,r=await(null==o.isRTL?void 0:o.isRTL(n.floating)),i=ot(l),a=nt(l),c="y"===at(l),s=xt.has(i)?-1:1,h=r&&c?-1:1,d=lt(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:f}="number"==typeof d?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&"number"==typeof f&&(v="end"===a?-1*f:f),c?{x:v*h,y:u*s}:{x:u*s,y:v*h}}(t,e);return i===(null==(l=a.offset)?void 0:l.placement)&&null!=(o=a.arrow)&&o.alignmentOffset?{}:{x:n+c.x,y:r+c.y,data:{...c,placement:i}}}}},sl=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:l,y:o,placement:n,platform:r}=t,{mainAxis:i=!0,crossAxis:a=!1,limiter:c={fn:e=>{let{x:t,y:l}=e;return{x:t,y:l}}},...s}=lt(e,t),h={x:l,y:o},d=await r.detectOverflow(t,s),u=at(n),v=rt(u);let f=h[v],p=h[u];const g=(e,t)=>tt(t+d["y"===e?"top":"left"],t,t-d["y"===e?"bottom":"right"]);i&&(f=g(v,f)),a&&(p=g(u,p));const w=c.fn({...t,[v]:f,[u]:p});return{...w,data:{x:w.x-l,y:w.y-o,enabled:{[v]:i,[u]:a}}}}}},hl=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var l,o;const{placement:n,middlewareData:r,rects:i,initialPlacement:a,platform:c,elements:s}=t,{mainAxis:h=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:p=!0,...g}=lt(e,t);if(null!=(l=r.arrow)&&l.alignmentOffset)return{};const w=ot(n),m=at(a),_=ot(a)===a,Z=await(null==c.isRTL?void 0:c.isRTL(s.floating)),x=u||(_||!p?[gt(a)]:function(e){const t=gt(e);return[ht(e),t,ht(t)]}(a)),b="none"!==f;!u&&b&&x.push(...pt(a,p,f,Z));const C=[a,...x],M=await c.detectOverflow(t,g),y=[];let V=(null==(o=r.flip)?void 0:o.overflows)||[];if(h&&y.push(M[w]),d){const e=st(n,i,Z);y.push(M[e[0]],M[e[1]])}if(V=[...V,{placement:n,overflows:y}],!y.every(e=>e<=0)){var H,P;const e=((null==(H=r.flip)?void 0:H.index)||0)+1,t=C[e];if(t){if(!("alignment"===d&&m!==at(t))||V.every(e=>at(e.placement)!==m||e.overflows[0]>0))return{data:{index:e,overflows:V},reset:{placement:t}}}let l=null==(P=V.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:P.placement;if(!l)switch(v){case"bestFit":{var O;const e=null==(O=V.filter(e=>{if(b){const t=at(e.placement);return t===m||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:O[0];e&&(l=e);break}case"initialPlacement":l=a}if(n!==l)return{reset:{placement:l}}}return{}}}},dl=(e,t,l)=>{const o=new Map,n=null!=l?l:{},r={...rl,...n.platform,_c:o};return(async(e,t,l)=>{const{placement:o="bottom",strategy:n="absolute",middleware:r=[],platform:i}=l,a=i.detectOverflow?i:{...i,detectOverflow:Zt},c=await(null==i.isRTL?void 0:i.isRTL(t));let s=await i.getElementRects({reference:e,floating:t,strategy:n}),{x:h,y:d}=_t(s,o,c),u=o,v=0;const f={};for(let l=0;l<r.length;l++){const p=r[l];if(!p)continue;const{name:g,fn:w}=p,{x:m,y:_,data:Z,reset:x}=await w({x:h,y:d,initialPlacement:o,placement:u,strategy:n,middlewareData:f,rects:s,platform:a,elements:{reference:e,floating:t}});h=null!=m?m:h,d=null!=_?_:d,f[g]={...f[g],...Z},x&&v<50&&(v++,"object"==typeof x&&(x.placement&&(u=x.placement),x.rects&&(s=!0===x.rects?await i.getElementRects({reference:e,floating:t,strategy:n}):x.rects),({x:h,y:d}=_t(s,u,c))),l=-1)}return{x:h,y:d,placement:u,strategy:n,middlewareData:f}})(e,t,{...n,platform:r})};class ul extends je{constructor(){super(...arguments),this.myDropdown=We(),this.dropdownMenuId=function(e="",t=""){return`id-${Math.random().toString().substring(2,6)}-sit-${e}-${t}`}("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=We(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=al(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const l=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},o=t.map(l),n=e.map(e=>{const n=l(e),r=o.indexOf(n);return-1!==r?t[r]:e}).concat(t.filter(t=>!e.some(e=>l(e)===l(t))));return n}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[cl(8),this.noFlip?void 0:hl(),sl()].filter(Boolean);let l=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(l=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const o=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:l}),{x:n,y:r,strategy:i,placement:a}=await dl(this.myDropdown.value,this.menuRef.value,o);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:i,left:`${n}px`,top:`${r}px`})}}e([He({type:Boolean,state:!0})],ul.prototype,"noFlip",void 0),e([He({type:Boolean,reflect:!0,state:!0})],ul.prototype,"menuAlignRight",void 0),e([He({type:String,reflect:!0,state:!0})],ul.prototype,"drop",void 0),e([He({type:Object})],ul.prototype,"floatingOpts",void 0),e([He({type:Boolean,reflect:!0})],ul.prototype,"menuIsOpen",void 0),e([He({type:Boolean,reflect:!0})],ul.prototype,"disabled",void 0),e([He({type:Boolean,reflect:!0})],ul.prototype,"readonly",void 0);class vl extends ul{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),l=t.find(t=>e.composedPath().includes(t));if(!l)return;const o=t.indexOf(l);this.nextDropdownItemNo=o+1,this.prevDropdownItemNo=o<=0?t.length-1:o-1,l.disabled||(this.emit("sit-select",{detail:{item:l}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const l=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");l&&l.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const l=(e%t.length+t.length)%t.length,o=t[l];this.emit("i-sit-option-focus",{detail:{option:o}}),this.nextDropdownItemNo=(l+1)%t.length,this.prevDropdownItemNo=(l-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===o?"0":"-1"),e===o&&t.focus()})}}var fl,pl;function gl(e,t){const l=Object.assign({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:n}=t;if(e in t){const r=e;t.update=function(e){if(e.has(r)){const t=e.get(r),n=this[r];t!==n&&(l.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,n))}n.call(this,e)}}}}vl.styles=ul.styles,e([(fl="ul.dropdown-menu",(e,t,l)=>{const o=e=>{const l=e.renderRoot?.querySelector(fl)??null;if(null===l&&pl&&!e.hasUpdated){const e="object"==typeof t?t.name:t;ze("",`@query'd field ${JSON.stringify(String(e))} with the 'cache' flag set for selector '${fl}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(pl){const{get:n,set:r}="object"==typeof t?e:l??(()=>{const e=Symbol(`${String(t)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return Oe(e,t,{get(){let e=n.call(this);return void 0===e&&(e=o(this),(null!==e||this.hasUpdated)&&r.call(this,e)),e}})}return Oe(e,t,{get(){return o(this)}})})],vl.prototype,"menu",void 0),e([Pe()],vl.prototype,"nextDropdownItemNo",void 0),e([Pe()],vl.prototype,"prevDropdownItemNo",void 0),e([He({type:Boolean,reflect:!0})],vl.prototype,"hidden",void 0);var wl=i`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:0 0 1px 0 hsla(0,0%,5%,.12),0 4px 8px 0 hsla(0,0%,5%,.12);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:left;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-top-left-radius:0;border-top-right-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{left:0;right:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,ml=i`.dropdown{display:flex;height:inherit;position:relative}.dropdown-menu{max-width:var(--sit-dimension-320)}.toggler-container{flex:1;pointer-events:none}.toggler-container ::slotted(*){pointer-events:auto}`;class _l extends vl{constructor(){super(),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.close="default",this.menuRef=Ke()}async _handleClick(e){if(this.disabled)return;const t=this._toggler[0];if(!t)return void this.toggleMenu();if(e.composedPath().includes(t))return void this.toggleMenu();if(!this.menuIsOpen)return;const l=this.menuRef.value;l&&e.composedPath().includes(l)||this.hideMenu()}_handleCloseMenu(){const e=this._toggler[0];null==e||e.focus()}async connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._handleCloseMenu)}async disconnectedCallback(){this.removeEventListener("sit-hide",this._handleCloseMenu)}async firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&await this.updateFloatingPosition(),this._handleDisabled()}_handleTogglerSlotChange(e){const t=e.target.assignedElements({flatten:!0})[0];t&&(t.setAttribute("aria-haspopup","menu"),t.setAttribute("aria-expanded",String(this.menuIsOpen)))}_handleMenuIsOpenChange(){const e=this._toggler[0];e&&e.setAttribute("aria-expanded",String(this.menuIsOpen))}_handleDisabled(){const e=this._toggler[0];e&&(this.disabled?e.setAttribute("disabled","true"):e.hasAttribute("disabled")&&e.removeAttribute("disabled"))}render(){return Q`
      <div class="dropdown" @click=${this._handleClick}>
        <div class="toggler-container" ${Ke(this.myDropdown)}>
          <slot name="toggler" @slotchange=${this._handleTogglerSlotChange}></slot>
        </div>
        <div class="dropdown-menu" role="menu" ${Ke(this.menuRef)}>
          <slot id="default" @click=${this.handleSelectSlot}></slot>
        </div>
      </div>
    `}}_l.styles=[...vl.styles,ml,wl],e([He({type:Boolean,reflect:!0,state:!1})],_l.prototype,"noFlip",void 0),e([He({type:Boolean,reflect:!0,state:!1})],_l.prototype,"menuAlignRight",void 0),e([He({type:String,reflect:!0,state:!1})],_l.prototype,"drop",void 0),e([He({type:String,reflect:!0,state:!1})],_l.prototype,"close",void 0),e([Be({slot:"toggler",flatten:!0})],_l.prototype,"_toggler",void 0),e([gl("menuIsOpen")],_l.prototype,"_handleMenuIsOpenChange",null),e([gl("disabled",{waitUntilFirstUpdate:!0})],_l.prototype,"_handleDisabled",null);const Zl=Se(
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
class extends ke{constructor(e){if(super(e),e.type!==$e||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const o=!!t[e];o===this._previousClasses.has(e)||this._staticClasses?.has(e)||(o?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return te}}),xl={announcement:()=>Promise.resolve().then(function(){return Bl}),archive:()=>Promise.resolve().then(function(){return Al}),"arrow-bar-down":()=>Promise.resolve().then(function(){return Ll}),"arrow-bar-left":()=>Promise.resolve().then(function(){return kl}),"arrow-bar-right":()=>Promise.resolve().then(function(){return Tl}),"arrow-bar-up":()=>Promise.resolve().then(function(){return Il}),"arrow-circle-down":()=>Promise.resolve().then(function(){return Nl}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Wl}),"arrow-circle-right":()=>Promise.resolve().then(function(){return ql}),"arrow-circle-up":()=>Promise.resolve().then(function(){return Jl}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Xl}),"arrow-down":()=>Promise.resolve().then(function(){return Ql}),"arrow-left":()=>Promise.resolve().then(function(){return to}),"arrow-repeat":()=>Promise.resolve().then(function(){return oo}),"arrow-right":()=>Promise.resolve().then(function(){return ro}),"arrow-square-down":()=>Promise.resolve().then(function(){return ao}),"arrow-square-left":()=>Promise.resolve().then(function(){return so}),"arrow-square-right":()=>Promise.resolve().then(function(){return uo}),"arrow-square-up":()=>Promise.resolve().then(function(){return fo}),"arrow-up":()=>Promise.resolve().then(function(){return go}),"bank-fill":()=>Promise.resolve().then(function(){return mo}),"bell-slash":()=>Promise.resolve().then(function(){return Zo}),bell:()=>Promise.resolve().then(function(){return bo}),"bi-funnel":()=>Promise.resolve().then(function(){return Mo}),"bookmark-fill":()=>Promise.resolve().then(function(){return Vo}),bookmark:()=>Promise.resolve().then(function(){return Po}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return zo}),"box-seam":()=>Promise.resolve().then(function(){return jo}),building:()=>Promise.resolve().then(function(){return $o}),bus:()=>Promise.resolve().then(function(){return So}),calculator:()=>Promise.resolve().then(function(){return Eo}),"calendar-check":()=>Promise.resolve().then(function(){return Ro}),"calendar-heart":()=>Promise.resolve().then(function(){return Do}),"calendar-x":()=>Promise.resolve().then(function(){return Uo}),calendar:()=>Promise.resolve().then(function(){return Fo}),camera:()=>Promise.resolve().then(function(){return Ko}),car:()=>Promise.resolve().then(function(){return Yo}),"chat-dots":()=>Promise.resolve().then(function(){return Go}),"chat-left-text":()=>Promise.resolve().then(function(){return en}),chat:()=>Promise.resolve().then(function(){return ln}),"check-circle-fill":()=>Promise.resolve().then(function(){return nn}),"check-circle":()=>Promise.resolve().then(function(){return an}),check:()=>Promise.resolve().then(function(){return sn}),"chevron-down":()=>Promise.resolve().then(function(){return dn}),"chevron-left":()=>Promise.resolve().then(function(){return vn}),"chevron-right":()=>Promise.resolve().then(function(){return pn}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return wn}),"chevron-up":()=>Promise.resolve().then(function(){return _n}),clock:()=>Promise.resolve().then(function(){return xn}),"cloud-check":()=>Promise.resolve().then(function(){return Cn}),"cloud-download":()=>Promise.resolve().then(function(){return yn}),"cloud-upload":()=>Promise.resolve().then(function(){return Hn}),cloud:()=>Promise.resolve().then(function(){return On}),"code-square":()=>Promise.resolve().then(function(){return Bn}),"coins-hand":()=>Promise.resolve().then(function(){return An}),compass:()=>Promise.resolve().then(function(){return Ln}),copy:()=>Promise.resolve().then(function(){return kn}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return Tn}),cross:()=>Promise.resolve().then(function(){return In}),"cursor-fill":()=>Promise.resolve().then(function(){return Nn}),cursor:()=>Promise.resolve().then(function(){return Wn}),"dash-circle":()=>Promise.resolve().then(function(){return qn}),"dash-square":()=>Promise.resolve().then(function(){return Jn}),dash:()=>Promise.resolve().then(function(){return Xn}),database:()=>Promise.resolve().then(function(){return Qn}),dataflow:()=>Promise.resolve().then(function(){return tr}),download:()=>Promise.resolve().then(function(){return or}),edit:()=>Promise.resolve().then(function(){return rr}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return ar}),"exclamation-circle":()=>Promise.resolve().then(function(){return sr}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return dr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return vr}),exclamation:()=>Promise.resolve().then(function(){return pr}),"eye-fill":()=>Promise.resolve().then(function(){return wr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return _r}),"eye-slash":()=>Promise.resolve().then(function(){return xr}),eye:()=>Promise.resolve().then(function(){return Cr}),"face-smile-fill":()=>Promise.resolve().then(function(){return yr}),"face-smile":()=>Promise.resolve().then(function(){return Hr}),facebook:()=>Promise.resolve().then(function(){return Or}),"file-earmark-text":()=>Promise.resolve().then(function(){return Br}),"file-pdf":()=>Promise.resolve().then(function(){return Ar}),"file-plus":()=>Promise.resolve().then(function(){return Lr}),"file-text":()=>Promise.resolve().then(function(){return kr}),file:()=>Promise.resolve().then(function(){return Tr}),files:()=>Promise.resolve().then(function(){return Ir}),fingerprint:()=>Promise.resolve().then(function(){return Nr}),flash:()=>Promise.resolve().then(function(){return Wr}),"folder-check":()=>Promise.resolve().then(function(){return qr}),"folder-minus":()=>Promise.resolve().then(function(){return Jr}),"folder-plus":()=>Promise.resolve().then(function(){return Xr}),folder:()=>Promise.resolve().then(function(){return Qr}),gear:()=>Promise.resolve().then(function(){return ti}),"geo-alt":()=>Promise.resolve().then(function(){return oi}),"geo-fill":()=>Promise.resolve().then(function(){return ri}),geo:()=>Promise.resolve().then(function(){return ai}),"globe-alt":()=>Promise.resolve().then(function(){return si}),globe:()=>Promise.resolve().then(function(){return di}),google:()=>Promise.resolve().then(function(){return vi}),"grid-alt":()=>Promise.resolve().then(function(){return pi}),"grid-fill":()=>Promise.resolve().then(function(){return wi}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return _i}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return xi}),"hard-drive":()=>Promise.resolve().then(function(){return Ci}),heart:()=>Promise.resolve().then(function(){return yi}),"house-door":()=>Promise.resolve().then(function(){return Hi}),house:()=>Promise.resolve().then(function(){return Oi}),image:()=>Promise.resolve().then(function(){return Bi}),"in-box":()=>Promise.resolve().then(function(){return Ai}),"info-circle-fill":()=>Promise.resolve().then(function(){return Li}),"info-circle":()=>Promise.resolve().then(function(){return ki}),instagram:()=>Promise.resolve().then(function(){return Ti}),key:()=>Promise.resolve().then(function(){return Ii}),"laptop-gear":()=>Promise.resolve().then(function(){return Ni}),laptop:()=>Promise.resolve().then(function(){return Wi}),layers:()=>Promise.resolve().then(function(){return qi}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return Ji}),"layout-text-window":()=>Promise.resolve().then(function(){return Xi}),layout:()=>Promise.resolve().then(function(){return Qi}),"life-buoy":()=>Promise.resolve().then(function(){return ta}),lightbulb:()=>Promise.resolve().then(function(){return oa}),link:()=>Promise.resolve().then(function(){return ra}),linkedin:()=>Promise.resolve().then(function(){return aa}),list:()=>Promise.resolve().then(function(){return sa}),"lock-fill":()=>Promise.resolve().then(function(){return da}),lock:()=>Promise.resolve().then(function(){return va}),login:()=>Promise.resolve().then(function(){return pa}),logout:()=>Promise.resolve().then(function(){return wa}),luggage:()=>Promise.resolve().then(function(){return _a}),"mail-open":()=>Promise.resolve().then(function(){return xa}),mail:()=>Promise.resolve().then(function(){return Ca}),map:()=>Promise.resolve().then(function(){return ya}),meetup:()=>Promise.resolve().then(function(){return Ha}),menu:()=>Promise.resolve().then(function(){return Oa}),microphone:()=>Promise.resolve().then(function(){return Ba}),monitor:()=>Promise.resolve().then(function(){return Aa}),moon:()=>Promise.resolve().then(function(){return La}),move:()=>Promise.resolve().then(function(){return ka}),paperclip:()=>Promise.resolve().then(function(){return Ta}),passcode:()=>Promise.resolve().then(function(){return Ia}),passport:()=>Promise.resolve().then(function(){return Na}),pause:()=>Promise.resolve().then(function(){return Wa}),pencil:()=>Promise.resolve().then(function(){return qa}),"pending-circle":()=>Promise.resolve().then(function(){return Ja}),"person-dash":()=>Promise.resolve().then(function(){return Xa}),"person-plus":()=>Promise.resolve().then(function(){return Qa}),"person-x":()=>Promise.resolve().then(function(){return tc}),person:()=>Promise.resolve().then(function(){return oc}),phone:()=>Promise.resolve().then(function(){return rc}),"pin-map-fill":()=>Promise.resolve().then(function(){return ac}),pin:()=>Promise.resolve().then(function(){return sc}),placeholder:()=>Promise.resolve().then(function(){return dc}),plane:()=>Promise.resolve().then(function(){return vc}),play:()=>Promise.resolve().then(function(){return pc}),"plus-circle":()=>Promise.resolve().then(function(){return wc}),"plus-square":()=>Promise.resolve().then(function(){return _c}),plus:()=>Promise.resolve().then(function(){return xc}),printer:()=>Promise.resolve().then(function(){return Cc}),"question-circle":()=>Promise.resolve().then(function(){return yc}),rocket:()=>Promise.resolve().then(function(){return Hc}),save:()=>Promise.resolve().then(function(){return Oc}),search:()=>Promise.resolve().then(function(){return Bc}),send:()=>Promise.resolve().then(function(){return Ac}),"sg-crest":()=>Promise.resolve().then(function(){return Lc}),share:()=>Promise.resolve().then(function(){return kc}),"shield-tick":()=>Promise.resolve().then(function(){return Tc}),"sidebar-collapse":()=>Promise.resolve().then(function(){return Ic}),"sidebar-expand":()=>Promise.resolve().then(function(){return Nc}),"slash-circle":()=>Promise.resolve().then(function(){return Wc}),"slash-divider":()=>Promise.resolve().then(function(){return qc}),sliders:()=>Promise.resolve().then(function(){return Jc}),"sort-ascending":()=>Promise.resolve().then(function(){return Xc}),"sort-descending":()=>Promise.resolve().then(function(){return Qc}),speedometer:()=>Promise.resolve().then(function(){return ts}),"star-ai":()=>Promise.resolve().then(function(){return os}),"star-fill":()=>Promise.resolve().then(function(){return rs}),star:()=>Promise.resolve().then(function(){return as}),stoplights:()=>Promise.resolve().then(function(){return ss}),sun:()=>Promise.resolve().then(function(){return ds}),"switch-horizontal":()=>Promise.resolve().then(function(){return vs}),"switch-vertical":()=>Promise.resolve().then(function(){return ps}),tablet:()=>Promise.resolve().then(function(){return ws}),telegram:()=>Promise.resolve().then(function(){return _s}),telephone:()=>Promise.resolve().then(function(){return xs}),"three-dots-vertical":()=>Promise.resolve().then(function(){return Cs}),"three-dots":()=>Promise.resolve().then(function(){return ys}),ticket:()=>Promise.resolve().then(function(){return Hs}),"toggle-off":()=>Promise.resolve().then(function(){return Os}),"toggle-on":()=>Promise.resolve().then(function(){return Bs}),train:()=>Promise.resolve().then(function(){return As}),translate:()=>Promise.resolve().then(function(){return Ls}),trash:()=>Promise.resolve().then(function(){return ks}),"trend-down":()=>Promise.resolve().then(function(){return Ts}),"trend-up":()=>Promise.resolve().then(function(){return Is}),truck:()=>Promise.resolve().then(function(){return Ns}),"twitter-x":()=>Promise.resolve().then(function(){return Ws}),unlock:()=>Promise.resolve().then(function(){return qs}),upload:()=>Promise.resolve().then(function(){return Js}),"user-check":()=>Promise.resolve().then(function(){return Xs}),"user-circle":()=>Promise.resolve().then(function(){return Qs}),"user-pause":()=>Promise.resolve().then(function(){return th}),"user-square":()=>Promise.resolve().then(function(){return oh}),users:()=>Promise.resolve().then(function(){return rh}),"video-recorder":()=>Promise.resolve().then(function(){return ah}),"volume-max":()=>Promise.resolve().then(function(){return sh}),"volume-x":()=>Promise.resolve().then(function(){return dh}),"window-dash":()=>Promise.resolve().then(function(){return vh}),"window-desktop":()=>Promise.resolve().then(function(){return ph}),"window-dock":()=>Promise.resolve().then(function(){return wh}),"window-fullscreen":()=>Promise.resolve().then(function(){return _h}),"window-plus":()=>Promise.resolve().then(function(){return xh}),"window-sidebar":()=>Promise.resolve().then(function(){return Ch}),"window-split":()=>Promise.resolve().then(function(){return yh}),"window-stack":()=>Promise.resolve().then(function(){return Hh}),"window-x":()=>Promise.resolve().then(function(){return Oh}),window:()=>Promise.resolve().then(function(){return Bh}),"xcircle-fill":()=>Promise.resolve().then(function(){return Ah}),xcircle:()=>Promise.resolve().then(function(){return Lh}),youtube:()=>Promise.resolve().then(function(){return kh}),"zoom-in":()=>Promise.resolve().then(function(){return Th}),"zoom-out":()=>Promise.resolve().then(function(){return Ih})};
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */var bl=i`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const Cl=new Map;class Ml extends je{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(Cl.has(e))return void(this._icon=Cl.get(e));const t=xl[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();Cl.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:le}}Ml.styles=[...je.styles,bl],e([He({type:String,reflect:!0})],Ml.prototype,"name",void 0),e([He({type:String,reflect:!0})],Ml.prototype,"size",void 0),e([He({type:String})],Ml.prototype,"ariaLabel",void 0),e([Pe()],Ml.prototype,"_icon",void 0);var yl,Vl,Hl=i`:host([disabled]){cursor:not-allowed}.dropdown-item{align-items:center;background-color:var(--sit-bg-transparent);clear:both;color:var(--sit-color-default);cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-sm);padding:var(--sit-padding-sm) var(--sit-padding-lg);text-align:inherit}.dropdown-item:hover{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus,.dropdown-item:focus-visible{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus-visible{outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.dropdown-item.active{background-color:var(--sit-bg-translucent-subtle);color:var(--sit-primary-color-default);text-decoration:none}.dropdown-item.disabled,.dropdown-item:disabled{opacity:var(--sit-opacity-40);pointer-events:none}::slotted(*){color:inherit!important;display:flex;gap:var(--sit-gap-sm);text-decoration:none!important}::slotted(a),::slotted(sit-checkbox){flex:1;margin:calc(var(--sit-padding-sm)*-1) calc(var(--sit-padding-lg)*-1);padding:var(--sit-padding-sm) var(--sit-padding-lg)}.dropdown-item.mainnav-dropdown-link{padding:var(--sit-padding-none)}.dropdown-item.mainnav-dropdown-link ::slotted(*){box-sizing:border-box;margin:auto;max-width:var(--sit-mainnav-max-width,1440px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x)}@media screen and (min-width:1024px){.dropdown-item.mainnav-dropdown-link ::slotted(*){padding:var(--sit-padding-sm) var(--sit-mainnav-padding-x)}}`;class Pl extends je{constructor(){super(...arguments),this.active=!1,this.disabled=!1,this.ariaLabel=""}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",e=>{"Enter"===e.key&&this.anchor.length>0&&this.anchor[0].click()}),this.setAttribute("role","menuitem"),this.setAttribute("aria-disabled",`${this.disabled}`)}render(){return Q`
      <div
        class="dropdown-item ${Zl({disabled:this.disabled,active:this.active})}"
        tabindex=${this.disabled?"-1":"0"}
        aria-label=${e=this.ariaLabel||void 0,e??le}
      >
        <slot></slot>
      </div>
    `;var e}}Pl.styles=[ml,Hl],Pl.dependencies={"sit-icon":Ml},e([Be({flatten:!0})],Pl.prototype,"anchor",void 0),e([He({type:Boolean})],Pl.prototype,"active",void 0),e([He({type:Boolean,reflect:!0})],Pl.prototype,"disabled",void 0),e([He({type:String})],Pl.prototype,"ariaLabel",void 0);class Ol extends je{constructor(){super(...arguments),this.size="md"}render(){return Q`
      <sit-dropdown>
    ...
    `}}Ol.styles=[...je.styles,Ae],Ol.dependencies={"sit-dropdown":_l,"sit-dropdown-item":Pl,"sit-icon":Ml},e([He({type:String,reflect:!0})],Ol.prototype,"size",void 0),yl="sit-overflow-menu",Vl=Ol,customElements.get(yl)||customElements.define(yl,Vl);var zl=Q`
...
`,Bl=Object.freeze({__proto__:null,default:zl}),jl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Al=Object.freeze({__proto__:null,default:jl}),$l=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ih=Object.freeze({__proto__:null,default:Rh})});
