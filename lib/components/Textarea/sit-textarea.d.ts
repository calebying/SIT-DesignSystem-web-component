...
declare const SitTextarea_base: (new (...args: any[]) => import("../../utils/validatorMixin").ToBeValidatedElementInterface) & typeof FormControlElement;
/**
 ...
 */
export declare class SitTextarea extends SitTextarea_base implements SitFormControl {
