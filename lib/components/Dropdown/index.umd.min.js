...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
const y=globalThis,V=e=>{y.emitLitDebugLogEvents&&y.dispatchEvent(new CustomEvent("lit-debug",{detail:e}))};let H,P=0;y.litIssuedWarnings??=new Set,H=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",y.litIssuedWarnings.has(t)||y.litIssuedWarnings.has(e)||(console.warn(t),y.litIssuedWarnings.add(t))},queueMicrotask(()=>{H("dev-mode","Lit is in dev mode. Not recommended for production!")});const O=y.ShadyDOM?.inUse&&!0===y.ShadyDOM?.noPatch?y.ShadyDOM.wrap:e=>e,z=y.trustedTypes,B=z?z.createPolicy("lit-html",{createHTML:e=>e}):void 0,j=e=>e,A=(e,t,l)=>j,$=e=>{if(re!==A)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");re=e},L=()=>{re=A},S=(e,t,l)=>re(e,t,l),k="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,T="?"+E,R=`<${T}>`,I=document,D=()=>I.createComment(""),N=e=>null===e||"object"!=typeof e&&"function"!=typeof e,U=Array.isArray,W="[ \t\n\f\r]",F=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,q=/-->/g,K=/>/g,J=new RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),Y=/'/g,X=/"/g,G=/^(?:script|style|textarea|title)$/i,Q=(ee=1,(e,...t)=>(e.some(e=>void 0===e)&&console.warn("Some template strings are undefined.\nThis is probably caused by illegal octal escape sequences."),t.some(e=>e?._$litStatic$)&&H("","Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.\nPlease use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions"),{_$litType$:ee,strings:e,values:t}));var ee;const te=Symbol.for("lit-noChange"),le=Symbol.for("lit-nothing"),oe=new WeakMap,ne=I.createTreeWalker(I,129);let re=A;function ie(e,t){if(!U(e)||!e.hasOwnProperty("raw")){let e="invalid template strings array";throw e="\n          Internal Error: expected template strings to be an array\n          with a 'raw' field. Faking a template strings array by\n          calling html or svg like an ordinary function is effectively\n          the same as calling unsafeHtml and can lead to major security\n          issues, e.g. opening your code up to XSS attacks.\n          If you're using the html or svg tagged template functions normally\n          and still seeing this error, please file a bug at\n          https://github.com/lit/lit/issues/new?template=bug_report.md\n          and include information about your build tooling, if any.\n        ".trim().replace(/\n */g,"\n"),new Error(e)}return void 0!==B?B.createHTML(t):t}class ae{constructor({strings:e,_$litType$:t},l){let o;this.parts=[];let n=0,r=0;const i=e.length-1,a=this.parts,[c,s]=((e,t)=>{const l=e.length-1,o=[];let n,r=2===t?"<svg>":3===t?"<math>":"",i=F;for(let t=0;t<l;t++){const l=e[t];let a,c,s=-1,h=0;for(;h<l.length&&(i.lastIndex=h,c=i.exec(l),null!==c);)if(h=i.lastIndex,i===F){if("!--"===c[1])i=q;else if(void 0!==c[1])i=K;else if(void 0!==c[2])G.test(c[2])&&(n=new RegExp(`</${c[2]}`,"g")),i=J;else if(void 0!==c[3])throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else i===J?">"===c[0]?(i=n??F,s=-1):void 0===c[1]?s=-2:(s=i.lastIndex-c[2].length,a=c[1],i=void 0===c[3]?J:'"'===c[3]?X:Y):i===X||i===Y?i=J:i===q||i===K?i=F:(i=J,n=void 0);console.assert(-1===s||i===J||i===Y||i===X,"unexpected parse state B");const d=i===J&&e[t+1].startsWith("/>")?" ":"";r+=i===F?l+R:s>=0?(o.push(a),l.slice(0,s)+k+l.slice(s)+E+d):l+E+(-2===s?t:d)}return[ie(e,r+(e[l]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),o]})(e,t);if(this.el=ae.createElement(c,l),ne.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(o=ne.nextNode())&&a.length<i;){if(1===o.nodeType){{const e=o.localName;if(/^(?:textarea|template)$/i.test(e)&&o.innerHTML.includes(E)){const t=`Expressions are not supported inside \`${e}\` elements. See https://lit.dev/msg/expression-in-${e} for more information.`;if("template"===e)throw new Error(t);H("",t)}}if(o.hasAttributes())for(const e of o.getAttributeNames())if(e.endsWith(k)){const t=s[r++],l=o.getAttribute(e).split(E),i=/([.?@])?(.*)/.exec(t);a.push({type:1,index:n,name:i[2],strings:l,ctor:"."===i[1]?ue:"?"===i[1]?ve:"@"===i[1]?fe:de}),o.removeAttribute(e)}else e.startsWith(E)&&(a.push({type:6,index:n}),o.removeAttribute(e));if(G.test(o.tagName)){const e=o.textContent.split(E),t=e.length-1;if(t>0){o.textContent=z?z.emptyScript:"";for(let l=0;l<t;l++)o.append(e[l],D()),ne.nextNode(),a.push({type:2,index:++n});o.append(e[t],D())}}}else if(8===o.nodeType){if(o.data===T)a.push({type:2,index:n});else{let e=-1;for(;-1!==(e=o.data.indexOf(E,e+1));)a.push({type:7,index:n}),e+=E.length-1}}n++}if(s.length!==r)throw new Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+e.join("${...}")+"`");V&&V({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const l=I.createElement("template");return l.innerHTML=e,l}}function ce(e,t,l=e,o){if(t===te)return t;let n=void 0!==o?l.__directives?.[o]:l.__directive;const r=N(t)?void 0:t._$litDirective$;return n?.constructor!==r&&(n?._$notifyDirectiveConnectionChanged?.(!1),void 0===r?n=void 0:(n=new r(e),n._$initialize(e,l,o)),void 0!==o?(l.__directives??=[])[o]=n:l.__directive=n),void 0!==n&&(t=ce(e,n._$resolve(e,t.values),n,o)),t}class se{constructor(e,t){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){const{el:{content:t},parts:l}=this._$template,o=(e?.creationScope??I).importNode(t,!0);ne.currentNode=o;let n=ne.nextNode(),r=0,i=0,a=l[0];for(;void 0!==a;){if(r===a.index){let t;2===a.type?t=new he(n,n.nextSibling,this,e):1===a.type?t=new a.ctor(n,a.name,a.strings,this,e):6===a.type&&(t=new pe(n,this,e)),this._$parts.push(t),a=l[++i]}r!==a?.index&&(n=ne.nextNode(),r++)}return ne.currentNode=I,o}_update(e){let t=0;for(const l of this._$parts)void 0!==l&&(V&&V({kind:"set part",part:l,value:e[t],valueIndex:t,values:e,templateInstance:this}),void 0!==l.strings?(l._$setValue(e,l,t),t+=l.strings.length-2):l._$setValue(e[t])),t++}}class he{get _$isConnected(){return this._$parent?._$isConnected??this.__isConnected}constructor(e,t,l,o){this.type=2,this._$committedValue=le,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=l,this.options=o,this.__isConnected=o?.isConnected??!0,this._textSanitizer=void 0}get parentNode(){let e=O(this._$startNode).parentNode;const t=this._$parent;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){if(null===this.parentNode)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=ce(this,e,t),N(e))e===le||null==e||""===e?(this._$committedValue!==le&&(V&&V({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=le):e!==this._$committedValue&&e!==te&&this._commitText(e);else if(void 0!==e._$litType$)this._commitTemplateResult(e);else if(void 0!==e.nodeType){if(this.options?.host===e)return this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),void console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");this._commitNode(e)}else(e=>U(e)||"function"==typeof e?.[Symbol.iterator])(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return O(O(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){if(this._$committedValue!==e){if(this._$clear(),re!==A){const e=this._$startNode.parentNode?.nodeName;if("STYLE"===e||"SCRIPT"===e){let t="Forbidden";throw t="STYLE"===e?"Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":"Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(t)}}V&&V({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==le&&N(this._$committedValue)){const t=O(this._$startNode).nextSibling;void 0===this._textSanitizer&&(this._textSanitizer=S(t,"data","property")),e=this._textSanitizer(e),V&&V({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=I.createTextNode("");this._commitNode(t),void 0===this._textSanitizer&&(this._textSanitizer=S(t,"data","property")),e=this._textSanitizer(e),V&&V({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){const{values:t,_$litType$:l}=e,o="number"==typeof l?this._$getTemplate(e):(void 0===l.el&&(l.el=ae.createElement(ie(l.h,l.h[0]),this.options)),l);if(this._$committedValue?._$template===o)V&&V({kind:"template updating",template:o,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:t}),this._$committedValue._update(t);else{const e=new se(o,this),l=e._clone(this.options);V&&V({kind:"template instantiated",template:o,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),e._update(t),V&&V({kind:"template instantiated and updated",template:o,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),this._commitNode(l),this._$committedValue=e}}_$getTemplate(e){let t=oe.get(e.strings);return void 0===t&&oe.set(e.strings,t=new ae(e)),t}_commitIterable(e){U(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let l,o=0;for(const n of e)o===t.length?t.push(l=new he(this._insert(D()),this._insert(D()),this,this.options)):l=t[o],l._$setValue(n),o++;o<t.length&&(this._$clear(l&&O(l._$endNode).nextSibling,o),t.length=o)}_$clear(e=O(this._$startNode).nextSibling,t){for(this._$notifyConnectionChanged?.(!1,!0,t);e!==this._$endNode;){const t=O(e).nextSibling;O(e).remove(),e=t}}setConnected(e){if(void 0!==this._$parent)throw new Error("part.setConnected() may only be called on a RootPart returned from render().");this.__isConnected=e,this._$notifyConnectionChanged?.(e)}}class de{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(e,t,l,o,n){this.type=1,this._$committedValue=le,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=o,this.options=n,l.length>2||""!==l[0]||""!==l[1]?(this._$committedValue=new Array(l.length-1).fill(new String),this.strings=l):this._$committedValue=le,this._sanitizer=void 0}_$setValue(e,t=this,l,o){const n=this.strings;let r=!1;if(void 0===n)e=ce(this,e,t,0),r=!N(e)||e!==this._$committedValue&&e!==te,r&&(this._$committedValue=e);else{const o=e;let i,a;for(e=n[0],i=0;i<n.length-1;i++)a=ce(this,o[l+i],t,i),a===te&&(a=this._$committedValue[i]),r||=!N(a)||a!==this._$committedValue[i],a===le?e=le:e!==le&&(e+=(a??"")+n[i+1]),this._$committedValue[i]=a}r&&!o&&this._commitValue(e)}_commitValue(e){e===le?O(this.element).removeAttribute(this.name):(void 0===this._sanitizer&&(this._sanitizer=re(this.element,this.name,"attribute")),e=this._sanitizer(e??""),V&&V({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),O(this.element).setAttribute(this.name,e??""))}}class ue extends de{constructor(){super(...arguments),this.type=3}_commitValue(e){void 0===this._sanitizer&&(this._sanitizer=re(this.element,this.name,"property")),e=this._sanitizer(e),V&&V({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===le?void 0:e}}class ve extends de{constructor(){super(...arguments),this.type=4}_commitValue(e){V&&V({kind:"commit boolean attribute",element:this.element,name:this.name,value:!(!e||e===le),options:this.options}),O(this.element).toggleAttribute(this.name,!!e&&e!==le)}}class fe extends de{constructor(e,t,l,o,n){if(super(e,t,l,o,n),this.type=5,void 0!==this.strings)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){if((e=ce(this,e,t,0)??le)===te)return;const l=this._$committedValue,o=e===le&&l!==le||e.capture!==l.capture||e.once!==l.once||e.passive!==l.passive,n=e!==le&&(l===le||o);V&&V({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:o,addListener:n,oldListener:l}),o&&this.element.removeEventListener(this.name,this,l),n&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){"function"==typeof this._$committedValue?this._$committedValue.call(this.options?.host??this.element,e):this._$committedValue.handleEvent(e)}}class pe{constructor(e,t,l){this.element=e,this.type=6,this._$disconnectableChildren=void 0,this._$parent=t,this.options=l}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){V&&V({kind:"commit to element binding",element:this.element,value:e,options:this.options}),ce(this,e)}}const ge=y.litHtmlPolyfillSupportDevMode;ge?.(ae,he),(y.litHtmlVersions??=[]).push("3.3.3"),y.litHtmlVersions.length>1&&queueMicrotask(()=>{H("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});const we=(e,t,l)=>{if(null==t)throw new TypeError(`The container to render into may not be ${t}`);const o=P++,n=l?.renderBefore??t;let r=n._$litPart$;if(V&&V({kind:"begin render",id:o,value:e,container:t,options:l,part:r}),void 0===r){const e=l?.renderBefore??null;n._$litPart$=r=new he(t.insertBefore(D(),e),e,void 0,l??{})}return r._$setValue(e),V&&V({kind:"end render",id:o,value:e,container:t,options:l,part:r}),r};we.setSanitizer=$,we.createSanitizer=S,we._testOnlyClearSanitizerFactoryDoNotCallOrElse=L;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const me=globalThis;let _e;me.litIssuedWarnings??=new Set,_e=(e,t)=>{t+=` See https://lit.dev/msg/${e} for more information.`,me.litIssuedWarnings.has(t)||me.litIssuedWarnings.has(e)||(console.warn(t),me.litIssuedWarnings.add(t))};class Ze extends M{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=we(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.__childPart?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.__childPart?.setConnected(!1)}render(){return te}}var xe;Ze._$litElement$=!0,Ze[xe="finalized",xe]=!0,me.litElementHydrateSupport?.({LitElement:Ze});const be=me.litElementPolyfillSupportDevMode;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
let Ce;be?.({LitElement:Ze}),(me.litElementVersions??=[]).push("4.2.2"),me.litElementVersions.length>1&&queueMicrotask(()=>{_e("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")}),globalThis.litIssuedWarnings??=new Set,Ce=(e,t)=>{t+=` See https://lit.dev/msg/${e} for more information.`,globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))};const Me={attribute:!0,type:String,converter:x,reflect:!1,hasChanged:b},ye=(e=Me,t,l)=>{const{kind:o,metadata:n}=l;null==n&&Ce("missing-class-metadata",`The class ${t} is missing decorator metadata. This could mean that you're using a compiler that supports decorators but doesn't support decorator metadata, such as TypeScript 5.1. Please update your compiler.`);let r=globalThis.litPropertyMetadata.get(n);if(void 0===r&&globalThis.litPropertyMetadata.set(n,r=new Map),"setter"===o&&((e=Object.create(e)).wrapped=!0),r.set(l.name,e),"accessor"===o){const{name:o}=l;return{set(l){const n=t.get.call(this);t.set.call(this,l),this.requestUpdate(o,n,e,!0,l)},init(t){return void 0!==t&&this._$changeProperty(o,void 0,e,t),t}}}if("setter"===o){const{name:o}=l;return function(l){const n=this[o];t.call(this,l),this.requestUpdate(o,n,e,!0,l)}}throw new Error(`Unsupported decorator location: ${o}`)};function Ve(e){return(t,l)=>"object"==typeof l?ye(e,t,l):((e,t,l)=>{const o=t.hasOwnProperty(l);return t.constructor.createProperty(l,e),o?Object.getOwnPropertyDescriptor(t,l):void 0})(e,t,l)}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
function ze(e){return(t,l)=>{const{slot:o,selector:n}=e??{},r="slot"+(o?`[name=${o}]`:":not([name])");return Pe(t,l,{get(){const t=this.renderRoot?.querySelector(r),l=t?.assignedElements(e)??[];return void 0===n?l:l.filter(e=>e.matches(n))}})}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */globalThis.litIssuedWarnings??=new Set,Oe=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))},window.ShadyDOM?.inUse&&!0===window.ShadyDOM?.noPatch&&window.ShadyDOM.wrap;const Be=1,je=2,Ae=e=>(...t)=>({_$litDirective$:e,values:t});
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class $e{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,l){this.__part=e,this._$parent=t,this.__attributeIndex=l}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const Le=(e,t)=>{const l=e._$disconnectableChildren;if(void 0===l)return!1;for(const e of l)e._$notifyDirectiveConnectionChanged?.(t,!1),Le(e,t);return!0},Se=e=>{let t,l;do{if(void 0===(t=e._$parent))break;l=t._$disconnectableChildren,l.delete(e),e=t}while(0===l?.size)},ke=e=>{for(let t;t=e._$parent;e=t){let l=t._$disconnectableChildren;if(void 0===l)t._$disconnectableChildren=l=new Set;else if(l.has(e))break;l.add(e),Re(t)}};function Ee(e){void 0!==this._$disconnectableChildren?(Se(this),this._$parent=e,ke(this)):this._$parent=e}function Te(e,t=!1,l=0){const o=this._$committedValue,n=this._$disconnectableChildren;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(o))for(let e=l;e<o.length;e++)Le(o[e],!1),Se(o[e]);else null!=o&&(Le(o,!1),Se(o));else Le(this,e)}const Re=e=>{e.type==je&&(e._$notifyConnectionChanged??=Te,e._$reparentDisconnectables??=Ee)};class Ie extends $e{constructor(){super(...arguments),this._$disconnectableChildren=void 0}_$initialize(e,t,l){super._$initialize(e,t,l),ke(this),this.isConnected=e._$isConnected}_$notifyDirectiveConnectionChanged(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Le(this,e),Se(this))}setValue(e){if(void 0===this.__part.strings)this.__part._$setValue(e,this);else{if(void 0===this.__attributeIndex)throw new Error("Expected this.__attributeIndex to be a number");const t=[...this.__part._$committedValue];t[this.__attributeIndex]=e,this.__part._$setValue(t,this,0)}}disconnected(){}reconnected(){}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const De=()=>new Ne;class Ne{}const Ue=new WeakMap;const We=Ae(class extends Ie{render(e){return le}update(e,[t]){const l=t!==this._ref;return l&&this._updateRefValue(void 0),(l||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),le}_updateRefValue(e){if(void 0!==this._ref)if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let l=Ue.get(t);void 0===l&&(l=new WeakMap,Ue.set(t,l)),void 0!==l.get(this._ref)&&this._ref.call(this._context,void 0),l.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?Ue.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}}),Fe=Math.min,qe=Math.max,Ke=Math.round,Je=Math.floor,Ye=e=>({x:e,y:e}),Xe={left:"right",right:"left",bottom:"top",top:"bottom"};function Ge(e,t,l){return qe(e,Fe(t,l))}function Qe(e,t){return"function"==typeof e?e(t):e}function et(e){return e.split("-")[0]}function tt(e){return e.split("-")[1]}function lt(e){return"x"===e?"y":"x"}function ot(e){return"y"===e?"height":"width"}function nt(e){const t=e[0];return"t"===t||"b"===t?"y":"x"}function rt(e){return lt(nt(e))}function it(e,t,l){void 0===l&&(l=!1);const o=tt(e),n=rt(e),r=ot(n);let i="x"===n?o===(l?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[r]>t.floating[r]&&(i=vt(i)),[i,vt(i)]}function at(e){return e.includes("start")?e.replace("start","end"):e.replace("end","start")}const ct=["left","right"],st=["right","left"],ht=["top","bottom"],dt=["bottom","top"];function ut(e,t,l,o){const n=tt(e);let r=function(e,t,l){switch(e){case"top":case"bottom":return l?t?st:ct:t?ct:st;case"left":case"right":return t?ht:dt;default:return[]}}(et(e),"start"===l,o);return n&&(r=r.map(e=>e+"-"+n),t&&(r=r.concat(r.map(at)))),r}function vt(e){const t=et(e);return Xe[t]+e.slice(t.length)}function ft(e){return"number"!=typeof e?function(e){var t,l,o,n;return{top:null!=(t=e.top)?t:0,right:null!=(l=e.right)?l:0,bottom:null!=(o=e.bottom)?o:0,left:null!=(n=e.left)?n:0}}(e):{top:e,right:e,bottom:e,left:e}}function pt(e){const{x:t,y:l,width:o,height:n}=e;return{width:o,height:n,top:l,left:t,right:t+o,bottom:l+n,x:t,y:l}}function gt(e,t,l){let{reference:o,floating:n}=e;const r=nt(t),i=rt(t),a=ot(i),c=et(t),s="y"===r,h=o.x+o.width/2-n.width/2,d=o.y+o.height/2-n.height/2,u=o[a]/2-n[a]/2;let v;switch(c){case"top":v={x:h,y:o.y-n.height};break;case"bottom":v={x:h,y:o.y+o.height};break;case"right":v={x:o.x+o.width,y:d};break;case"left":v={x:o.x-n.width,y:d};break;default:v={x:o.x,y:o.y}}const f=tt(t);return f&&(v[i]+=u*("end"===f?1:-1)*(l&&s?-1:1)),v}async function wt(e,t){var l;void 0===t&&(t={});const{x:o,y:n,platform:r,rects:i,elements:a,strategy:c}=e,{boundary:s="clippingAncestors",rootBoundary:h="viewport",elementContext:d="floating",altBoundary:u=!1,padding:v=0}=Qe(t,e),f=ft(v),p=a[u?"floating"===d?"reference":"floating":d],g=pt(await r.getClippingRect({element:null==(l=await(null==r.isElement?void 0:r.isElement(p)))||l?p:p.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(a.floating)),boundary:s,rootBoundary:h,strategy:c})),w="floating"===d?{x:o,y:n,width:i.floating.width,height:i.floating.height}:i.reference,m=await(null==r.getOffsetParent?void 0:r.getOffsetParent(a.floating)),_=await(null==r.isElement?void 0:r.isElement(m))&&await(null==r.getScale?void 0:r.getScale(m))||{x:1,y:1},Z=pt(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:m,strategy:c}):w);return{top:(g.top-Z.top+f.top)/_.y,bottom:(Z.bottom-g.bottom+f.bottom)/_.y,left:(g.left-Z.left+f.left)/_.x,right:(Z.right-g.right+f.right)/_.x}}const mt=new Set(["left","top"]);function _t(){return"undefined"!=typeof window}function Zt(e){return Ct(e)?(e.nodeName||"").toLowerCase():"#document"}function xt(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function bt(e){var t;return null==(t=(Ct(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Ct(e){return!!_t()&&(e instanceof Node||e instanceof xt(e).Node)}function Mt(e){return!!_t()&&(e instanceof Element||e instanceof xt(e).Element)}function yt(e){return!!_t()&&(e instanceof HTMLElement||e instanceof xt(e).HTMLElement)}function Vt(e){return!(!_t()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof xt(e).ShadowRoot)}function Ht(e){const{overflow:t,overflowX:l,overflowY:o,display:n}=kt(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+l)&&"inline"!==n&&"contents"!==n}function Pt(e){return/^(table|td|th)$/.test(Zt(e))}function Ot(e){try{if(e.matches(":popover-open"))return!0}catch(e){}try{return e.matches(":modal")}catch(e){return!1}}const zt=/transform|translate|scale|rotate|perspective|filter/,Bt=/paint|layout|strict|content/,jt=e=>!!e&&"none"!==e;let At;function $t(e){const t=Mt(e)?kt(e):e;return jt(t.transform)||jt(t.translate)||jt(t.scale)||jt(t.rotate)||jt(t.perspective)||!Lt()&&(jt(t.backdropFilter)||jt(t.filter))||zt.test(t.willChange||"")||Bt.test(t.contain||"")}function Lt(){return null==At&&(At="undefined"!=typeof CSS&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),At}function St(e){return/^(html|body|#document)$/.test(Zt(e))}function kt(e){return xt(e).getComputedStyle(e)}function Et(e){return Mt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Tt(e){if("html"===Zt(e))return e;const t=e.assignedSlot||e.parentNode||Vt(e)&&e.host||bt(e);return Vt(t)?t.host:t}function Rt(e){const t=Tt(e);return St(t)?(e.ownerDocument||e).body:yt(t)&&Ht(t)?t:Rt(t)}function It(e,t,l){var o;void 0===t&&(t=[]),void 0===l&&(l=!0);const n=Rt(e),r=n===(null==(o=e.ownerDocument)?void 0:o.body),i=xt(n);if(r){const e=Dt(i);return t.concat(i,i.visualViewport||[],Ht(n)?n:[],e&&l?It(e):[])}return t.concat(n,It(n,[],l))}function Dt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Nt(e){const t=kt(e);let l=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const n=yt(e),r=n?e.offsetWidth:l,i=n?e.offsetHeight:o,a=Ke(l)!==r||Ke(o)!==i;return a&&(l=r,o=i),{width:l,height:o,$:a}}function Ut(e){return Mt(e)?e:e.contextElement}function Wt(e){const t=Ut(e);if(!yt(t))return Ye(1);const l=t.getBoundingClientRect(),{width:o,height:n,$:r}=Nt(t);let i=(r?Ke(l.width):l.width)/o,a=(r?Ke(l.height):l.height)/n;return i&&Number.isFinite(i)||(i=1),a&&Number.isFinite(a)||(a=1),{x:i,y:a}}const Ft=Ye(0);function qt(e){const t=xt(e);return Lt()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Ft}function Kt(e,t,l,o){void 0===t&&(t=!1),void 0===l&&(l=!1);const n=e.getBoundingClientRect(),r=Ut(e);let i=Ye(1);t&&(o?Mt(o)&&(i=Wt(o)):i=Wt(e));const a=function(e,t,l){return void 0===t&&(t=!1),!!l&&t&&l===xt(e)}(r,l,o)?qt(r):Ye(0);let c=(n.left+a.x)/i.x,s=(n.top+a.y)/i.y,h=n.width/i.x,d=n.height/i.y;if(r&&o){const e=xt(r),t=Mt(o)?xt(o):o;let l=e,n=Dt(l);for(;n&&t!==l;){const e=Wt(n),t=n.getBoundingClientRect(),o=kt(n),r=t.left+(n.clientLeft+parseFloat(o.paddingLeft))*e.x,i=t.top+(n.clientTop+parseFloat(o.paddingTop))*e.y;c*=e.x,s*=e.y,h*=e.x,d*=e.y,c+=r,s+=i,l=xt(n),n=Dt(l)}}return pt({width:h,height:d,x:c,y:s})}function Jt(e,t){const l=Et(e).scrollLeft;return t?t.left+l:Kt(bt(e)).left+l}function Yt(e,t){const l=e.getBoundingClientRect();return{x:l.left+t.scrollLeft-Jt(e,l),y:l.top+t.scrollTop}}function Xt(e,t,l){let o;if("viewport"===t||"layoutViewport"===t)o=function(e,t,l){void 0===l&&(l="viewport");const o="layoutViewport"===l,n=xt(e),r=bt(e),i=n.visualViewport;let a=r.clientWidth,c=r.clientHeight,s=0,h=0;if(i){const e=!Lt()||"fixed"===t;o?e||(s=-i.offsetLeft,h=-i.offsetTop):(a=i.width,c=i.height,e&&(s=i.offsetLeft,h=i.offsetTop))}if(Jt(r)<=0){const e=r.ownerDocument,t=e.body,l=getComputedStyle(t),o="CSS1Compat"===e.compatMode&&parseFloat(l.marginLeft)+parseFloat(l.marginRight)||0,n=Math.abs(r.clientWidth-t.clientWidth-o),i="stable both-edges"===getComputedStyle(r).scrollbarGutter?n/2:n;i<=25&&(a-=i)}return{width:a,height:c,x:s,y:h}}(e,l,t);else if("document"===t)o=function(e){const t=Et(e),l=e.ownerDocument.body,o=qe(e.scrollWidth,e.clientWidth,l.scrollWidth,l.clientWidth),n=qe(e.scrollHeight,e.clientHeight,l.scrollHeight,l.clientHeight);let r=-t.scrollLeft+Jt(e);const i=-t.scrollTop;return"rtl"===kt(l).direction&&(r+=qe(e.clientWidth,l.clientWidth)-o),{width:o,height:n,x:r,y:i}}(bt(e));else if(Mt(t))o=function(e,t){const l=Kt(e,!0,"fixed"===t),o=l.top+e.clientTop,n=l.left+e.clientLeft,r=Wt(e);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:n*r.x,y:o*r.y}}(t,l);else{const l=qt(e);o={x:t.x-l.x,y:t.y-l.y,width:t.width,height:t.height}}return pt(o)}function Gt(e,t,l){const o=yt(t),n=bt(t),r="fixed"===l,i=Kt(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const c=Ye(0);if((o||!r)&&(("body"!==Zt(t)||Ht(n))&&(a=Et(t)),o)){const e=Kt(t,!0,r,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}!o&&n&&(c.x=Jt(n));const s=!n||o||r?Ye(0):Yt(n,a);return{x:i.left+a.scrollLeft-c.x-s.x,y:i.top+a.scrollTop-c.y-s.y,width:i.width,height:i.height}}function Qt(e){return"static"===kt(e).position}function el(e,t){if(!yt(e)||"fixed"===kt(e).position)return null;if(t)return t(e);let l=e.offsetParent;return bt(e)===l&&(l=l.ownerDocument.body),l}function tl(e,t){const l=xt(e);if(Ot(e))return l;if(!yt(e)){let t=Tt(e);for(;t&&!St(t);){if(Mt(t)&&!Qt(t))return t;t=Tt(t)}return l}let o=el(e,t);for(;o&&Pt(o)&&Qt(o);)o=el(o,t);return o&&St(o)&&Qt(o)&&!$t(o)?l:o||function(e){let t=Tt(e);for(;yt(t)&&!St(t);){if($t(t))return t;if(Ot(t))return null;t=Tt(t)}return null}(e)||l}const ll={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:l,offsetParent:o,strategy:n}=e;const r="fixed"===n,i=bt(o),a=!!t&&Ot(t.floating);if(o===i||a&&r)return l;let c={scrollLeft:0,scrollTop:0},s=Ye(1);const h=Ye(0),d=yt(o);if((d||!r)&&(("body"!==Zt(o)||Ht(i))&&(c=Et(o)),d)){const e=Kt(o);s=Wt(o),h.x=e.x+o.clientLeft,h.y=e.y+o.clientTop}const u=!i||d||r?Ye(0):Yt(i,c);return{width:l.width*s.x,height:l.height*s.y,x:l.x*s.x-c.scrollLeft*s.x+h.x+u.x,y:l.y*s.y-c.scrollTop*s.y+h.y+u.y}},getDocumentElement:bt,getClippingRect:function(e){let{element:t,boundary:l,rootBoundary:o,strategy:n}=e;const r=[..."clippingAncestors"===l?Ot(t)?[]:function(e,t){const l=t.get(e);if(l)return l;let o=It(e,[],!1).filter(e=>Mt(e)&&"body"!==Zt(e)),n=null;const r="fixed"===kt(e).position;let i=r?Tt(e):e;for(;Mt(i)&&!St(i);){const e=kt(i),t=$t(i),l=n?n.position:r?"fixed":"";t||"fixed"!==l&&("absolute"!==l||"static"!==e.position)?n=e:o=o.filter(e=>e!==i),i=Tt(i)}return t.set(e,o),o}(t,this._c):[].concat(l),o],i=Xt(t,r[0],n);let a=i.top,c=i.right,s=i.bottom,h=i.left;for(let e=1;e<r.length;e++){const l=Xt(t,r[e],n);a=qe(l.top,a),c=Fe(l.right,c),s=Fe(l.bottom,s),h=qe(l.left,h)}return{width:c-h,height:s-a,x:h,y:a}},getOffsetParent:tl,getElementRects:async function(e){const t=this.getOffsetParent||tl,l=this.getDimensions,o=await l(e.floating);return{reference:Gt(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return e.getClientRects?Array.from(e.getClientRects()):[]},getDimensions:function(e){const{width:t,height:l}=Nt(e);return{width:t,height:l}},getScale:Wt,isElement:Mt,isRTL:function(e){return"rtl"===kt(e).direction}};function ol(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function nl(e,t,l,o){void 0===o&&(o={});const{ancestorScroll:n=!0,ancestorResize:r=!0,elementResize:i="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:c=!1}=o,s=Ut(e),h=n||r?[...s?It(s):[],...t?It(t):[]]:[];h.forEach(e=>{n&&e.addEventListener("scroll",l),r&&e.addEventListener("resize",l)});const d=s&&a?function(e,t,l){let o,n=null;const r=bt(e);function i(){var e;clearTimeout(o),null==(e=n)||e.disconnect(),n=null}function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),i();const s=e.getBoundingClientRect(),{left:h,top:d,width:u,height:v}=s;if(l||t(),!u||!v)return;const f={rootMargin:-Je(d)+"px "+-Je(r.clientWidth-(h+u))+"px "+-Je(r.clientHeight-(d+v))+"px "+-Je(h)+"px",threshold:qe(0,Fe(1,c))||1};let p=!0;function g(t){const l=t[0].intersectionRatio;if(!ol(s,e.getBoundingClientRect()))return a();if(l!==c){if(!p)return a();l?a(!1,l):o=setTimeout(()=>{a(!1,1e-7)},1e3)}p=!1}try{n=new IntersectionObserver(g,{...f,root:r.ownerDocument})}catch(e){n=new IntersectionObserver(g,f)}n.observe(e)}const c=xt(e),s=()=>a(l);return c.addEventListener("resize",s),a(!0),()=>{c.removeEventListener("resize",s),i()}}(s,l,r):null;let u,v=-1,f=null;i&&(f=new ResizeObserver(e=>{let[o]=e;o&&o.target===s&&f&&t&&(f.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=f)||e.observe(t)})),l()}),s&&!c&&f.observe(s),t&&f.observe(t));let p=c?Kt(e):null;return c&&function t(){const o=Kt(e);p&&!ol(p,o)&&l();p=o,u=requestAnimationFrame(t)}(),l(),()=>{var e;h.forEach(e=>{n&&e.removeEventListener("scroll",l),r&&e.removeEventListener("resize",l)}),null==d||d(),null==(e=f)||e.disconnect(),f=null,c&&cancelAnimationFrame(u)}}const rl=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var l,o;const{x:n,y:r,placement:i,middlewareData:a}=t,c=await async function(e,t){const{placement:l,platform:o,elements:n}=e,r=await(null==o.isRTL?void 0:o.isRTL(n.floating)),i=et(l),a=tt(l),c="y"===nt(l),s=mt.has(i)?-1:1,h=r&&c?-1:1,d=Qe(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:f}="number"==typeof d?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&"number"==typeof f&&(v="end"===a?-1*f:f),c?{x:v*h,y:u*s}:{x:u*s,y:v*h}}(t,e);return i===(null==(l=a.offset)?void 0:l.placement)&&null!=(o=a.arrow)&&o.alignmentOffset?{}:{x:n+c.x,y:r+c.y,data:{...c,placement:i}}}}},il=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:l,y:o,placement:n,platform:r}=t,{mainAxis:i=!0,crossAxis:a=!1,limiter:c={fn:e=>{let{x:t,y:l}=e;return{x:t,y:l}}},...s}=Qe(e,t),h={x:l,y:o},d=await r.detectOverflow(t,s),u=nt(n),v=lt(u);let f=h[v],p=h[u];const g=(e,t)=>Ge(t+d["y"===e?"top":"left"],t,t-d["y"===e?"bottom":"right"]);i&&(f=g(v,f)),a&&(p=g(u,p));const w=c.fn({...t,[v]:f,[u]:p});return{...w,data:{x:w.x-l,y:w.y-o,enabled:{[v]:i,[u]:a}}}}}},al=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var l,o;const{placement:n,middlewareData:r,rects:i,initialPlacement:a,platform:c,elements:s}=t,{mainAxis:h=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:p=!0,...g}=Qe(e,t);if(null!=(l=r.arrow)&&l.alignmentOffset)return{};const w=et(n),m=nt(a),_=et(a)===a,Z=await(null==c.isRTL?void 0:c.isRTL(s.floating)),x=u||(_||!p?[vt(a)]:function(e){const t=vt(e);return[at(e),t,at(t)]}(a)),b="none"!==f;!u&&b&&x.push(...ut(a,p,f,Z));const C=[a,...x],M=await c.detectOverflow(t,g),y=[];let V=(null==(o=r.flip)?void 0:o.overflows)||[];if(h&&y.push(M[w]),d){const e=it(n,i,Z);y.push(M[e[0]],M[e[1]])}if(V=[...V,{placement:n,overflows:y}],!y.every(e=>e<=0)){var H,P;const e=((null==(H=r.flip)?void 0:H.index)||0)+1,t=C[e];if(t){if(!("alignment"===d&&m!==nt(t))||V.every(e=>nt(e.placement)!==m||e.overflows[0]>0))return{data:{index:e,overflows:V},reset:{placement:t}}}let l=null==(P=V.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:P.placement;if(!l)switch(v){case"bestFit":{var O;const e=null==(O=V.filter(e=>{if(b){const t=nt(e.placement);return t===m||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:O[0];e&&(l=e);break}case"initialPlacement":l=a}if(n!==l)return{reset:{placement:l}}}return{}}}},cl=(e,t,l)=>{const o=new Map,n=null!=l?l:{},r={...ll,...n.platform,_c:o};return(async(e,t,l)=>{const{placement:o="bottom",strategy:n="absolute",middleware:r=[],platform:i}=l,a=i.detectOverflow?i:{...i,detectOverflow:wt},c=await(null==i.isRTL?void 0:i.isRTL(t));let s=await i.getElementRects({reference:e,floating:t,strategy:n}),{x:h,y:d}=gt(s,o,c),u=o,v=0;const f={};for(let l=0;l<r.length;l++){const p=r[l];if(!p)continue;const{name:g,fn:w}=p,{x:m,y:_,data:Z,reset:x}=await w({x:h,y:d,initialPlacement:o,placement:u,strategy:n,middlewareData:f,rects:s,platform:a,elements:{reference:e,floating:t}});h=null!=m?m:h,d=null!=_?_:d,f[g]={...f[g],...Z},x&&v<50&&(v++,"object"==typeof x&&(x.placement&&(u=x.placement),x.rects&&(s=!0===x.rects?await i.getElementRects({reference:e,floating:t,strategy:n}):x.rects),({x:h,y:d}=gt(s,u,c))),l=-1)}return{x:h,y:d,placement:u,strategy:n,middlewareData:f}})(e,t,{...n,platform:r})};var sl=i`:host{-webkit-text-size-adjust:100%;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-font-smoothing:antialiased;color:var(--sit-body-color-default,#1a1a1a);display:block;font-family:var(--sit-font-family-brand,"Inter",system-ui,sans-serif);font-size:var(--sit-font-size-body-md,1rem);font-weight:var(--sit-font-weight-regular,400);line-height:var(--sit-line-height-xs,24px);margin:0;*,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}:disabled{cursor:not-allowed}@media (prefers-reduced-motion:no-preference){:root{scroll-behavior:smooth}}::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}::slotted(svg){vertical-align:middle}}`;class hl extends Ze{emit(e,t){const l=new CustomEvent(e,Object.assign({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(l),l}static define(e,t=this,l={}){if(customElements.get(e));else try{customElements.define(e,t,l)}catch(o){customElements.define(e,class extends t{},l)}}constructor(){super(),this.ssr=Boolean(this.shadowRoot),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}firstUpdated(e){var t;super.firstUpdated(e),this.ssr&&(null===(t=this.shadowRoot)||void 0===t||t.querySelectorAll("slot").forEach(e=>{e.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}))}}hl.styles=[sl],hl.dependencies={},e([Ve({type:Boolean,reflect:!0})],hl.prototype,"ssr",void 0);class dl extends hl{constructor(){super(...arguments),this.myDropdown=De(),this.dropdownMenuId=function(e="",t=""){return`id-${Math.random().toString().substring(2,6)}-sit-${e}-${t}`}("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=De(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=nl(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const l=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},o=t.map(l),n=e.map(e=>{const n=l(e),r=o.indexOf(n);return-1!==r?t[r]:e}).concat(t.filter(t=>!e.some(e=>l(e)===l(t))));return n}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[rl(8),this.noFlip?void 0:al(),il()].filter(Boolean);let l=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(l=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const o=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:l}),{x:n,y:r,strategy:i,placement:a}=await cl(this.myDropdown.value,this.menuRef.value,o);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:i,left:`${n}px`,top:`${r}px`})}}e([Ve({type:Boolean,state:!0})],dl.prototype,"noFlip",void 0),e([Ve({type:Boolean,reflect:!0,state:!0})],dl.prototype,"menuAlignRight",void 0),e([Ve({type:String,reflect:!0,state:!0})],dl.prototype,"drop",void 0),e([Ve({type:Object})],dl.prototype,"floatingOpts",void 0),e([Ve({type:Boolean,reflect:!0})],dl.prototype,"menuIsOpen",void 0),e([Ve({type:Boolean,reflect:!0})],dl.prototype,"disabled",void 0),e([Ve({type:Boolean,reflect:!0})],dl.prototype,"readonly",void 0);class ul extends dl{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),l=t.find(t=>e.composedPath().includes(t));if(!l)return;const o=t.indexOf(l);this.nextDropdownItemNo=o+1,this.prevDropdownItemNo=o<=0?t.length-1:o-1,l.disabled||(this.emit("sit-select",{detail:{item:l}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const l=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");l&&l.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const l=(e%t.length+t.length)%t.length,o=t[l];this.emit("i-sit-option-focus",{detail:{option:o}}),this.nextDropdownItemNo=(l+1)%t.length,this.prevDropdownItemNo=(l-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===o?"0":"-1"),e===o&&t.focus()})}}var vl,fl;function pl(e,t){const l=Object.assign({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:n}=t;if(e in t){const r=e;t.update=function(e){if(e.has(r)){const t=e.get(r),n=this[r];t!==n&&(l.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,n))}n.call(this,e)}}}}ul.styles=dl.styles,e([(vl="ul.dropdown-menu",(e,t,l)=>{const o=e=>{const l=e.renderRoot?.querySelector(vl)??null;if(null===l&&fl&&!e.hasUpdated){const e="object"==typeof t?t.name:t;Oe("",`@query'd field ${JSON.stringify(String(e))} with the 'cache' flag set for selector '${vl}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(fl){const{get:n,set:r}="object"==typeof t?e:l??(()=>{const e=Symbol(`${String(t)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return Pe(e,t,{get(){let e=n.call(this);return void 0===e&&(e=o(this),(null!==e||this.hasUpdated)&&r.call(this,e)),e}})}return Pe(e,t,{get(){return o(this)}})})],ul.prototype,"menu",void 0),e([He()],ul.prototype,"nextDropdownItemNo",void 0),e([He()],ul.prototype,"prevDropdownItemNo",void 0),e([Ve({type:Boolean,reflect:!0})],ul.prototype,"hidden",void 0);var gl=i`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:0 0 1px 0 hsla(0,0%,5%,.12),0 4px 8px 0 hsla(0,0%,5%,.12);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:left;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-top-left-radius:0;border-top-right-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{left:0;right:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,wl=i`.dropdown{display:flex;height:inherit;position:relative}.dropdown-menu{max-width:var(--sit-dimension-320)}.toggler-container{flex:1;pointer-events:none}.toggler-container ::slotted(*){pointer-events:auto}`;class ml extends ul{constructor(){super(),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.close="default",this.menuRef=We()}async _handleClick(e){if(this.disabled)return;const t=this._toggler[0];if(!t)return void this.toggleMenu();if(e.composedPath().includes(t))return void this.toggleMenu();if(!this.menuIsOpen)return;const l=this.menuRef.value;l&&e.composedPath().includes(l)||this.hideMenu()}_handleCloseMenu(){const e=this._toggler[0];null==e||e.focus()}async connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._handleCloseMenu)}async disconnectedCallback(){this.removeEventListener("sit-hide",this._handleCloseMenu)}async firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&await this.updateFloatingPosition(),this._handleDisabled()}_handleTogglerSlotChange(e){const t=e.target.assignedElements({flatten:!0})[0];t&&(t.setAttribute("aria-haspopup","menu"),t.setAttribute("aria-expanded",String(this.menuIsOpen)))}_handleMenuIsOpenChange(){const e=this._toggler[0];e&&e.setAttribute("aria-expanded",String(this.menuIsOpen))}_handleDisabled(){const e=this._toggler[0];e&&(this.disabled?e.setAttribute("disabled","true"):e.hasAttribute("disabled")&&e.removeAttribute("disabled"))}render(){return Q`
      <div class="dropdown" @click=${this._handleClick}>
        <div class="toggler-container" ${We(this.myDropdown)}>
          <slot name="toggler" @slotchange=${this._handleTogglerSlotChange}></slot>
        </div>
        <div class="dropdown-menu" role="menu" ${We(this.menuRef)}>
          <slot id="default" @click=${this.handleSelectSlot}></slot>
        </div>
      </div>
    `}}ml.styles=[...ul.styles,wl,gl],e([Ve({type:Boolean,reflect:!0,state:!1})],ml.prototype,"noFlip",void 0),e([Ve({type:Boolean,reflect:!0,state:!1})],ml.prototype,"menuAlignRight",void 0),e([Ve({type:String,reflect:!0,state:!1})],ml.prototype,"drop",void 0),e([Ve({type:String,reflect:!0,state:!1})],ml.prototype,"close",void 0),e([ze({slot:"toggler",flatten:!0})],ml.prototype,"_toggler",void 0),e([pl("menuIsOpen")],ml.prototype,"_handleMenuIsOpenChange",null),e([pl("disabled",{waitUntilFirstUpdate:!0})],ml.prototype,"_handleDisabled",null);const _l=Ae(
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
class extends $e{constructor(e){if(super(e),e.type!==Be||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const l=e.element.classList;for(const e of this._previousClasses)e in t||(l.remove(e),this._previousClasses.delete(e));for(const e in t){const o=!!t[e];o===this._previousClasses.has(e)||this._staticClasses?.has(e)||(o?(l.add(e),this._previousClasses.add(e)):(l.remove(e),this._previousClasses.delete(e)))}return te}}),Zl={announcement:()=>Promise.resolve().then(function(){return Pl}),archive:()=>Promise.resolve().then(function(){return zl}),"arrow-bar-down":()=>Promise.resolve().then(function(){return jl}),"arrow-bar-left":()=>Promise.resolve().then(function(){return $l}),"arrow-bar-right":()=>Promise.resolve().then(function(){return Sl}),"arrow-bar-up":()=>Promise.resolve().then(function(){return El}),"arrow-circle-down":()=>Promise.resolve().then(function(){return Rl}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Dl}),"arrow-circle-right":()=>Promise.resolve().then(function(){return Ul}),"arrow-circle-up":()=>Promise.resolve().then(function(){return Fl}),"arrow-clockwise":()=>Promise.resolve().then(function(){return Kl}),"arrow-down":()=>Promise.resolve().then(function(){return Yl}),"arrow-left":()=>Promise.resolve().then(function(){return Gl}),"arrow-repeat":()=>Promise.resolve().then(function(){return eo}),"arrow-right":()=>Promise.resolve().then(function(){return lo}),"arrow-square-down":()=>Promise.resolve().then(function(){return no}),"arrow-square-left":()=>Promise.resolve().then(function(){return io}),"arrow-square-right":()=>Promise.resolve().then(function(){return co}),"arrow-square-up":()=>Promise.resolve().then(function(){return ho}),"arrow-up":()=>Promise.resolve().then(function(){return vo}),"bank-fill":()=>Promise.resolve().then(function(){return po}),"bell-slash":()=>Promise.resolve().then(function(){return wo}),bell:()=>Promise.resolve().then(function(){return _o}),"bi-funnel":()=>Promise.resolve().then(function(){return xo}),"bookmark-fill":()=>Promise.resolve().then(function(){return Co}),bookmark:()=>Promise.resolve().then(function(){return yo}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return Ho}),"box-seam":()=>Promise.resolve().then(function(){return Oo}),building:()=>Promise.resolve().then(function(){return Bo}),bus:()=>Promise.resolve().then(function(){return Ao}),calculator:()=>Promise.resolve().then(function(){return Lo}),"calendar-check":()=>Promise.resolve().then(function(){return ko}),"calendar-heart":()=>Promise.resolve().then(function(){return To}),"calendar-x":()=>Promise.resolve().then(function(){return Io}),calendar:()=>Promise.resolve().then(function(){return No}),camera:()=>Promise.resolve().then(function(){return Wo}),car:()=>Promise.resolve().then(function(){return qo}),"chat-dots":()=>Promise.resolve().then(function(){return Jo}),"chat-left-text":()=>Promise.resolve().then(function(){return Xo}),chat:()=>Promise.resolve().then(function(){return Qo}),"check-circle-fill":()=>Promise.resolve().then(function(){return tn}),"check-circle":()=>Promise.resolve().then(function(){return on}),check:()=>Promise.resolve().then(function(){return rn}),"chevron-down":()=>Promise.resolve().then(function(){return cn}),"chevron-left":()=>Promise.resolve().then(function(){return hn}),"chevron-right":()=>Promise.resolve().then(function(){return un}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return fn}),"chevron-up":()=>Promise.resolve().then(function(){return gn}),clock:()=>Promise.resolve().then(function(){return mn}),"cloud-check":()=>Promise.resolve().then(function(){return Zn}),"cloud-download":()=>Promise.resolve().then(function(){return bn}),"cloud-upload":()=>Promise.resolve().then(function(){return Mn}),cloud:()=>Promise.resolve().then(function(){return Vn}),"code-square":()=>Promise.resolve().then(function(){return Pn}),"coins-hand":()=>Promise.resolve().then(function(){return zn}),compass:()=>Promise.resolve().then(function(){return jn}),copy:()=>Promise.resolve().then(function(){return $n}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return Sn}),cross:()=>Promise.resolve().then(function(){return En}),"cursor-fill":()=>Promise.resolve().then(function(){return Rn}),cursor:()=>Promise.resolve().then(function(){return Dn}),"dash-circle":()=>Promise.resolve().then(function(){return Un}),"dash-square":()=>Promise.resolve().then(function(){return Fn}),dash:()=>Promise.resolve().then(function(){return Kn}),database:()=>Promise.resolve().then(function(){return Yn}),dataflow:()=>Promise.resolve().then(function(){return Gn}),download:()=>Promise.resolve().then(function(){return er}),edit:()=>Promise.resolve().then(function(){return lr}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return nr}),"exclamation-circle":()=>Promise.resolve().then(function(){return ir}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return cr}),"exclamation-triangle":()=>Promise.resolve().then(function(){return hr}),exclamation:()=>Promise.resolve().then(function(){return ur}),"eye-fill":()=>Promise.resolve().then(function(){return fr}),"eye-slash-fill":()=>Promise.resolve().then(function(){return gr}),"eye-slash":()=>Promise.resolve().then(function(){return mr}),eye:()=>Promise.resolve().then(function(){return Zr}),"face-smile-fill":()=>Promise.resolve().then(function(){return br}),"face-smile":()=>Promise.resolve().then(function(){return Mr}),facebook:()=>Promise.resolve().then(function(){return Vr}),"file-earmark-text":()=>Promise.resolve().then(function(){return Pr}),"file-pdf":()=>Promise.resolve().then(function(){return zr}),"file-plus":()=>Promise.resolve().then(function(){return jr}),"file-text":()=>Promise.resolve().then(function(){return $r}),file:()=>Promise.resolve().then(function(){return Sr}),files:()=>Promise.resolve().then(function(){return Er}),fingerprint:()=>Promise.resolve().then(function(){return Rr}),flash:()=>Promise.resolve().then(function(){return Dr}),"folder-check":()=>Promise.resolve().then(function(){return Ur}),"folder-minus":()=>Promise.resolve().then(function(){return Fr}),"folder-plus":()=>Promise.resolve().then(function(){return Kr}),folder:()=>Promise.resolve().then(function(){return Yr}),gear:()=>Promise.resolve().then(function(){return Gr}),"geo-alt":()=>Promise.resolve().then(function(){return ei}),"geo-fill":()=>Promise.resolve().then(function(){return li}),geo:()=>Promise.resolve().then(function(){return ni}),"globe-alt":()=>Promise.resolve().then(function(){return ii}),globe:()=>Promise.resolve().then(function(){return ci}),google:()=>Promise.resolve().then(function(){return hi}),"grid-alt":()=>Promise.resolve().then(function(){return ui}),"grid-fill":()=>Promise.resolve().then(function(){return fi}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return gi}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return mi}),"hard-drive":()=>Promise.resolve().then(function(){return Zi}),heart:()=>Promise.resolve().then(function(){return bi}),"house-door":()=>Promise.resolve().then(function(){return Mi}),house:()=>Promise.resolve().then(function(){return Vi}),image:()=>Promise.resolve().then(function(){return Pi}),"in-box":()=>Promise.resolve().then(function(){return zi}),"info-circle-fill":()=>Promise.resolve().then(function(){return ji}),"info-circle":()=>Promise.resolve().then(function(){return $i}),instagram:()=>Promise.resolve().then(function(){return Si}),key:()=>Promise.resolve().then(function(){return Ei}),"laptop-gear":()=>Promise.resolve().then(function(){return Ri}),laptop:()=>Promise.resolve().then(function(){return Di}),layers:()=>Promise.resolve().then(function(){return Ui}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return Fi}),"layout-text-window":()=>Promise.resolve().then(function(){return Ki}),layout:()=>Promise.resolve().then(function(){return Yi}),"life-buoy":()=>Promise.resolve().then(function(){return Gi}),lightbulb:()=>Promise.resolve().then(function(){return ea}),link:()=>Promise.resolve().then(function(){return la}),linkedin:()=>Promise.resolve().then(function(){return na}),list:()=>Promise.resolve().then(function(){return ia}),"lock-fill":()=>Promise.resolve().then(function(){return ca}),lock:()=>Promise.resolve().then(function(){return ha}),login:()=>Promise.resolve().then(function(){return ua}),logout:()=>Promise.resolve().then(function(){return fa}),luggage:()=>Promise.resolve().then(function(){return ga}),"mail-open":()=>Promise.resolve().then(function(){return ma}),mail:()=>Promise.resolve().then(function(){return Za}),map:()=>Promise.resolve().then(function(){return ba}),meetup:()=>Promise.resolve().then(function(){return Ma}),menu:()=>Promise.resolve().then(function(){return Va}),microphone:()=>Promise.resolve().then(function(){return Pa}),monitor:()=>Promise.resolve().then(function(){return za}),moon:()=>Promise.resolve().then(function(){return ja}),move:()=>Promise.resolve().then(function(){return $a}),paperclip:()=>Promise.resolve().then(function(){return Sa}),passcode:()=>Promise.resolve().then(function(){return Ea}),passport:()=>Promise.resolve().then(function(){return Ra}),pause:()=>Promise.resolve().then(function(){return Da}),pencil:()=>Promise.resolve().then(function(){return Ua}),"pending-circle":()=>Promise.resolve().then(function(){return Fa}),"person-dash":()=>Promise.resolve().then(function(){return Ka}),"person-plus":()=>Promise.resolve().then(function(){return Ya}),"person-x":()=>Promise.resolve().then(function(){return Ga}),person:()=>Promise.resolve().then(function(){return ec}),phone:()=>Promise.resolve().then(function(){return lc}),"pin-map-fill":()=>Promise.resolve().then(function(){return nc}),pin:()=>Promise.resolve().then(function(){return ic}),placeholder:()=>Promise.resolve().then(function(){return cc}),plane:()=>Promise.resolve().then(function(){return hc}),play:()=>Promise.resolve().then(function(){return uc}),"plus-circle":()=>Promise.resolve().then(function(){return fc}),"plus-square":()=>Promise.resolve().then(function(){return gc}),plus:()=>Promise.resolve().then(function(){return mc}),printer:()=>Promise.resolve().then(function(){return Zc}),"question-circle":()=>Promise.resolve().then(function(){return bc}),rocket:()=>Promise.resolve().then(function(){return Mc}),save:()=>Promise.resolve().then(function(){return Vc}),search:()=>Promise.resolve().then(function(){return Pc}),send:()=>Promise.resolve().then(function(){return zc}),"sg-crest":()=>Promise.resolve().then(function(){return jc}),share:()=>Promise.resolve().then(function(){return $c}),"shield-tick":()=>Promise.resolve().then(function(){return Sc}),"sidebar-collapse":()=>Promise.resolve().then(function(){return Ec}),"sidebar-expand":()=>Promise.resolve().then(function(){return Rc}),"slash-circle":()=>Promise.resolve().then(function(){return Dc}),"slash-divider":()=>Promise.resolve().then(function(){return Uc}),sliders:()=>Promise.resolve().then(function(){return Fc}),"sort-ascending":()=>Promise.resolve().then(function(){return Kc}),"sort-descending":()=>Promise.resolve().then(function(){return Yc}),speedometer:()=>Promise.resolve().then(function(){return Gc}),"star-ai":()=>Promise.resolve().then(function(){return es}),"star-fill":()=>Promise.resolve().then(function(){return ls}),star:()=>Promise.resolve().then(function(){return ns}),stoplights:()=>Promise.resolve().then(function(){return is}),sun:()=>Promise.resolve().then(function(){return cs}),"switch-horizontal":()=>Promise.resolve().then(function(){return hs}),"switch-vertical":()=>Promise.resolve().then(function(){return us}),tablet:()=>Promise.resolve().then(function(){return fs}),telegram:()=>Promise.resolve().then(function(){return gs}),telephone:()=>Promise.resolve().then(function(){return ms}),"three-dots-vertical":()=>Promise.resolve().then(function(){return Zs}),"three-dots":()=>Promise.resolve().then(function(){return bs}),ticket:()=>Promise.resolve().then(function(){return Ms}),"toggle-off":()=>Promise.resolve().then(function(){return Vs}),"toggle-on":()=>Promise.resolve().then(function(){return Ps}),train:()=>Promise.resolve().then(function(){return zs}),translate:()=>Promise.resolve().then(function(){return js}),trash:()=>Promise.resolve().then(function(){return $s}),"trend-down":()=>Promise.resolve().then(function(){return Ss}),"trend-up":()=>Promise.resolve().then(function(){return Es}),truck:()=>Promise.resolve().then(function(){return Rs}),"twitter-x":()=>Promise.resolve().then(function(){return Ds}),unlock:()=>Promise.resolve().then(function(){return Us}),upload:()=>Promise.resolve().then(function(){return Fs}),"user-check":()=>Promise.resolve().then(function(){return Ks}),"user-circle":()=>Promise.resolve().then(function(){return Ys}),"user-pause":()=>Promise.resolve().then(function(){return Gs}),"user-square":()=>Promise.resolve().then(function(){return eh}),users:()=>Promise.resolve().then(function(){return lh}),"video-recorder":()=>Promise.resolve().then(function(){return nh}),"volume-max":()=>Promise.resolve().then(function(){return ih}),"volume-x":()=>Promise.resolve().then(function(){return ch}),"window-dash":()=>Promise.resolve().then(function(){return hh}),"window-desktop":()=>Promise.resolve().then(function(){return uh}),"window-dock":()=>Promise.resolve().then(function(){return fh}),"window-fullscreen":()=>Promise.resolve().then(function(){return gh}),"window-plus":()=>Promise.resolve().then(function(){return mh}),"window-sidebar":()=>Promise.resolve().then(function(){return Zh}),"window-split":()=>Promise.resolve().then(function(){return bh}),"window-stack":()=>Promise.resolve().then(function(){return Mh}),"window-x":()=>Promise.resolve().then(function(){return Vh}),window:()=>Promise.resolve().then(function(){return Ph}),"xcircle-fill":()=>Promise.resolve().then(function(){return zh}),xcircle:()=>Promise.resolve().then(function(){return jh}),youtube:()=>Promise.resolve().then(function(){return $h}),"zoom-in":()=>Promise.resolve().then(function(){return Sh}),"zoom-out":()=>Promise.resolve().then(function(){return Eh})};
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */var xl=i`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const bl=new Map;class Cl extends hl{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(bl.has(e))return void(this._icon=bl.get(e));const t=Zl[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const l=await t();bl.set(e,l.default),this._icon=l.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:le}}Cl.styles=[...hl.styles,xl],e([Ve({type:String,reflect:!0})],Cl.prototype,"name",void 0),e([Ve({type:String,reflect:!0})],Cl.prototype,"size",void 0),e([Ve({type:String})],Cl.prototype,"ariaLabel",void 0),e([He()],Cl.prototype,"_icon",void 0);var Ml=i`:host([disabled]){cursor:not-allowed}.dropdown-item{align-items:center;background-color:var(--sit-bg-transparent);clear:both;color:var(--sit-color-default);cursor:pointer;display:flex;font-size:var(--sit-font-size-label-sm);gap:var(--sit-gap-sm);padding:var(--sit-padding-sm) var(--sit-padding-lg);text-align:inherit}.dropdown-item:hover{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus,.dropdown-item:focus-visible{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item:focus-visible{outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}.dropdown-item.active{background-color:var(--sit-bg-translucent-subtle);color:var(--sit-primary-color-default);text-decoration:none}.dropdown-item.disabled,.dropdown-item:disabled{opacity:var(--sit-opacity-40);pointer-events:none}::slotted(*){color:inherit!important;display:flex;gap:var(--sit-gap-sm);text-decoration:none!important}::slotted(a),::slotted(sit-checkbox){flex:1;margin:calc(var(--sit-padding-sm)*-1) calc(var(--sit-padding-lg)*-1);padding:var(--sit-padding-sm) var(--sit-padding-lg)}.dropdown-item.mainnav-dropdown-link{padding:var(--sit-padding-none)}.dropdown-item.mainnav-dropdown-link ::slotted(*){box-sizing:border-box;margin:auto;max-width:var(--sit-mainnav-max-width,1440px);padding:var(--sit-padding-sm) var(--sit-mainnav-mobile-padding-x)}@media screen and (min-width:1024px){.dropdown-item.mainnav-dropdown-link ::slotted(*){padding:var(--sit-padding-sm) var(--sit-mainnav-padding-x)}}`;class yl extends hl{constructor(){super(...arguments),this.active=!1,this.disabled=!1,this.ariaLabel=""}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",e=>{"Enter"===e.key&&this.anchor.length>0&&this.anchor[0].click()}),this.setAttribute("role","menuitem"),this.setAttribute("aria-disabled",`${this.disabled}`)}render(){return Q`
      <div
    ...
    `;var e}}function Vl(e,t){customElements.get(e)||customElements.define(e,t)}yl.styles=[wl,Ml],yl.dependencies={"sit-icon":Cl},e([ze({flatten:!0})],yl.prototype,"anchor",void 0),e([Ve({type:Boolean})],yl.prototype,"active",void 0),e([Ve({type:Boolean,reflect:!0})],yl.prototype,"disabled",void 0),e([Ve({type:String})],yl.prototype,"ariaLabel",void 0),Vl("sit-dropdown",ml),Vl("sit-dropdown-item",yl);var Hl=Q`
...
`,Pl=Object.freeze({__proto__:null,default:Hl}),Ol=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zl=Object.freeze({__proto__:null,default:Ol}),Bl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jl=Object.freeze({__proto__:null,default:Bl}),Al=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$l=Object.freeze({__proto__:null,default:Al}),Ll=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sl=Object.freeze({__proto__:null,default:Ll}),kl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,El=Object.freeze({__proto__:null,default:kl}),Tl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Rl=Object.freeze({__proto__:null,default:Tl}),Il=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Dl=Object.freeze({__proto__:null,default:Il}),Nl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ul=Object.freeze({__proto__:null,default:Nl}),Wl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fl=Object.freeze({__proto__:null,default:Wl}),ql=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kl=Object.freeze({__proto__:null,default:ql}),Jl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yl=Object.freeze({__proto__:null,default:Jl}),Xl=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gl=Object.freeze({__proto__:null,default:Xl}),Ql=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,eo=Object.freeze({__proto__:null,default:Ql}),to=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lo=Object.freeze({__proto__:null,default:to}),oo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,no=Object.freeze({__proto__:null,default:oo}),ro=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,io=Object.freeze({__proto__:null,default:ro}),ao=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,co=Object.freeze({__proto__:null,default:ao}),so=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,xo=Object.freeze({__proto__:null,default:Zo}),bo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Co=Object.freeze({__proto__:null,default:bo}),Mo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,yo=Object.freeze({__proto__:null,default:Mo}),Vo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Oo=Object.freeze({__proto__:null,default:Po}),zo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Bo=Object.freeze({__proto__:null,default:zo}),jo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ao=Object.freeze({__proto__:null,default:jo}),$o=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lo=Object.freeze({__proto__:null,default:$o}),So=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ko=Object.freeze({__proto__:null,default:So}),Eo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wo=Object.freeze({__proto__:null,default:Uo}),Fo=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,qo=Object.freeze({__proto__:null,default:Fo}),Ko=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Xo=Object.freeze({__proto__:null,default:Yo}),Go=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qo=Object.freeze({__proto__:null,default:Go}),en=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,on=Object.freeze({__proto__:null,default:ln}),nn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,rn=Object.freeze({__proto__:null,default:nn}),an=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cn=Object.freeze({__proto__:null,default:an}),sn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zn=Object.freeze({__proto__:null,default:_n}),xn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bn=Object.freeze({__proto__:null,default:xn}),Cn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mn=Object.freeze({__proto__:null,default:Cn}),yn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vn=Object.freeze({__proto__:null,default:yn}),Hn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Pn=Object.freeze({__proto__:null,default:Hn}),On=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zn=Object.freeze({__proto__:null,default:On}),Bn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jn=Object.freeze({__proto__:null,default:Bn}),An=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$n=Object.freeze({__proto__:null,default:An}),Ln=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sn=Object.freeze({__proto__:null,default:Ln}),kn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,En=Object.freeze({__proto__:null,default:kn}),Tn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fn=Object.freeze({__proto__:null,default:Wn}),qn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kn=Object.freeze({__proto__:null,default:qn}),Jn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gn=Object.freeze({__proto__:null,default:Xn}),Qn=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,er=Object.freeze({__proto__:null,default:Qn}),tr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lr=Object.freeze({__proto__:null,default:tr}),or=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nr=Object.freeze({__proto__:null,default:or}),rr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ir=Object.freeze({__proto__:null,default:rr}),ar=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,cr=Object.freeze({__proto__:null,default:ar}),sr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zr=Object.freeze({__proto__:null,default:_r}),xr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,br=Object.freeze({__proto__:null,default:xr}),Cr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Mr=Object.freeze({__proto__:null,default:Cr}),yr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Vr=Object.freeze({__proto__:null,default:yr}),Hr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pr=Object.freeze({__proto__:null,default:Hr}),Or=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zr=Object.freeze({__proto__:null,default:Or}),Br=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jr=Object.freeze({__proto__:null,default:Br}),Ar=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$r=Object.freeze({__proto__:null,default:Ar}),Lr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sr=Object.freeze({__proto__:null,default:Lr}),kr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Er=Object.freeze({__proto__:null,default:kr}),Tr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fr=Object.freeze({__proto__:null,default:Wr}),qr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kr=Object.freeze({__proto__:null,default:qr}),Jr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gr=Object.freeze({__proto__:null,default:Xr}),Qr=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,li=Object.freeze({__proto__:null,default:ti}),oi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ni=Object.freeze({__proto__:null,default:oi}),ri=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,ii=Object.freeze({__proto__:null,default:ri}),ai=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ci=Object.freeze({__proto__:null,default:ai}),si=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zi=Object.freeze({__proto__:null,default:_i}),xi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bi=Object.freeze({__proto__:null,default:xi}),Ci=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mi=Object.freeze({__proto__:null,default:Ci}),yi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vi=Object.freeze({__proto__:null,default:yi}),Hi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pi=Object.freeze({__proto__:null,default:Hi}),Oi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zi=Object.freeze({__proto__:null,default:Oi}),Bi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ji=Object.freeze({__proto__:null,default:Bi}),Ai=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$i=Object.freeze({__proto__:null,default:Ai}),Li=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Si=Object.freeze({__proto__:null,default:Li}),ki=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Ei=Object.freeze({__proto__:null,default:ki}),Ti=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fi=Object.freeze({__proto__:null,default:Wi}),qi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ki=Object.freeze({__proto__:null,default:qi}),Ji=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gi=Object.freeze({__proto__:null,default:Xi}),Qi=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ea=Object.freeze({__proto__:null,default:Qi}),ta=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,la=Object.freeze({__proto__:null,default:ta}),oa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,na=Object.freeze({__proto__:null,default:oa}),ra=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ia=Object.freeze({__proto__:null,default:ra}),aa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ca=Object.freeze({__proto__:null,default:aa}),sa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Za=Object.freeze({__proto__:null,default:_a}),xa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ba=Object.freeze({__proto__:null,default:xa}),Ca=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ma=Object.freeze({__proto__:null,default:Ca}),ya=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Va=Object.freeze({__proto__:null,default:ya}),Ha=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pa=Object.freeze({__proto__:null,default:Ha}),Oa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,za=Object.freeze({__proto__:null,default:Oa}),Ba=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ja=Object.freeze({__proto__:null,default:Ba}),Aa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$a=Object.freeze({__proto__:null,default:Aa}),La=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sa=Object.freeze({__proto__:null,default:La}),ka=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ea=Object.freeze({__proto__:null,default:ka}),Ta=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fa=Object.freeze({__proto__:null,default:Wa}),qa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ka=Object.freeze({__proto__:null,default:qa}),Ja=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ga=Object.freeze({__proto__:null,default:Xa}),Qa=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ec=Object.freeze({__proto__:null,default:Qa}),tc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,lc=Object.freeze({__proto__:null,default:tc}),oc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nc=Object.freeze({__proto__:null,default:oc}),rc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ic=Object.freeze({__proto__:null,default:rc}),ac=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,cc=Object.freeze({__proto__:null,default:ac}),sc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zc=Object.freeze({__proto__:null,default:_c}),xc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,bc=Object.freeze({__proto__:null,default:xc}),Cc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mc=Object.freeze({__proto__:null,default:Cc}),yc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vc=Object.freeze({__proto__:null,default:yc}),Hc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Pc=Object.freeze({__proto__:null,default:Hc}),Oc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zc=Object.freeze({__proto__:null,default:Oc}),Bc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="#DB0000"
...
`,jc=Object.freeze({__proto__:null,default:Bc}),Ac=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$c=Object.freeze({__proto__:null,default:Ac}),Lc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Sc=Object.freeze({__proto__:null,default:Lc}),kc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ec=Object.freeze({__proto__:null,default:kc}),Tc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fc=Object.freeze({__proto__:null,default:Wc}),qc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kc=Object.freeze({__proto__:null,default:qc}),Jc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Gc=Object.freeze({__proto__:null,default:Xc}),Qc=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ls=Object.freeze({__proto__:null,default:ts}),os=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ns=Object.freeze({__proto__:null,default:os}),rs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,is=Object.freeze({__proto__:null,default:rs}),as=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,cs=Object.freeze({__proto__:null,default:as}),ss=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Zs=Object.freeze({__proto__:null,default:_s}),xs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bs=Object.freeze({__proto__:null,default:xs}),Cs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ms=Object.freeze({__proto__:null,default:Cs}),ys=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Vs=Object.freeze({__proto__:null,default:ys}),Hs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ps=Object.freeze({__proto__:null,default:Hs}),Os=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,zs=Object.freeze({__proto__:null,default:Os}),Bs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,js=Object.freeze({__proto__:null,default:Bs}),As=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,$s=Object.freeze({__proto__:null,default:As}),Ls=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ss=Object.freeze({__proto__:null,default:Ls}),ks=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Es=Object.freeze({__proto__:null,default:ks}),Ts=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Fs=Object.freeze({__proto__:null,default:Ws}),qs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ks=Object.freeze({__proto__:null,default:qs}),Js=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Gs=Object.freeze({__proto__:null,default:Xs}),Qs=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,eh=Object.freeze({__proto__:null,default:Qs}),th=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,lh=Object.freeze({__proto__:null,default:th}),oh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nh=Object.freeze({__proto__:null,default:oh}),rh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ih=Object.freeze({__proto__:null,default:rh}),ah=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ch=Object.freeze({__proto__:null,default:ah}),sh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,hh=Object.freeze({__proto__:null,default:sh}),dh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,uh=Object.freeze({__proto__:null,default:dh}),vh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,fh=Object.freeze({__proto__:null,default:vh}),ph=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,gh=Object.freeze({__proto__:null,default:ph}),wh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,mh=Object.freeze({__proto__:null,default:wh}),_h=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Zh=Object.freeze({__proto__:null,default:_h}),xh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,bh=Object.freeze({__proto__:null,default:xh}),Ch=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Mh=Object.freeze({__proto__:null,default:Ch}),yh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Vh=Object.freeze({__proto__:null,default:yh}),Hh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ph=Object.freeze({__proto__:null,default:Hh}),Oh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,zh=Object.freeze({__proto__:null,default:Oh}),Bh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jh=Object.freeze({__proto__:null,default:Bh}),Ah=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,$h=Object.freeze({__proto__:null,default:Ah}),Lh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Sh=Object.freeze({__proto__:null,default:Lh}),kh=Q`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
