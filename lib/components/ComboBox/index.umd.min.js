!function(e){"function"==typeof define&&define.amd?define(e):e()}(function(){"use strict";function e(e,t,i,l){var o,r=arguments.length,n=r<3?t:null===l?l=Object.getOwnPropertyDescriptor(t,i):l;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,l);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(n=(r<3?o(n):r>3?o(t,i,n):o(t,i))||n);return r>3&&n&&Object.defineProperty(t,i,n),n}"function"==typeof SuppressedError&&SuppressedError;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const t=globalThis,i=e=>{t.emitLitDebugLogEvents&&t.dispatchEvent(new CustomEvent("lit-debug",{detail:e}))};let l,o=0;t.litIssuedWarnings??=new Set,l=(e,i)=>{i+=e?` See https://lit.dev/msg/${e} for more information.`:"",t.litIssuedWarnings.has(i)||t.litIssuedWarnings.has(e)||(console.warn(i),t.litIssuedWarnings.add(i))},queueMicrotask(()=>{l("dev-mode","Lit is in dev mode. Not recommended for production!")});const r=t.ShadyDOM?.inUse&&!0===t.ShadyDOM?.noPatch?t.ShadyDOM.wrap:e=>e,n=t.trustedTypes,a=n?n.createPolicy("lit-html",{createHTML:e=>e}):void 0,s=e=>e,c=(e,t,i)=>s,d=e=>{if(L!==c)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");L=e},h=()=>{L=c},u=(e,t,i)=>L(e,t,i),v="$lit$",p=`lit$${Math.random().toFixed(9).slice(2)}$`,f="?"+p,m=`<${f}>`,g=document,w=()=>g.createComment(""),_=e=>null===e||"object"!=typeof e&&"function"!=typeof e,b=Array.isArray,x=e=>b(e)||"function"==typeof e?.[Symbol.iterator],y="[ \t\n\f\r]",C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Z=/-->/g,M=/>/g,V=new RegExp(`>|${y}(?:([^\\s"'>=/]+)(${y}*=${y}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),k=/'/g,H=/"/g,P=/^(?:script|style|textarea|title)$/i,$=(O=1,(e,...t)=>(e.some(e=>void 0===e)&&console.warn("Some template strings are undefined.\nThis is probably caused by illegal octal escape sequences."),t.some(e=>e?._$litStatic$)&&l("","Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.\nPlease use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions"),{_$litType$:O,strings:e,values:t}));var O;const z=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),B=new WeakMap,A=g.createTreeWalker(g,129);let L=c;function j(e,t){if(!b(e)||!e.hasOwnProperty("raw")){let e="invalid template strings array";throw e="\n          Internal Error: expected template strings to be an array\n          with a 'raw' field. Faking a template strings array by\n          calling html or svg like an ordinary function is effectively\n          the same as calling unsafeHtml and can lead to major security\n          issues, e.g. opening your code up to XSS attacks.\n          If you're using the html or svg tagged template functions normally\n          and still seeing this error, please file a bug at\n          https://github.com/lit/lit/issues/new?template=bug_report.md\n          and include information about your build tooling, if any.\n        ".trim().replace(/\n */g,"\n"),new Error(e)}return void 0!==a?a.createHTML(t):t}const E=(e,t)=>{const i=e.length-1,l=[];let o,r=2===t?"<svg>":3===t?"<math>":"",n=C;for(let t=0;t<i;t++){const i=e[t];let a,s,c=-1,d=0;for(;d<i.length&&(n.lastIndex=d,s=n.exec(i),null!==s);)if(d=n.lastIndex,n===C){if("!--"===s[1])n=Z;else if(void 0!==s[1])n=M;else if(void 0!==s[2])P.test(s[2])&&(o=new RegExp(`</${s[2]}`,"g")),n=V;else if(void 0!==s[3])throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else n===V?">"===s[0]?(n=o??C,c=-1):void 0===s[1]?c=-2:(c=n.lastIndex-s[2].length,a=s[1],n=void 0===s[3]?V:'"'===s[3]?H:k):n===H||n===k?n=V:n===Z||n===M?n=C:(n=V,o=void 0);console.assert(-1===c||n===V||n===k||n===H,"unexpected parse state B");const h=n===V&&e[t+1].startsWith("/>")?" ":"";r+=n===C?i+m:c>=0?(l.push(a),i.slice(0,c)+v+i.slice(c)+p+h):i+p+(-2===c?t:h)}return[j(e,r+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),l]};class I{constructor({strings:e,_$litType$:t},o){let r;this.parts=[];let a=0,s=0;const c=e.length-1,d=this.parts,[h,u]=E(e,t);if(this.el=I.createElement(h,o),A.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(r=A.nextNode())&&d.length<c;){if(1===r.nodeType){{const e=r.localName;if(/^(?:textarea|template)$/i.test(e)&&r.innerHTML.includes(p)){const t=`Expressions are not supported inside \`${e}\` elements. See https://lit.dev/msg/expression-in-${e} for more information.`;if("template"===e)throw new Error(t);l("",t)}}if(r.hasAttributes())for(const e of r.getAttributeNames())if(e.endsWith(v)){const t=u[s++],i=r.getAttribute(e).split(p),l=/([.?@])?(.*)/.exec(t);d.push({type:1,index:a,name:l[2],strings:i,ctor:"."===l[1]?F:"?"===l[1]?N:"@"===l[1]?W:U}),r.removeAttribute(e)}else e.startsWith(p)&&(d.push({type:6,index:a}),r.removeAttribute(e));if(P.test(r.tagName)){const e=r.textContent.split(p),t=e.length-1;if(t>0){r.textContent=n?n.emptyScript:"";for(let i=0;i<t;i++)r.append(e[i],w()),A.nextNode(),d.push({type:2,index:++a});r.append(e[t],w())}}}else if(8===r.nodeType){if(r.data===f)d.push({type:2,index:a});else{let e=-1;for(;-1!==(e=r.data.indexOf(p,e+1));)d.push({type:7,index:a}),e+=p.length-1}}a++}if(u.length!==s)throw new Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+e.join("${...}")+"`");i&&i({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const i=g.createElement("template");return i.innerHTML=e,i}}function T(e,t,i=e,l){if(t===z)return t;let o=void 0!==l?i.__directives?.[l]:i.__directive;const r=_(t)?void 0:t._$litDirective$;return o?.constructor!==r&&(o?._$notifyDirectiveConnectionChanged?.(!1),void 0===r?o=void 0:(o=new r(e),o._$initialize(e,i,l)),void 0!==l?(i.__directives??=[])[l]=o:i.__directive=o),void 0!==o&&(t=T(e,o._$resolve(e,t.values),o,l)),t}class R{constructor(e,t){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){const{el:{content:t},parts:i}=this._$template,l=(e?.creationScope??g).importNode(t,!0);A.currentNode=l;let o=A.nextNode(),r=0,n=0,a=i[0];for(;void 0!==a;){if(r===a.index){let t;2===a.type?t=new D(o,o.nextSibling,this,e):1===a.type?t=new a.ctor(o,a.name,a.strings,this,e):6===a.type&&(t=new q(o,this,e)),this._$parts.push(t),a=i[++n]}r!==a?.index&&(o=A.nextNode(),r++)}return A.currentNode=g,l}_update(e){let t=0;for(const l of this._$parts)void 0!==l&&(i&&i({kind:"set part",part:l,value:e[t],valueIndex:t,values:e,templateInstance:this}),void 0!==l.strings?(l._$setValue(e,l,t),t+=l.strings.length-2):l._$setValue(e[t])),t++}}class D{get _$isConnected(){return this._$parent?._$isConnected??this.__isConnected}constructor(e,t,i,l){this.type=2,this._$committedValue=S,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=i,this.options=l,this.__isConnected=l?.isConnected??!0,this._textSanitizer=void 0}get parentNode(){let e=r(this._$startNode).parentNode;const t=this._$parent;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){if(null===this.parentNode)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=T(this,e,t),_(e))e===S||null==e||""===e?(this._$committedValue!==S&&(i&&i({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=S):e!==this._$committedValue&&e!==z&&this._commitText(e);else if(void 0!==e._$litType$)this._commitTemplateResult(e);else if(void 0!==e.nodeType){if(this.options?.host===e)return this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),void console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");this._commitNode(e)}else x(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return r(r(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){if(this._$committedValue!==e){if(this._$clear(),L!==c){const e=this._$startNode.parentNode?.nodeName;if("STYLE"===e||"SCRIPT"===e){let t="Forbidden";throw t="STYLE"===e?"Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":"Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(t)}}i&&i({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==S&&_(this._$committedValue)){const t=r(this._$startNode).nextSibling;void 0===this._textSanitizer&&(this._textSanitizer=u(t,"data","property")),e=this._textSanitizer(e),i&&i({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=g.createTextNode("");this._commitNode(t),void 0===this._textSanitizer&&(this._textSanitizer=u(t,"data","property")),e=this._textSanitizer(e),i&&i({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){const{values:t,_$litType$:l}=e,o="number"==typeof l?this._$getTemplate(e):(void 0===l.el&&(l.el=I.createElement(j(l.h,l.h[0]),this.options)),l);if(this._$committedValue?._$template===o)i&&i({kind:"template updating",template:o,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:t}),this._$committedValue._update(t);else{const e=new R(o,this),l=e._clone(this.options);i&&i({kind:"template instantiated",template:o,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),e._update(t),i&&i({kind:"template instantiated and updated",template:o,instance:e,parts:e._$parts,options:this.options,fragment:l,values:t}),this._commitNode(l),this._$committedValue=e}}_$getTemplate(e){let t=B.get(e.strings);return void 0===t&&B.set(e.strings,t=new I(e)),t}_commitIterable(e){b(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let i,l=0;for(const o of e)l===t.length?t.push(i=new D(this._insert(w()),this._insert(w()),this,this.options)):i=t[l],i._$setValue(o),l++;l<t.length&&(this._$clear(i&&r(i._$endNode).nextSibling,l),t.length=l)}_$clear(e=r(this._$startNode).nextSibling,t){for(this._$notifyConnectionChanged?.(!1,!0,t);e!==this._$endNode;){const t=r(e).nextSibling;r(e).remove(),e=t}}setConnected(e){if(void 0!==this._$parent)throw new Error("part.setConnected() may only be called on a RootPart returned from render().");this.__isConnected=e,this._$notifyConnectionChanged?.(e)}}class U{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(e,t,i,l,o){this.type=1,this._$committedValue=S,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=l,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=S,this._sanitizer=void 0}_$setValue(e,t=this,i,l){const o=this.strings;let r=!1;if(void 0===o)e=T(this,e,t,0),r=!_(e)||e!==this._$committedValue&&e!==z,r&&(this._$committedValue=e);else{const l=e;let n,a;for(e=o[0],n=0;n<o.length-1;n++)a=T(this,l[i+n],t,n),a===z&&(a=this._$committedValue[n]),r||=!_(a)||a!==this._$committedValue[n],a===S?e=S:e!==S&&(e+=(a??"")+o[n+1]),this._$committedValue[n]=a}r&&!l&&this._commitValue(e)}_commitValue(e){e===S?r(this.element).removeAttribute(this.name):(void 0===this._sanitizer&&(this._sanitizer=L(this.element,this.name,"attribute")),e=this._sanitizer(e??""),i&&i({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),r(this.element).setAttribute(this.name,e??""))}}class F extends U{constructor(){super(...arguments),this.type=3}_commitValue(e){void 0===this._sanitizer&&(this._sanitizer=L(this.element,this.name,"property")),e=this._sanitizer(e),i&&i({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===S?void 0:e}}class N extends U{constructor(){super(...arguments),this.type=4}_commitValue(e){i&&i({kind:"commit boolean attribute",element:this.element,name:this.name,value:!(!e||e===S),options:this.options}),r(this.element).toggleAttribute(this.name,!!e&&e!==S)}}class W extends U{constructor(e,t,i,l,o){if(super(e,t,i,l,o),this.type=5,void 0!==this.strings)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){if((e=T(this,e,t,0)??S)===z)return;const l=this._$committedValue,o=e===S&&l!==S||e.capture!==l.capture||e.once!==l.once||e.passive!==l.passive,r=e!==S&&(l===S||o);i&&i({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:o,addListener:r,oldListener:l}),o&&this.element.removeEventListener(this.name,this,l),r&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){"function"==typeof this._$committedValue?this._$committedValue.call(this.options?.host??this.element,e):this._$committedValue.handleEvent(e)}}class q{constructor(e,t,i){this.element=e,this.type=6,this._$disconnectableChildren=void 0,this._$parent=t,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){i&&i({kind:"commit to element binding",element:this.element,value:e,options:this.options}),T(this,e)}}const K={_boundAttributeSuffix:v,_marker:p,_markerMatch:f,_HTML_RESULT:1,_getTemplateHtml:E,_TemplateInstance:R,_isIterable:x,_resolveDirective:T,_ChildPart:D,_AttributePart:U,_BooleanAttributePart:N,_EventPart:W,_PropertyPart:F,_ElementPart:q},G=t.litHtmlPolyfillSupportDevMode;G?.(I,D),(t.litHtmlVersions??=[]).push("3.3.2"),t.litHtmlVersions.length>1&&queueMicrotask(()=>{l("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});const J=(e,t,l)=>{if(null==t)throw new TypeError(`The container to render into may not be ${t}`);const r=o++,n=l?.renderBefore??t;let a=n._$litPart$;if(i&&i({kind:"begin render",id:r,value:e,container:t,options:l,part:a}),void 0===a){const e=l?.renderBefore??null;n._$litPart$=a=new D(t.insertBefore(w(),e),e,void 0,l??{})}return a._$setValue(e),i&&i({kind:"end render",id:r,value:e,container:t,options:l,part:a}),a};J.setSanitizer=d,J.createSanitizer=u,J._testOnlyClearSanitizerFactoryDoNotCallOrElse=h;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */const{_ChildPart:le}=K,oe=window.ShadyDOM?.inUse&&!0===window.ShadyDOM?.noPatch?window.ShadyDOM.wrap:e=>e,re=e=>void 0===e.strings,ne=()=>document.createComment(""),ae=(e,t,i)=>{const l=oe(e._$startNode).parentNode,o=void 0===t?e._$endNode:t._$startNode;if(void 0===i){const t=oe(l).insertBefore(ne(),o),r=oe(l).insertBefore(ne(),o);i=new le(t,r,e,e.options)}else{const t=oe(i._$endNode).nextSibling,r=i._$parent,n=r!==e;if(n){let t;i._$reparentDisconnectables?.(e),i._$parent=e,void 0!==i._$notifyConnectionChanged&&(t=e._$isConnected)!==r._$isConnected&&i._$notifyConnectionChanged(t)}if(t!==o||n){let e=i._$startNode;for(;e!==t;){const t=oe(e).nextSibling;oe(l).insertBefore(e,o),e=t}}}return i},se=(e,t,i=e)=>(e._$setValue(t,i),e),ce={},de=(e,t=ce)=>e._$committedValue=t,he=e=>{e._$clear(),e._$startNode.remove()};const ue=te(
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
class extends ie{constructor(e){if(super(e),e.type!==Q&&e.type!==X&&e.type!==ee)throw new Error("The `live` directive is not allowed on child or event bindings");if(!re(e))throw new Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===z||t===S)return t;const i=e.element,l=e.name;if(e.type===Q){if(t===i[l])return z}else if(e.type===ee){if(!!t===i.hasAttribute(l))return z}else if(e.type===X&&i.getAttribute(l)===String(t))return z;return de(e),t}}),ve=globalThis,pe=ve.ShadowRoot&&(void 0===ve.ShadyCSS||ve.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,fe=Symbol(),me=new WeakMap;
/**
   * @license
   * Copyright 2019 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class ge{constructor(e,t,i){if(this._$cssResult$=!0,i!==fe)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this._strings=t}get styleSheet(){let e=this._styleSheet;const t=this._strings;if(pe&&void 0===e){const i=void 0!==t&&1===t.length;i&&(e=me.get(t)),void 0===e&&((this._styleSheet=e=new CSSStyleSheet).replaceSync(this.cssText),i&&me.set(t,e))}return e}toString(){return this.cssText}}const we=(e,...t)=>{const i=1===e.length?e[0]:t.reduce((t,i,l)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${e}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)})(i)+e[l+1],e[0]);return new ge(i,e,fe)},_e=e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return new ge("string"==typeof(i=t)?i:String(i),void 0,fe);var i},be=pe?e=>e:e=>e instanceof CSSStyleSheet?_e(e):e,{is:xe,defineProperty:ye,getOwnPropertyDescriptor:Ce,getOwnPropertyNames:Ze,getOwnPropertySymbols:Me,getPrototypeOf:Ve}=Object,ke=globalThis;let He;const Pe=ke.trustedTypes,$e=Pe?Pe.emptyScript:"",Oe=ke.reactiveElementPolyfillSupportDevMode;ke.litIssuedWarnings??=new Set,He=(e,t)=>{t+=` See https://lit.dev/msg/${e} for more information.`,ke.litIssuedWarnings.has(t)||ke.litIssuedWarnings.has(e)||(console.warn(t),ke.litIssuedWarnings.add(t))},queueMicrotask(()=>{He("dev-mode","Lit is in dev mode. Not recommended for production!"),ke.ShadyDOM?.inUse&&void 0===Oe&&He("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});const ze=(e,t)=>e,Se={toAttribute(e,t){switch(t){case Boolean:e=e?$e:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=null!==e;break;case Number:i=null===e?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch(e){i=null}}return i}},Be=(e,t)=>!xe(e,t),Ae={attribute:!0,type:String,converter:Se,reflect:!1,useDefault:!1,hasChanged:Be};Symbol.metadata??=Symbol("metadata"),ke.litPropertyMetadata??=new WeakMap;class Le extends HTMLElement{static addInitializer(e){this.__prepare(),(this._initializers??=[]).push(e)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(e,t=Ae){if(t.state&&(t.attribute=!1),this.__prepare(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol.for(`${String(e)} (@property() cache)`),l=this.getPropertyDescriptor(e,i,t);void 0!==l&&ye(this.prototype,e,l)}}static getPropertyDescriptor(e,t,i){const{get:l,set:o}=Ce(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};if(null==l){if("value"in(Ce(this.prototype,e)??{}))throw new Error(`Field ${JSON.stringify(String(e))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);He("reactive-property-without-getter",`Field ${JSON.stringify(String(e))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:l,set(t){const r=l?.call(this);o?.call(this,t),this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ae}static __prepare(){if(this.hasOwnProperty(ze("elementProperties")))return;const e=Ve(this);e.finalize(),void 0!==e._initializers&&(this._initializers=[...e._initializers]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(ze("finalized")))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(ze("properties"))){const e=this.properties,t=[...Ze(e),...Me(e)];for(const i of t)this.createProperty(i,e[i])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,i]of t)this.elementProperties.set(e,i)}this.__attributeToPropertyMap=new Map;for(const[e,t]of this.elementProperties){const i=this.__attributeNameForProperty(e,t);void 0!==i&&this.__attributeToPropertyMap.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles),this.hasOwnProperty("createProperty")&&He("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators"),this.hasOwnProperty("getPropertyDescriptor")&&He("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const e of i)t.unshift(be(e))}else void 0!==e&&t.push(be(e));return t}static __attributeNameForProperty(e,t){const i=t.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise(e=>this.enableUpdating=e),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach(e=>e(this))}addController(e){(this.__controllers??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this.__controllers?.delete(e)}__saveInstanceProperties(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this.__instanceProperties=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((e,t)=>{if(pe)e.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const i of t){const t=document.createElement("style"),l=ve.litNonce;void 0!==l&&t.setAttribute("nonce",l),t.textContent=i.cssText,e.appendChild(t)}})(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this.__controllers?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$attributeToProperty(e,i)}__propertyToAttribute(e,t){const i=this.constructor.elementProperties.get(e),l=this.constructor.__attributeNameForProperty(e,i);if(void 0!==l&&!0===i.reflect){const o=(void 0!==i.converter?.toAttribute?i.converter:Se).toAttribute(t,i.type);this.constructor.enabledWarnings.includes("migration")&&void 0===o&&He("undefined-attribute-value",`The attribute value for the ${e} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`),this.__reflectingProperty=e,null==o?this.removeAttribute(l):this.setAttribute(l,o),this.__reflectingProperty=null}}_$attributeToProperty(e,t){const i=this.constructor,l=i.__attributeToPropertyMap.get(e);if(void 0!==l&&this.__reflectingProperty!==l){const e=i.getPropertyOptions(l),o="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:Se;this.__reflectingProperty=l;const r=o.fromAttribute(t,e.type);this[l]=r??this.__defaultValues?.get(l)??r,this.__reflectingProperty=null}}requestUpdate(e,t,i,l=!1,o){if(void 0!==e){e instanceof Event&&He("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");const r=this.constructor;!1===l&&(o=this[e]),i??=r.getPropertyOptions(e);if(!((i.hasChanged??Be)(o,t)||i.useDefault&&i.reflect&&o===this.__defaultValues?.get(e)&&!this.hasAttribute(r.__attributeNameForProperty(e,i))))return;this._$changeProperty(e,t,i)}!1===this.isUpdatePending&&(this.__updatePromise=this.__enqueueUpdate())}_$changeProperty(e,t,{useDefault:i,reflect:l,wrapped:o},r){i&&!(this.__defaultValues??=new Map).has(e)&&(this.__defaultValues.set(e,r??t??this[e]),!0!==o||void 0!==r)||(this._$changedProperties.has(e)||(this.hasUpdated||i||(t=void 0),this._$changedProperties.set(e,t)),!0===l&&this.__reflectingProperty!==e&&(this.__reflectingProperties??=new Set).add(e))}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){const e=this.performUpdate();return this.constructor.enabledWarnings.includes("async-perform-update")&&"function"==typeof e?.then&&He("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`),e}performUpdate(){if(!this.isUpdatePending)return;var e;if(e={kind:"update"},ke.emitLitDebugLogEvents&&ke.dispatchEvent(new CustomEvent("lit-debug",{detail:e})),!this.hasUpdated){this.renderRoot??=this.createRenderRoot();{const e=[...this.constructor.elementProperties.keys()].filter(e=>this.hasOwnProperty(e)&&e in Ve(this));if(e.length)throw new Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${e.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(const[e,t]of this.__instanceProperties)this[e]=t;this.__instanceProperties=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,i]of e){const{wrapped:e}=i,l=this[t];!0!==e||this._$changedProperties.has(t)||void 0===l||this._$changeProperty(t,void 0,i,l)}}let t=!1;const i=this._$changedProperties;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),this.__controllers?.forEach(e=>e.hostUpdate?.()),this.update(i)):this.__markUpdated()}catch(e){throw t=!1,this.__markUpdated(),e}t&&this._$didUpdate(i)}willUpdate(e){}_$didUpdate(e){this.__controllers?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e),this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update")&&He("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(e){return!0}update(e){this.__reflectingProperties&&=this.__reflectingProperties.forEach(e=>this.__propertyToAttribute(e,this[e])),this.__markUpdated()}updated(e){}firstUpdated(e){}}Le.elementStyles=[],Le.shadowRootOptions={mode:"open"},Le[ze("elementProperties")]=new Map,Le[ze("finalized")]=new Map,Oe?.({ReactiveElement:Le});{Le.enabledWarnings=["change-in-update","async-perform-update"];const e=function(e){e.hasOwnProperty(ze("enabledWarnings"))||(e.enabledWarnings=e.enabledWarnings.slice())};Le.enableWarning=function(t){e(this),this.enabledWarnings.includes(t)||this.enabledWarnings.push(t)},Le.disableWarning=function(t){e(this);const i=this.enabledWarnings.indexOf(t);i>=0&&this.enabledWarnings.splice(i,1)}}(ke.reactiveElementVersions??=[]).push("2.1.2"),ke.reactiveElementVersions.length>1&&queueMicrotask(()=>{He("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")})
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */;const je=globalThis;let Ee;je.litIssuedWarnings??=new Set,Ee=(e,t)=>{t+=` See https://lit.dev/msg/${e} for more information.`,je.litIssuedWarnings.has(t)||je.litIssuedWarnings.has(e)||(console.warn(t),je.litIssuedWarnings.add(t))};class Ie extends Le{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=J(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.__childPart?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.__childPart?.setConnected(!1)}render(){return z}}var Te;Ie._$litElement$=!0,Ie[(Te="finalized",Te)]=!0,je.litElementHydrateSupport?.({LitElement:Ie});const Re=je.litElementPolyfillSupportDevMode;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
let De;Re?.({LitElement:Ie}),(je.litElementVersions??=[]).push("4.2.2"),je.litElementVersions.length>1&&queueMicrotask(()=>{Ee("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")}),globalThis.litIssuedWarnings??=new Set,De=(e,t)=>{t+=` See https://lit.dev/msg/${e} for more information.`,globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))};const Ue={attribute:!0,type:String,converter:Se,reflect:!1,hasChanged:Be},Fe=(e=Ue,t,i)=>{const{kind:l,metadata:o}=i;null==o&&De("missing-class-metadata",`The class ${t} is missing decorator metadata. This could mean that you're using a compiler that supports decorators but doesn't support decorator metadata, such as TypeScript 5.1. Please update your compiler.`);let r=globalThis.litPropertyMetadata.get(o);if(void 0===r&&globalThis.litPropertyMetadata.set(o,r=new Map),"setter"===l&&((e=Object.create(e)).wrapped=!0),r.set(i.name,e),"accessor"===l){const{name:l}=i;return{set(i){const o=t.get.call(this);t.set.call(this,i),this.requestUpdate(l,o,e,!0,i)},init(t){return void 0!==t&&this._$changeProperty(l,void 0,e,t),t}}}if("setter"===l){const{name:l}=i;return function(i){const o=this[l];t.call(this,i),this.requestUpdate(l,o,e,!0,i)}}throw new Error(`Unsupported decorator location: ${l}`)};function Ne(e){return(t,i)=>"object"==typeof i?Fe(e,t,i):((e,t,i)=>{const l=t.hasOwnProperty(i);return t.constructor.createProperty(i,e),l?Object.getOwnPropertyDescriptor(t,i):void 0})(e,t,i)}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const qe=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,i),i);
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
function Ge(e){return(t,i)=>qe(t,i,{async get(){return await this.updateComplete,this.renderRoot?.querySelector(e)??null}})}
/**
   * @license
   * Copyright 2021 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function Je(e){return(t,i)=>{const{slot:l,selector:o}=e??{},r="slot"+(l?`[name=${l}]`:":not([name])");return qe(t,i,{get(){const t=this.renderRoot?.querySelector(r),i=t?.assignedElements(e)??[];return void 0===o?i:i.filter(e=>e.matches(o))}})}}
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */globalThis.litIssuedWarnings??=new Set,Ke=(e,t)=>{t+=e?` See https://lit.dev/msg/${e} for more information.`:"",globalThis.litIssuedWarnings.has(t)||globalThis.litIssuedWarnings.has(e)||(console.warn(t),globalThis.litIssuedWarnings.add(t))};const Xe=te(class extends ie{constructor(e){if(super(e),e.type!==X||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const i=e.element.classList;for(const e of this._previousClasses)e in t||(i.remove(e),this._previousClasses.delete(e));for(const e in t){const l=!!t[e];l===this._previousClasses.has(e)||this._staticClasses?.has(e)||(l?(i.add(e),this._previousClasses.add(e)):(i.remove(e),this._previousClasses.delete(e)))}return z}}),Ye=e=>e??S,Qe=(e,t)=>{const i=e._$disconnectableChildren;if(void 0===i)return!1;for(const e of i)e._$notifyDirectiveConnectionChanged?.(t,!1),Qe(e,t);return!0},et=e=>{let t,i;do{if(void 0===(t=e._$parent))break;i=t._$disconnectableChildren,i.delete(e),e=t}while(0===i?.size)},tt=e=>{for(let t;t=e._$parent;e=t){let i=t._$disconnectableChildren;if(void 0===i)t._$disconnectableChildren=i=new Set;else if(i.has(e))break;i.add(e),ot(t)}};
/**
   * @license
   * Copyright 2018 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function it(e){void 0!==this._$disconnectableChildren?(et(this),this._$parent=e,tt(this)):this._$parent=e}function lt(e,t=!1,i=0){const l=this._$committedValue,o=this._$disconnectableChildren;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(l))for(let e=i;e<l.length;e++)Qe(l[e],!1),et(l[e]);else null!=l&&(Qe(l,!1),et(l));else Qe(this,e)}const ot=e=>{e.type==Y&&(e._$notifyConnectionChanged??=lt,e._$reparentDisconnectables??=it)};class rt extends ie{constructor(){super(...arguments),this._$disconnectableChildren=void 0}_$initialize(e,t,i){super._$initialize(e,t,i),tt(this),this.isConnected=e._$isConnected}_$notifyDirectiveConnectionChanged(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Qe(this,e),et(this))}setValue(e){if(re(this.__part))this.__part._$setValue(e,this);else{if(void 0===this.__attributeIndex)throw new Error("Expected this.__attributeIndex to be a number");const t=[...this.__part._$committedValue];t[this.__attributeIndex]=e,this.__part._$setValue(t,this,0)}}disconnected(){}reconnected(){}}
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const nt=()=>new at;class at{}const st=new WeakMap;const ct=te(class extends rt{render(e){return S}update(e,[t]){const i=t!==this._ref;return i&&void 0!==this._ref&&this._updateRefValue(void 0),(i||this._lastElementForRef!==this._element)&&(this._ref=t,this._context=e.options?.host,this._updateRefValue(this._element=e.element)),S}_updateRefValue(e){if(this.isConnected||(e=void 0),"function"==typeof this._ref){const t=this._context??globalThis;let i=st.get(t);void 0===i&&(i=new WeakMap,st.set(t,i)),void 0!==i.get(this._ref)&&this._ref.call(this._context,void 0),i.set(this._ref,e),void 0!==e&&this._ref.call(this._context,e)}else this._ref.value=e}get _lastElementForRef(){return"function"==typeof this._ref?st.get(this._context??globalThis)?.get(this._ref):this._ref?.value}disconnected(){this._lastElementForRef===this._element&&this._updateRefValue(void 0)}reconnected(){this._updateRefValue(this._element)}}),dt=["top","right","bottom","left"],ht=Math.min,ut=Math.max,vt=Math.round,pt=Math.floor,ft=e=>({x:e,y:e}),mt={left:"right",right:"left",bottom:"top",top:"bottom"},gt={start:"end",end:"start"};function wt(e,t,i){return ut(e,ht(t,i))}function _t(e,t){return"function"==typeof e?e(t):e}function bt(e){return e.split("-")[0]}function xt(e){return e.split("-")[1]}function yt(e){return"x"===e?"y":"x"}function Ct(e){return"y"===e?"height":"width"}const Zt=new Set(["top","bottom"]);function Mt(e){return Zt.has(bt(e))?"y":"x"}function Vt(e){return yt(Mt(e))}function kt(e,t,i){void 0===i&&(i=!1);const l=xt(e),o=Vt(e),r=Ct(o);let n="x"===o?l===(i?"end":"start")?"right":"left":"start"===l?"bottom":"top";return t.reference[r]>t.floating[r]&&(n=Bt(n)),[n,Bt(n)]}function Ht(e){return e.replace(/start|end/g,e=>gt[e])}const Pt=["left","right"],$t=["right","left"],Ot=["top","bottom"],zt=["bottom","top"];function St(e,t,i,l){const o=xt(e);let r=function(e,t,i){switch(e){case"top":case"bottom":return i?t?$t:Pt:t?Pt:$t;case"left":case"right":return t?Ot:zt;default:return[]}}(bt(e),"start"===i,l);return o&&(r=r.map(e=>e+"-"+o),t&&(r=r.concat(r.map(Ht)))),r}function Bt(e){return e.replace(/left|right|bottom|top/g,e=>mt[e])}function At(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function Lt(e){const{x:t,y:i,width:l,height:o}=e;return{width:l,height:o,top:i,left:t,right:t+l,bottom:i+o,x:t,y:i}}function jt(e,t,i){let{reference:l,floating:o}=e;const r=Mt(t),n=Vt(t),a=Ct(n),s=bt(t),c="y"===r,d=l.x+l.width/2-o.width/2,h=l.y+l.height/2-o.height/2,u=l[a]/2-o[a]/2;let v;switch(s){case"top":v={x:d,y:l.y-o.height};break;case"bottom":v={x:d,y:l.y+l.height};break;case"right":v={x:l.x+l.width,y:h};break;case"left":v={x:l.x-o.width,y:h};break;default:v={x:l.x,y:l.y}}switch(xt(t)){case"start":v[n]-=u*(i&&c?-1:1);break;case"end":v[n]+=u*(i&&c?-1:1)}return v}async function Et(e,t){var i;void 0===t&&(t={});const{x:l,y:o,platform:r,rects:n,elements:a,strategy:s}=e,{boundary:c="clippingAncestors",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:u=!1,padding:v=0}=_t(t,e),p=At(v),f=a[u?"floating"===h?"reference":"floating":h],m=Lt(await r.getClippingRect({element:null==(i=await(null==r.isElement?void 0:r.isElement(f)))||i?f:f.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:d,strategy:s})),g="floating"===h?{x:l,y:o,width:n.floating.width,height:n.floating.height}:n.reference,w=await(null==r.getOffsetParent?void 0:r.getOffsetParent(a.floating)),_=await(null==r.isElement?void 0:r.isElement(w))&&await(null==r.getScale?void 0:r.getScale(w))||{x:1,y:1},b=Lt(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:g,offsetParent:w,strategy:s}):g);return{top:(m.top-b.top+p.top)/_.y,bottom:(b.bottom-m.bottom+p.bottom)/_.y,left:(m.left-b.left+p.left)/_.x,right:(b.right-m.right+p.right)/_.x}}function It(e,t){return{top:e.top-t.height,right:e.right-t.width,bottom:e.bottom-t.height,left:e.left-t.width}}function Tt(e){return dt.some(t=>e[t]>=0)}const Rt=new Set(["left","top"]);function Dt(){return"undefined"!=typeof window}function Ut(e){return Wt(e)?(e.nodeName||"").toLowerCase():"#document"}function Ft(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function Nt(e){var t;return null==(t=(Wt(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Wt(e){return!!Dt()&&(e instanceof Node||e instanceof Ft(e).Node)}function qt(e){return!!Dt()&&(e instanceof Element||e instanceof Ft(e).Element)}function Kt(e){return!!Dt()&&(e instanceof HTMLElement||e instanceof Ft(e).HTMLElement)}function Gt(e){return!(!Dt()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof Ft(e).ShadowRoot)}const Jt=new Set(["inline","contents"]);function Xt(e){const{overflow:t,overflowX:i,overflowY:l,display:o}=ci(e);return/auto|scroll|overlay|hidden|clip/.test(t+l+i)&&!Jt.has(o)}const Yt=new Set(["table","td","th"]);function Qt(e){return Yt.has(Ut(e))}const ei=[":popover-open",":modal"];function ti(e){return ei.some(t=>{try{return e.matches(t)}catch(e){return!1}})}const ii=["transform","translate","scale","rotate","perspective"],li=["transform","translate","scale","rotate","perspective","filter"],oi=["paint","layout","strict","content"];function ri(e){const t=ni(),i=qt(e)?ci(e):e;return ii.some(e=>!!i[e]&&"none"!==i[e])||!!i.containerType&&"normal"!==i.containerType||!t&&!!i.backdropFilter&&"none"!==i.backdropFilter||!t&&!!i.filter&&"none"!==i.filter||li.some(e=>(i.willChange||"").includes(e))||oi.some(e=>(i.contain||"").includes(e))}function ni(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}const ai=new Set(["html","body","#document"]);function si(e){return ai.has(Ut(e))}function ci(e){return Ft(e).getComputedStyle(e)}function di(e){return qt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function hi(e){if("html"===Ut(e))return e;const t=e.assignedSlot||e.parentNode||Gt(e)&&e.host||Nt(e);return Gt(t)?t.host:t}function ui(e){const t=hi(e);return si(t)?e.ownerDocument?e.ownerDocument.body:e.body:Kt(t)&&Xt(t)?t:ui(t)}function vi(e,t,i){var l;void 0===t&&(t=[]),void 0===i&&(i=!0);const o=ui(e),r=o===(null==(l=e.ownerDocument)?void 0:l.body),n=Ft(o);if(r){const e=pi(n);return t.concat(n,n.visualViewport||[],Xt(o)?o:[],e&&i?vi(e):[])}return t.concat(o,vi(o,[],i))}function pi(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function fi(e){const t=ci(e);let i=parseFloat(t.width)||0,l=parseFloat(t.height)||0;const o=Kt(e),r=o?e.offsetWidth:i,n=o?e.offsetHeight:l,a=vt(i)!==r||vt(l)!==n;return a&&(i=r,l=n),{width:i,height:l,$:a}}function mi(e){return qt(e)?e:e.contextElement}function gi(e){const t=mi(e);if(!Kt(t))return ft(1);const i=t.getBoundingClientRect(),{width:l,height:o,$:r}=fi(t);let n=(r?vt(i.width):i.width)/l,a=(r?vt(i.height):i.height)/o;return n&&Number.isFinite(n)||(n=1),a&&Number.isFinite(a)||(a=1),{x:n,y:a}}const wi=ft(0);function _i(e){const t=Ft(e);return ni()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:wi}function bi(e,t,i,l){void 0===t&&(t=!1),void 0===i&&(i=!1);const o=e.getBoundingClientRect(),r=mi(e);let n=ft(1);t&&(l?qt(l)&&(n=gi(l)):n=gi(e));const a=function(e,t,i){return void 0===t&&(t=!1),!(!i||t&&i!==Ft(e))&&t}(r,i,l)?_i(r):ft(0);let s=(o.left+a.x)/n.x,c=(o.top+a.y)/n.y,d=o.width/n.x,h=o.height/n.y;if(r){const e=Ft(r),t=l&&qt(l)?Ft(l):l;let i=e,o=pi(i);for(;o&&l&&t!==i;){const e=gi(o),t=o.getBoundingClientRect(),l=ci(o),r=t.left+(o.clientLeft+parseFloat(l.paddingLeft))*e.x,n=t.top+(o.clientTop+parseFloat(l.paddingTop))*e.y;s*=e.x,c*=e.y,d*=e.x,h*=e.y,s+=r,c+=n,i=Ft(o),o=pi(i)}}return Lt({width:d,height:h,x:s,y:c})}function xi(e,t){const i=di(e).scrollLeft;return t?t.left+i:bi(Nt(e)).left+i}function yi(e,t){const i=e.getBoundingClientRect();return{x:i.left+t.scrollLeft-xi(e,i),y:i.top+t.scrollTop}}const Ci=new Set(["absolute","fixed"]);function Zi(e,t,i){let l;if("viewport"===t)l=function(e,t){const i=Ft(e),l=Nt(e),o=i.visualViewport;let r=l.clientWidth,n=l.clientHeight,a=0,s=0;if(o){r=o.width,n=o.height;const e=ni();(!e||e&&"fixed"===t)&&(a=o.offsetLeft,s=o.offsetTop)}const c=xi(l);if(c<=0){const e=l.ownerDocument,t=e.body,i=getComputedStyle(t),o="CSS1Compat"===e.compatMode&&parseFloat(i.marginLeft)+parseFloat(i.marginRight)||0,n=Math.abs(l.clientWidth-t.clientWidth-o);n<=25&&(r-=n)}else c<=25&&(r+=c);return{width:r,height:n,x:a,y:s}}(e,i);else if("document"===t)l=function(e){const t=Nt(e),i=di(e),l=e.ownerDocument.body,o=ut(t.scrollWidth,t.clientWidth,l.scrollWidth,l.clientWidth),r=ut(t.scrollHeight,t.clientHeight,l.scrollHeight,l.clientHeight);let n=-i.scrollLeft+xi(e);const a=-i.scrollTop;return"rtl"===ci(l).direction&&(n+=ut(t.clientWidth,l.clientWidth)-o),{width:o,height:r,x:n,y:a}}(Nt(e));else if(qt(t))l=function(e,t){const i=bi(e,!0,"fixed"===t),l=i.top+e.clientTop,o=i.left+e.clientLeft,r=Kt(e)?gi(e):ft(1);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:o*r.x,y:l*r.y}}(t,i);else{const i=_i(e);l={x:t.x-i.x,y:t.y-i.y,width:t.width,height:t.height}}return Lt(l)}function Mi(e,t){const i=hi(e);return!(i===t||!qt(i)||si(i))&&("fixed"===ci(i).position||Mi(i,t))}function Vi(e,t,i){const l=Kt(t),o=Nt(t),r="fixed"===i,n=bi(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const s=ft(0);function c(){s.x=xi(o)}if(l||!l&&!r)if(("body"!==Ut(t)||Xt(o))&&(a=di(t)),l){const e=bi(t,!0,r,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&c();r&&!l&&o&&c();const d=!o||l||r?ft(0):yi(o,a);return{x:n.left+a.scrollLeft-s.x-d.x,y:n.top+a.scrollTop-s.y-d.y,width:n.width,height:n.height}}function ki(e){return"static"===ci(e).position}function Hi(e,t){if(!Kt(e)||"fixed"===ci(e).position)return null;if(t)return t(e);let i=e.offsetParent;return Nt(e)===i&&(i=i.ownerDocument.body),i}function Pi(e,t){const i=Ft(e);if(ti(e))return i;if(!Kt(e)){let t=hi(e);for(;t&&!si(t);){if(qt(t)&&!ki(t))return t;t=hi(t)}return i}let l=Hi(e,t);for(;l&&Qt(l)&&ki(l);)l=Hi(l,t);return l&&si(l)&&ki(l)&&!ri(l)?i:l||function(e){let t=hi(e);for(;Kt(t)&&!si(t);){if(ri(t))return t;if(ti(t))return null;t=hi(t)}return null}(e)||i}const $i={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:i,offsetParent:l,strategy:o}=e;const r="fixed"===o,n=Nt(l),a=!!t&&ti(t.floating);if(l===n||a&&r)return i;let s={scrollLeft:0,scrollTop:0},c=ft(1);const d=ft(0),h=Kt(l);if((h||!h&&!r)&&(("body"!==Ut(l)||Xt(n))&&(s=di(l)),Kt(l))){const e=bi(l);c=gi(l),d.x=e.x+l.clientLeft,d.y=e.y+l.clientTop}const u=!n||h||r?ft(0):yi(n,s);return{width:i.width*c.x,height:i.height*c.y,x:i.x*c.x-s.scrollLeft*c.x+d.x+u.x,y:i.y*c.y-s.scrollTop*c.y+d.y+u.y}},getDocumentElement:Nt,getClippingRect:function(e){let{element:t,boundary:i,rootBoundary:l,strategy:o}=e;const r=[..."clippingAncestors"===i?ti(t)?[]:function(e,t){const i=t.get(e);if(i)return i;let l=vi(e,[],!1).filter(e=>qt(e)&&"body"!==Ut(e)),o=null;const r="fixed"===ci(e).position;let n=r?hi(e):e;for(;qt(n)&&!si(n);){const t=ci(n),i=ri(n);i||"fixed"!==t.position||(o=null),(r?!i&&!o:!i&&"static"===t.position&&o&&Ci.has(o.position)||Xt(n)&&!i&&Mi(e,n))?l=l.filter(e=>e!==n):o=t,n=hi(n)}return t.set(e,l),l}(t,this._c):[].concat(i),l],n=r[0],a=r.reduce((e,i)=>{const l=Zi(t,i,o);return e.top=ut(l.top,e.top),e.right=ht(l.right,e.right),e.bottom=ht(l.bottom,e.bottom),e.left=ut(l.left,e.left),e},Zi(t,n,o));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}},getOffsetParent:Pi,getElementRects:async function(e){const t=this.getOffsetParent||Pi,i=this.getDimensions,l=await i(e.floating);return{reference:Vi(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:l.width,height:l.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:i}=fi(e);return{width:t,height:i}},getScale:gi,isElement:qt,isRTL:function(e){return"rtl"===ci(e).direction}};function Oi(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function zi(e,t,i,l){void 0===l&&(l={});const{ancestorScroll:o=!0,ancestorResize:r=!0,elementResize:n="function"==typeof ResizeObserver,layoutShift:a="function"==typeof IntersectionObserver,animationFrame:s=!1}=l,c=mi(e),d=o||r?[...c?vi(c):[],...vi(t)]:[];d.forEach(e=>{o&&e.addEventListener("scroll",i,{passive:!0}),r&&e.addEventListener("resize",i)});const h=c&&a?function(e,t){let i,l=null;const o=Nt(e);function r(){var e;clearTimeout(i),null==(e=l)||e.disconnect(),l=null}return function n(a,s){void 0===a&&(a=!1),void 0===s&&(s=1),r();const c=e.getBoundingClientRect(),{left:d,top:h,width:u,height:v}=c;if(a||t(),!u||!v)return;const p={rootMargin:-pt(h)+"px "+-pt(o.clientWidth-(d+u))+"px "+-pt(o.clientHeight-(h+v))+"px "+-pt(d)+"px",threshold:ut(0,ht(1,s))||1};let f=!0;function m(t){const l=t[0].intersectionRatio;if(l!==s){if(!f)return n();l?n(!1,l):i=setTimeout(()=>{n(!1,1e-7)},1e3)}1!==l||Oi(c,e.getBoundingClientRect())||n(),f=!1}try{l=new IntersectionObserver(m,{...p,root:o.ownerDocument})}catch(e){l=new IntersectionObserver(m,p)}l.observe(e)}(!0),r}(c,i):null;let u,v=-1,p=null;n&&(p=new ResizeObserver(e=>{let[l]=e;l&&l.target===c&&p&&(p.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var e;null==(e=p)||e.observe(t)})),i()}),c&&!s&&p.observe(c),p.observe(t));let f=s?bi(e):null;return s&&function t(){const l=bi(e);f&&!Oi(f,l)&&i();f=l,u=requestAnimationFrame(t)}(),i(),()=>{var e;d.forEach(e=>{o&&e.removeEventListener("scroll",i),r&&e.removeEventListener("resize",i)}),null==h||h(),null==(e=p)||e.disconnect(),p=null,s&&cancelAnimationFrame(u)}}const Si=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var i,l;const{x:o,y:r,placement:n,middlewareData:a}=t,s=await async function(e,t){const{placement:i,platform:l,elements:o}=e,r=await(null==l.isRTL?void 0:l.isRTL(o.floating)),n=bt(i),a=xt(i),s="y"===Mt(i),c=Rt.has(n)?-1:1,d=r&&s?-1:1,h=_t(t,e);let{mainAxis:u,crossAxis:v,alignmentAxis:p}="number"==typeof h?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:h.mainAxis||0,crossAxis:h.crossAxis||0,alignmentAxis:h.alignmentAxis};return a&&"number"==typeof p&&(v="end"===a?-1*p:p),s?{x:v*d,y:u*c}:{x:u*c,y:v*d}}(t,e);return n===(null==(i=a.offset)?void 0:i.placement)&&null!=(l=a.arrow)&&l.alignmentOffset?{}:{x:o+s.x,y:r+s.y,data:{...s,placement:n}}}}},Bi=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:l,placement:o}=t,{mainAxis:r=!0,crossAxis:n=!1,limiter:a={fn:e=>{let{x:t,y:i}=e;return{x:t,y:i}}},...s}=_t(e,t),c={x:i,y:l},d=await Et(t,s),h=Mt(bt(o)),u=yt(h);let v=c[u],p=c[h];if(r){const e="y"===u?"bottom":"right";v=wt(v+d["y"===u?"top":"left"],v,v-d[e])}if(n){const e="y"===h?"bottom":"right";p=wt(p+d["y"===h?"top":"left"],p,p-d[e])}const f=a.fn({...t,[u]:v,[h]:p});return{...f,data:{x:f.x-i,y:f.y-l,enabled:{[u]:r,[h]:n}}}}}},Ai=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var i,l;const{placement:o,middlewareData:r,rects:n,initialPlacement:a,platform:s,elements:c}=t,{mainAxis:d=!0,crossAxis:h=!0,fallbackPlacements:u,fallbackStrategy:v="bestFit",fallbackAxisSideDirection:p="none",flipAlignment:f=!0,...m}=_t(e,t);if(null!=(i=r.arrow)&&i.alignmentOffset)return{};const g=bt(o),w=Mt(a),_=bt(a)===a,b=await(null==s.isRTL?void 0:s.isRTL(c.floating)),x=u||(_||!f?[Bt(a)]:function(e){const t=Bt(e);return[Ht(e),t,Ht(t)]}(a)),y="none"!==p;!u&&y&&x.push(...St(a,f,p,b));const C=[a,...x],Z=await Et(t,m),M=[];let V=(null==(l=r.flip)?void 0:l.overflows)||[];if(d&&M.push(Z[g]),h){const e=kt(o,n,b);M.push(Z[e[0]],Z[e[1]])}if(V=[...V,{placement:o,overflows:M}],!M.every(e=>e<=0)){var k,H;const e=((null==(k=r.flip)?void 0:k.index)||0)+1,t=C[e];if(t){if(!("alignment"===h&&w!==Mt(t))||V.every(e=>Mt(e.placement)!==w||e.overflows[0]>0))return{data:{index:e,overflows:V},reset:{placement:t}}}let i=null==(H=V.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:H.placement;if(!i)switch(v){case"bestFit":{var P;const e=null==(P=V.filter(e=>{if(y){const t=Mt(e.placement);return t===w||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:P[0];e&&(i=e);break}case"initialPlacement":i=a}if(o!==i)return{reset:{placement:i}}}return{}}}},Li=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var i,l;const{placement:o,rects:r,platform:n,elements:a}=t,{apply:s=()=>{},...c}=_t(e,t),d=await Et(t,c),h=bt(o),u=xt(o),v="y"===Mt(o),{width:p,height:f}=r.floating;let m,g;"top"===h||"bottom"===h?(m=h,g=u===(await(null==n.isRTL?void 0:n.isRTL(a.floating))?"start":"end")?"left":"right"):(g=h,m="end"===u?"top":"bottom");const w=f-d.top-d.bottom,_=p-d.left-d.right,b=ht(f-d[m],w),x=ht(p-d[g],_),y=!t.middlewareData.shift;let C=b,Z=x;if(null!=(i=t.middlewareData.shift)&&i.enabled.x&&(Z=_),null!=(l=t.middlewareData.shift)&&l.enabled.y&&(C=w),y&&!u){const e=ut(d.left,0),t=ut(d.right,0),i=ut(d.top,0),l=ut(d.bottom,0);v?Z=p-2*(0!==e||0!==t?e+t:ut(d.left,d.right)):C=f-2*(0!==i||0!==l?i+l:ut(d.top,d.bottom))}await s({...t,availableWidth:Z,availableHeight:C});const M=await n.getDimensions(a.floating);return p!==M.width||f!==M.height?{reset:{rects:!0}}:{}}}},ji=function(e){return void 0===e&&(e={}),{name:"hide",options:e,async fn(t){const{rects:i}=t,{strategy:l="referenceHidden",...o}=_t(e,t);switch(l){case"referenceHidden":{const e=It(await Et(t,{...o,elementContext:"reference"}),i.reference);return{data:{referenceHiddenOffsets:e,referenceHidden:Tt(e)}}}case"escaped":{const e=It(await Et(t,{...o,altBoundary:!0}),i.floating);return{data:{escapedOffsets:e,escaped:Tt(e)}}}default:return{}}}}},Ei=(e,t,i)=>{const l=new Map,o={platform:$i,...i},r={...o.platform,_c:l};return(async(e,t,i)=>{const{placement:l="bottom",strategy:o="absolute",middleware:r=[],platform:n}=i,a=r.filter(Boolean),s=await(null==n.isRTL?void 0:n.isRTL(t));let c=await n.getElementRects({reference:e,floating:t,strategy:o}),{x:d,y:h}=jt(c,l,s),u=l,v={},p=0;for(let i=0;i<a.length;i++){const{name:r,fn:f}=a[i],{x:m,y:g,data:w,reset:_}=await f({x:d,y:h,initialPlacement:l,placement:u,strategy:o,middlewareData:v,rects:c,platform:n,elements:{reference:e,floating:t}});d=null!=m?m:d,h=null!=g?g:h,v={...v,[r]:{...v[r],...w}},_&&p<=50&&(p++,"object"==typeof _&&(_.placement&&(u=_.placement),_.rects&&(c=!0===_.rects?await n.getElementRects({reference:e,floating:t,strategy:o}):_.rects),({x:d,y:h}=jt(c,u,s))),i=-1)}return{x:d,y:h,placement:u,strategy:o,middlewareData:v}})(e,t,{...o,platform:r})};var Ii=we`:host([menuisopen]:not([disabled]):not([readonly])) .dropdown-menu{display:block}.dropdown-menu{background-clip:padding-box;background-color:var(--sit-surface-default);border-radius:var(--sit-border-radius-md);box-shadow:var(--sit-elevation-surface-3);color:var(--sit-color-default);display:none;list-style:none;margin:0;max-height:var(--sit-dimension-480);min-width:var(--sit-dimension-192);overflow-y:auto;padding:var(--sit-padding-xs) 0;position:absolute;text-align:start;z-index:var(--sit-z-index-floating)}.nav-tabs .dropdown-menu{border-start-end-radius:0;border-start-start-radius:0;margin-top:calc(var(--sit-nav-tabs-border-width)*-1)}@media (min-width:512px){.navbar-expand-sm .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:768px){.navbar-expand-md .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1024px){.navbar-expand-lg .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1280px){.navbar-expand-xl .navbar-nav .dropdown-menu{position:absolute}}@media (min-width:1440px){.navbar-expand-xxl .navbar-nav .dropdown-menu{position:absolute}}.navbar-expand .navbar-nav .dropdown-menu{position:absolute}.sit.navbar .dropdown-menu.megamenu{inset-inline:0;width:100%}.sit.combobox>.dropdown-menu{min-width:100%}`,Ti=we`.invalid-feedback-container{display:flex;gap:var(--sit-form-gap-sm)}.invalid-feedback,.invalid-feedback-container{color:var(--sit-form-danger-color-default);line-height:var(--sit-line-height-20)}.invalid-feedback{font-size:var(--sit-font-size-label-sm);font-weight:var(--sit-font-weight-regular)}.valid-icon{color:var(--sit-form-success-color-default)}`,Ri=we`.form-text{color:var(--sit-form-color-subtle);font-size:var(--sit-font-size-label-sm);line-height:var(--sit-line-height-2-xs)}.form-text.disabled{opacity:var(--sit-opacity-40)}`,Di=we`.form-control-container{display:flex;flex-direction:column;gap:var(--sit-form-gap-md)}.m-width-160{min-width:var(--sit-dimension-160)}.m-width-256{min-width:var(--sit-dimension-256)}.form-label{color:var(--sit-form-color-default);font-size:var(--sit-font-size-label-md);font-weight:var(--sit-font-weight-semibold)}.form-control-group{align-items:center;background-color:var(--sit-form-surface-default);border:var(--sit-form-border-width-default) solid var(--sit-border-color-default);border-radius:var(--input-border-radius,var(--sit-form-border-radius-md));display:flex;gap:var(--sit-form-gap-md);height:var(--sit-dimension-48);justify-content:center;overflow:hidden;padding:0 var(--sit-form-padding-x);transition:border-color .15s ease-in-out,box-shadow .15s ease-in-out;width:-webkit-fill-available;width:-moz-available}.form-control{appearance:none;background-clip:padding-box;background:none;border:none;color:var(--sit-form-color-default);display:block;flex-grow:1;font-family:var(--sit-font-family-brand);font-size:var(--sit-font-size-label-md);line-height:var(--sit-line-height-xs);min-width:0;outline:none;padding:0;width:100%}.form-clearable{color:var(--sit-color-subtle);cursor:pointer}@media (prefers-reduced-motion:reduce){.form-control-group{transition:none}}.form-control-group:not(.disabled):not(.is-invalid):not(.readonly):not(:focus-within):hover{outline:var(--sit-form-border-width-thick) solid var(--sit-border-color-emphasis);outline-offset:var(--sit-form-outline-offset-focus)}.form-control-group:not(.disabled):not(.is-invalid):focus-within{outline:var(--sit-form-outline-focus);outline-offset:var(--sit-form-outline-offset-focus)}.form-control-container.disabled{opacity:var(--sit-opacity-40)}.form-control-group.disabled{background-color:var(--sit-form-surface-muted);cursor:not-allowed}.form-control-group.readonly{background-color:var(--sit-form-surface-raised)}.form-control-group.is-invalid:not(.disabled){border:var(--sit-form-border-width-default) solid var(--sit-form-danger-border-color-default)}.form-control-group:not(.disabled).is-invalid:focus-within{outline:var(--sit-border-width-2) solid var(--sit-form-danger-color-default);outline-offset:var(--sit-form-outline-offset-focus)}`;const Ui=(e="value")=>(t,i)=>{const l=t.constructor,o=l.prototype.attributeChangedCallback;l.prototype.attributeChangedCallback=function(t,r,n){var a;const s=l.getPropertyOptions(e);if(t===("string"==typeof s.attribute?s.attribute:e).toLowerCase()){const t=s.converter||Se,l=("function"==typeof t?t:null!==(a=null==t?void 0:t.fromAttribute)&&void 0!==a?a:Se.fromAttribute)(n,s.type);this[e]!==l&&(this[i]=l)}o.call(this,t,r,n)}};function Fi(e="",t=""){return`id-${Math.random().toString().substring(2,6)}-sit-${e}-${t}`}class Ni{constructor(e,t){(this.host=e).addController(this),this._internals=e._internals||this.host.attachInternals(),this.options=Object.assign({setInvalid:(e,t)=>{e.invalid=t},value:e=>e.value,input:e=>e.input},t)}hostConnected(){this.host.addEventListener("invalid",e=>this.handleInvalid(e))}hostDisconnected(){this.host.removeEventListener("invalid",e=>this.handleInvalid(e))}handleInvalid(e){e.preventDefault(),this.options.setInvalid(this.host,!0)}handleInput(e){const t=e.target;this.options.setInvalid(this.host,!1),this.validateInput(t)}handleChange(e){const t=e.target;this.validateInput(t),this.options.setInvalid(this.host,!this.checkValidity())}get form(){return this._internals.form}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}updateInvalidState(){this.options.setInvalid(this.host,!this.checkValidity())}resetValidity(){return this._internals.setValidity({})}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}setValidity(e,t,i){return this._internals.setValidity(e,t,i)}setFormValue(){const e=this.options.value(this.host);this._internals.setFormValue(e)}validateInput(e){if(this.options.input(this.host).disabled)return this._internals.setValidity({});const t=e.validity;if(t.valid)this._internals.setValidity({});else for(const i in t)t[i]&&(this.validationError=i.toString(),this._internals.setValidity({[this.validationError]:!0},e.validationMessage,e))}}const Wi=t=>{class i extends t{constructor(...e){super(...e),this._isTouched=!1,this._internals=this.attachInternals()}connectedCallback(){var e;super.connectedCallback(),null!==(e=this.inputValidationController)&&void 0!==e||(this.inputValidationController=new Ni(this))}async firstUpdated(e){super.firstUpdated(e),this.input=this.shadowRoot.querySelector("input")||await this.sitInput||this.shadowRoot.querySelector("textarea")||await this.sitDatepickerInput,this._mixinSetFormValue(),this._mixinShouldSkipSitValidation()||this._mixinValidate(this.input)}formResetCallback(){this._mixinResetFormControl?this._mixinResetFormControl():(this.value=this.defaultValue,this._mixinResetValidity(this.input)),this._mixinSetFormValue()}_mixinHandleChange(e){this._mixinSetFormValue(),this._mixinShouldSkipSitValidation()||this.inputValidationController.handleChange(e)}_mixinHandleInputChange(e){this._mixinSetFormValue(),this._mixinShouldSkipSitValidation()||this.inputValidationController.handleInput(e)}_mixinResetValidity(e){this.inputValidationController.resetValidity(),this.inputValidationController.updateInvalidState(),this._isTouched&&(this._isTouched=!1),this._mixinShouldSkipSitValidation()||this.inputValidationController.validateInput(e)}_mixinValidate(e){this._mixinShouldSkipSitValidation()||this.inputValidationController.validateInput(e)}_mixinSetFormValue(){const e=this.value;this._internals.setFormValue(e)}_mixinCheckValidity(){return!!this._mixinShouldSkipSitValidation()||this.inputValidationController.checkValidity()}_mixinReportValidity(){return!!this._mixinShouldSkipSitValidation()||this.inputValidationController.reportValidity()}_mixinGetValidity(){return this._internals.validity}_mixinGetValidationMessage(){return this._internals.validationMessage}_mixinSetValidity(e,t,i){if(!this._mixinShouldSkipSitValidation())return this.inputValidationController.setValidity(e,t,i)}_mixinShouldSkipSitValidation(){const e=this.closest("form");return(null==e?void 0:e.noValidate)||this.noValidate}}return i.formAssociated=!0,e([Ge("sit-input")],i.prototype,"sitInput",void 0),e([Ge("sit-datepicker-input")],i.prototype,"sitDatepickerInput",void 0),i};var qi=we`:host{-webkit-text-size-adjust:100%;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-font-smoothing:antialiased;color:var(--sit-body-color-default,#1a1a1a);display:block;font-family:var(--sit-font-family-brand,"Inter",system-ui,sans-serif);font-size:var(--sit-font-size-body-md,1rem);font-weight:var(--sit-font-weight-regular,400);line-height:var(--sit-line-height-xs,24px);margin:0;*,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}:disabled{cursor:not-allowed}@media (prefers-reduced-motion:no-preference){:root{scroll-behavior:smooth}}::slotted(a[target=_blank]):after,a[target=_blank]:after{background-color:currentColor;content:"/";display:inline-block;height:1em;-webkit-mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");mask-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9.774 4.4H9.8a.6.6 0 1 1 0 1.2c-.85 0-1.451 0-1.922.039-.463.038-.745.11-.968.223A2.4 2.4 0 0 0 5.861 6.91c-.113.223-.184.505-.222.968-.039.47-.04 1.072-.04 1.922v4.4c0 .85.001 1.451.04 1.922.038.463.11.745.222.968a2.4 2.4 0 0 0 1.05 1.048c.222.114.504.185.967.223.47.038 1.072.039 1.922.039h4.4c.85 0 1.451 0 1.921-.039.464-.038.746-.11.969-.223a2.4 2.4 0 0 0 1.048-1.048c.113-.223.185-.505.223-.968.038-.47.039-1.072.039-1.922a.6.6 0 1 1 1.2 0v.026c0 .818 0 1.468-.043 1.993-.044.538-.136.996-.35 1.415a3.6 3.6 0 0 1-1.573 1.574c-.42.213-.878.305-1.415.35-.525.042-1.175.042-1.993.042H9.774c-.818 0-1.469 0-1.993-.043-.538-.044-.996-.136-1.415-.35a3.6 3.6 0 0 1-1.574-1.573c-.213-.42-.305-.877-.35-1.415-.042-.525-.042-1.175-.042-1.993V9.774c0-.818 0-1.468.043-1.993.044-.538.136-.996.35-1.415a3.6 3.6 0 0 1 1.573-1.574c.42-.213.877-.305 1.415-.35C8.305 4.4 8.956 4.4 9.774 4.4ZM12.4 5a.6.6 0 0 1 .6-.6h6a.6.6 0 0 1 .6.6v6a.6.6 0 1 1-1.2 0V6.449l-5.976 5.975a.6.6 0 0 1-.848-.848L17.55 5.6H13a.6.6 0 0 1-.6-.6Z' fill='%230E0E0E'/%3E%3C/svg%3E");-webkit-mask-position:center;mask-position:center;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;vertical-align:top;width:1em}::slotted(svg){vertical-align:middle}}`;class Ki extends Ie{emit(e,t){const i=new CustomEvent(e,Object.assign({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(i),i}static define(e,t=this,i={}){if(customElements.get(e));else try{customElements.define(e,t,i)}catch(l){customElements.define(e,class extends t{},i)}}constructor(){super(),this.ssr=Boolean(this.shadowRoot),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}firstUpdated(e){var t;super.firstUpdated(e),this.ssr&&(null===(t=this.shadowRoot)||void 0===t||t.querySelectorAll("slot").forEach(e=>{e.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}))}}Ki.styles=[qi],Ki.dependencies={},e([Ne({type:Boolean,reflect:!0})],Ki.prototype,"ssr",void 0);class Gi extends Ki{constructor(){super(...arguments),this.myDropdown=nt(),this.dropdownMenuId=Fi("dropdown-menu","div"),this.noFlip=!1,this.menuAlignRight=!1,this.drop="down",this.floatingOpts={},this.menuIsOpen=!1,this.close="default",this.disabled=!1,this.readonly=!1,this.menuRef=nt(),this._handleClickOutOfElement=e=>{this.menuIsOpen&&(e.composedPath().includes(this)||this.hideMenu(!0))}}connectedCallback(){super.connectedCallback(),"inside"!==this.close&&document.addEventListener("click",this._handleClickOutOfElement),this.addEventListener("keydown",this._handleKeyboardMenuEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),this.removeEventListener("keydown",this._handleKeyboardMenuEvent),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this.menuIsOpen&&requestAnimationFrame(async()=>{await this.updateFloatingPosition(),this._startAutoUpdate()})}async showMenu(){this.disabled||this.menuIsOpen||(this.menuIsOpen=!0,this.emit("sit-show"),await this.updateFloatingPosition(),this.emit("sit-after-show"),this._startAutoUpdate())}_startAutoUpdate(){this.myDropdown.value&&this.menuRef.value&&(this._cleanupAutoUpdate=zi(this.myDropdown.value,this.menuRef.value,()=>this.updateFloatingPosition()))}hideMenu(e){this.menuIsOpen&&(this.emit("sit-hide",{detail:{isOutside:e}}),this.menuIsOpen=!1,setTimeout(()=>this.emit("sit-after-hide"),0),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0))}toggleMenu(){this.menuIsOpen?this.hideMenu():this.showMenu()}_handleKeyboardMenuEvent(e){if(!this.readonly)switch(e.key){case"ArrowDown":case"ArrowUp":e.preventDefault(),this.menuIsOpen||this.showMenu();break;case"Escape":this.hideMenu()}}mergeMiddleware(e,t){const i=e=>{var t;return(null==e?void 0:e.name)||(null===(t=null==e?void 0:e.constructor)||void 0===t?void 0:t.name)},l=t.map(i),o=e.map(e=>{const o=i(e),r=l.indexOf(o);return-1!==r?t[r]:e}).concat(t.filter(t=>!e.some(e=>i(e)===i(t))));return o}async updateFloatingPosition(){if(!this.myDropdown.value||!this.menuRef.value)return;let e="bottom-start";switch(this.drop){case"up":e=this.menuAlignRight?"top-end":"top-start";break;case"right":e="right-start";break;case"left":e="left-start";break;case"down":e=this.menuAlignRight?"bottom-end":"bottom-start";break;default:e="bottom-start"}const t=[Si(8),this.noFlip?void 0:Ai(),Bi()].filter(Boolean);let i=t;Array.isArray(this.floatingOpts.middleware)&&this.floatingOpts.middleware.length>0&&(i=this.mergeMiddleware(t,this.floatingOpts.middleware.filter(Boolean)));const l=Object.assign(Object.assign({strategy:"fixed",placement:e},this.floatingOpts),{middleware:i}),{x:o,y:r,strategy:n,placement:a}=await Ei(this.myDropdown.value,this.menuRef.value,l);this.menuRef.value.setAttribute("data-placement",a),Object.assign(this.menuRef.value.style,{position:n,left:`${o}px`,top:`${r}px`})}}e([Ne({type:Boolean,state:!0})],Gi.prototype,"noFlip",void 0),e([Ne({type:Boolean,reflect:!0,state:!0})],Gi.prototype,"menuAlignRight",void 0),e([Ne({type:String,reflect:!0,state:!0})],Gi.prototype,"drop",void 0),e([Ne({type:Object})],Gi.prototype,"floatingOpts",void 0),e([Ne({type:Boolean,reflect:!0})],Gi.prototype,"menuIsOpen",void 0),e([Ne({type:Boolean,reflect:!0})],Gi.prototype,"disabled",void 0),e([Ne({type:Boolean,reflect:!0})],Gi.prototype,"readonly",void 0);class Ji extends Gi{constructor(){super(...arguments),this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1,this.hidden=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("sit-hide",this._resetMenu)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sit-hide",this._resetMenu)}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keydown",this._handleKeyboardMenuItemsEvent)}handleSelectSlot(e){const t=this._getActiveMenuItems(),i=t.find(t=>e.composedPath().includes(t));if(!i)return;const l=t.indexOf(i);this.nextDropdownItemNo=l+1,this.prevDropdownItemNo=l<=0?t.length-1:l-1,i.disabled||(this.emit("sit-select",{detail:{item:i}}),"outside"!==this.close&&this.hideMenu())}_resetMenu(){this.nextDropdownItemNo=0,this.prevDropdownItemNo=-1;this._getMenuItems().forEach(e=>{var t;const i=null===(t=null==e?void 0:e.shadowRoot)||void 0===t?void 0:t.querySelector(".dropdown-item");i&&i.removeAttribute("tabindex")})}_handleKeyboardMenuItemsEvent(e){if(this.readonly)return;const t=this._getActiveMenuItems();if(0!==t.length)switch(e.key){case"ArrowDown":e.preventDefault(),this._setMenuItem(this.nextDropdownItemNo);break;case"ArrowUp":e.preventDefault(),this._setMenuItem(this.prevDropdownItemNo);break;case"Tab":if(!this.menuIsOpen)return;e.preventDefault(),e.shiftKey?this._setMenuItem(this.prevDropdownItemNo):this._setMenuItem(this.nextDropdownItemNo);break;case"Enter":t.find(t=>e.composedPath().includes(t))&&this.handleSelectSlot(e);break}}_getMenuItems(){var e,t;if(this.shadowRoot.querySelector("slot#default")){return null===(e=this.shadowRoot.querySelector("slot#default"))||void 0===e?void 0:e.assignedElements({flatten:!0}).filter(e=>!e.classList.contains("empty-menu")&&!e.hasAttribute("hidden"))}if(null===(t=this.menu)||void 0===t?void 0:t.hasChildNodes()){return[...Array.from(this.menu.children)]}return[]}_getActiveMenuItems(){return this._getMenuItems().filter(e=>!e.disabled&&!e.hidden)}_setMenuItem(e){const t=this._getActiveMenuItems();if(0===t.length)return;const i=(e%t.length+t.length)%t.length,l=t[i];this.emit("i-sit-option-focus",{detail:{option:l}}),this.nextDropdownItemNo=(i+1)%t.length,this.prevDropdownItemNo=(i-1+t.length)%t.length,t.forEach(e=>{const t=e.shadowRoot.querySelector(".dropdown-item");t.setAttribute("tabindex",e===l?"0":"-1"),e===l&&t.focus()})}}var Xi,Yi;Ji.styles=Gi.styles,e([(Xi="ul.dropdown-menu",(e,t,i)=>{const l=e=>{const i=e.renderRoot?.querySelector(Xi)??null;if(null===i&&Yi&&!e.hasUpdated){const e="object"==typeof t?t.name:t;Ke("",`@query'd field ${JSON.stringify(String(e))} with the 'cache' flag set for selector '${Xi}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return i};if(Yi){const{get:o,set:r}="object"==typeof t?e:i??(()=>{const e=Symbol(`${String(t)} (@query() cache)`);return{get(){return this[e]},set(t){this[e]=t}}})();return qe(e,t,{get(){let e=o.call(this);return void 0===e&&(e=l(this),(null!==e||this.hasUpdated)&&r.call(this,e)),e}})}return qe(e,t,{get(){return l(this)}})})],Ji.prototype,"menu",void 0),e([We()],Ji.prototype,"nextDropdownItemNo",void 0),e([We()],Ji.prototype,"prevDropdownItemNo",void 0),e([Ne({type:Boolean,reflect:!0})],Ji.prototype,"hidden",void 0);var Qi=we`.empty-menu,.loading-menu{padding:var(--sit-padding-sm) var(--sit-padding-lg,20px);pointer-events:none}.loading-menu{align-items:center;display:flex;gap:var(--sit-gap-xs)}`;class el extends(Wi(Ji)){setInvalid(e){this.invalid=e,e?this.emit("sit-invalid"):this.emit("sit-valid")}constructor(){super(),this.label="",this.hintText="",this.autofocus=!1,this.disabled=!1,this.required=!1,this.loading=!1,this.value="",this.displayValue="",this.defaultValue="",this.hasFeedback=!1,this.invalidFeedback="",this.invalid=!1,this.autocomplete="on",this.menuList=[],this.selectedItems=[],this.filteredList=[],this._isTouched=!1,this._controlId=Fi("input"),this._labelId=Fi("label"),this.floatingOpts={middleware:[Li({apply({rects:e,elements:t}){t.floating.style.width=`${e.reference.width}px`}})]}}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",async e=>{var t;if(this._mixinShouldSkipSitValidation())return;const i=this.constructor.childName,l=(null===(t=e.relatedTarget)||void 0===t?void 0:t.tagName.toLowerCase())===i;this.invalid=!l&&!this._mixinReportValidity()})}reportValidity(){return this._mixinReportValidity()}setValidity(e,t,i){return this._mixinSetValidity(e,t,i)}checkValidity(){return this._mixinCheckValidity()}get validity(){return this._mixinGetValidity()}get validationMessage(){return this._mixinGetValidationMessage()}_renderFeedback(){return this.invalid&&this.hasFeedback?$` <div class="invalid-feedback-container">
        ...
        </div>`:$`${this._renderHintText()}`}_renderHintText(){const e=$` <div id="${this._controlId}Help" class="form-text">${this.hintText}</div> `;return this.hintText&&e}_renderLabel(){const e=$`
      <label
        for=${this._controlId}
        id=${this._labelId}
        ...
        >${this.label}</label
      >
    `;return this.label&&e}_handleClick(){if(this.readonly)return null;this.menuIsOpen?this.hideMenu():this.showMenu()}async _getMenuListFromOptions(e){const t=e.map(async e=>(await e.updateComplete,e)),i=await Promise.all(t);return null==i?void 0:i.map(e=>{var t;return{label:e.innerText,value:e.getAttribute("value"),disabled:null!==(t=e.disabled)&&void 0!==t?t:void 0}})}_renderEmptyMenu(){return $` <div class="empty-menu">No options</div> `}_renderLoadingMenu(){return $`<div class="loading-menu"><sit-spinner size="xs" tone="brand"></sit-spinner>Loading...</div>`}}function tl(e,t){const i=Object.assign({waitUntilFirstUpdate:!1},t);return(t,l)=>{const{update:o}=t;if(e in t){const r=e;t.update=function(e){if(e.has(r)){const t=e.get(r),o=this[r];t!==o&&(i.waitUntilFirstUpdate&&!this.hasUpdated||this[l](t,o))}o.call(this,e)}}}}el.styles=[...Ji.styles,Ii,Ri,Ti,Di,Qi],e([Ne({reflect:!0})],el.prototype,"label",void 0),e([Ne({reflect:!0})],el.prototype,"hintText",void 0),e([Ne({reflect:!0})],el.prototype,"name",void 0),e([Ne({type:String,reflect:!0})],el.prototype,"placeholder",void 0),e([Ne({type:Boolean,reflect:!0})],el.prototype,"autofocus",void 0),e([Ne({type:Boolean,reflect:!0})],el.prototype,"disabled",void 0),e([Ne({type:Boolean,reflect:!0})],el.prototype,"required",void 0),e([Ne({type:Boolean,reflect:!0})],el.prototype,"loading",void 0),e([Ne({type:String,reflect:!0})],el.prototype,"value",void 0),e([We()],el.prototype,"displayValue",void 0),e([Ui()],el.prototype,"defaultValue",void 0),e([Ne({type:Boolean,reflect:!0})],el.prototype,"hasFeedback",void 0),e([Ne({type:String,reflect:!0})],el.prototype,"invalidFeedback",void 0),e([Ne({type:Boolean,reflect:!0})],el.prototype,"invalid",void 0),e([Ne({type:String,reflect:!0})],el.prototype,"autocomplete",void 0),e([Ne({type:Array})],el.prototype,"menuList",void 0),e([We()],el.prototype,"selectedItems",void 0),e([We()],el.prototype,"filteredList",void 0),e([Ge("input.form-control")],el.prototype,"_input",void 0);var il=we`:host{cursor:default;display:inline-flex;max-width:100%}:host([variant=accent]) .badge{background-color:var(--sit-accent-surface-default)}:host([variant=success]) .badge{background-color:var(--sit-success-surface-default)}:host([variant=danger]) .badge{background-color:var(--sit-danger-surface-default)}:host([variant=warning]) .badge{background-color:var(--sit-warning-surface-default);color:var(--sit-color-fixed-dark)}:host([variant=cyan]) .badge{background-color:var(--sit-cyan-surface-default)}:host([variant=purple]) .badge{background-color:var(--sit-purple-surface-default)}:host([variant=neutral]) .badge{background-color:var(--sit-neutral-surface-default)}:host([variant=white]) .badge{background-color:var(--sit-surface-fixed-light);color:var(--sit-color-fixed-dark)}:host([variant=accent][outlined]) .badge{background-color:var(--sit-accent-surface-muted);border:var(--sit-border-width-1) solid var(--sit-accent-border-color-muted);color:var(--sit-accent-color-fixed-dark)}:host([variant=success][outlined]) .badge{background-color:var(--sit-success-surface-muted);border:var(--sit-border-width-1) solid var(--sit-success-border-color-muted);color:var(--sit-success-color-fixed-dark)}:host([variant=danger][outlined]) .badge{background-color:var(--sit-danger-surface-muted);border:var(--sit-border-width-1) solid var(--sit-danger-border-color-muted);color:var(--sit-danger-color-fixed-dark)}:host([variant=warning][outlined]) .badge{background-color:var(--sit-warning-surface-muted);border:var(--sit-border-width-1) solid var(--sit-warning-border-color-muted);color:var(--sit-warning-color-fixed-dark)}:host([variant=cyan][outlined]) .badge{background-color:var(--sit-cyan-surface-muted);border:var(--sit-border-width-1) solid var(--sit-cyan-border-color-muted);color:var(--sit-cyan-color-fixed-dark)}:host([variant=purple][outlined]) .badge{background-color:var(--sit-purple-surface-muted);border:var(--sit-border-width-1) solid var(--sit-purple-border-color-muted);color:var(--sit-purple-color-fixed-dark)}:host([variant=neutral][outlined]) .badge{background-color:var(--sit-neutral-surface-muted);border:var(--sit-border-width-1) solid var(--sit-neutral-border-color-muted);color:var(--sit-color-fixed-dark)}:host([variant=white][outlined]) .badge{background-color:var(--sit-surface-fixed-light);border:var(--sit-border-width-1) solid var(--sit-border-color-muted);color:var(--sit-color-fixed-dark)}sit-tooltip{display:block;max-width:100%}.badge{align-items:center;background-color:var(--sit-primary-surface-default);border:var(--sit-border-width-1) solid var(--sit-border-color-transparent);border-radius:var(--sit-border-radius-sm);color:var(--sit-color-fixed-light);display:inline-flex;font-size:var(--sit-font-size-label-xs);height:var(--sit-dimension-24,24px);justify-content:center;line-height:var(--sit-line-height-3-xs);max-width:var(--sit-dimension-192,192px);min-width:var(--sit-dimension-24);padding:var(--sit-padding-none) var(--sit-padding-xs)}.badge.badge--outlined{background-color:var(--sit-primary-surface-muted);border:var(--sit-border-width-1) solid var(--sit-primary-border-color-muted);color:var(--sit-primary-color-fixed-dark)}.badge.badge--full-width{max-width:100%}.badge__label{overflow:hidden;padding:var(--sit-padding-none) var(--sit-padding-3-xs);text-overflow:ellipsis;white-space:nowrap}.badge--dismissible{padding-right:0}.badge--dismissible sit-close-button{--sit-close-btn-border-radius:var(--sit-border-radius-sm)}slot::slotted(*){color:inherit!important;font-size:inherit!important;font-weight:inherit!important;line-height:inherit!important;margin:inherit!important}`,ll=we`:host{display:contents}.tooltip-placeholder{display:inline-block;max-width:100%}.tooltip{word-wrap:break-word;background-color:var(--sit-surface-fixed-dark);border-radius:var(--sit-border-radius-md);box-shadow:var(--sit-elevation-surface-4);color:var(--sit-color-fixed-light);display:block;font-size:var(--sit-font-size-label-sm);line-break:auto;max-width:var(--sit-dimension-320);padding:var(--sit-padding-xs) var(--sit-padding-sm);text-align:left;text-decoration:none;text-shadow:none;text-transform:none;white-space:normal;word-break:normal;word-spacing:normal;z-index:var(--sit-z-index-overlay)}div{max-width:fit-content}`;class ol extends Ki{constructor(){super(...arguments),this._myTooltip=nt(),this._tooltipBubble=nt(),this.content="",this.placement="top",this.trigger="hover focus",this.open=!1,this._tooltipId=Fi("tooltip","bubble"),this._handleClickOutOfElement=e=>{this.open&&(e.composedPath().includes(this)||this.hide())},this._handleKeyDown=e=>{this.open&&"Escape"===e.key&&this.hide()}}connectedCallback(){super.connectedCallback(),this.trigger.includes("click")&&document.addEventListener("click",this._handleClickOutOfElement),document.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutOfElement),document.removeEventListener("keydown",this._handleKeyDown),this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0)}firstUpdated(e){super.firstUpdated(e),this._tooltipTargetElements.forEach(e=>{e.setAttribute("data-sit-tooltip",this.content),e.setAttribute("aria-describedby",this._tooltipId),this.trigger.includes("hover")&&(e.addEventListener("mouseenter",()=>this.show()),e.addEventListener("mouseleave",()=>this.hide())),this.trigger.includes("focus")&&(e.addEventListener("focus",()=>this.show()),e.addEventListener("blur",()=>this.hide())),"click"===this.trigger&&e.addEventListener("click",()=>this.toggle())})}_handleSlotChange(){this._tooltipTargetElements.forEach(e=>{e.setAttribute("data-sit-tooltip",this.content),e.setAttribute("aria-describedby",this._tooltipId)})}async updateFloatingPosition(){if(!this._myTooltip.value||!this._tooltipBubble.value)return;const{x:e,y:t,placement:i,strategy:l,middlewareData:o}=await Ei(this._tooltipTargetElements[0],this._tooltipBubble.value,{strategy:"fixed",placement:this.placement,middleware:[Si(8),Ai(),Bi(),ji()]});this._tooltipBubble.value.setAttribute("data-placement",i),Object.assign(this._tooltipBubble.value.style,{position:l,left:`${e}px`,top:`${t}px`});const{referenceHidden:r,escaped:n}=o.hide||{};this._tooltipBubble.value.style.visibility=r||n?"hidden":"visible"}async show(){this.open||(this.open=!0,this.emit("sit-show"),await this.updateComplete,await this.updateFloatingPosition(),this._myTooltip.value&&this._tooltipBubble.value&&(this._cleanupAutoUpdate=zi(this._tooltipTargetElements[0],this._tooltipBubble.value,()=>this.updateFloatingPosition())),this.emit("sit-after-show"))}hide(){this.open&&(this.emit("sit-hide"),this.open=!1,this._cleanupAutoUpdate&&(this._cleanupAutoUpdate(),this._cleanupAutoUpdate=void 0),setTimeout(()=>this.emit("sit-after-hide"),0))}toggle(){this.open?this.hide():this.show()}render(){return $`
      <div ${ct(this._myTooltip)} class="tooltip-placeholder">
        <slot @slotchange=${()=>this._handleSlotChange()}></slot>
        ${this.open?$`<div ${ct(this._tooltipBubble)} id=${this._tooltipId} class="tooltip" role="tooltip">
              ${this.content}
            </div>`:null}
      </div>
    `}}ol.styles=[...Ki.styles,ll],e([Ne({type:String})],ol.prototype,"content",void 0),e([Ne({type:String})],ol.prototype,"placement",void 0),e([Ne({type:String})],ol.prototype,"trigger",void 0),e([We()],ol.prototype,"open",void 0),e([Je()],ol.prototype,"_tooltipTargetElements",void 0);var rl=we`:host{--sit-close-btn-border-radius:var(--sit-border-radius-sm);display:inline-flex}:host([size=sm]) .btn-close{height:var(--sit-dimension-24);width:var(--sit-dimension-24)}:host([tone=fixed-light]) .btn-close{color:var(--sit-color-fixed-light)}:host([tone=fixed-dark]) .btn-close{color:var(--sit-color-fixed-dark)}.btn-close{align-items:center;background-color:var(--sit-bg-transparent);border:0;border:var(--sit-border-width-1) solid var(--sit-border-color-transparent);border-radius:var(--sit-close-btn-border-radius);cursor:pointer;display:flex;height:var(--sit-dimension-32);justify-content:center;padding:0;position:relative;width:var(--sit-dimension-32)}.btn-close:focus-visible,.btn-close:hover{background-color:var(--sit-bg-translucent)}:host([tone=fixed-light]) .btn-close:focus-visible,:host([tone=fixed-light]) .btn-close:hover{background-color:var(--sit-bg-translucent-fixed-light)}:host([tone=fixed-dark]) .btn-close:focus-visible,:host([tone=fixed-dark]) .btn-close:hover{background-color:var(--sit-bg-translucent-fixed-dark)}.btn-close:focus-visible{outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}:host([disabled]) .btn-close{cursor:not-allowed;opacity:var(--sit-opacity-40);pointer-events:none}`;function nl(e,t){customElements.get(e)||customElements.define(e,t)}function al(e){return!!function(e){return!!customElements.get(e)}(e)||(console.error(`Custom element of name : ${e} is not registered. Remember to import the component file for custom element registration`),!1)}class sl extends Ki{constructor(){super(...arguments),this.size="md",this.tone="default",this.disabled=!1,this._clickHandler=()=>{}}_handleClick(e){if(this.disabled)return e.preventDefault(),void e.stopPropagation();this.removeEventListener("click",this._clickHandler),this.addEventListener("click",this._clickHandler)}firstUpdated(e){super.firstUpdated(e),al("sit-icon")}render(){return $`
    ...
    `}}sl.styles=[...Ki.styles,rl],e([Ne({type:String,reflect:!0})],sl.prototype,"size",void 0),e([Ne({type:String,reflect:!0})],sl.prototype,"tone",void 0),e([Ne({type:Boolean,reflect:!0})],sl.prototype,"disabled",void 0);class cl extends Ki{constructor(){super(...arguments),this.show=!1,this.variant="primary",this.outlined=!1,this.dismissible=!1,this.fullWidth=!1,this.truncated=!1,this.text=""}close(){this.show=!1}_handleShowChange(){if(this.show){if(this.emit("sit-show",{cancelable:!0}).defaultPrevented)return void(this.show=!1);this.emit("sit-after-show")}else{if(this.emit("sit-hide",{cancelable:!0}).defaultPrevented)return void(this.show=!0);this.emit("sit-after-hide")}}_handleTruncation(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".badge__label");t&&(this.truncated=t.scrollWidth>t.clientWidth)}_handleLabelSlotChange(e){this.text=function(e){if(!e)return"";const t=e.assignedNodes({flatten:!0});let i="";return[...t].forEach(e=>{e.nodeType===Node.TEXT_NODE&&(i+=e.textContent.trim())}),i}(e.target)}_renderBadge(){const e=this.outlined||"warning"===this.variant||"white"===this.variant;return $`<div
      class="
          ${Xe({"badge--dismissible":this.dismissible,badge:!0,"badge--outlined":this.outlined,"badge--full-width":this.fullWidth})}"
      aria-hidden=${this.show?"false":"true"}
    >
      ${this.dismissible?S:$`<slot name="icon"></slot>`}

      <span class="badge__label">
        <slot @slotchange=${this._handleLabelSlotChange}></slot>
      </span>

      ${this.dismissible?$`<sit-close-button
            size="sm"
            aria-label="close the badge"
            @click=${this.close}
            tone=${e?"fixed-dark":"fixed-light"}
          ></sit-close-button>`:S}
    </div>`}render(){return this.dismissible&&this.show||!this.dismissible?this.truncated?$`<sit-tooltip content=${this.text} @sit-hide=${e=>e.stopPropagation()}
            >${this._renderBadge()}</sit-tooltip
          >`:this._renderBadge():S}}cl.styles=[...Ki.styles,il],cl.dependencies={"sit-close-button":sl,"sit-tooltip":ol},e([Ne({type:Boolean,reflect:!0})],cl.prototype,"show",void 0),e([Ne({reflect:!0})],cl.prototype,"variant",void 0),e([Ne({type:Boolean,reflect:!0})],cl.prototype,"outlined",void 0),e([Ne({type:Boolean,reflect:!0})],cl.prototype,"dismissible",void 0),e([Ne({type:Boolean,reflect:!0})],cl.prototype,"fullWidth",void 0),e([We()],cl.prototype,"truncated",void 0),e([We()],cl.prototype,"text",void 0),e([tl("show")],cl.prototype,"_handleShowChange",null),e([tl("text",{waitUntilFirstUpdate:!0})],cl.prototype,"_handleTruncation",null);const dl={announcement:()=>Promise.resolve().then(function(){return Ll}),archive:()=>Promise.resolve().then(function(){return El}),"arrow-bar-down":()=>Promise.resolve().then(function(){return Tl}),"arrow-bar-left":()=>Promise.resolve().then(function(){return Dl}),"arrow-bar-right":()=>Promise.resolve().then(function(){return Fl}),"arrow-bar-up":()=>Promise.resolve().then(function(){return Wl}),"arrow-circle-down":()=>Promise.resolve().then(function(){return Kl}),"arrow-circle-left":()=>Promise.resolve().then(function(){return Jl}),"arrow-circle-right":()=>Promise.resolve().then(function(){return Yl}),"arrow-circle-up":()=>Promise.resolve().then(function(){return eo}),"arrow-clockwise":()=>Promise.resolve().then(function(){return io}),"arrow-down":()=>Promise.resolve().then(function(){return oo}),"arrow-left":()=>Promise.resolve().then(function(){return no}),"arrow-repeat":()=>Promise.resolve().then(function(){return so}),"arrow-right":()=>Promise.resolve().then(function(){return ho}),"arrow-square-down":()=>Promise.resolve().then(function(){return vo}),"arrow-square-left":()=>Promise.resolve().then(function(){return fo}),"arrow-square-right":()=>Promise.resolve().then(function(){return go}),"arrow-square-up":()=>Promise.resolve().then(function(){return _o}),"arrow-up":()=>Promise.resolve().then(function(){return xo}),"bank-fill":()=>Promise.resolve().then(function(){return Co}),"bell-slash":()=>Promise.resolve().then(function(){return Mo}),bell:()=>Promise.resolve().then(function(){return ko}),"bi-funnel":()=>Promise.resolve().then(function(){return Po}),"bookmark-fill":()=>Promise.resolve().then(function(){return Oo}),bookmark:()=>Promise.resolve().then(function(){return So}),"box-arrow-up-right":()=>Promise.resolve().then(function(){return Ao}),"box-seam":()=>Promise.resolve().then(function(){return jo}),building:()=>Promise.resolve().then(function(){return Io}),bus:()=>Promise.resolve().then(function(){return Ro}),calculator:()=>Promise.resolve().then(function(){return Uo}),"calendar-check":()=>Promise.resolve().then(function(){return No}),"calendar-heart":()=>Promise.resolve().then(function(){return qo}),"calendar-x":()=>Promise.resolve().then(function(){return Go}),calendar:()=>Promise.resolve().then(function(){return Xo}),camera:()=>Promise.resolve().then(function(){return Qo}),car:()=>Promise.resolve().then(function(){return tr}),"chat-dots":()=>Promise.resolve().then(function(){return lr}),"chat-left-text":()=>Promise.resolve().then(function(){return rr}),chat:()=>Promise.resolve().then(function(){return ar}),"check-circle-fill":()=>Promise.resolve().then(function(){return cr}),"check-circle":()=>Promise.resolve().then(function(){return hr}),check:()=>Promise.resolve().then(function(){return vr}),"chevron-down":()=>Promise.resolve().then(function(){return fr}),"chevron-left":()=>Promise.resolve().then(function(){return gr}),"chevron-right":()=>Promise.resolve().then(function(){return _r}),"chevron-selector-vertical":()=>Promise.resolve().then(function(){return xr}),"chevron-up":()=>Promise.resolve().then(function(){return Cr}),clock:()=>Promise.resolve().then(function(){return Mr}),"cloud-check":()=>Promise.resolve().then(function(){return kr}),"cloud-download":()=>Promise.resolve().then(function(){return Pr}),"cloud-upload":()=>Promise.resolve().then(function(){return Or}),cloud:()=>Promise.resolve().then(function(){return Sr}),"code-square":()=>Promise.resolve().then(function(){return Ar}),"coins-hand":()=>Promise.resolve().then(function(){return jr}),compass:()=>Promise.resolve().then(function(){return Ir}),copy:()=>Promise.resolve().then(function(){return Rr}),"cpu-chip-ai":()=>Promise.resolve().then(function(){return Ur}),cross:()=>Promise.resolve().then(function(){return Nr}),"cursor-fill":()=>Promise.resolve().then(function(){return qr}),cursor:()=>Promise.resolve().then(function(){return Gr}),"dash-circle":()=>Promise.resolve().then(function(){return Xr}),"dash-square":()=>Promise.resolve().then(function(){return Qr}),dash:()=>Promise.resolve().then(function(){return tn}),database:()=>Promise.resolve().then(function(){return on}),dataflow:()=>Promise.resolve().then(function(){return nn}),download:()=>Promise.resolve().then(function(){return sn}),edit:()=>Promise.resolve().then(function(){return dn}),"exclamation-circle-fill":()=>Promise.resolve().then(function(){return un}),"exclamation-circle":()=>Promise.resolve().then(function(){return pn}),"exclamation-triangle-fill":()=>Promise.resolve().then(function(){return mn}),"exclamation-triangle":()=>Promise.resolve().then(function(){return wn}),exclamation:()=>Promise.resolve().then(function(){return bn}),"eye-fill":()=>Promise.resolve().then(function(){return yn}),"eye-slash-fill":()=>Promise.resolve().then(function(){return Zn}),"eye-slash":()=>Promise.resolve().then(function(){return Vn}),eye:()=>Promise.resolve().then(function(){return Hn}),"face-smile-fill":()=>Promise.resolve().then(function(){return $n}),"face-smile":()=>Promise.resolve().then(function(){return zn}),facebook:()=>Promise.resolve().then(function(){return Bn}),"file-earmark-text":()=>Promise.resolve().then(function(){return Ln}),"file-pdf":()=>Promise.resolve().then(function(){return En}),"file-plus":()=>Promise.resolve().then(function(){return Tn}),"file-text":()=>Promise.resolve().then(function(){return Dn}),file:()=>Promise.resolve().then(function(){return Fn}),files:()=>Promise.resolve().then(function(){return Wn}),fingerprint:()=>Promise.resolve().then(function(){return Kn}),flash:()=>Promise.resolve().then(function(){return Jn}),"folder-check":()=>Promise.resolve().then(function(){return Yn}),"folder-minus":()=>Promise.resolve().then(function(){return ea}),"folder-plus":()=>Promise.resolve().then(function(){return ia}),folder:()=>Promise.resolve().then(function(){return oa}),gear:()=>Promise.resolve().then(function(){return na}),"geo-alt":()=>Promise.resolve().then(function(){return sa}),"geo-fill":()=>Promise.resolve().then(function(){return da}),geo:()=>Promise.resolve().then(function(){return ua}),"globe-alt":()=>Promise.resolve().then(function(){return pa}),globe:()=>Promise.resolve().then(function(){return ma}),google:()=>Promise.resolve().then(function(){return wa}),"grid-alt":()=>Promise.resolve().then(function(){return ba}),"grid-fill":()=>Promise.resolve().then(function(){return ya}),"hand-thumbs-down":()=>Promise.resolve().then(function(){return Za}),"hand-thumbs-up":()=>Promise.resolve().then(function(){return Va}),"hard-drive":()=>Promise.resolve().then(function(){return Ha}),heart:()=>Promise.resolve().then(function(){return $a}),"house-door":()=>Promise.resolve().then(function(){return za}),house:()=>Promise.resolve().then(function(){return Ba}),image:()=>Promise.resolve().then(function(){return La}),"in-box":()=>Promise.resolve().then(function(){return Ea}),"info-circle-fill":()=>Promise.resolve().then(function(){return Ta}),"info-circle":()=>Promise.resolve().then(function(){return Da}),instagram:()=>Promise.resolve().then(function(){return Fa}),key:()=>Promise.resolve().then(function(){return Wa}),"laptop-gear":()=>Promise.resolve().then(function(){return Ka}),laptop:()=>Promise.resolve().then(function(){return Ja}),layers:()=>Promise.resolve().then(function(){return Ya}),"layout-text-window-reverse":()=>Promise.resolve().then(function(){return es}),"layout-text-window":()=>Promise.resolve().then(function(){return is}),layout:()=>Promise.resolve().then(function(){return os}),"life-buoy":()=>Promise.resolve().then(function(){return ns}),lightbulb:()=>Promise.resolve().then(function(){return ss}),link:()=>Promise.resolve().then(function(){return ds}),linkedin:()=>Promise.resolve().then(function(){return us}),list:()=>Promise.resolve().then(function(){return ps}),"lock-fill":()=>Promise.resolve().then(function(){return ms}),lock:()=>Promise.resolve().then(function(){return ws}),login:()=>Promise.resolve().then(function(){return bs}),logout:()=>Promise.resolve().then(function(){return ys}),luggage:()=>Promise.resolve().then(function(){return Zs}),"mail-open":()=>Promise.resolve().then(function(){return Vs}),mail:()=>Promise.resolve().then(function(){return Hs}),map:()=>Promise.resolve().then(function(){return $s}),meetup:()=>Promise.resolve().then(function(){return zs}),menu:()=>Promise.resolve().then(function(){return Bs}),microphone:()=>Promise.resolve().then(function(){return Ls}),monitor:()=>Promise.resolve().then(function(){return Es}),moon:()=>Promise.resolve().then(function(){return Ts}),move:()=>Promise.resolve().then(function(){return Ds}),paperclip:()=>Promise.resolve().then(function(){return Fs}),passcode:()=>Promise.resolve().then(function(){return Ws}),passport:()=>Promise.resolve().then(function(){return Ks}),pause:()=>Promise.resolve().then(function(){return Js}),pencil:()=>Promise.resolve().then(function(){return Ys}),"pending-circle":()=>Promise.resolve().then(function(){return ec}),"person-dash":()=>Promise.resolve().then(function(){return ic}),"person-plus":()=>Promise.resolve().then(function(){return oc}),"person-x":()=>Promise.resolve().then(function(){return nc}),person:()=>Promise.resolve().then(function(){return sc}),phone:()=>Promise.resolve().then(function(){return dc}),"pin-map-fill":()=>Promise.resolve().then(function(){return uc}),pin:()=>Promise.resolve().then(function(){return pc}),placeholder:()=>Promise.resolve().then(function(){return mc}),plane:()=>Promise.resolve().then(function(){return wc}),play:()=>Promise.resolve().then(function(){return bc}),"plus-circle":()=>Promise.resolve().then(function(){return yc}),"plus-square":()=>Promise.resolve().then(function(){return Zc}),plus:()=>Promise.resolve().then(function(){return Vc}),printer:()=>Promise.resolve().then(function(){return Hc}),"question-circle":()=>Promise.resolve().then(function(){return $c}),rocket:()=>Promise.resolve().then(function(){return zc}),save:()=>Promise.resolve().then(function(){return Bc}),search:()=>Promise.resolve().then(function(){return Lc}),send:()=>Promise.resolve().then(function(){return Ec}),"sg-crest":()=>Promise.resolve().then(function(){return Tc}),share:()=>Promise.resolve().then(function(){return Dc}),"shield-tick":()=>Promise.resolve().then(function(){return Fc}),"sidebar-collapse":()=>Promise.resolve().then(function(){return Wc}),"sidebar-expand":()=>Promise.resolve().then(function(){return Kc}),"slash-circle":()=>Promise.resolve().then(function(){return Jc}),"slash-divider":()=>Promise.resolve().then(function(){return Yc}),sliders:()=>Promise.resolve().then(function(){return ed}),"sort-ascending":()=>Promise.resolve().then(function(){return id}),"sort-descending":()=>Promise.resolve().then(function(){return od}),speedometer:()=>Promise.resolve().then(function(){return nd}),"star-ai":()=>Promise.resolve().then(function(){return sd}),"star-fill":()=>Promise.resolve().then(function(){return dd}),star:()=>Promise.resolve().then(function(){return ud}),stoplights:()=>Promise.resolve().then(function(){return pd}),sun:()=>Promise.resolve().then(function(){return md}),"switch-horizontal":()=>Promise.resolve().then(function(){return wd}),"switch-vertical":()=>Promise.resolve().then(function(){return bd}),tablet:()=>Promise.resolve().then(function(){return yd}),telegram:()=>Promise.resolve().then(function(){return Zd}),telephone:()=>Promise.resolve().then(function(){return Vd}),"three-dots-vertical":()=>Promise.resolve().then(function(){return Hd}),"three-dots":()=>Promise.resolve().then(function(){return $d}),ticket:()=>Promise.resolve().then(function(){return zd}),"toggle-off":()=>Promise.resolve().then(function(){return Bd}),"toggle-on":()=>Promise.resolve().then(function(){return Ld}),train:()=>Promise.resolve().then(function(){return Ed}),translate:()=>Promise.resolve().then(function(){return Td}),trash:()=>Promise.resolve().then(function(){return Dd}),"trend-down":()=>Promise.resolve().then(function(){return Fd}),"trend-up":()=>Promise.resolve().then(function(){return Wd}),truck:()=>Promise.resolve().then(function(){return Kd}),"twitter-x":()=>Promise.resolve().then(function(){return Jd}),unlock:()=>Promise.resolve().then(function(){return Yd}),upload:()=>Promise.resolve().then(function(){return eh}),"user-check":()=>Promise.resolve().then(function(){return ih}),"user-circle":()=>Promise.resolve().then(function(){return oh}),"user-pause":()=>Promise.resolve().then(function(){return nh}),"user-square":()=>Promise.resolve().then(function(){return sh}),users:()=>Promise.resolve().then(function(){return dh}),"video-recorder":()=>Promise.resolve().then(function(){return uh}),"volume-max":()=>Promise.resolve().then(function(){return ph}),"volume-x":()=>Promise.resolve().then(function(){return mh}),"window-dash":()=>Promise.resolve().then(function(){return wh}),"window-desktop":()=>Promise.resolve().then(function(){return bh}),"window-dock":()=>Promise.resolve().then(function(){return yh}),"window-fullscreen":()=>Promise.resolve().then(function(){return Zh}),"window-plus":()=>Promise.resolve().then(function(){return Vh}),"window-sidebar":()=>Promise.resolve().then(function(){return Hh}),"window-split":()=>Promise.resolve().then(function(){return $h}),"window-stack":()=>Promise.resolve().then(function(){return zh}),"window-x":()=>Promise.resolve().then(function(){return Bh}),window:()=>Promise.resolve().then(function(){return Lh}),"xcircle-fill":()=>Promise.resolve().then(function(){return Eh}),xcircle:()=>Promise.resolve().then(function(){return Th}),youtube:()=>Promise.resolve().then(function(){return Dh}),"zoom-in":()=>Promise.resolve().then(function(){return Fh}),"zoom-out":()=>Promise.resolve().then(function(){return Wh})};var hl=we`:host{color:inherit;display:inline-flex;vertical-align:bottom}:host(.icon-left){margin-right:.25rem}:host(.icon-right){margin-left:.25rem}:host([size=xs]) svg{height:var(--sit-icon-size-xs);width:var(--sit-icon-size-xs)}:host([size=sm]) svg{height:var(--sit-icon-size-sm);width:var(--sit-icon-size-sm)}:host([size=md]) svg{height:var(--sit-icon-size-md);width:var(--sit-icon-size-md)}:host([size=xl]) svg{height:var(--sit-icon-size-xl);width:var(--sit-icon-size-xl)}:host([size="2-xl"]) svg{height:var(--sit-icon-size-2-xl);width:var(--sit-icon-size-2-xl)}:host([size="3-xl"]) svg{height:var(--sit-icon-size-3-xl);width:var(--sit-icon-size-3-xl)}svg{display:inline-block;height:var(--sit-icon-size-lg);width:var(--sit-icon-size-lg)}`;const ul=new Map;class vl extends Ki{constructor(){super(...arguments),this.size="lg"}willUpdate(e){e.has("name")&&this._loadIcon(this.name)}async _loadIcon(e){if(!e)return void(this._icon=void 0);if(ul.has(e))return void(this._icon=ul.get(e));const t=dl[e];if(!t)return console.warn(`Icon not found: ${e}`),void(this._icon=void 0);try{const i=await t();ul.set(e,i.default),this._icon=i.default}catch(t){console.warn(`Failed to load icon: ${e}`),this._icon=void 0}}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("svg");t&&(this.ariaLabel?(t.removeAttribute("aria-hidden"),t.setAttribute("aria-label",this.ariaLabel)):(t.removeAttribute("aria-label"),t.setAttribute("aria-hidden","true")))}render(){var e;return null!==(e=this._icon)&&void 0!==e?e:S}}vl.styles=[...Ki.styles,hl],e([Ne({type:String,reflect:!0})],vl.prototype,"name",void 0),e([Ne({type:String,reflect:!0})],vl.prototype,"size",void 0),e([Ne({type:String})],vl.prototype,"ariaLabel",void 0),e([We()],vl.prototype,"_icon",void 0);var pl=we`:host{display:block;position:relative}.dropdown{display:flex;height:100%}.dropdown-menu{box-sizing:border-box;max-height:10rem;overflow-x:hidden;overflow-y:auto}.visually-hidden{clip:rect(0,0,0,0)!important;border:0!important;height:1px!important;margin:-1px!important;overflow:hidden!important;padding:0!important;position:absolute!important;white-space:nowrap!important;width:1px!important}.combobox .form-control-group{height:unset;min-height:var(--sit-dimension-48)}.combobox-input-container{align-items:center;display:flex;flex-wrap:wrap;gap:var(--sit-gap-xs);padding:calc(var(--sit-form-padding-y) - var(--sit-form-border-width-default)) 0;width:calc(100% - var(--sit-icon-size-md, 1.25rem))}.combobox-input-container .form-control{flex:1 1 0;min-width:10ch}slot[id=default].d-none,slot[id=default].d-none::slotted(*){display:none}.form-clearable:focus-visible{outline:var(--sit-outline-focus);outline-offset:var(--sit-outline-offset-focus)}`,fl=we`:host([active]) .dropdown-item{background-color:var(--sit-bg-translucent-subtle)}.dropdown-item{background-color:var(--sit-bg-transparent);clear:both;color:var(--sit-form-color-default);cursor:pointer;font-size:var(--sit-font-size-label-md);height:100%;overflow-wrap:anywhere;padding:var(--sit-padding-sm) var(--sit-padding-md);text-align:inherit;white-space:normal}.dropdown-item.disabled{opacity:var(--sit-opacity-40);pointer-events:none}.dropdown-item .normal-item-content{align-items:center;display:flex;justify-content:space-between}:host([active]) .dropdown-item .normal-item-content{color:var(--sit-form-primary-color-default)}.dropdown-item:hover{background:var(--sit-bg-translucent-subtle)}.dropdown-item:focus-visible{background:var(--sit-bg-translucent-subtle);outline:var(--sit-form-outline-focus);outline-offset:var(--sit-form-outline-offset-focus)}`;class ml extends Ki{constructor(){super(...arguments),this.active=!1,this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-disabled",`${this.disabled}`),this.setAttribute("aria-selected",`${this.active}`)}updated(e){super.updated(e),e.has("active")&&this.setAttribute("aria-selected",`${this.active}`),e.has("disabled")&&this.setAttribute("aria-disabled",`${this.disabled}`)}render(){const e={disabled:this.disabled,active:this.active};return $`
      <div class="dropdown-item ${Xe(e)}" tabindex=${this.disabled?"-1":"0"}>
        ${this._renderItemContent()}
      </div>
    `}}ml.styles=[fl],e([Ne({type:Boolean,reflect:!0})],ml.prototype,"active",void 0),e([Ne({type:Boolean,reflect:!0})],ml.prototype,"disabled",void 0),e([Ne({type:String,reflect:!0})],ml.prototype,"value",void 0);var gl=we`.form-label{color:var(--sit-form-color-default);font-weight:var(--sit-font-weight-semibold);margin-bottom:0}.form-label.disabled{opacity:var(--sit-opacity-40)}.form-check-label{color:var(--sit-form-color-default)}.form-check-input:disabled~.form-check-label,.form-check-input[disabled]~.form-check-label{cursor:not-allowed}`,wl=we`.form-control::placeholder{color:var(--sit-form-color-subtle);font-family:var(--sit-font-family-brand);font-weight:var(--sit-font-weight-light);line-height:var(--sit-line-height-24)}`;class _l extends Ki{constructor(){super(...arguments),this.label="",this.hintText="",this.disabled=!1,this.invalid=!1,this._controlId=Fi("input"),this._labelId=Fi("label")}setInvalid(e){this.invalid=e,e?this.emit("sit-invalid"):this.emit("sit-valid")}}_l.styles=[...Ki.styles,Ti,Ri,gl,wl],e([Ne({reflect:!0})],_l.prototype,"label",void 0),e([Ne({reflect:!0})],_l.prototype,"hintText",void 0),e([Ne({reflect:!0})],_l.prototype,"name",void 0),e([Ne({type:Boolean,reflect:!0})],_l.prototype,"disabled",void 0),e([Ne({type:Boolean,reflect:!0})],_l.prototype,"invalid",void 0);var bl=we`.form-check-input[type=checkbox]{border-radius:var(--sit-form-border-radius-md)}.form-check-input[checked]{--sit-radio-bg-image:url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" fill="none"><path d="M14.347 3.979a.522.522 0 0 1 0 .739L7.043 12.02a.521.521 0 0 1-.738 0L2.653 8.369a.522.522 0 1 1 .739-.738l3.282 3.283 6.934-6.935a.52.52 0 0 1 .739 0Z" fill="%23fff"/></svg>')}.form-check-input:indeterminate,.form-check-input[indeterminate]{--sit-radio-bg-image:url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.5 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5Z" fill="%23fff"/></svg>');background-color:var(--sit-form-primary-surface-default);border:var(--sit-form-border-width-default) solid var(--sit-border-color-transparent)}.form-check-input:indeterminate:focus,.form-check-input:indeterminate:hover,.form-check-input[indeterminate]:focus-visible,.form-check-input[indeterminate]:hover{background-color:var(--sit-form-primary-surface-emphasis)}.form-check-input:indeterminate.is-invalid,.form-check-input[checked].is-invalid,.form-check-input[indeterminate].is-invalid{background-color:var(--sit-form-danger-surface-default)}.form-check-label{flex:1;font-size:var(--sit-font-size-label-md)}.form-check{margin:var(--sit-form-padding-inline-sm) 0;padding:0}`,xl=we`input{margin:0}.form-check{display:flex;gap:var(--sit-form-gap-md);padding:var(--sit-form-padding-inline-sm) 0}.form-check-input{appearance:none;background-color:var(--sit-form-surface-default);background-image:var(--sit-radio-bg-image);background-position:50%;background-repeat:no-repeat;background-size:auto;border:var(--sit-form-border-width-default) solid var(--sit-border-color-default);flex-shrink:0;height:var(--sit-form-height-sm);width:var(--sit-form-width-xs)}.form-check-input[checked]{background-color:var(--sit-form-primary-surface-default);border:var(--sit-form-border-width-default) solid var(--sit-border-color-transparent)}.form-check-input:focus-visible{outline:var(--sit-form-outline-focus);outline-offset:var(--sit-form-outline-offset-focus)}.form-check-input:not([disabled]):not(.is-invalid):not([aria-checked=true]):not(:focus-visible):hover{outline:var(--sit-form-border-width-thick) solid var(--sit-border-color-emphasis);outline-offset:var(--sit-form-outline-offset-focus)}.form-check-input:not([disabled]):not(.is-invalid)[checked]:focus-visible,.form-check-input:not([disabled]):not(.is-invalid)[checked]:hover{background-color:var(--sit-form-primary-surface-emphasis)}:host([disabled]) .form-check{cursor:not-allowed;opacity:var(--sit-opacity-40)}.form-check-input:not([disabled]).is-invalid{border:var(--sit-form-border-width-default) solid var(--sit-form-danger-border-color-default)}.form-check-input:not([disabled]).is-invalid:focus-visible{outline:var(--sit-border-width-2) solid var(--sit-form-danger-color-default);outline-offset:var(--sit-form-outline-offset-focus)}`;class yl extends(Wi(_l)){constructor(){super(...arguments),this.checked=!1,this.defaultChecked=!1,this.indeterminate=!1,this.required=!1,this.noValidate=!1,this.invalidFeedback="",this._isTouched=!1,this._handleHostClick=e=>{e.composedPath()[0]===this&&(e.stopPropagation(),this.input.click())}}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}_handleChange(e){this.indeterminate&&(this.indeterminate=!this.indeterminate),this.checked=!this.checked,super._mixinHandleChange(e),this.emit("sit-change",{detail:{checked:this.checked,value:this.value}}),this.checked?this.emit("sit-check",{detail:{value:this.value}}):this.emit("sit-uncheck",{detail:{value:this.value}})}_handleKeyDown(e){const t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;"Enter"!==e.key||t||this.click()}_handleBlur(){this._isTouched=!0,this.emit("sit-blur")}_handleFocus(){this.emit("sit-focus")}_handleInvalid(e){e.preventDefault(),this.invalid=!0}_handleDisabledChange(){this.setInvalid(!1)}_handleIsTouched(){this._mixinShouldSkipSitValidation()||this._isTouched&&(this.invalid=!this.input.checkValidity())}_mixinResetFormControl(){this._isTouched=!1,this.checked=this.input.checked=this.defaultChecked,this.input.dispatchEvent(new InputEvent("reset")),this._mixinResetValidity(this.input)}reportValidity(){return this._mixinReportValidity()}checkValidity(){return this._mixinCheckValidity()}get validity(){return this._mixinGetValidity()}get validationMessage(){return this._mixinGetValidationMessage()}firstUpdated(e){super.firstUpdated(e),this.checked&&this.emit("sit-check",{detail:{value:this.value}})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._handleHostClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleHostClick)}render(){const e="both"===this.hasFeedback||"style"===this.hasFeedback,t="both"===this.hasFeedback||"text"===this.hasFeedback;return $`
      ...
      ${t&&this.invalid?$`
          ...
          `:S}
    `}}yl.styles=[..._l.styles,xl,bl],yl.dependencies={"sit-icon":vl},e([Ne({type:String,reflect:!0})],yl.prototype,"value",void 0),e([Ne({type:Boolean,reflect:!0})],yl.prototype,"checked",void 0),e([Ne({type:String,reflect:!0})],yl.prototype,"hasFeedback",void 0),e([Ui("checked")],yl.prototype,"defaultChecked",void 0),e([Ne({type:Boolean,reflect:!0})],yl.prototype,"indeterminate",void 0),e([Ne({type:Boolean,reflect:!0})],yl.prototype,"required",void 0),e([Ne({type:Boolean,reflect:!0})],yl.prototype,"noValidate",void 0),e([Ne({type:String,reflect:!0})],yl.prototype,"invalidFeedback",void 0),e([We()],yl.prototype,"_isTouched",void 0),e([tl("disabled",{waitUntilFirstUpdate:!0})],yl.prototype,"_handleDisabledChange",null),e([tl("_isTouched",{waitUntilFirstUpdate:!0})],yl.prototype,"_handleIsTouched",null);class Cl extends ml{constructor(){super(...arguments),this.checkbox=!1,this._renderItemContent=()=>this.checkbox?$`
        ...
        `:$`
          <div class="normal-item-content" role="presentation">
            <slot></slot>
            ${this.active?$` <sit-icon name="check"></sit-icon> `:S}
          </div>
        `}connectedCallback(){super.connectedCallback()}firstUpdated(e){super.firstUpdated(e);const t=this.parentElement;(null==t?void 0:t.multiSelect)&&(this.checkbox=!0)}}Cl.dependencies={"sit-icon":vl,"sit-checkbox":yl},e([Ne({type:Boolean,reflect:!0})],Cl.prototype,"checkbox",void 0);
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const Zl=(e,t,i)=>{const l=new Map;for(let o=t;o<=i;o++)l.set(e[o],o);return l};const Ml=te(class extends ie{constructor(e){if(super(e),e.type!==Y)throw new Error("repeat() can only be used in text expressions")}_getValuesAndKeys(e,t,i){let l;void 0===i?i=t:void 0!==t&&(l=t);const o=[],r=[];let n=0;for(const t of e)o[n]=l?l(t,n):n,r[n]=i(t,n),n++;return{values:r,keys:o}}render(e,t,i){return this._getValuesAndKeys(e,t,i).values}update(e,[t,i,l]){const o=e._$committedValue;const{values:r,keys:n}=this._getValuesAndKeys(t,i,l);if(!Array.isArray(o))return this._itemKeys=n,r;const a=this._itemKeys??=[],s=[];let c,d,h=0,u=o.length-1,v=0,p=r.length-1;for(;h<=u&&v<=p;)if(null===o[h])h++;else if(null===o[u])u--;else if(a[h]===n[v])s[v]=se(o[h],r[v]),h++,v++;else if(a[u]===n[p])s[p]=se(o[u],r[p]),u--,p--;else if(a[h]===n[p])s[p]=se(o[h],r[p]),ae(e,s[p+1],o[h]),h++,p--;else if(a[u]===n[v])s[v]=se(o[u],r[v]),ae(e,o[h],o[u]),u--,v++;else if(void 0===c&&(c=Zl(n,v,p),d=Zl(a,h,u)),c.has(a[h]))if(c.has(a[u])){const t=d.get(n[v]),i=void 0!==t?o[t]:null;if(null===i){const t=ae(e,o[h]);se(t,r[v]),s[v]=t}else s[v]=se(i,r[v]),ae(e,o[h],i),o[t]=null;v++}else he(o[u]),u--;else he(o[h]),h++;for(;v<=p;){const t=ae(e,s[p+1]);se(t,r[v]),s[v++]=t}for(;h<=u;){const e=o[h++];null!==e&&he(e)}return this._itemKeys=n,de(e,s),z}}),Vl=Symbol.for(""),kl=e=>{if(e?.r===Vl)return e?._$litStatic$},Hl=new Map,Pl=($l=$,(e,...t)=>{const i=t.length;let l,o;const r=[],n=[];let a,s=0,c=!1;for(;s<i;){for(a=e[s];s<i&&void 0!==(o=t[s],l=kl(o));)a+=l+e[++s],c=!0;s!==i&&n.push(o),r.push(a),s++}if(s===i&&r.push(e[i]),c){const i=r.join("$$lit$$");void 0===(e=Hl.get(i))&&(r.raw=r,Hl.set(i,e=r)),t=n}return $l(e,...t)});
/**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */var $l,Ol=we`:host{--sit-spinner-bg:var(--sit-primary-surface-default);display:inline-flex}:host([variant=neutral]){--sit-spinner-bg:var(--sit-neutral-surface-default)}:host([tone=neutral]){--sit-spinner-bg:var(--sit-surface-inverse)}:host([tone=inverse]){--sit-spinner-bg:var(--sit-surface-default)}:host([tone=fixed-light]){--sit-spinner-bg:var(--sit-surface-fixed-light)}:host([tone=fixed-dark]){--sit-spinner-bg:var(--sit-surface-fixed-dark)}.spinner-wrapper{align-items:center;display:flex;flex-direction:column;gap:var(--sit-gap-2-xs)}.spinner-wrapper.spinner-wrapper--horizontal{flex-direction:row}.spinner-wrapper__spinner{--border-thickness:4px;animation:spinner .75s linear infinite;border:var(--border-thickness) solid var(--sit-bg-translucent);border-radius:50%;border-right:var(--border-thickness) solid var(--sit-spinner-bg);color:var(--sit-spinner-color);display:inline-flex;height:var(--sit-dimension-32);width:var(--sit-dimension-32)}.spinner-wrapper__spinner--xs{--border-thickness:2px;height:var(--sit-dimension-16);width:var(--sit-dimension-16)}.spinner-wrapper__spinner--sm{--border-thickness:3px;height:var(--sit-dimension-24);width:var(--sit-dimension-24)}.spinner-wrapper__spinner--lg{--border-thickness:6px;height:var(--sit-dimension-48);width:var(--sit-dimension-48)}.spinner-wrapper__spinner--xl{--border-thickness:8px;height:var(--sit-dimension-64);width:var(--sit-dimension-64)}.spinner-wrapper__label{color:var(--sit-neutral-color-default);font-size:var(--sit-font-size-label-sm)}@media (prefers-reduced-motion:reduce){.spinner-wrapper__spinner{animation-duration:1.5s}}

/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,zl=we`.text-primary{color:var(--sit-primary-rgb)!important}.text-secondary{color:var(--sit-secondary-rgb)!important}.text-success{color:var(--sit-success-rgb)!important}.text-info{color:var(--sit-info-rgb)!important}.text-warning{color:var(--sit-warning-rgb)!important}.text-danger{color:var(--sit-danger-rgb)!important}.text-light{color:var(--sit-light-rgb)!important}.text-dark{color:var(--sit-dark-rgb)!important}.text-muted{color:var(--sit-secondary-color)!important}`;class Sl extends Ki{constructor(){super(...arguments),this.variant="primary",this.tone="brand",this.size="md",this.orientation="vertical"}render(){return Pl`
      <div
        class="spinner-wrapper ${Xe({"spinner-wrapper--horizontal":"horizontal"===this.orientation})}"
      >
        <div
          class="spinner-wrapper__spinner ${Xe({[`spinner-wrapper__spinner--${this.size}`]:this.size})}"
          role="status"
        >
          ${this.label?S:Pl`<span class="sr-only">Loading...</span>`}
        </div>
        ${this.label?Pl`<span class="spinner-wrapper__label">${this.label}</span>`:S}
      </div>
    `}}Sl.styles=[...Ki.styles,zl,Ol],e([Ne({type:String,reflect:!0})],Sl.prototype,"variant",void 0),e([Ne({type:String,reflect:!0})],Sl.prototype,"tone",void 0),e([Ne({type:String,reflect:!0})],Sl.prototype,"size",void 0),e([Ne({reflect:!0,type:String})],Sl.prototype,"label",void 0),e([Ne({type:String,reflect:!0})],Sl.prototype,"orientation",void 0);class Bl extends el{constructor(){super(...arguments),this.multiSelect=!1,this.badgeFullWidth=!1,this.clearable=!1,this.noValidate=!1,this.async=!1,this.emptyMenuAsync=!1,this.scrollBottomOffset=0,this.filterFunction=(e,t)=>t.label.toLowerCase().startsWith(e.toLowerCase()),this.optionList=[],this.emptyMenuAfterFiltering=!1,this.isFocused=!1,this.isScrollEnd=!1,this.suffixIconTemplate=$`<sit-icon
    name=${this.menuIsOpen?"chevron-up":"chevron-down"}
    size="md"
  ></sit-icon>`,this.prefixIconTemplate=$`${S}`}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",async()=>{this.isFocused=!0}),this.addEventListener("blur",async()=>{this.isFocused=!1}),this.addEventListener("keydown",e=>{var t,i;"Enter"===e.key&&(null===(i=null===(t=e.target.shadowRoot)||void 0===t?void 0:t.querySelector(".form-clearable"))||void 0===i?void 0:i.matches(":focus"))&&this._handleClear()}),this.addEventListener("sit-hide",async e=>{if(!e.detail.isOutside){(await this._input).focus()}this.options.forEach(e=>e.removeAttribute("hidden")),this.emptyMenuAfterFiltering=!1})}async firstUpdated(e){super.firstUpdated(e),this.async&&(this.filterFunction=()=>!0),this.menuList.forEach(e=>{const t=document.createElement("sit-combo-box-option");t.innerText=e.label,t.value=e.value,t.checkbox=this.multiSelect,t.active=this.value.includes(e.value),this.appendChild(t)}),this._setupValidation(this.menuList),this.menuIsOpen&&await this.updateFloatingPosition()}async _handleDefaultSlotChange(e){const t=e.target.assignedElements({flatten:!0});t.forEach(e=>!e.hasAttribute("disabled")&&(!e.clickEventAdded&&(e.addEventListener("click",e=>{e.preventDefault();const t=e.target;return this.multiSelect&&t.active?this._handleItemUnselect(e):this._handleItemSelected(e),!1}),e.clickEventAdded=!0,void e.addEventListener("keydown",e=>{if("Enter"===e.key){this.close="outside";e.target.click()}})))),await this.updateComplete,this.optionList=await this._getMenuListFromOptions(t),this._setupValidation(this.optionList)}async _setupValidation(e){var t;if(this.value&&e.length>0){const i=this.value.split(";"),l=e.filter(({value:e})=>i.includes(e));this.selectedItems=[...l,...this.selectedItems],this.multiSelect||(this.displayValue=null===(t=l[0])||void 0===t?void 0:t.label)}this.multiSelect?this.input=await this._multiSelectInput:this.input=await this._input,this._mixinValidate(this.input)}async _handleValueChange(){this.options.forEach(e=>e.removeAttribute("hidden"));const e=await this._input;this._mixinSetFormValue(),this.multiSelect?this._mixinValidate(this.input):this._mixinValidate(e);this.selectedItems.map(e=>e.value).join(";")!==this.value&&this._updateValueAndDisplayValue(this.optionList),(this._isTouched||""!==this.value)&&(this._mixinShouldSkipSitValidation()||(this.invalid=!this._mixinReportValidity()))}_emitChangeEvents(){this._mixinSetFormValue(),this.emit("sit-change"),this.value&&this.emit("sit-select")}_handleOptionListChange(){this._updateValueAndDisplayValue(this.optionList)}_handleMenuListChange(){const e=this.menuList.map(e=>{const t=document.createElement("sit-combo-box-option");return t.innerText=e.label,t.value=e.value,t.checkbox=this.multiSelect,t.active=this.value.includes(e.value),t});this.replaceChildren(...e)}_updateValueAndDisplayValue(e){var t;const i=this.value.split(";"),l=e.filter(({value:e})=>i.includes(e));this.selectedItems=[...l];const o=l.map(e=>e.value).join(";");o!==this.value&&(this.value=o),this.multiSelect||this.async||(this.displayValue=(null===(t=l[0])||void 0===t?void 0:t.label)||""),this.options.forEach(e=>e.active=i.includes(e.value))}async _handleInputChange(e){const t=e.target;this.displayValue=t.value,this.emit("sit-input",{detail:{displayValue:this.displayValue}}),this.invalid=!1,this.showMenu(),""!==this.displayValue||this.multiSelect||(this.selectedItems=[],this.value=this.selectedItems.join(";"),this.options.forEach(e=>e.active=!1),this._emitChangeEvents());const i=this.options.map(e=>({value:e.value,label:e.textContent.trim()}));this.filteredList=i.filter(e=>this.filterFunction(this.displayValue,e)),this.emptyMenuAfterFiltering=0===this.filteredList.length;const l=this.filteredList.map(e=>e.value);this.options.forEach(e=>{l.includes(e.value)?e.hidden=!1:e.hidden=!0})}async _handleItemSelected(e){var t,i,l;const o=e.target;if(o.disabled)return;const r=null!==(i=null===(t=o.textContent)||void 0===t?void 0:t.trim())&&void 0!==i?i:"",n=null!==(l=o.getAttribute("value"))&&void 0!==l?l:r,a=this.filteredList.find(e=>e.value.toString()===n)||{label:r,value:n};this.multiSelect?(this.selectedItems.some(e=>e.value===a.value)||(this.selectedItems=[...this.selectedItems,a]),this.value=this.selectedItems.map(e=>e.value).join(";"),o.active=!0):0!==this.selectedItems.length&&this.selectedItems[0].value===a.value||(this.options.forEach(e=>e.active=!1),o.active=!0,this.selectedItems=[a],this.value=a.value.toString(),this.displayValue=a.label,this.hideMenu()),this._emitChangeEvents()}_handleItemUnselect(e){var t,i,l;const o=e.target;if(o.disabled)return;o.removeAttribute("active");const r=null!==(i=null===(t=o.textContent)||void 0===t?void 0:t.trim())&&void 0!==i?i:"",n=null!==(l=o.getAttribute("value"))&&void 0!==l?l:r,a=this.filteredList.find(e=>e.value.toString()===n)||{label:r,value:n};this.selectedItems=this.selectedItems.filter(e=>e.value!==a.value),this.value=this.selectedItems.map(e=>e.value).join(";"),this._emitChangeEvents()}async _handleBadgeDismissed(e,t){var i;e.preventDefault();const l=t.value;null===(i=this.options)||void 0===i||i.forEach(e=>e.value===l?e.active=!1:null),this.selectedItems=this.selectedItems.filter(e=>e.value!==t.value),this.value=this.selectedItems.map(e=>e.value).join(";"),this._emitChangeEvents()}async _handleMultiSelectKeyDown(e){var t;if(this.multiSelect&&"Backspace"===e.key&&this.multiSelect&&""===this.displayValue.trim()&&this.selectedItems.length>0){const e=this.selectedItems[this.selectedItems.length-1].value;null===(t=this.options)||void 0===t||t.forEach(t=>t.value===e?t.active=!1:null),this.selectedItems=this.selectedItems.slice(0,-1),this.value=this.selectedItems.map(e=>e.value).join(";"),this._emitChangeEvents()}}_handleFocus(){this.emit("sit-focus")}async _handleInputBlur(e){if(e.preventDefault(),this.emit("sit-blur"),this.multiSelect){this.selectedItems.filter(({label:e})=>this.displayValue===e).length<=0&&(this.displayValue="")}else this.selectedItems.length>0?this.displayValue=this.selectedItems[0].label:this.displayValue=""}async _handleClear(){var e;this.value=this.displayValue="",null===(e=this.options)||void 0===e||e.forEach(e=>e.active=!1),this._emitChangeEvents();(await this._input).focus(),this.showMenu()}async _mixinResetFormControl(){if(this.value=this.defaultValue,this.multiSelect){const e=this.value.split(";");this.options.forEach(t=>{t.active=e.includes(t.value)});const t=this.options.filter(t=>e.includes(t.value));this.selectedItems=t.map(e=>({value:e.value,label:e.textContent.trim()})),this._mixinResetValidity(await this._multiSelectInput)}else{this.options.forEach(e=>{e.active=e.value===this.value});const e=this.options.filter(e=>e.value===this.value);e.length<=0?this.displayValue="":this.displayValue=e[0].textContent.trim(),this._mixinResetValidity(await this._input)}}async _handleScroll(e){const t=e.target;if(t){const e=t.scrollHeight-t.clientHeight,i=Math.max(0,this.scrollBottomOffset);t.scrollTop>=e-i?(this.isScrollEnd||this.emit("sit-scroll-end"),this.isScrollEnd=!0):this.isScrollEnd=!1}}_renderInput(e){const t=this.hasFeedback,i=e;return $`
      <div
        ${ct(this.myDropdown)}
      ...
      >
        ...
        <div class="combobox-input-container">
          ${this.multiSelect?$`
                ${Ml(this.selectedItems,e=>e.value,e=>$`<sit-badge
                      outlined
                      variant="neutral"
                      show
                      ?dismissible=${!(this.readonly||this.disabled)}
                      ?fullwidth=${this.badgeFullWidth}
                      @sit-hide=${t=>this._handleBadgeDismissed(t,e)}
                      >${e.label}</sit-badge
                    >`)}
              `:S}
          <input
            ...
            @focus=${this._handleFocus}
            aria-describedby=${Ye(this.invalid&&this.hasFeedback?`${this._controlId}-invalid`:void 0)}
    ...
    `}_renderFeedbackMenu(){return this.loading?this._renderLoadingMenu():this.async?this.emptyMenuAsync||0===this.optionList.length?this._renderEmptyMenu():S:0===this.optionList.length||this.emptyMenuAfterFiltering&&this.optionList.length>0?this._renderEmptyMenu():S}render(){const e=(this.isFocused||this.menuIsOpen)&&""!==this.value&&this.clearable&&!this.readonly;return $`
      <div
        class=${Xe({"form-control-container":!0,"m-width-256":!0,disabled:this.disabled,combobox:!0})}
      ...
      ${this.multiSelect?$`<input
            ...
            .autocomplete=${this.autocomplete}
          />`:S}
    `}}Bl.styles=[...el.styles,Di,pl],Bl.childName="sit-combo-box-option",Bl.dependencies={[Bl.childName]:Cl,"sit-icon":vl,"sit-badge":cl,"sit-spinner":Sl},e([Ne({type:Boolean,reflect:!0})],Bl.prototype,"multiSelect",void 0),e([Ne({type:Boolean,reflect:!0})],Bl.prototype,"badgeFullWidth",void 0),e([Ne({type:Boolean,reflect:!0})],Bl.prototype,"clearable",void 0),e([Ne({type:Boolean,reflect:!0})],Bl.prototype,"noValidate",void 0),e([Ne({type:Boolean,reflect:!0})],Bl.prototype,"async",void 0),e([Ne({type:Boolean,reflect:!0})],Bl.prototype,"emptyMenuAsync",void 0),e([Ne({type:Number,reflect:!0})],Bl.prototype,"scrollBottomOffset",void 0),e([Ne()],Bl.prototype,"filterFunction",void 0),e([Ge("input#multi-select-input-tracker")],Bl.prototype,"_multiSelectInput",void 0),e([Je({flatten:!0,selector:"sit-combo-box-option"})],Bl.prototype,"options",void 0),e([We()],Bl.prototype,"optionList",void 0),e([We()],Bl.prototype,"emptyMenuAfterFiltering",void 0),e([We()],Bl.prototype,"isFocused",void 0),e([We()],Bl.prototype,"isScrollEnd",void 0),e([tl("value",{waitUntilFirstUpdate:!0})],Bl.prototype,"_handleValueChange",null),e([tl("optionList",{waitUntilFirstUpdate:!0})],Bl.prototype,"_handleOptionListChange",null),e([tl("menuList",{waitUntilFirstUpdate:!0})],Bl.prototype,"_handleMenuListChange",null),nl("sit-combo-box",Bl),nl("sit-combo-box-option",Cl);var Al=$`
...
`,Ll=Object.freeze({__proto__:null,default:Al}),jl=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,El=Object.freeze({__proto__:null,default:jl}),Il=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Tl=Object.freeze({__proto__:null,default:Il}),Rl=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Dl=Object.freeze({__proto__:null,default:Rl}),Ul=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Fl=Object.freeze({__proto__:null,default:Ul}),Nl=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Wl=Object.freeze({__proto__:null,default:Nl}),ql=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kl=Object.freeze({__proto__:null,default:ql}),Gl=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Jl=Object.freeze({__proto__:null,default:Gl}),Xl=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yl=Object.freeze({__proto__:null,default:Xl}),Ql=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,eo=Object.freeze({__proto__:null,default:Ql}),to=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,io=Object.freeze({__proto__:null,default:to}),lo=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oo=Object.freeze({__proto__:null,default:lo}),ro=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,no=Object.freeze({__proto__:null,default:ro}),ao=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fo=Object.freeze({__proto__:null,default:po}),mo=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,go=Object.freeze({__proto__:null,default:mo}),wo=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ao=Object.freeze({__proto__:null,default:Bo}),Lo=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,jo=Object.freeze({__proto__:null,default:Lo}),Eo=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Go=Object.freeze({__proto__:null,default:Ko}),Jo=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Xo=Object.freeze({__proto__:null,default:Jo}),Yo=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qo=Object.freeze({__proto__:null,default:Yo}),er=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,tr=Object.freeze({__proto__:null,default:er}),ir=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,lr=Object.freeze({__proto__:null,default:ir}),or=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,rr=Object.freeze({__proto__:null,default:or}),nr=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ar=Object.freeze({__proto__:null,default:nr}),sr=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,fr=Object.freeze({__proto__:null,default:pr}),mr=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,gr=Object.freeze({__proto__:null,default:mr}),wr=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ar=Object.freeze({__proto__:null,default:Br}),Lr=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,jr=Object.freeze({__proto__:null,default:Lr}),Er=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ur=Object.freeze({__proto__:null,default:Dr}),Fr=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Nr=Object.freeze({__proto__:null,default:Fr}),Wr=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Qr=Object.freeze({__proto__:null,default:Yr}),en=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,on=Object.freeze({__proto__:null,default:ln}),rn=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nn=Object.freeze({__proto__:null,default:rn}),an=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mn=Object.freeze({__proto__:null,default:fn}),gn=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wn=Object.freeze({__proto__:null,default:gn}),_n=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12.6 8a.6.6 0 1 0-1.2 0v5a.6.6 0 1 0 1.2 0V8Zm-1.45 8c0-.47.38-.85.85-.85h.01a.85.85 0 0 1 0 1.7H12a.85.85 0 0 1-.85-.85Z"
...
`,Bn=Object.freeze({__proto__:null,default:Sn}),An=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ln=Object.freeze({__proto__:null,default:An}),jn=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kn=Object.freeze({__proto__:null,default:qn}),Gn=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yn=Object.freeze({__proto__:null,default:Xn}),Qn=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,ea=Object.freeze({__proto__:null,default:Qn}),ta=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ia=Object.freeze({__proto__:null,default:ta}),la=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oa=Object.freeze({__proto__:null,default:la}),ra=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,na=Object.freeze({__proto__:null,default:ra}),aa=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ma=Object.freeze({__proto__:null,default:fa}),ga=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wa=Object.freeze({__proto__:null,default:ga}),_a=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ba=Object.freeze({__proto__:null,default:Sa}),Aa=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,La=Object.freeze({__proto__:null,default:Aa}),ja=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ka=Object.freeze({__proto__:null,default:qa}),Ga=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ya=Object.freeze({__proto__:null,default:Xa}),Qa=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,is=Object.freeze({__proto__:null,default:ts}),ls=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,os=Object.freeze({__proto__:null,default:ls}),rs=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ns=Object.freeze({__proto__:null,default:rs}),as=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,ms=Object.freeze({__proto__:null,default:fs}),gs=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ws=Object.freeze({__proto__:null,default:gs}),_s=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bs=Object.freeze({__proto__:null,default:Ss}),As=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ls=Object.freeze({__proto__:null,default:As}),js=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ks=Object.freeze({__proto__:null,default:qs}),Gs=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Ys=Object.freeze({__proto__:null,default:Xs}),Qs=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ic=Object.freeze({__proto__:null,default:tc}),lc=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oc=Object.freeze({__proto__:null,default:lc}),rc=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nc=Object.freeze({__proto__:null,default:rc}),ac=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mc=Object.freeze({__proto__:null,default:fc}),gc=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,wc=Object.freeze({__proto__:null,default:gc}),_c=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bc=Object.freeze({__proto__:null,default:Sc}),Ac=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lc=Object.freeze({__proto__:null,default:Ac}),jc=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Kc=Object.freeze({__proto__:null,default:qc}),Gc=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Yc=Object.freeze({__proto__:null,default:Xc}),Qc=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,id=Object.freeze({__proto__:null,default:td}),ld=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,od=Object.freeze({__proto__:null,default:ld}),rd=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,nd=Object.freeze({__proto__:null,default:rd}),ad=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,md=Object.freeze({__proto__:null,default:fd}),gd=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,wd=Object.freeze({__proto__:null,default:gd}),_d=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Bd=Object.freeze({__proto__:null,default:Sd}),Ad=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Ld=Object.freeze({__proto__:null,default:Ad}),jd=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Kd=Object.freeze({__proto__:null,default:qd}),Gd=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,Yd=Object.freeze({__proto__:null,default:Xd}),Qd=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,ih=Object.freeze({__proto__:null,default:th}),lh=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,oh=Object.freeze({__proto__:null,default:lh}),rh=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
...
`,nh=Object.freeze({__proto__:null,default:rh}),ah=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,mh=Object.freeze({__proto__:null,default:fh}),gh=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,wh=Object.freeze({__proto__:null,default:gh}),_h=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
`,Bh=Object.freeze({__proto__:null,default:Sh}),Ah=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Lh=Object.freeze({__proto__:null,default:Ah}),jh=$`
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      fill-rule="evenodd"
...
`,Wh=Object.freeze({__proto__:null,default:Nh})});
