...
export class SitQuantityToggle extends SitFormValidatorMixin(FormControlElement) implements SitFormControl {
  ...
  /** @internal */
  @query("sit-icon-button[ariaLabel^='increase by']") private plusBtn: HTMLButtonElement;
  /** @internal */
  @query("sit-icon-button[ariaLabel^='decrease by']") private minusBtn: HTMLButtonElement;
  ...
  @queryAsync("sit-input") private _sitInput: Promise<SitInput>;
