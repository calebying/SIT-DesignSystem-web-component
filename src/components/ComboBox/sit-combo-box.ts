...
export class SitComboBox extends SelectElement {
  ...
  static childName = "sit-combo-box-option";
  /** @internal */
  static dependencies = {
  ...
  async firstUpdated(changedProperties: PropertyValueMap<this>) {
    ...
    this.menuList.forEach(o => {
      const comboBoxOption = document.createElement("sit-combo-box-option") as SitComboBoxOption;
  ...
  protected async _handleInputChange(e: CustomEvent) {
    ...
    this.emit<ISitComboBoxInputEventDetail>("sit-input", { detail: { displayValue: this.displayValue } });
    this.invalid = false;
    this.showMenu();
  ...
  protected suffixIconTemplate: TemplateResult = html`<sit-icon
